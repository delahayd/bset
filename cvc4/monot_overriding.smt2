...
(assert
;; monot_overriding
 ;; File "lemmes_bbook.why", line 837, characters 7-23
  (not
  (forall ((s (set a)) (t (set b)) (h (set (tuple21 a b))) (q (set (tuple21 a
  b))) (p (set (tuple21 a b))))
  (=> (and (mem4 h (relation1 s t)) (mem4 q (relation1 s t)))
  (=> (subset6 p h) (subset6 (infix_lspl1 p q) (infix_lspl1 h q)))))))
(check-sat)
