...
(declare-fun relation5 ((set a) (set (tuple21 b c))) (set (set (tuple21 a
  (tuple21 b c)))))
...
(assert
;; mem_direct_product_1
 ;; File "lemmes_bbook.why", line 513, characters 7-27
  (not
  (forall ((s (set a)) (t (set b)) (u (set c)) (p (set (tuple21 a b)))
  (q (set (tuple21 a c))))
  (=> (and (mem4 p (relation1 s t)) (mem11 q (relation3 s u))) (mem15
  (direct_product1 p q) (relation5 s (times3 t u)))))))
(check-sat)
