...
(assert
;; equal_semicolon_25
 ;; File "lemmes_bbook.why", line 1721, characters 7-25
  (not
  (forall ((s (set a)) (t (set b)) (u (set c)) (p (set (tuple21 a b)))
  (q (set (tuple21 a b))) (r (set (tuple21 b c))))
  (=>
  (and (mem4 p (relation1 s t))
  (and (mem4 q (relation1 s t)) (mem9 r (relation4 t u)))) (infix_eqeq9
  (semicolon1 (union5 p q) r) (union10 (semicolon1 p r) (semicolon1 q r)))))))
(check-sat)
