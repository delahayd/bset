...
(assert
;; equal_substraction_5
 ;; File "lemmes_bbook.why", line 2112, characters 7-27
  (not
  (forall ((s (set a)) (u (set a)) (v (set a)) (t (set b)) (r (set (tuple21 a
  b))))
  (=> (and (subset2 u s) (and (subset2 v s) (mem4 r (relation1 s t))))
  (infix_eqeq4 (domain_substraction1 u (domain_restriction1 v r))
  (domain_restriction1 (diff1 v u) r))))))
(check-sat)
