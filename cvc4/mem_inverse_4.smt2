...
(declare-fun infix_gtmngtgt2 ((set b) (set a)) (set (set (tuple21 b a))))

;; mem_total_bijection_set
  (assert
  (forall ((s (set b)) (t (set a)) (x (set (tuple21 b a))))
  (= (mem6 x (infix_gtmngtgt2 s t))
...
(assert
;; mem_inverse_4
 ;; File "lemmes_bbook.why", line 328, characters 7-20
  (not
  (forall ((s (set a)) (t (set b)) (f (set (tuple21 a b))))
  (=> (mem4 f (infix_gtmngtgt1 s t)) (mem6 (inverse2 f)
  (infix_gtmngtgt2 t s))))))
(check-sat)
