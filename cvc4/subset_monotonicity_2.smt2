...
(declare-fun power1 ((set a)) (set (set a)))
...
(declare-fun subset4 ((set (set a)) (set (set a))) Bool)
...
(declare-fun t2tb9 ((set (set (set a)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (set a))))) (sort (set1 (set1 (set1 a1))) (t2tb9 x))))

(declare-fun tb2t9 (uni) (set (set (set a))))

;; BridgeL
  (assert
  (forall ((i (set (set (set a)))))
  (! (= (tb2t9 (t2tb9 i)) i) :pattern ((t2tb9 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (set1 a1))) j) (= (t2tb9 (tb2t9 j)) j)) :pattern (
  (t2tb9 (tb2t9 j))) )))

;; subset_def
  (assert
  (forall ((s (set (set a))) (t (set (set a))))
  (= (subset4 s t) (mem (set1 (set1 a1)) (t2tb s)
  (power (set1 a1) (t2tb t))))))
...
;; subset_def
  ...
  (= (subset2 s t) (mem (set1 a1) (t2tb1 s) (t2tb (power1 t))))))
...
;; subsetnoteq_def
  (assert
  (forall ((s (set (set a))) (t (set (set a))))
  (= (subsetnoteq (set1 a1) (t2tb s) (t2tb t))
  (and (subset4 s t) (not (infix_eqeq (set1 a1) (t2tb s) (t2tb t)))))))
...
;; mem_power
  (assert
  (forall ((s (set a)) (t (set a)))
  (= (mem (set1 a1) (t2tb1 s) (t2tb (power1 t)))
  (forall ((x a))
...
(assert
;; subset_monotonicity_2
 ;; File "lemmes_bbook.why", line 51, characters 7-28
  (not
  (forall ((s (set a)) (t (set a)))
  (=> (subset2 s t) (subset4 (power1 s) (power1 t))))))
(check-sat)
