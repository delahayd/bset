...
(assert
;; equal_restriction_17
 ;; File "lemmes_bbook.why", line 2001, characters 7-27
  (not
  (forall ((s (set a)) (u (set a)) (t (set b)) (r (set (tuple21 a b))))
  (=>
  (and (subset2 u s)
  (and (mem4 r (relation1 s t)) (infix_eqeq1 (inter1 (dom1 r) u) empty1)))
  (infix_eqeq4 (domain_restriction1 u r) empty3)))))
(check-sat)
