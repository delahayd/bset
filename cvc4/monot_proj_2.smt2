...
(declare-fun subset16 ((set (tuple21 (tuple21 a b) b))
  (set (tuple21 (tuple21 a b) b))) Bool)
...
;; subset_def
  ...
  b))))
  (= (subset16 s t) (mem (set1 (tuple2 (tuple2 a1 b1) b1)) (t2tb27 s)
  (power (tuple2 (tuple2 a1 b1) b1) (t2tb27 t))))))
...
;; subsetnoteq_def
  ...
  (forall ((s (set (tuple21 (tuple21 a b) b))) (t (set (tuple21 (tuple21 a b)
  b))))
  (= (subsetnoteq (tuple2 (tuple2 a1 b1) b1) (t2tb27 s) (t2tb27 t))
  (and (subset16 s t)
  (not (infix_eqeq (tuple2 (tuple2 a1 b1) b1) (t2tb27 s) (t2tb27 t)))))))
...
;; mem_times
  ...
  (= (mem (tuple2 (tuple2 a1 b1) b1) (t2tb28 (Tuple24 x y))
  (times b1 (tuple2 a1 b1) (t2tb11 s) (t2tb12 t)))
  (and (mem (tuple2 a1 b1) (t2tb13 x) (t2tb11 s)) (mem b1 (t2tb14 y)
  (t2tb12 t))))))
...
;; mem_relation
  ...
  (=> (mem (tuple2 (tuple2 a1 b1) b1) (t2tb28 (Tuple24 x y)) (t2tb27 r))
  (and (mem (tuple2 a1 b1) (t2tb13 x) (t2tb11 u)) (mem b1 (t2tb14 y)
  (t2tb12 v))))))))
...
;; mem_inverse
  ...
  (inverse b1 (tuple2 a1 b1) (t2tb27 p))) (mem (tuple2 (tuple2 a1 b1) b1)
  (t2tb28 (Tuple24 y x)) (t2tb27 p)))))
...
;; mem_inverse
  ...
  (= (mem (tuple2 (tuple2 a1 b1) b1) (t2tb28 (Tuple24 x y))
  (inverse (tuple2 a1 b1) b1 (t2tb34 p))) (mem (tuple2 b1 (tuple2 a1 b1))
...
;; mem_dom
  ...
  (= (mem (tuple2 a1 b1) (t2tb13 x) (dom b1 (tuple2 a1 b1) (t2tb27 p)))
  (exists ((b2 b)) (mem (tuple2 (tuple2 a1 b1) b1) (t2tb28 (Tuple24 x b2))
  (t2tb27 p))))))
...
;; mem_ran
  ...
  (= (mem b1 (t2tb14 x) (ran b1 (tuple2 a1 b1) (t2tb27 p)))
  (exists ((a2 (tuple21 a b))) (mem (tuple2 (tuple2 a1 b1) b1)
  (t2tb28 (Tuple24 a2 x)) (t2tb27 p))))))
...
;; mem_semicolon
  ...
  (Tuple2 a2 (tuple2 a1 b1) x (t2tb13 b2)) p) (mem (tuple2 (tuple2 a1 b1) b1)
  (t2tb28 (Tuple24 b2 y)) (t2tb27 q))))))))
...
;; mem_semicolon
  ...
  (and
  (=> (mem (tuple2 (tuple2 a1 b1) b1) (t2tb28 (Tuple24 x y))
  (semicolon b1 b2 (tuple2 a1 b1) p q))
  (exists ((b3 uni))
  (and (sort b2 b3)
  ...
  (and (mem (tuple2 (tuple2 a1 b1) b2)
  (Tuple2 (tuple2 a1 b1) b2 (t2tb13 x) b3) p) (mem (tuple2 b2 b1)
  (Tuple2 b2 b1 b3 (t2tb14 y)) q))) (mem (tuple2 (tuple2 a1 b1) b1)
  (t2tb28 (Tuple24 x y)) (semicolon b1 b2 (tuple2 a1 b1) p q)))))))
...
;; mem_semicolon
  ...
  (= (mem (tuple2 (tuple2 a1 b1) b1) (t2tb28 (Tuple24 x y))
  (semicolon b1 (tuple2 a1 b1) (tuple2 a1 b1) (t2tb25 p) (t2tb27 q)))
  (exists ((b2 (tuple21 a b)))
  (and (mem (tuple2 (tuple2 a1 b1) (tuple2 a1 b1))
  (Tuple2 (tuple2 a1 b1) (tuple2 a1 b1) (t2tb13 x) (t2tb13 b2)) (t2tb25 p))
  (mem (tuple2 (tuple2 a1 b1) b1) (t2tb28 (Tuple24 b2 y)) (t2tb27 q)))))))
...
;; mem_semicolon
  ...
  (x (tuple21 a b)) (y b))
  (= (mem (tuple2 (tuple2 a1 b1) b1) (t2tb28 (Tuple24 x y))
  (semicolon b1 b1 (tuple2 a1 b1) (t2tb27 p) (t2tb35 q)))
  (exists ((b2 b))
  (and (mem (tuple2 (tuple2 a1 b1) b1) (t2tb28 (Tuple24 x b2)) (t2tb27 p))
  (mem (tuple2 b1 b1) (Tuple2 b1 b1 (t2tb14 b2) (t2tb14 y)) (t2tb35 q)))))))
...
;; mem_semicolon
  ...
  (exists ((b2 b))
  (and (mem (tuple2 (tuple2 a1 b1) b1) (t2tb28 (Tuple24 x b2)) (t2tb27 p))
  (mem (tuple2 b1 c2) (Tuple2 b1 c2 (t2tb14 b2) y) q)))))))
...
;; mem_semicolon
  ...
  (Tuple2 (tuple2 a1 b1) a1 (t2tb13 x) (t2tb2 b2)) (t2tb29 p)) (mem
  (tuple2 a1 b1) (t2tb13 (Tuple21 b2 y)) (t2tb11 q)))))))
...
;; mem_semicolon
  ...
  b))) (x a) (y b))
  (= (mem (tuple2 a1 b1) (t2tb13 (Tuple21 x y))
  (semicolon b1 (tuple2 a1 b1) a1 (t2tb41 p) (t2tb27 q)))
  (exists ((b2 (tuple21 a b)))
  (and (mem (tuple2 a1 (tuple2 a1 b1))
  (Tuple2 a1 (tuple2 a1 b1) (t2tb2 x) (t2tb13 b2)) (t2tb41 p)) (mem
  (tuple2 (tuple2 a1 b1) b1) (t2tb28 (Tuple24 b2 y)) (t2tb27 q)))))))
...
;; mem_domain_restriction
  ...
  (x (tuple21 a b)) (y b))
  (= (mem (tuple2 (tuple2 a1 b1) b1) (t2tb28 (Tuple24 x y))
  (domain_restriction b1 (tuple2 a1 b1) (t2tb11 s) (t2tb27 p)))
  (and (mem (tuple2 (tuple2 a1 b1) b1) (t2tb28 (Tuple24 x y)) (t2tb27 p))
...
;; mem_range_restriction
  ...
  (y b))
  (= (mem (tuple2 (tuple2 a1 b1) b1) (t2tb28 (Tuple24 x y))
  (range_restriction b1 (tuple2 a1 b1) (t2tb27 p) (t2tb12 t)))
  (and (mem (tuple2 (tuple2 a1 b1) b1) (t2tb28 (Tuple24 x y)) (t2tb27 p))
  (mem b1 (t2tb14 y) (t2tb12 t))))))
...
;; mem_domain_substraction
  ...
  (x (tuple21 a b)) (y b))
  (= (mem (tuple2 (tuple2 a1 b1) b1) (t2tb28 (Tuple24 x y))
  (domain_substraction b1 (tuple2 a1 b1) (t2tb11 s) (t2tb27 p)))
  (and (mem (tuple2 (tuple2 a1 b1) b1) (t2tb28 (Tuple24 x y)) (t2tb27 p))
...
;; mem_range_substraction
  ...
  (y b))
  (= (mem (tuple2 (tuple2 a1 b1) b1) (t2tb28 (Tuple24 x y))
  (range_substraction b1 (tuple2 a1 b1) (t2tb27 p) (t2tb12 t)))
  (and (mem (tuple2 (tuple2 a1 b1) b1) (t2tb28 (Tuple24 x y)) (t2tb27 p))
...
;; mem_image
  ...
  (= (mem b1 (t2tb14 x) (image b1 (tuple2 a1 b1) (t2tb27 p) (t2tb11 w)))
  (exists ((a2 (tuple21 a b)))
  (and (mem (tuple2 a1 b1) (t2tb13 a2) (t2tb11 w)) (mem
  (tuple2 (tuple2 a1 b1) b1) (t2tb28 (Tuple24 a2 x)) (t2tb27 p)))))))
...
;; mem_overriding
  ...
  b))) (x (tuple21 a b)) (y b))
  (= (mem (tuple2 (tuple2 a1 b1) b1) (t2tb28 (Tuple24 x y))
  (infix_lspl b1 (tuple2 a1 b1) (t2tb27 q) (t2tb27 p)))
  (or
  (and (mem (tuple2 (tuple2 a1 b1) b1) (t2tb28 (Tuple24 x y)) (t2tb27 q))
  (not (mem (tuple2 a1 b1) (t2tb13 x) (dom b1 (tuple2 a1 b1) (t2tb27 p)))))
  (mem (tuple2 (tuple2 a1 b1) b1) (t2tb28 (Tuple24 x y)) (t2tb27 p))))))
...
;; mem_direct_product
  ...
  (and (mem (tuple2 (tuple2 a1 b1) b2)
  (Tuple2 (tuple2 a1 b1) b2 (t2tb13 x) y) f) (mem (tuple2 (tuple2 a1 b1) b1)
  (t2tb28 (Tuple24 x z)) (t2tb27 g)))))))

(declare-fun t2tb1353 ((set (tuple21 (tuple21 a b) (tuple21 (tuple21 a b)
  b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 a b) (tuple21 (tuple21 a b) b))))) (sort
  (set1 (tuple2 (tuple2 a1 b1) (tuple2 (tuple2 a1 b1) b1))) (t2tb1353 x))))

(declare-fun tb2t1353 (uni) (set (tuple21 (tuple21 a b) (tuple21 (tuple21 a
  b) b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 a b) (tuple21 (tuple21 a b) b)))))
  (! (= (tb2t1353 (t2tb1353 i)) i) :pattern ((t2tb1353 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 a1 b1) (tuple2 (tuple2 a1 b1) b1))) j)
     (= (t2tb1353 (tb2t1353 j)) j)) :pattern ((t2tb1353 (tb2t1353 j))) )))

(declare-fun t2tb1354 ((tuple21 (tuple21 a b) (tuple21 (tuple21 a b)
  b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 a b) (tuple21 (tuple21 a b) b)))) (sort
  (tuple2 (tuple2 a1 b1) (tuple2 (tuple2 a1 b1) b1)) (t2tb1354 x))))

(declare-fun tb2t1354 (uni) (tuple21 (tuple21 a b) (tuple21 (tuple21 a b)
  b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 a b) (tuple21 (tuple21 a b) b))))
  (! (= (tb2t1354 (t2tb1354 i)) i) :pattern ((t2tb1354 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 a1 b1) (tuple2 (tuple2 a1 b1) b1)) j)
     (= (t2tb1354 (tb2t1354 j)) j)) :pattern ((t2tb1354 (tb2t1354 j))) )))
...
;; mem_direct_product
  ...
  (mem (tuple2 (tuple2 a1 b1) b1) (t2tb28 (Tuple24 x z)) (t2tb27 g))))))
...
;; mem_direct_product
  ...
  (and (mem (tuple2 (tuple2 a1 b1) b1) (t2tb28 (Tuple24 x y)) (t2tb27 f))
  (mem (tuple2 (tuple2 a1 b1) b1) (t2tb28 (Tuple24 x z)) (t2tb27 g))))))
...
;; mem_direct_product
  ...
  (and (mem (tuple2 (tuple2 a1 b1) a1)
  (Tuple2 (tuple2 a1 b1) a1 (t2tb13 x) (t2tb2 y)) (t2tb29 f)) (mem
  (tuple2 (tuple2 a1 b1) b1) (t2tb28 (Tuple24 x z)) (t2tb27 g))))))
...
(declare-fun t2tb1357 ((set (tuple21 a (tuple21 (tuple21 a b) b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 a (tuple21 (tuple21 a b) b))))) (sort
  (set1 (tuple2 a1 (tuple2 (tuple2 a1 b1) b1))) (t2tb1357 x))))

(declare-fun tb2t1357 (uni) (set (tuple21 a (tuple21 (tuple21 a b) b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 a (tuple21 (tuple21 a b) b)))))
  (! (= (tb2t1357 (t2tb1357 i)) i) :pattern ((t2tb1357 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 a1 (tuple2 (tuple2 a1 b1) b1))) j)
     (= (t2tb1357 (tb2t1357 j)) j)) :pattern ((t2tb1357 (tb2t1357 j))) )))

(declare-fun t2tb1358 ((tuple21 a (tuple21 (tuple21 a b) b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 a (tuple21 (tuple21 a b) b)))) (sort
  (tuple2 a1 (tuple2 (tuple2 a1 b1) b1)) (t2tb1358 x))))

(declare-fun tb2t1358 (uni) (tuple21 a (tuple21 (tuple21 a b) b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 a (tuple21 (tuple21 a b) b))))
  (! (= (tb2t1358 (t2tb1358 i)) i) :pattern ((t2tb1358 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 a1 (tuple2 (tuple2 a1 b1) b1)) j)
     (= (t2tb1358 (tb2t1358 j)) j)) :pattern ((t2tb1358 (tb2t1358 j))) )))
...
;; mem_direct_product
  ...
  (and (mem (tuple2 a1 (tuple2 a1 b1))
  (Tuple2 a1 (tuple2 a1 b1) (t2tb2 x) (t2tb13 y)) (t2tb41 f)) (mem
...
(declare-fun t2tb1359 ((set (tuple21 (tuple21 (tuple21 a b) b) (tuple21 a
  b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 (tuple21 a b) b) (tuple21 a b))))) (sort
  (set1 (tuple2 (tuple2 (tuple2 a1 b1) b1) (tuple2 a1 b1))) (t2tb1359 x))))

(declare-fun tb2t1359 (uni) (set (tuple21 (tuple21 (tuple21 a b) b)
  (tuple21 a b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 (tuple21 a b) b) (tuple21 a b)))))
  (! (= (tb2t1359 (t2tb1359 i)) i) :pattern ((t2tb1359 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 (tuple2 a1 b1) b1) (tuple2 a1 b1))) j)
     (= (t2tb1359 (tb2t1359 j)) j)) :pattern ((t2tb1359 (tb2t1359 j))) )))

(declare-fun t2tb1360 ((tuple21 (set (tuple21 a b)) (set b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (set (tuple21 a b)) (set b)))) (sort
  (tuple2 (set1 (tuple2 a1 b1)) (set1 b1)) (t2tb1360 x))))

(declare-fun tb2t1360 (uni) (tuple21 (set (tuple21 a b)) (set b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (set (tuple21 a b)) (set b))))
  (! (= (tb2t1360 (t2tb1360 i)) i) :pattern ((t2tb1360 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (set1 (tuple2 a1 b1)) (set1 b1)) j)
     (= (t2tb1360 (tb2t1360 j)) j)) :pattern ((t2tb1360 (tb2t1360 j))) )))

(declare-fun t2tb1361 ((tuple21 (tuple21 (tuple21 a b) b) (tuple21 a
  b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 (tuple21 a b) b) (tuple21 a b)))) (sort
  (tuple2 (tuple2 (tuple2 a1 b1) b1) (tuple2 a1 b1)) (t2tb1361 x))))

(declare-fun tb2t1361 (uni) (tuple21 (tuple21 (tuple21 a b) b) (tuple21 a
  b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 (tuple21 a b) b) (tuple21 a b))))
  (! (= (tb2t1361 (t2tb1361 i)) i) :pattern ((t2tb1361 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 (tuple2 a1 b1) b1) (tuple2 a1 b1)) j)
     (= (t2tb1361 (tb2t1361 j)) j)) :pattern ((t2tb1361 (tb2t1361 j))) )))
...
;; mem_proj_op_1
  ...
  (Tuple2 (tuple2 (tuple2 a1 b1) b1) (tuple2 a1 b1) (t2tb28 (Tuple24 x y))
  (t2tb13 z))
  (times (tuple2 a1 b1) (tuple2 (tuple2 a1 b1) b1)
  (times b1 (tuple2 a1 b1) (t2tb11 s) (t2tb12 t)) (t2tb11 s))) (= z x)))))
...
(declare-fun t2tb1362 ((set (tuple21 (tuple21 (tuple21 a b) b) b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 (tuple21 a b) b) b)))) (sort
  (set1 (tuple2 (tuple2 (tuple2 a1 b1) b1) b1)) (t2tb1362 x))))

(declare-fun tb2t1362 (uni) (set (tuple21 (tuple21 (tuple21 a b) b) b)))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 (tuple21 a b) b) b))))
  (! (= (tb2t1362 (t2tb1362 i)) i) :pattern ((t2tb1362 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 (tuple2 a1 b1) b1) b1)) j)
     (= (t2tb1362 (tb2t1362 j)) j)) :pattern ((t2tb1362 (tb2t1362 j))) )))

(declare-fun t2tb1363 ((tuple21 (tuple21 (tuple21 a b) b) b)) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 (tuple21 a b) b) b))) (sort
  (tuple2 (tuple2 (tuple2 a1 b1) b1) b1) (t2tb1363 x))))

(declare-fun tb2t1363 (uni) (tuple21 (tuple21 (tuple21 a b) b) b))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 (tuple21 a b) b) b)))
  (! (= (tb2t1363 (t2tb1363 i)) i) :pattern ((t2tb1363 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 (tuple2 a1 b1) b1) b1) j)
     (= (t2tb1363 (tb2t1363 j)) j)) :pattern ((t2tb1363 (tb2t1363 j))) )))
...
;; mem_proj_op_2
  ...
  (Tuple2 (tuple2 (tuple2 a1 b1) b1) b1 (t2tb28 (Tuple24 x y)) (t2tb14 z))
  (times b1 (tuple2 (tuple2 a1 b1) b1)
  (times b1 (tuple2 a1 b1) (t2tb11 s) (t2tb12 t)) (t2tb12 t))) (= z y)))))
...
;; mem_proj_op_2
  ...
  (= (mem (tuple2 (tuple2 a1 b1) b1) (t2tb28 (Tuple24 (Tuple21 x y) z))
  (t2tb27 (prj21 (Tuple23 s t))))
  (and (mem (tuple2 (tuple2 a1 b1) b1) (t2tb28 (Tuple24 (Tuple21 x y) z))
...
;; mem_parallel_product
  ...
  (tuple2 (tuple2 a1 b1) b1) (t2tb28 (Tuple24 y w)) (t2tb27 k)))))))
...
;; mem_parallel_product
  ...
  (and (mem (tuple2 a2 (tuple2 a1 b1))
  (Tuple2 a2 (tuple2 a1 b1) x (t2tb13 z)) h) (mem (tuple2 (tuple2 a1 b1) b1)
  (t2tb28 (Tuple24 y w)) (t2tb27 k)))))))
...
;; mem_parallel_product
  ...
  (and (mem (tuple2 a2 (tuple2 a1 b1))
  (Tuple2 a2 (tuple2 a1 b1) x (t2tb13 z)) h) (mem (tuple2 a1 b1)
  (t2tb13 (Tuple21 y w)) (t2tb11 k)))))))
...
;; mem_parallel_product
  ...
  (and (mem (tuple2 a2 a1) (Tuple2 a2 a1 x (t2tb2 z)) h) (mem
  (tuple2 (tuple2 a1 b1) b1) (t2tb28 (Tuple24 y w)) (t2tb27 k)))))))
...
;; mem_parallel_product
  ...
  (= (mem (tuple2 (tuple2 (tuple2 a1 b1) b1) (tuple2 b2 d2))
  (Tuple2 (tuple2 (tuple2 a1 b1) b1) (tuple2 b2 d2) (t2tb28 (Tuple24 x y))
  (Tuple2 b2 d2 z w)) (parallel_product d2 b1 b2 (tuple2 a1 b1) h k))
  (and (mem (tuple2 (tuple2 a1 b1) b2)
  (Tuple2 (tuple2 a1 b1) b2 (t2tb13 x) z) h) (mem (tuple2 b1 d2)
  (Tuple2 b1 d2 (t2tb14 y) w) k))))))

(declare-fun t2tb1364 ((set (tuple21 (tuple21 (tuple21 a b) b)
...
(declare-fun tb2t1364 (uni) (set (tuple21 (tuple21 (tuple21 a b) b)
  (tuple21 (tuple21 a b) b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 (tuple21 a b) b) (tuple21 (tuple21 a b)
  b))))) (! (= (tb2t1364 (t2tb1364 i)) i) :pattern ((t2tb1364 i)) )))
...
;; BridgeR
  ...
  (! (=> (sort
     ...
     (= (t2tb1364 (tb2t1364 j)) j)) :pattern ((t2tb1364 (tb2t1364 j))) )))

(declare-fun t2tb1365 ((tuple21 (tuple21 (tuple21 a b) b) (tuple21 (tuple21 a
  b) b))) uni)
...
(declare-fun tb2t1365 (uni) (tuple21 (tuple21 (tuple21 a b) b)
  (tuple21 (tuple21 a b) b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 (tuple21 a b) b) (tuple21 (tuple21 a b) b))))
  (! (= (tb2t1365 (t2tb1365 i)) i) :pattern ((t2tb1365 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 (tuple2 a1 b1) b1) (tuple2 (tuple2 a1 b1) b1))
     j) (= (t2tb1365 (tb2t1365 j)) j)) :pattern ((t2tb1365 (tb2t1365 j))) )))
...
(declare-fun t2tb1366 ((set (tuple21 (tuple21 (tuple21 a b) (tuple21 a b))
  (tuple21 b b)))) uni)
...
(declare-fun tb2t1366 (uni) (set (tuple21 (tuple21 (tuple21 a b) (tuple21 a
  b)) (tuple21 b b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 (tuple21 a b) (tuple21 a b)) (tuple21 b
  b))))) (! (= (tb2t1366 (t2tb1366 i)) i) :pattern ((t2tb1366 i)) )))
...
;; BridgeR
  ...
  (! (=> (sort
     ...
     (= (t2tb1366 (tb2t1366 j)) j)) :pattern ((t2tb1366 (tb2t1366 j))) )))

(declare-fun t2tb1367 ((tuple21 (tuple21 (tuple21 a b) (tuple21 a b))
  (tuple21 b b))) uni)
...
(declare-fun tb2t1367 (uni) (tuple21 (tuple21 (tuple21 a b) (tuple21 a b))
  (tuple21 b b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 (tuple21 a b) (tuple21 a b)) (tuple21 b b))))
  (! (= (tb2t1367 (t2tb1367 i)) i) :pattern ((t2tb1367 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 (tuple2 a1 b1) (tuple2 a1 b1)) (tuple2 b1 b1))
     j) (= (t2tb1367 (tb2t1367 j)) j)) :pattern ((t2tb1367 (tb2t1367 j))) )))
...
;; mem_parallel_product
  ...
  (t2tb27 k)))
  (and (mem (tuple2 (tuple2 a1 b1) b1) (t2tb28 (Tuple24 x z)) (t2tb27 h))
  (mem (tuple2 (tuple2 a1 b1) b1) (t2tb28 (Tuple24 y w)) (t2tb27 k))))))
...
;; mem_parallel_product
  ...
  (y b) (z b) (w uni))
  (= (mem (tuple2 (tuple2 (tuple2 a1 b1) b1) (tuple2 b1 d2))
  (Tuple2 (tuple2 (tuple2 a1 b1) b1) (tuple2 b1 d2) (t2tb28 (Tuple24 x y))
  (Tuple2 b1 d2 (t2tb14 z) w))
  (parallel_product d2 b1 b1 (tuple2 a1 b1) (t2tb27 h) k))
  (and (mem (tuple2 (tuple2 a1 b1) b1) (t2tb28 (Tuple24 x z)) (t2tb27 h))
  (mem (tuple2 b1 d2) (Tuple2 b1 d2 (t2tb14 y) w) k))))))

(declare-fun t2tb1368 ((tuple21 (tuple21 (tuple21 a b) (set a)) (tuple21 b
  (set b)))) uni)
...
(declare-fun tb2t1368 (uni) (tuple21 (tuple21 (tuple21 a b) (set a))
  (tuple21 b (set b))))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 (tuple21 a b) (set a)) (tuple21 b (set b)))))
  (! (= (tb2t1368 (t2tb1368 i)) i) :pattern ((t2tb1368 i)) )))
...
;; BridgeR
  ...
  (! (=> (sort
     ...
     (= (t2tb1368 (tb2t1368 j)) j)) :pattern ((t2tb1368 (tb2t1368 j))) )))
...
(declare-fun t2tb1369 ((set (tuple21 (tuple21 (tuple21 a b) (set a))
  (tuple21 b (set b))))) uni)
...
(declare-fun tb2t1369 (uni) (set (tuple21 (tuple21 (tuple21 a b) (set a))
  (tuple21 b (set b)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 (tuple21 a b) (set a)) (tuple21 b
  (set b)))))) (! (= (tb2t1369 (t2tb1369 i)) i) :pattern ((t2tb1369 i)) )))
...
;; BridgeR
  ...
  (! (=> (sort
     (set1 (tuple2 (tuple2 (tuple2 a1 b1) (set1 a1)) (tuple2 b1 (set1 b1))))
     j) (= (t2tb1369 (tb2t1369 j)) j)) :pattern ((t2tb1369 (tb2t1369 j))) )))
...
(declare-fun t2tb1370 ((set (tuple21 (tuple21 (tuple21 a b) a) (tuple21 b
  b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 (tuple21 a b) a) (tuple21 b b))))) (sort
  (set1 (tuple2 (tuple2 (tuple2 a1 b1) a1) (tuple2 b1 b1))) (t2tb1370 x))))

(declare-fun tb2t1370 (uni) (set (tuple21 (tuple21 (tuple21 a b) a)
  (tuple21 b b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 (tuple21 a b) a) (tuple21 b b)))))
  (! (= (tb2t1370 (t2tb1370 i)) i) :pattern ((t2tb1370 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 (tuple2 a1 b1) a1) (tuple2 b1 b1))) j)
     (= (t2tb1370 (tb2t1370 j)) j)) :pattern ((t2tb1370 (tb2t1370 j))) )))

(declare-fun t2tb1371 ((tuple21 (tuple21 (tuple21 a b) a) (tuple21 b
  b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 (tuple21 a b) a) (tuple21 b b)))) (sort
  (tuple2 (tuple2 (tuple2 a1 b1) a1) (tuple2 b1 b1)) (t2tb1371 x))))

(declare-fun tb2t1371 (uni) (tuple21 (tuple21 (tuple21 a b) a) (tuple21 b
  b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 (tuple21 a b) a) (tuple21 b b))))
  (! (= (tb2t1371 (t2tb1371 i)) i) :pattern ((t2tb1371 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 (tuple2 a1 b1) a1) (tuple2 b1 b1)) j)
     (= (t2tb1371 (tb2t1371 j)) j)) :pattern ((t2tb1371 (tb2t1371 j))) )))
...
;; mem_parallel_product
  ...
  (forall ((h (set (tuple21 (tuple21 a b) b))) (k uni) (x (tuple21 a b))
  (y uni) (z b) (w uni))
  (= (mem (tuple2 (tuple2 (tuple2 a1 b1) c2) (tuple2 b1 d2))
  (Tuple2 (tuple2 (tuple2 a1 b1) c2) (tuple2 b1 d2)
  (Tuple2 (tuple2 a1 b1) c2 (t2tb13 x) y) (Tuple2 b1 d2 (t2tb14 z) w))
  (parallel_product d2 c2 b1 (tuple2 a1 b1) (t2tb27 h) k))
  (and (mem (tuple2 (tuple2 a1 b1) b1) (t2tb28 (Tuple24 x z)) (t2tb27 h))
...
(declare-fun t2tb1372 ((set (tuple21 (tuple21 (tuple21 a b) b)
...
(declare-fun tb2t1372 (uni) (set (tuple21 (tuple21 (tuple21 a b) b)
  (tuple21 (set a) (set b)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 (tuple21 a b) b) (tuple21 (set a)
  (set b)))))) (! (= (tb2t1372 (t2tb1372 i)) i) :pattern ((t2tb1372 i)) )))
...
;; BridgeR
  ...
  (! (=> (sort
     (set1 (tuple2 (tuple2 (tuple2 a1 b1) b1) (tuple2 (set1 a1) (set1 b1))))
     j) (= (t2tb1372 (tb2t1372 j)) j)) :pattern ((t2tb1372 (tb2t1372 j))) )))
...
(declare-fun t2tb1373 ((tuple21 (tuple21 (tuple21 a b) b) (tuple21 (set a)
  (set b)))) uni)
...
(declare-fun tb2t1373 (uni) (tuple21 (tuple21 (tuple21 a b) b)
  (tuple21 (set a) (set b))))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 (tuple21 a b) b) (tuple21 (set a) (set b)))))
  (! (= (tb2t1373 (t2tb1373 i)) i) :pattern ((t2tb1373 i)) )))
...
;; BridgeR
  ...
  (! (=> (sort
     ...
     (= (t2tb1373 (tb2t1373 j)) j)) :pattern ((t2tb1373 (tb2t1373 j))) )))
...
;; mem_parallel_product
  ...
  (parallel_product (set1 b1) b1 (set1 a1) (tuple2 a1 b1) (t2tb1318 h)
  (t2tb1350 k)))
...
(declare-fun t2tb1374 ((set (tuple21 (tuple21 (set a) (set b))
  (tuple21 (tuple21 a b) b)))) uni)
...
(declare-fun tb2t1374 (uni) (set (tuple21 (tuple21 (set a) (set b))
  (tuple21 (tuple21 a b) b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 (set a) (set b)) (tuple21 (tuple21 a b)
  b))))) (! (= (tb2t1374 (t2tb1374 i)) i) :pattern ((t2tb1374 i)) )))
...
;; BridgeR
  ...
  (! (=> (sort
     (set1 (tuple2 (tuple2 (set1 a1) (set1 b1)) (tuple2 (tuple2 a1 b1) b1)))
     j) (= (t2tb1374 (tb2t1374 j)) j)) :pattern ((t2tb1374 (tb2t1374 j))) )))
...
(declare-fun t2tb1375 ((tuple21 (tuple21 (set a) (set b)) (tuple21 (tuple21 a
  b) b))) uni)
...
(declare-fun tb2t1375 (uni) (tuple21 (tuple21 (set a) (set b))
  (tuple21 (tuple21 a b) b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 (set a) (set b)) (tuple21 (tuple21 a b) b))))
  (! (= (tb2t1375 (t2tb1375 i)) i) :pattern ((t2tb1375 i)) )))
...
;; BridgeR
  ...
  (! (=> (sort
     ...
     (= (t2tb1375 (tb2t1375 j)) j)) :pattern ((t2tb1375 (tb2t1375 j))) )))
...
;; mem_parallel_product
  ...
  (parallel_product b1 (set1 b1) (tuple2 a1 b1) (set1 a1) (t2tb1328 h)
  (t2tb1341 k)))
...
(declare-fun t2tb1376 ((set (tuple21 (tuple21 (set a) (tuple21 a b))
  (tuple21 (set b) b)))) uni)
...
(declare-fun tb2t1376 (uni) (set (tuple21 (tuple21 (set a) (tuple21 a b))
  (tuple21 (set b) b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 (set a) (tuple21 a b)) (tuple21 (set b)
  b))))) (! (= (tb2t1376 (t2tb1376 i)) i) :pattern ((t2tb1376 i)) )))
...
;; BridgeR
  ...
  (! (=> (sort
     (set1 (tuple2 (tuple2 (set1 a1) (tuple2 a1 b1)) (tuple2 (set1 b1) b1)))
     j) (= (t2tb1376 (tb2t1376 j)) j)) :pattern ((t2tb1376 (tb2t1376 j))) )))

(declare-fun t2tb1377 ((tuple21 (tuple21 (set a) (tuple21 a b))
  (tuple21 (set b) b))) uni)
...
(declare-fun tb2t1377 (uni) (tuple21 (tuple21 (set a) (tuple21 a b))
  (tuple21 (set b) b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 (set a) (tuple21 a b)) (tuple21 (set b) b))))
  (! (= (tb2t1377 (t2tb1377 i)) i) :pattern ((t2tb1377 i)) )))
...
;; BridgeR
  ...
  (! (=> (sort
     ...
     (= (t2tb1377 (tb2t1377 j)) j)) :pattern ((t2tb1377 (tb2t1377 j))) )))
...
;; mem_parallel_product
  ...
  (parallel_product b1 (tuple2 a1 b1) (set1 b1) (set1 a1) (t2tb1285 h)
  (t2tb27 k)))
  (and (mem (tuple2 (set1 a1) (set1 b1)) (t2tb495 (Tuple23 x z))
  (t2tb1285 h)) (mem (tuple2 (tuple2 a1 b1) b1) (t2tb28 (Tuple24 y w))
  (t2tb27 k))))))
...
(declare-fun t2tb1378 ((set (tuple21 (tuple21 a (tuple21 a b)) (tuple21 b
  b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 a (tuple21 a b)) (tuple21 b b))))) (sort
  (set1 (tuple2 (tuple2 a1 (tuple2 a1 b1)) (tuple2 b1 b1))) (t2tb1378 x))))

(declare-fun tb2t1378 (uni) (set (tuple21 (tuple21 a (tuple21 a b))
  (tuple21 b b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 a (tuple21 a b)) (tuple21 b b)))))
  (! (= (tb2t1378 (t2tb1378 i)) i) :pattern ((t2tb1378 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 a1 (tuple2 a1 b1)) (tuple2 b1 b1))) j)
     (= (t2tb1378 (tb2t1378 j)) j)) :pattern ((t2tb1378 (tb2t1378 j))) )))

(declare-fun t2tb1379 ((tuple21 (tuple21 a (tuple21 a b)) (tuple21 b
  b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 a (tuple21 a b)) (tuple21 b b)))) (sort
  (tuple2 (tuple2 a1 (tuple2 a1 b1)) (tuple2 b1 b1)) (t2tb1379 x))))

(declare-fun tb2t1379 (uni) (tuple21 (tuple21 a (tuple21 a b)) (tuple21 b
  b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 a (tuple21 a b)) (tuple21 b b))))
  (! (= (tb2t1379 (t2tb1379 i)) i) :pattern ((t2tb1379 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 a1 (tuple2 a1 b1)) (tuple2 b1 b1)) j)
     (= (t2tb1379 (tb2t1379 j)) j)) :pattern ((t2tb1379 (tb2t1379 j))) )))
...
;; mem_partial_function_set
  ...
  b))))
  (= (mem (set1 (tuple2 (tuple2 a1 b1) b1)) (t2tb27 f)
  (infix_plmngt b1 (tuple2 a1 b1) (t2tb11 s) (t2tb12 t)))
  (and (mem (set1 (tuple2 (tuple2 a1 b1) b1)) (t2tb27 f)
  (relation b1 (tuple2 a1 b1) (t2tb11 s) (t2tb12 t)))
  (forall ((x (tuple21 a b)) (y1 b) (y2 b))
  (=>
  (and (mem (tuple2 (tuple2 a1 b1) b1) (t2tb28 (Tuple24 x y1)) (t2tb27 f))
  (mem (tuple2 (tuple2 a1 b1) b1) (t2tb28 (Tuple24 x y2)) (t2tb27 f)))
  (= y1 y2)))))))
...
;; apply_def0
  ...
  (=>
  (and (mem (set1 (tuple2 (tuple2 a1 b1) b1)) (t2tb27 f)
  (infix_plmngt b1 (tuple2 a1 b1) (t2tb11 s) (t2tb12 t))) (mem (tuple2 a1 b1)
  (t2tb13 a2) (dom b1 (tuple2 a1 b1) (t2tb27 f)))) (mem
  (tuple2 (tuple2 a1 b1) b1)
  (t2tb28
  (Tuple24 a2 (tb2t14 (apply b1 (tuple2 a1 b1) (t2tb27 f) (t2tb13 a2)))))
  (t2tb27 f)))))
...
(assert
;; monot_proj_2
 ;; File "lemmes_bbook.why", line 863, characters 7-19
  (not
  (forall ((s (set a)) (u (set a)) (t (set b)) (v (set b)))
  (=> (and (subset2 u s) (subset5 v t)) (subset16 (prj21 (Tuple23 u v))
  (prj21 (Tuple23 s t)))))))
(check-sat)
