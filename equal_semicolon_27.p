...
tff(equal_semicolon_27, conjecture, ![A : $tType, B : $tType, C : $tType]:
  ...
  => infix_eqeq(tuple2(A, C), semicolon(A, B, C, diff(tuple2(A, B), P, Q),
  R), diff(tuple2(A, C), semicolon(A, B, C, P, R), semicolon(A, B, C, Q,
  R))))).
