...
;; infix ==_def
  ...
  (forall ((a ty))
  (forall ((s uni) (t uni))
  (and (=> (infix_eqeq a s t) (forall ((x uni)) (= (mem a x s) (mem a x t))))
  (=> (forall ((x uni)) (=> (sort a x) (= (mem a x s) (mem a x t))))
  (infix_eqeq a s t))))))
...
(assert
;; subset_reflexivity
 ;; File "lemmes_bbook.why", line 29, characters 7-25
  (not (forall ((s (set a))) (subset2 s s))))
(check-sat)
