...
tff(equal_semicolon_21, conjecture, ![A : $tType, B : $tType, C : $tType]:
  ...
  => infix_eqeq(tuple2(A, C), semicolon(A, B, C, range_restriction(A, B, P,
  V), R), semicolon(A, B, C, P, domain_restriction(B, C, V, R))))).
