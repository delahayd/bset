...
(assert
;; inclusion_semicolon_3
 ;; File "lemmes_bbook.why", line 1004, characters 7-28
  (not
  (forall ((s (set a)) (t (set b)) (u (set c)) (p (set (tuple21 a b)))
  (q (set (tuple21 a b))) (r (set (tuple21 b c))))
  (=>
  (and (mem4 p (relation1 s t))
  (and (mem4 q (relation1 s t)) (mem9 r (relation4 t u)))) (subset11
  (semicolon1 (inter4 p q) r) (inter8 (semicolon1 p r) (semicolon1 q r)))))))
(check-sat)
