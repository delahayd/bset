...
(assert
;; equal_image_13
 ;; File "lemmes_bbook.why", line 2387, characters 7-21
  (not
  (forall ((s (set a)) (u (set a)) (t (set b)) (p (set (tuple21 a b)))
  (q (set (tuple21 a b))))
  (=>
  (and (mem6 (inverse2 p) (infix_plmngt2 t s))
  (and (mem6 (inverse2 q) (infix_plmngt2 t s))
  (and (subset2 u s) (infix_eqeq4 (range_restriction1 p (ran1 q))
  (range_restriction1 q (ran1 p)))))) (infix_eqeq3 (image1 (inter4 p q) u)
  (inter3 (image1 p u) (image1 q u)))))))
(check-sat)
