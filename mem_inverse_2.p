...
tff(mem_inverse_2, conjecture, ![A : $tType, B : $tType]: ![S:set(A), T:
  set(B), F:set(tuple2(A, B))]: (mem(set(tuple2(A, B)), F, infix_gtplgt(A,
  B, S, T)) => mem(set(tuple2(B, A)), inverse(A, B, F), infix_plmngt(B, A, T,
  S)))).
