...
fof(equal_semicolon_10, conjecture, ![S, T, U, F, P, Q]: ((sort(set(a),
  ...
  => infix_eqeq(tuple2(a, c), semicolon(c, b, a, F, infix_lspl(c, b, P, Q)),
  infix_lspl(c, a, semicolon(c, b, a, F, P), semicolon(c, b, a, F,
  Q))))))))))).
