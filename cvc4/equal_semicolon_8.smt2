...
(declare-fun domain_substraction3 ((set b) (set (tuple21 b
  c))) (set (tuple21 b c)))
...
(declare-fun range_substraction3 ((set (tuple21 b c))
  (set c)) (set (tuple21 b c)))

(declare-fun range_substraction4 ((set (tuple21 a c))
  (set c)) (set (tuple21 a c)))
...
(assert
;; equal_semicolon_8
 ;; File "lemmes_bbook.why", line 1567, characters 7-24
  (not
  (forall ((s (set a)) (t (set b)) (v (set b)) (u (set c)) (r (set (tuple21 a
  b))) (p (set (tuple21 b c))))
  (=>
  (and (mem4 r (relation1 s t)) (and (subset5 v t) (mem9 p (relation4 t u))))
  (infix_eqeq9 (semicolon1 r (domain_substraction3 v p))
  (semicolon1 (range_substraction1 r v) p))))))
(check-sat)
