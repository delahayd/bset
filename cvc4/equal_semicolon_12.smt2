...
(declare-fun inter9 ((set (set (tuple21 b c))) (set (set (tuple21 b
  c)))) (set (set (tuple21 b c))))
...
;; mem_inter
  ...
  (forall ((s (set (set (tuple21 b c)))) (t (set (set (tuple21 b c))))
  (x (set (tuple21 b c))))
  (= (mem9 x (inter9 s t)) (and (mem9 x s) (mem9 x t)))))
...
(assert
;; equal_semicolon_12
 ;; File "lemmes_bbook.why", line 1603, characters 7-25
  (not
  (forall ((s (set a)) (t (set b)) (u (set c)) (f (set (tuple21 a b)))
  (p (set (tuple21 b c))) (q (set (tuple21 b c))))
  (=>
  (and (mem4 f (infix_plmngt1 s t))
  (and (mem9 p (relation4 t u)) (mem9 q (relation4 t u)))) (infix_eqeq9
  (semicolon1 f (inter7 p q)) (inter8 (semicolon1 f p) (semicolon1 f q)))))))
(check-sat)
