...
(assert
;; mem_union_2
 ;; File "lemmes_bbook.why", line 653, characters 7-18
  (not
  (forall ((s (set a)) (t (set b)) (f (set (tuple21 a b))) (g (set (tuple21 a
  b))))
  (=>
  (and (mem4 f (infix_gtplgt1 s t))
  (and (mem4 g (infix_gtplgt1 s t))
  (and (infix_eqeq4 (domain_restriction1 (dom1 g) f)
  (domain_restriction1 (dom1 f) g)) (infix_eqeq4
  (range_restriction1 f (ran1 g)) (range_restriction1 g (ran1 f)))))) (mem4
  (union5 f g) (infix_gtplgt1 s t))))))
(check-sat)
