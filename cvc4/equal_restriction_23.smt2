...
;; mem_partial_function_set
  ...
  (= (mem4 f2 (infix_plmngt1 s t))
  (and (mem4 f2 (tb2t10 (relation b1 a1 (t2tb1 s) (t2tb12 t))))
...
;; apply_def0
  ...
  (=>
  (and (mem4 f2 (infix_plmngt1 s t)) (mem1 a2
...
(assert
;; equal_restriction_23
 ;; File "lemmes_bbook.why", line 2051, characters 7-27
  (not
  (forall ((s (set a)) (t (set b)) (v (set b)) (f2 (set (tuple21 a b))))
  (=> (and (mem4 f2 (infix_plmngt1 s t)) (subset5 v t)) (infix_eqeq4
  (domain_restriction1 (image2 (inverse2 f2) v) f2)
  (range_restriction1 f2 v))))))
(check-sat)
