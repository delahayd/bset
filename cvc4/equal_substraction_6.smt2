...
(assert
;; equal_substraction_6
 ;; File "lemmes_bbook.why", line 2121, characters 7-27
  (not
  (forall ((s (set a)) (u (set a)) (t (set b)) (w (set b)) (r (set (tuple21 a
  b))))
  (=> (and (subset2 u s) (and (mem4 r (relation1 s t)) (subset5 w t)))
  (infix_eqeq4 (domain_substraction1 u (range_restriction1 r w))
  (range_restriction1 (domain_substraction1 u r) w))))))
(check-sat)
