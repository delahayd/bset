...
(declare-fun empty10 () (set (tuple21 a a)))
...
;; empty_def1
  (assert (is_empty (tuple2 a1 a1) (t2tb4 empty10)))
...
;; empty
  (assert
  (forall ((x (tuple21 a a)))
  (not (mem (tuple2 a1 a1) (t2tb5 x) (t2tb4 empty10)))))
...
;; mem_non_empty_power
  ...
  (forall ((x (tuple21 a a)))
  (=> (mem (tuple2 a1 a1) (t2tb5 x) (t2tb4 s)) (mem (tuple2 a1 a1) (t2tb5 x)
  (t2tb4 t)))) (not (infix_eqeq2 s empty10))))))
...
(assert
;; equal_identity_5
 ;; File "lemmes_bbook.why", line 1846, characters 7-23
  (not
  (forall ((s (set a)) (u (set a)))
  (=> (and (subset2 u s) (infix_eqeq1 u empty1)) (infix_eqeq2 (id1 u)
  empty10)))))
(check-sat)
