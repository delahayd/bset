...
tff(equal_semicolon_25, conjecture, ![A : $tType, B : $tType, C : $tType]:
  ...
  => infix_eqeq(tuple2(A, C), semicolon(A, B, C, union(tuple2(A, B), P, Q),
  R), union(tuple2(A, C), semicolon(A, B, C, P, R), semicolon(A, B, C, Q,
  R))))).
