...
;; mem_domain_substraction
  (assert
  (forall ((p (set (tuple21 a b))) (s (set a)) (x a) (y b))
  (= (mem3 (Tuple21 x y) (domain_substraction1 s p))
...
(assert
;; equal_substraction_17
 ;; File "lemmes_bbook.why", line 2203, characters 7-28
  (not
  (forall ((s (set a)) (u (set a)) (t (set b)) (x a) (y b))
  (=> (and (subset2 u s) (and (mem1 x s) (and (mem2 y t) (mem1 x u))))
  (infix_eqeq4 (domain_substraction1 u (singleton3 (Tuple21 x y))) empty3)))))
(check-sat)
