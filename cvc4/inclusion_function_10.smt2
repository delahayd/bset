...
;; mem_relation
  ...
  (= (mem (set1 (tuple2 a1 b1)) (t2tb11 r) (t2tb10 (relation1 u v)))
  (forall ((x a) (y b))
  (=> (mem (tuple2 a1 b1) (Tuple2 a1 b1 (t2tb2 x) (t2tb14 y)) (t2tb11 r))
...
;; mem_partial_function_set
  ...
  (and (mem (set1 (tuple2 a1 b1)) (t2tb11 f) (t2tb10 (relation1 s t)))
...
(assert
;; inclusion_function_10
 ;; File "lemmes_bbook.why", line 932, characters 7-28
  (not
  (forall ((s (set a)) (t (set b))) (subset7 (infix_plmngt1 s t)
  (relation1 s t)))))
(check-sat)
