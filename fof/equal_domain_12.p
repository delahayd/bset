...
fof(equal_domain_12, conjecture, ![S, T, U, V, P, Q]: ((sort(set(a), S) = S)
  ...
  & mem(set(tuple2(c, d)), Q, relation(d, c, U, V))) => infix_eqeq(tuple2(a,
  c), dom(tuple2(b, d), tuple2(a, c), parallel_product(d, c, b, a, P, Q)),
  times(c, a, dom(b, a, P), dom(d, c, Q))))))))))).
