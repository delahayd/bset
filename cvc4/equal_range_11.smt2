...
(declare-fun t2tb1971 ((set (tuple21 (tuple21 a (tuple21 b c)) (tuple21 b
  c)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 a (tuple21 b c)) (tuple21 b c))))) (sort
  (set1 (tuple2 (tuple2 a1 (tuple2 b1 c1)) (tuple2 b1 c1))) (t2tb1971 x))))

(declare-fun tb2t1971 (uni) (set (tuple21 (tuple21 a (tuple21 b c))
  (tuple21 b c))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 a (tuple21 b c)) (tuple21 b c)))))
  (! (= (tb2t1971 (t2tb1971 i)) i) :pattern ((t2tb1971 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 a1 (tuple2 b1 c1)) (tuple2 b1 c1))) j)
     (= (t2tb1971 (tb2t1971 j)) j)) :pattern ((t2tb1971 (tb2t1971 j))) )))

(declare-fun t2tb1972 ((tuple21 (tuple21 a (tuple21 b c)) (tuple21 b
  c))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 a (tuple21 b c)) (tuple21 b c)))) (sort
  (tuple2 (tuple2 a1 (tuple2 b1 c1)) (tuple2 b1 c1)) (t2tb1972 x))))

(declare-fun tb2t1972 (uni) (tuple21 (tuple21 a (tuple21 b c)) (tuple21 b
  c)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 a (tuple21 b c)) (tuple21 b c))))
  (! (= (tb2t1972 (t2tb1972 i)) i) :pattern ((t2tb1972 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 a1 (tuple2 b1 c1)) (tuple2 b1 c1)) j)
     (= (t2tb1972 (tb2t1972 j)) j)) :pattern ((t2tb1972 (tb2t1972 j))) )))
...
(declare-fun t2tb1973 ((tuple21 (tuple21 a (tuple21 b c)) (tuple21 b
  a))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 a (tuple21 b c)) (tuple21 b a)))) (sort
  (tuple2 (tuple2 a1 (tuple2 b1 c1)) (tuple2 b1 a1)) (t2tb1973 x))))

(declare-fun tb2t1973 (uni) (tuple21 (tuple21 a (tuple21 b c)) (tuple21 b
  a)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 a (tuple21 b c)) (tuple21 b a))))
  (! (= (tb2t1973 (t2tb1973 i)) i) :pattern ((t2tb1973 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 a1 (tuple2 b1 c1)) (tuple2 b1 a1)) j)
     (= (t2tb1973 (tb2t1973 j)) j)) :pattern ((t2tb1973 (tb2t1973 j))) )))

(declare-fun t2tb1974 ((set (tuple21 (tuple21 a (tuple21 b c)) (tuple21 b
  a)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 a (tuple21 b c)) (tuple21 b a))))) (sort
  (set1 (tuple2 (tuple2 a1 (tuple2 b1 c1)) (tuple2 b1 a1))) (t2tb1974 x))))

(declare-fun tb2t1974 (uni) (set (tuple21 (tuple21 a (tuple21 b c))
  (tuple21 b a))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 a (tuple21 b c)) (tuple21 b a)))))
  (! (= (tb2t1974 (t2tb1974 i)) i) :pattern ((t2tb1974 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 a1 (tuple2 b1 c1)) (tuple2 b1 a1))) j)
     (= (t2tb1974 (tb2t1974 j)) j)) :pattern ((t2tb1974 (tb2t1974 j))) )))
...
(declare-fun t2tb1975 ((set (tuple21 (set (tuple21 a c)) (tuple21 b
  c)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (set (tuple21 a c)) (tuple21 b c))))) (sort
  (set1 (tuple2 (set1 (tuple2 a1 c1)) (tuple2 b1 c1))) (t2tb1975 x))))

(declare-fun tb2t1975 (uni) (set (tuple21 (set (tuple21 a c)) (tuple21 b
  c))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (set (tuple21 a c)) (tuple21 b c)))))
  (! (= (tb2t1975 (t2tb1975 i)) i) :pattern ((t2tb1975 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (set1 (tuple2 a1 c1)) (tuple2 b1 c1))) j)
     (= (t2tb1975 (tb2t1975 j)) j)) :pattern ((t2tb1975 (tb2t1975 j))) )))

(declare-fun t2tb1976 ((tuple21 (set (tuple21 a c)) (tuple21 b c))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (set (tuple21 a c)) (tuple21 b c)))) (sort
  (tuple2 (set1 (tuple2 a1 c1)) (tuple2 b1 c1)) (t2tb1976 x))))

(declare-fun tb2t1976 (uni) (tuple21 (set (tuple21 a c)) (tuple21 b c)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (set (tuple21 a c)) (tuple21 b c))))
  (! (= (tb2t1976 (t2tb1976 i)) i) :pattern ((t2tb1976 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (set1 (tuple2 a1 c1)) (tuple2 b1 c1)) j)
     (= (t2tb1976 (tb2t1976 j)) j)) :pattern ((t2tb1976 (tb2t1976 j))) )))
...
(declare-fun t2tb1977 ((set (tuple21 (set (tuple21 a c)) (tuple21 b
  a)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (set (tuple21 a c)) (tuple21 b a))))) (sort
  (set1 (tuple2 (set1 (tuple2 a1 c1)) (tuple2 b1 a1))) (t2tb1977 x))))

(declare-fun tb2t1977 (uni) (set (tuple21 (set (tuple21 a c)) (tuple21 b
  a))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (set (tuple21 a c)) (tuple21 b a)))))
  (! (= (tb2t1977 (t2tb1977 i)) i) :pattern ((t2tb1977 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (set1 (tuple2 a1 c1)) (tuple2 b1 a1))) j)
     (= (t2tb1977 (tb2t1977 j)) j)) :pattern ((t2tb1977 (tb2t1977 j))) )))

(declare-fun t2tb1978 ((tuple21 (set (tuple21 a c)) (tuple21 b a))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (set (tuple21 a c)) (tuple21 b a)))) (sort
  (tuple2 (set1 (tuple2 a1 c1)) (tuple2 b1 a1)) (t2tb1978 x))))

(declare-fun tb2t1978 (uni) (tuple21 (set (tuple21 a c)) (tuple21 b a)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (set (tuple21 a c)) (tuple21 b a))))
  (! (= (tb2t1978 (t2tb1978 i)) i) :pattern ((t2tb1978 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (set1 (tuple2 a1 c1)) (tuple2 b1 a1)) j)
     (= (t2tb1978 (tb2t1978 j)) j)) :pattern ((t2tb1978 (tb2t1978 j))) )))
...
(declare-fun t2tb1979 ((set (tuple21 (tuple21 a c) (tuple21 b a)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 a c) (tuple21 b a))))) (sort
  (set1 (tuple2 (tuple2 a1 c1) (tuple2 b1 a1))) (t2tb1979 x))))

(declare-fun tb2t1979 (uni) (set (tuple21 (tuple21 a c) (tuple21 b a))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 a c) (tuple21 b a)))))
  (! (= (tb2t1979 (t2tb1979 i)) i) :pattern ((t2tb1979 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 a1 c1) (tuple2 b1 a1))) j)
     (= (t2tb1979 (tb2t1979 j)) j)) :pattern ((t2tb1979 (tb2t1979 j))) )))

(declare-fun t2tb1980 ((tuple21 (tuple21 a c) (tuple21 b a))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 a c) (tuple21 b a)))) (sort
  (tuple2 (tuple2 a1 c1) (tuple2 b1 a1)) (t2tb1980 x))))

(declare-fun tb2t1980 (uni) (tuple21 (tuple21 a c) (tuple21 b a)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 a c) (tuple21 b a))))
  (! (= (tb2t1980 (t2tb1980 i)) i) :pattern ((t2tb1980 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 a1 c1) (tuple2 b1 a1)) j)
     (= (t2tb1980 (tb2t1980 j)) j)) :pattern ((t2tb1980 (tb2t1980 j))) )))
...
(declare-fun t2tb1981 ((set (tuple21 (tuple21 b c) (tuple21 a (tuple21 b
  c))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b c) (tuple21 a (tuple21 b c)))))) (sort
  (set1 (tuple2 (tuple2 b1 c1) (tuple2 a1 (tuple2 b1 c1)))) (t2tb1981 x))))

(declare-fun tb2t1981 (uni) (set (tuple21 (tuple21 b c) (tuple21 a (tuple21 b
  c)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b c) (tuple21 a (tuple21 b c))))))
  (! (= (tb2t1981 (t2tb1981 i)) i) :pattern ((t2tb1981 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 c1) (tuple2 a1 (tuple2 b1 c1)))) j)
     (= (t2tb1981 (tb2t1981 j)) j)) :pattern ((t2tb1981 (tb2t1981 j))) )))

(declare-fun t2tb1982 ((tuple21 (tuple21 b c) (tuple21 a (tuple21 b
  c)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 b c) (tuple21 a (tuple21 b c))))) (sort
  (tuple2 (tuple2 b1 c1) (tuple2 a1 (tuple2 b1 c1))) (t2tb1982 x))))

(declare-fun tb2t1982 (uni) (tuple21 (tuple21 b c) (tuple21 a (tuple21 b
  c))))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b c) (tuple21 a (tuple21 b c)))))
  (! (= (tb2t1982 (t2tb1982 i)) i) :pattern ((t2tb1982 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 c1) (tuple2 a1 (tuple2 b1 c1))) j)
     (= (t2tb1982 (tb2t1982 j)) j)) :pattern ((t2tb1982 (tb2t1982 j))) )))
...
(declare-fun t2tb1983 ((set (tuple21 (tuple21 b c) (set (tuple21 a
  c))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b c) (set (tuple21 a c)))))) (sort
  (set1 (tuple2 (tuple2 b1 c1) (set1 (tuple2 a1 c1)))) (t2tb1983 x))))

(declare-fun tb2t1983 (uni) (set (tuple21 (tuple21 b c) (set (tuple21 a
  c)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b c) (set (tuple21 a c))))))
  (! (= (tb2t1983 (t2tb1983 i)) i) :pattern ((t2tb1983 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 c1) (set1 (tuple2 a1 c1)))) j)
     (= (t2tb1983 (tb2t1983 j)) j)) :pattern ((t2tb1983 (tb2t1983 j))) )))

(declare-fun t2tb1984 ((tuple21 (tuple21 b c) (set (tuple21 a c)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 b c) (set (tuple21 a c))))) (sort
  (tuple2 (tuple2 b1 c1) (set1 (tuple2 a1 c1))) (t2tb1984 x))))

(declare-fun tb2t1984 (uni) (tuple21 (tuple21 b c) (set (tuple21 a c))))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b c) (set (tuple21 a c)))))
  (! (= (tb2t1984 (t2tb1984 i)) i) :pattern ((t2tb1984 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 c1) (set1 (tuple2 a1 c1))) j)
     (= (t2tb1984 (tb2t1984 j)) j)) :pattern ((t2tb1984 (tb2t1984 j))) )))
...
(declare-fun t2tb1985 ((set (tuple21 (tuple21 b c) (tuple21 b a)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b c) (tuple21 b a))))) (sort
  (set1 (tuple2 (tuple2 b1 c1) (tuple2 b1 a1))) (t2tb1985 x))))

(declare-fun tb2t1985 (uni) (set (tuple21 (tuple21 b c) (tuple21 b a))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b c) (tuple21 b a)))))
  (! (= (tb2t1985 (t2tb1985 i)) i) :pattern ((t2tb1985 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 c1) (tuple2 b1 a1))) j)
     (= (t2tb1985 (tb2t1985 j)) j)) :pattern ((t2tb1985 (tb2t1985 j))) )))

(declare-fun t2tb1986 ((tuple21 (tuple21 b c) (tuple21 b a))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 b c) (tuple21 b a)))) (sort
  (tuple2 (tuple2 b1 c1) (tuple2 b1 a1)) (t2tb1986 x))))

(declare-fun tb2t1986 (uni) (tuple21 (tuple21 b c) (tuple21 b a)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b c) (tuple21 b a))))
  (! (= (tb2t1986 (t2tb1986 i)) i) :pattern ((t2tb1986 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 c1) (tuple2 b1 a1)) j)
     (= (t2tb1986 (tb2t1986 j)) j)) :pattern ((t2tb1986 (tb2t1986 j))) )))
...
(declare-fun t2tb1987 ((set (tuple21 c (tuple21 b a)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 c (tuple21 b a))))) (sort
  (set1 (tuple2 c1 (tuple2 b1 a1))) (t2tb1987 x))))

(declare-fun tb2t1987 (uni) (set (tuple21 c (tuple21 b a))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 c (tuple21 b a)))))
  (! (= (tb2t1987 (t2tb1987 i)) i) :pattern ((t2tb1987 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 c1 (tuple2 b1 a1))) j)
     (= (t2tb1987 (tb2t1987 j)) j)) :pattern ((t2tb1987 (tb2t1987 j))) )))

(declare-fun t2tb1988 ((tuple21 c (tuple21 b a))) uni)
...
(declare-fun tb2t1988 (uni) (tuple21 c (tuple21 b a)))

;; BridgeL
  (assert
  (forall ((i (tuple21 c (tuple21 b a))))
  (! (= (tb2t1988 (t2tb1988 i)) i) :pattern ((t2tb1988 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 c1 (tuple2 b1 a1)) j) (= (t2tb1988 (tb2t1988 j)) j)) :pattern (
  (t2tb1988 (tb2t1988 j))) )))
...
(declare-fun t2tb1989 ((tuple21 (tuple21 b a) (tuple21 a (tuple21 b
  c)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 b a) (tuple21 a (tuple21 b c))))) (sort
  (tuple2 (tuple2 b1 a1) (tuple2 a1 (tuple2 b1 c1))) (t2tb1989 x))))

(declare-fun tb2t1989 (uni) (tuple21 (tuple21 b a) (tuple21 a (tuple21 b
  c))))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b a) (tuple21 a (tuple21 b c)))))
  (! (= (tb2t1989 (t2tb1989 i)) i) :pattern ((t2tb1989 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 a1) (tuple2 a1 (tuple2 b1 c1))) j)
     (= (t2tb1989 (tb2t1989 j)) j)) :pattern ((t2tb1989 (tb2t1989 j))) )))

(declare-fun t2tb1990 ((set (tuple21 (tuple21 b a) (tuple21 a (tuple21 b
  c))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b a) (tuple21 a (tuple21 b c)))))) (sort
  (set1 (tuple2 (tuple2 b1 a1) (tuple2 a1 (tuple2 b1 c1)))) (t2tb1990 x))))

(declare-fun tb2t1990 (uni) (set (tuple21 (tuple21 b a) (tuple21 a (tuple21 b
  c)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b a) (tuple21 a (tuple21 b c))))))
  (! (= (tb2t1990 (t2tb1990 i)) i) :pattern ((t2tb1990 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 a1) (tuple2 a1 (tuple2 b1 c1)))) j)
     (= (t2tb1990 (tb2t1990 j)) j)) :pattern ((t2tb1990 (tb2t1990 j))) )))
...
(declare-fun t2tb1991 ((set (tuple21 (tuple21 b a) (set (tuple21 a
  c))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b a) (set (tuple21 a c)))))) (sort
  (set1 (tuple2 (tuple2 b1 a1) (set1 (tuple2 a1 c1)))) (t2tb1991 x))))

(declare-fun tb2t1991 (uni) (set (tuple21 (tuple21 b a) (set (tuple21 a
  c)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b a) (set (tuple21 a c))))))
  (! (= (tb2t1991 (t2tb1991 i)) i) :pattern ((t2tb1991 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 a1) (set1 (tuple2 a1 c1)))) j)
     (= (t2tb1991 (tb2t1991 j)) j)) :pattern ((t2tb1991 (tb2t1991 j))) )))

(declare-fun t2tb1992 ((tuple21 (tuple21 b a) (set (tuple21 a c)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 b a) (set (tuple21 a c))))) (sort
  (tuple2 (tuple2 b1 a1) (set1 (tuple2 a1 c1))) (t2tb1992 x))))

(declare-fun tb2t1992 (uni) (tuple21 (tuple21 b a) (set (tuple21 a c))))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b a) (set (tuple21 a c)))))
  (! (= (tb2t1992 (t2tb1992 i)) i) :pattern ((t2tb1992 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 a1) (set1 (tuple2 a1 c1))) j)
     (= (t2tb1992 (tb2t1992 j)) j)) :pattern ((t2tb1992 (tb2t1992 j))) )))
...
(declare-fun t2tb1993 ((set (tuple21 (tuple21 b a) (tuple21 a c)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b a) (tuple21 a c))))) (sort
  (set1 (tuple2 (tuple2 b1 a1) (tuple2 a1 c1))) (t2tb1993 x))))

(declare-fun tb2t1993 (uni) (set (tuple21 (tuple21 b a) (tuple21 a c))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b a) (tuple21 a c)))))
  (! (= (tb2t1993 (t2tb1993 i)) i) :pattern ((t2tb1993 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 a1) (tuple2 a1 c1))) j)
     (= (t2tb1993 (tb2t1993 j)) j)) :pattern ((t2tb1993 (tb2t1993 j))) )))

(declare-fun t2tb1994 ((tuple21 (tuple21 b a) (tuple21 a c))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 b a) (tuple21 a c)))) (sort
  (tuple2 (tuple2 b1 a1) (tuple2 a1 c1)) (t2tb1994 x))))

(declare-fun tb2t1994 (uni) (tuple21 (tuple21 b a) (tuple21 a c)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b a) (tuple21 a c))))
  (! (= (tb2t1994 (t2tb1994 i)) i) :pattern ((t2tb1994 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 a1) (tuple2 a1 c1)) j)
     (= (t2tb1994 (tb2t1994 j)) j)) :pattern ((t2tb1994 (tb2t1994 j))) )))
...
(declare-fun t2tb1995 ((set (tuple21 (tuple21 b a) (tuple21 b c)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b a) (tuple21 b c))))) (sort
  (set1 (tuple2 (tuple2 b1 a1) (tuple2 b1 c1))) (t2tb1995 x))))

(declare-fun tb2t1995 (uni) (set (tuple21 (tuple21 b a) (tuple21 b c))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b a) (tuple21 b c)))))
  (! (= (tb2t1995 (t2tb1995 i)) i) :pattern ((t2tb1995 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 a1) (tuple2 b1 c1))) j)
     (= (t2tb1995 (tb2t1995 j)) j)) :pattern ((t2tb1995 (tb2t1995 j))) )))

(declare-fun t2tb1996 ((tuple21 (tuple21 b a) (tuple21 b c))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 b a) (tuple21 b c)))) (sort
  (tuple2 (tuple2 b1 a1) (tuple2 b1 c1)) (t2tb1996 x))))

(declare-fun tb2t1996 (uni) (tuple21 (tuple21 b a) (tuple21 b c)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b a) (tuple21 b c))))
  (! (= (tb2t1996 (t2tb1996 i)) i) :pattern ((t2tb1996 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 a1) (tuple2 b1 c1)) j)
     (= (t2tb1996 (tb2t1996 j)) j)) :pattern ((t2tb1996 (tb2t1996 j))) )))
...
(declare-fun t2tb1997 ((set (tuple21 (tuple21 b a) c))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b a) c)))) (sort
  (set1 (tuple2 (tuple2 b1 a1) c1)) (t2tb1997 x))))

(declare-fun tb2t1997 (uni) (set (tuple21 (tuple21 b a) c)))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b a) c))))
  (! (= (tb2t1997 (t2tb1997 i)) i) :pattern ((t2tb1997 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 a1) c1)) j)
     (= (t2tb1997 (tb2t1997 j)) j)) :pattern ((t2tb1997 (tb2t1997 j))) )))

(declare-fun t2tb1998 ((tuple21 (tuple21 b a) c)) uni)
...
(declare-fun tb2t1998 (uni) (tuple21 (tuple21 b a) c))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b a) c)))
  (! (= (tb2t1998 (t2tb1998 i)) i) :pattern ((t2tb1998 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 a1) c1) j) (= (t2tb1998 (tb2t1998 j)) j)) :pattern (
  (t2tb1998 (tb2t1998 j))) )))
...
(declare-fun t2tb1999 ((set (set (tuple21 (tuple21 a (tuple21 b c))
  (tuple21 b c))))) uni)
...
(declare-fun tb2t1999 (uni) (set (set (tuple21 (tuple21 a (tuple21 b c))
  (tuple21 b c)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 a (tuple21 b c)) (tuple21 b c))))))
  (! (= (tb2t1999 (t2tb1999 i)) i) :pattern ((t2tb1999 i)) )))
...
;; BridgeR
  ...
  (! (=> (sort
     ...
     (= (t2tb1999 (tb2t1999 j)) j)) :pattern ((t2tb1999 (tb2t1999 j))) )))
...
;; mem_relation
  ...
  (=> (mem (tuple2 (tuple2 a1 (tuple2 b1 c1)) (tuple2 b1 c1))
  (Tuple2 (tuple2 a1 (tuple2 b1 c1)) (tuple2 b1 c1) (t2tb260 x) (t2tb134 y))
  (t2tb1971 r)) (and (mem14 x u) (mem8 y v)))))))
...
(declare-fun t2tb2000 ((set (set (tuple21 (tuple21 a (tuple21 b c))
  (tuple21 b a))))) uni)
...
(declare-fun tb2t2000 (uni) (set (set (tuple21 (tuple21 a (tuple21 b c))
  (tuple21 b a)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 a (tuple21 b c)) (tuple21 b a))))))
  (! (= (tb2t2000 (t2tb2000 i)) i) :pattern ((t2tb2000 i)) )))
...
;; BridgeR
  ...
  (! (=> (sort
     ...
     (= (t2tb2000 (tb2t2000 j)) j)) :pattern ((t2tb2000 (tb2t2000 j))) )))
...
;; mem_relation
  ...
  (=> (mem (tuple2 (tuple2 a1 (tuple2 b1 c1)) (tuple2 b1 a1))
  (Tuple2 (tuple2 a1 (tuple2 b1 c1)) (tuple2 b1 a1) (t2tb260 x) (t2tb38 y))
  (t2tb1974 r)) (and (mem14 x u) (mem5 y v)))))))
...
(declare-fun t2tb2001 ((set (set (tuple21 (set (tuple21 a c)) (tuple21 b
  c))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (set (tuple21 a c)) (tuple21 b c)))))) (sort
  (set1 (set1 (tuple2 (set1 (tuple2 a1 c1)) (tuple2 b1 c1)))) (t2tb2001 x))))

(declare-fun tb2t2001 (uni) (set (set (tuple21 (set (tuple21 a c)) (tuple21 b
  c)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (set (tuple21 a c)) (tuple21 b c))))))
  (! (= (tb2t2001 (t2tb2001 i)) i) :pattern ((t2tb2001 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (set1 (tuple2 a1 c1)) (tuple2 b1 c1)))) j)
     (= (t2tb2001 (tb2t2001 j)) j)) :pattern ((t2tb2001 (tb2t2001 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (set (tuple21 a c)))) (v (set (tuple21 b c)))
  (r (set (tuple21 (set (tuple21 a c)) (tuple21 b c)))))
  (= (mem (set1 (tuple2 (set1 (tuple2 a1 c1)) (tuple2 b1 c1))) (t2tb1975 r)
  (relation (tuple2 b1 c1) (set1 (tuple2 a1 c1)) (t2tb128 u) (t2tb131 v)))
  (forall ((x (set (tuple21 a c))) (y (tuple21 b c)))
  (=> (mem (tuple2 (set1 (tuple2 a1 c1)) (tuple2 b1 c1))
  (Tuple2 (set1 (tuple2 a1 c1)) (tuple2 b1 c1) (t2tb129 x) (t2tb134 y))
  (t2tb1975 r)) (and (mem11 x u) (mem8 y v)))))))
...
(declare-fun t2tb2002 ((set (set (tuple21 (set (tuple21 a c)) (tuple21 b
  a))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (set (tuple21 a c)) (tuple21 b a)))))) (sort
  (set1 (set1 (tuple2 (set1 (tuple2 a1 c1)) (tuple2 b1 a1)))) (t2tb2002 x))))

(declare-fun tb2t2002 (uni) (set (set (tuple21 (set (tuple21 a c)) (tuple21 b
  a)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (set (tuple21 a c)) (tuple21 b a))))))
  (! (= (tb2t2002 (t2tb2002 i)) i) :pattern ((t2tb2002 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (set1 (tuple2 a1 c1)) (tuple2 b1 a1)))) j)
     (= (t2tb2002 (tb2t2002 j)) j)) :pattern ((t2tb2002 (tb2t2002 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (set (tuple21 a c)))) (v (set (tuple21 b a)))
  (r (set (tuple21 (set (tuple21 a c)) (tuple21 b a)))))
  (= (mem (set1 (tuple2 (set1 (tuple2 a1 c1)) (tuple2 b1 a1))) (t2tb1977 r)
  (relation (tuple2 b1 a1) (set1 (tuple2 a1 c1)) (t2tb128 u) (t2tb37 v)))
  (forall ((x (set (tuple21 a c))) (y (tuple21 b a)))
  (=> (mem (tuple2 (set1 (tuple2 a1 c1)) (tuple2 b1 a1))
  (Tuple2 (set1 (tuple2 a1 c1)) (tuple2 b1 a1) (t2tb129 x) (t2tb38 y))
  (t2tb1977 r)) (and (mem11 x u) (mem5 y v)))))))
...
(declare-fun t2tb2003 ((set (set (tuple21 (tuple21 a c) (tuple21 b
  a))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 a c) (tuple21 b a)))))) (sort
  (set1 (set1 (tuple2 (tuple2 a1 c1) (tuple2 b1 a1)))) (t2tb2003 x))))

(declare-fun tb2t2003 (uni) (set (set (tuple21 (tuple21 a c) (tuple21 b
  a)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 a c) (tuple21 b a))))))
  (! (= (tb2t2003 (t2tb2003 i)) i) :pattern ((t2tb2003 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 a1 c1) (tuple2 b1 a1)))) j)
     (= (t2tb2003 (tb2t2003 j)) j)) :pattern ((t2tb2003 (tb2t2003 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 a c))) (v (set (tuple21 b a)))
  (r (set (tuple21 (tuple21 a c) (tuple21 b a)))))
  (= (mem (set1 (tuple2 (tuple2 a1 c1) (tuple2 b1 a1))) (t2tb1979 r)
  (relation (tuple2 b1 a1) (tuple2 a1 c1) (t2tb129 u) (t2tb37 v)))
  (forall ((x (tuple21 a c)) (y (tuple21 b a)))
  (=> (mem (tuple2 (tuple2 a1 c1) (tuple2 b1 a1))
  (Tuple2 (tuple2 a1 c1) (tuple2 b1 a1) (t2tb133 x) (t2tb38 y)) (t2tb1979 r))
...
(declare-fun t2tb2004 ((set (set (tuple21 (tuple21 b c) (tuple21 a (tuple21 b
  c)))))) uni)
...
(declare-fun tb2t2004 (uni) (set (set (tuple21 (tuple21 b c) (tuple21 a
  (tuple21 b c))))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 b c) (tuple21 a (tuple21 b c)))))))
  (! (= (tb2t2004 (t2tb2004 i)) i) :pattern ((t2tb2004 i)) )))
...
;; BridgeR
  ...
  (! (=> (sort
     ...
     (= (t2tb2004 (tb2t2004 j)) j)) :pattern ((t2tb2004 (tb2t2004 j))) )))
...
;; mem_relation
  ...
  (=> (mem (tuple2 (tuple2 b1 c1) (tuple2 a1 (tuple2 b1 c1)))
  (Tuple2 (tuple2 b1 c1) (tuple2 a1 (tuple2 b1 c1)) (t2tb134 x) (t2tb260 y))
  (t2tb1981 r)) (and (mem8 x u) (mem14 y v)))))))

(declare-fun t2tb2005 ((set (set (tuple21 (tuple21 b c) (set (tuple21 a
  c)))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 b c) (set (tuple21 a c))))))) (sort
  (set1 (set1 (tuple2 (tuple2 b1 c1) (set1 (tuple2 a1 c1))))) (t2tb2005 x))))

(declare-fun tb2t2005 (uni) (set (set (tuple21 (tuple21 b c) (set (tuple21 a
  c))))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 b c) (set (tuple21 a c)))))))
  (! (= (tb2t2005 (t2tb2005 i)) i) :pattern ((t2tb2005 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 b1 c1) (set1 (tuple2 a1 c1))))) j)
     (= (t2tb2005 (tb2t2005 j)) j)) :pattern ((t2tb2005 (tb2t2005 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 b c))) (v (set (set (tuple21 a c))))
  (r (set (tuple21 (tuple21 b c) (set (tuple21 a c))))))
  (= (mem (set1 (tuple2 (tuple2 b1 c1) (set1 (tuple2 a1 c1)))) (t2tb1983 r)
  (relation (set1 (tuple2 a1 c1)) (tuple2 b1 c1) (t2tb131 u) (t2tb128 v)))
  (forall ((x (tuple21 b c)) (y (set (tuple21 a c))))
  (=> (mem (tuple2 (tuple2 b1 c1) (set1 (tuple2 a1 c1)))
  (Tuple2 (tuple2 b1 c1) (set1 (tuple2 a1 c1)) (t2tb134 x) (t2tb129 y))
  (t2tb1983 r)) (and (mem8 x u) (mem11 y v)))))))
...
(declare-fun t2tb2006 ((set (set (tuple21 (tuple21 b c) (tuple21 b
  a))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 b c) (tuple21 b a)))))) (sort
  (set1 (set1 (tuple2 (tuple2 b1 c1) (tuple2 b1 a1)))) (t2tb2006 x))))

(declare-fun tb2t2006 (uni) (set (set (tuple21 (tuple21 b c) (tuple21 b
  a)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 b c) (tuple21 b a))))))
  (! (= (tb2t2006 (t2tb2006 i)) i) :pattern ((t2tb2006 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 b1 c1) (tuple2 b1 a1)))) j)
     (= (t2tb2006 (tb2t2006 j)) j)) :pattern ((t2tb2006 (tb2t2006 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 b c))) (v (set (tuple21 b a)))
  (r (set (tuple21 (tuple21 b c) (tuple21 b a)))))
  (= (mem (set1 (tuple2 (tuple2 b1 c1) (tuple2 b1 a1))) (t2tb1985 r)
  (relation (tuple2 b1 a1) (tuple2 b1 c1) (t2tb131 u) (t2tb37 v)))
  (forall ((x (tuple21 b c)) (y (tuple21 b a)))
  (=> (mem (tuple2 (tuple2 b1 c1) (tuple2 b1 a1))
  (Tuple2 (tuple2 b1 c1) (tuple2 b1 a1) (t2tb134 x) (t2tb38 y)) (t2tb1985 r))
...
(declare-fun t2tb2007 ((set (set (tuple21 c (tuple21 b a))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 c (tuple21 b a)))))) (sort
  (set1 (set1 (tuple2 c1 (tuple2 b1 a1)))) (t2tb2007 x))))

(declare-fun tb2t2007 (uni) (set (set (tuple21 c (tuple21 b a)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 c (tuple21 b a))))))
  (! (= (tb2t2007 (t2tb2007 i)) i) :pattern ((t2tb2007 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 c1 (tuple2 b1 a1)))) j)
     (= (t2tb2007 (tb2t2007 j)) j)) :pattern ((t2tb2007 (tb2t2007 j))) )))

;; mem_relation
  (assert
  (forall ((u (set c)) (v (set (tuple21 b a))) (r (set (tuple21 c (tuple21 b
  a)))))
  (= (mem (set1 (tuple2 c1 (tuple2 b1 a1))) (t2tb1987 r)
  (relation (tuple2 b1 a1) c1 (t2tb132 u) (t2tb37 v)))
  (forall ((x c) (y (tuple21 b a)))
  (=> (mem (tuple2 c1 (tuple2 b1 a1))
  (Tuple2 c1 (tuple2 b1 a1) (t2tb135 x) (t2tb38 y)) (t2tb1987 r))
...
(declare-fun t2tb2008 ((set (set (tuple21 (tuple21 b a) (tuple21 a (tuple21 b
  c)))))) uni)
...
(declare-fun tb2t2008 (uni) (set (set (tuple21 (tuple21 b a) (tuple21 a
  (tuple21 b c))))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 b a) (tuple21 a (tuple21 b c)))))))
  (! (= (tb2t2008 (t2tb2008 i)) i) :pattern ((t2tb2008 i)) )))
...
;; BridgeR
  ...
  (! (=> (sort
     ...
     (= (t2tb2008 (tb2t2008 j)) j)) :pattern ((t2tb2008 (tb2t2008 j))) )))
...
;; mem_relation
  ...
  (=> (mem (tuple2 (tuple2 b1 a1) (tuple2 a1 (tuple2 b1 c1)))
  (Tuple2 (tuple2 b1 a1) (tuple2 a1 (tuple2 b1 c1)) (t2tb38 x) (t2tb260 y))
  (t2tb1990 r)) (and (mem5 x u) (mem14 y v)))))))

(declare-fun t2tb2009 ((set (set (tuple21 (tuple21 b a) (set (tuple21 a
  c)))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 b a) (set (tuple21 a c))))))) (sort
  (set1 (set1 (tuple2 (tuple2 b1 a1) (set1 (tuple2 a1 c1))))) (t2tb2009 x))))

(declare-fun tb2t2009 (uni) (set (set (tuple21 (tuple21 b a) (set (tuple21 a
  c))))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 b a) (set (tuple21 a c)))))))
  (! (= (tb2t2009 (t2tb2009 i)) i) :pattern ((t2tb2009 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 b1 a1) (set1 (tuple2 a1 c1))))) j)
     (= (t2tb2009 (tb2t2009 j)) j)) :pattern ((t2tb2009 (tb2t2009 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 b a))) (v (set (set (tuple21 a c))))
  (r (set (tuple21 (tuple21 b a) (set (tuple21 a c))))))
  (= (mem (set1 (tuple2 (tuple2 b1 a1) (set1 (tuple2 a1 c1)))) (t2tb1991 r)
  (relation (set1 (tuple2 a1 c1)) (tuple2 b1 a1) (t2tb37 u) (t2tb128 v)))
  (forall ((x (tuple21 b a)) (y (set (tuple21 a c))))
  (=> (mem (tuple2 (tuple2 b1 a1) (set1 (tuple2 a1 c1)))
  (Tuple2 (tuple2 b1 a1) (set1 (tuple2 a1 c1)) (t2tb38 x) (t2tb129 y))
  (t2tb1991 r)) (and (mem5 x u) (mem11 y v)))))))

(declare-fun t2tb2010 ((set (set (tuple21 (tuple21 b a) (tuple21 a
  c))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 b a) (tuple21 a c)))))) (sort
  (set1 (set1 (tuple2 (tuple2 b1 a1) (tuple2 a1 c1)))) (t2tb2010 x))))

(declare-fun tb2t2010 (uni) (set (set (tuple21 (tuple21 b a) (tuple21 a
  c)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 b a) (tuple21 a c))))))
  (! (= (tb2t2010 (t2tb2010 i)) i) :pattern ((t2tb2010 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 b1 a1) (tuple2 a1 c1)))) j)
     (= (t2tb2010 (tb2t2010 j)) j)) :pattern ((t2tb2010 (tb2t2010 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 b a))) (v (set (tuple21 a c)))
  (r (set (tuple21 (tuple21 b a) (tuple21 a c)))))
  (= (mem (set1 (tuple2 (tuple2 b1 a1) (tuple2 a1 c1))) (t2tb1993 r)
  (relation (tuple2 a1 c1) (tuple2 b1 a1) (t2tb37 u) (t2tb129 v)))
  (forall ((x (tuple21 b a)) (y (tuple21 a c)))
  (=> (mem (tuple2 (tuple2 b1 a1) (tuple2 a1 c1))
  (Tuple2 (tuple2 b1 a1) (tuple2 a1 c1) (t2tb38 x) (t2tb133 y)) (t2tb1993 r))
  (and (mem5 x u) (mem10 y v)))))))

(declare-fun t2tb2011 ((set (set (tuple21 (tuple21 b a) (tuple21 b
  c))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 b a) (tuple21 b c)))))) (sort
  (set1 (set1 (tuple2 (tuple2 b1 a1) (tuple2 b1 c1)))) (t2tb2011 x))))

(declare-fun tb2t2011 (uni) (set (set (tuple21 (tuple21 b a) (tuple21 b
  c)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 b a) (tuple21 b c))))))
  (! (= (tb2t2011 (t2tb2011 i)) i) :pattern ((t2tb2011 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 b1 a1) (tuple2 b1 c1)))) j)
     (= (t2tb2011 (tb2t2011 j)) j)) :pattern ((t2tb2011 (tb2t2011 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 b a))) (v (set (tuple21 b c)))
  (r (set (tuple21 (tuple21 b a) (tuple21 b c)))))
  (= (mem (set1 (tuple2 (tuple2 b1 a1) (tuple2 b1 c1))) (t2tb1995 r)
  (relation (tuple2 b1 c1) (tuple2 b1 a1) (t2tb37 u) (t2tb131 v)))
  (forall ((x (tuple21 b a)) (y (tuple21 b c)))
  (=> (mem (tuple2 (tuple2 b1 a1) (tuple2 b1 c1))
  (Tuple2 (tuple2 b1 a1) (tuple2 b1 c1) (t2tb38 x) (t2tb134 y)) (t2tb1995 r))
  (and (mem5 x u) (mem8 y v)))))))

(declare-fun t2tb2012 ((set (set (tuple21 (tuple21 b a) c)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 b a) c))))) (sort
  (set1 (set1 (tuple2 (tuple2 b1 a1) c1))) (t2tb2012 x))))

(declare-fun tb2t2012 (uni) (set (set (tuple21 (tuple21 b a) c))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 b a) c)))))
  (! (= (tb2t2012 (t2tb2012 i)) i) :pattern ((t2tb2012 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 b1 a1) c1))) j)
     (= (t2tb2012 (tb2t2012 j)) j)) :pattern ((t2tb2012 (tb2t2012 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 b a))) (v (set c)) (r (set (tuple21 (tuple21 b a)
  c))))
  (= (mem (set1 (tuple2 (tuple2 b1 a1) c1)) (t2tb1997 r)
  (relation c1 (tuple2 b1 a1) (t2tb37 u) (t2tb132 v)))
  (forall ((x (tuple21 b a)) (y c))
  (=> (mem (tuple2 (tuple2 b1 a1) c1)
  (Tuple2 (tuple2 b1 a1) c1 (t2tb38 x) (t2tb135 y)) (t2tb1997 r))
...
(declare-fun ran2 ((set (tuple21 b a))) (set a))

(declare-fun ran1 ((set (tuple21 a b))) (set b))

(declare-fun ran4 ((set (tuple21 b c))) (set c))

(declare-fun ran5 ((set (tuple21 a c))) (set c))

(declare-fun ran7 ((set (tuple21 a (tuple21 b c)))) (set (tuple21 b c)))
...
;; mem_image
  ...
  (= (mem8 x
  (tb2t131
  (image (tuple2 b1 c1) (tuple2 a1 (tuple2 b1 c1)) (t2tb1971 p) (t2tb261 w))))
  (exists ((a2 (tuple21 a (tuple21 b c))))
...
;; mem_image
  ...
  (= (mem5 x
  (tb2t37
  (image (tuple2 b1 a1) (tuple2 a1 (tuple2 b1 c1)) (t2tb1974 p) (t2tb261 w))))
  (exists ((a2 (tuple21 a (tuple21 b c))))
...
;; mem_image
  ...
  (= (mem8 x
  (tb2t131
  (image (tuple2 b1 c1) (set1 (tuple2 a1 c1)) (t2tb1975 p) (t2tb128 w))))
  (exists ((a2 (set (tuple21 a c))))
...
;; mem_image
  ...
  (= (mem5 x
  (tb2t37
  (image (tuple2 b1 a1) (set1 (tuple2 a1 c1)) (t2tb1977 p) (t2tb128 w))))
  (exists ((a2 (set (tuple21 a c))))
...
;; mem_image
  ...
  c))) (x (tuple21 b a)))
  (= (mem5 x
  (tb2t37 (image (tuple2 b1 a1) (tuple2 a1 c1) (t2tb1979 p) (t2tb129 w))))
  (exists ((a2 (tuple21 a c)))
...
;; mem_image
  ...
  (= (mem14 x
  (tb2t261
  (image (tuple2 a1 (tuple2 b1 c1)) (tuple2 b1 c1) (t2tb1981 p) (t2tb131 w))))
...
;; mem_image
  ...
  (= (mem11 x
  (tb2t128
  (image (set1 (tuple2 a1 c1)) (tuple2 b1 c1) (t2tb1983 p) (t2tb131 w))))
  (exists ((a2 (tuple21 b c)))
...
;; mem_image
  ...
  c))) (x (tuple21 b a)))
  (= (mem5 x
  (tb2t37 (image (tuple2 b1 a1) (tuple2 b1 c1) (t2tb1985 p) (t2tb131 w))))
  (exists ((a2 (tuple21 b c)))
...
;; mem_image
  ...
  (= (mem5 x (tb2t37 (image (tuple2 b1 a1) c1 (t2tb1987 p) (t2tb132 w))))
  (exists ((a2 c))
  (and (mem7 a2 w) (mem (tuple2 c1 (tuple2 b1 a1))
  (Tuple2 c1 (tuple2 b1 a1) (t2tb135 a2) (t2tb38 x)) (t2tb1987 p)))))))
...
;; mem_image
  ...
  (= (mem14 x
  (tb2t261
  (image (tuple2 a1 (tuple2 b1 c1)) (tuple2 b1 a1) (t2tb1990 p) (t2tb37 w))))
...
;; mem_image
  ...
  (= (mem11 x
  (tb2t128
  (image (set1 (tuple2 a1 c1)) (tuple2 b1 a1) (t2tb1991 p) (t2tb37 w))))
  (exists ((a2 (tuple21 b a)))
...
;; mem_image
  ...
  a))) (x (tuple21 a c)))
  (= (mem10 x
  (tb2t129 (image (tuple2 a1 c1) (tuple2 b1 a1) (t2tb1993 p) (t2tb37 w))))
  (exists ((a2 (tuple21 b a)))
...
;; mem_image
  ...
  a))) (x (tuple21 b c)))
  (= (mem8 x
  (tb2t131 (image (tuple2 b1 c1) (tuple2 b1 a1) (t2tb1995 p) (t2tb37 w))))
  (exists ((a2 (tuple21 b a)))
...
;; mem_image
  ...
  (= (mem7 x (tb2t132 (image c1 (tuple2 b1 a1) (t2tb1997 p) (t2tb37 w))))
  (exists ((a2 (tuple21 b a)))
  (and (mem5 a2 w) (mem (tuple2 (tuple2 b1 a1) c1)
  (Tuple2 (tuple2 b1 a1) c1 (t2tb38 a2) (t2tb135 x)) (t2tb1997 p)))))))
...
(declare-fun t2tb2013 ((set (tuple21 b (tuple21 c a)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 b (tuple21 c a))))) (sort
  (set1 (tuple2 b1 (tuple2 c1 a1))) (t2tb2013 x))))

(declare-fun tb2t2013 (uni) (set (tuple21 b (tuple21 c a))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 b (tuple21 c a)))))
  (! (= (tb2t2013 (t2tb2013 i)) i) :pattern ((t2tb2013 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 b1 (tuple2 c1 a1))) j)
     (= (t2tb2013 (tb2t2013 j)) j)) :pattern ((t2tb2013 (tb2t2013 j))) )))

(declare-fun t2tb2014 ((tuple21 b (tuple21 c a))) uni)
...
(declare-fun tb2t2014 (uni) (tuple21 b (tuple21 c a)))

;; BridgeL
  (assert
  (forall ((i (tuple21 b (tuple21 c a))))
  (! (= (tb2t2014 (t2tb2014 i)) i) :pattern ((t2tb2014 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 b1 (tuple2 c1 a1)) j) (= (t2tb2014 (tb2t2014 j)) j)) :pattern (
  (t2tb2014 (tb2t2014 j))) )))
...
(declare-fun t2tb2015 ((set (tuple21 (tuple21 b b) (tuple21 c a)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b b) (tuple21 c a))))) (sort
  (set1 (tuple2 (tuple2 b1 b1) (tuple2 c1 a1))) (t2tb2015 x))))

(declare-fun tb2t2015 (uni) (set (tuple21 (tuple21 b b) (tuple21 c a))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b b) (tuple21 c a)))))
  (! (= (tb2t2015 (t2tb2015 i)) i) :pattern ((t2tb2015 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 b1) (tuple2 c1 a1))) j)
     (= (t2tb2015 (tb2t2015 j)) j)) :pattern ((t2tb2015 (tb2t2015 j))) )))

(declare-fun t2tb2016 ((tuple21 (tuple21 b b) (tuple21 c a))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 b b) (tuple21 c a)))) (sort
  (tuple2 (tuple2 b1 b1) (tuple2 c1 a1)) (t2tb2016 x))))

(declare-fun tb2t2016 (uni) (tuple21 (tuple21 b b) (tuple21 c a)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b b) (tuple21 c a))))
  (! (= (tb2t2016 (t2tb2016 i)) i) :pattern ((t2tb2016 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 b1) (tuple2 c1 a1)) j)
     (= (t2tb2016 (tb2t2016 j)) j)) :pattern ((t2tb2016 (tb2t2016 j))) )))
...
(declare-fun t2tb2017 ((set (tuple21 (tuple21 b a) (tuple21 c (tuple21 b
  c))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b a) (tuple21 c (tuple21 b c)))))) (sort
  (set1 (tuple2 (tuple2 b1 a1) (tuple2 c1 (tuple2 b1 c1)))) (t2tb2017 x))))

(declare-fun tb2t2017 (uni) (set (tuple21 (tuple21 b a) (tuple21 c (tuple21 b
  c)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b a) (tuple21 c (tuple21 b c))))))
  (! (= (tb2t2017 (t2tb2017 i)) i) :pattern ((t2tb2017 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 a1) (tuple2 c1 (tuple2 b1 c1)))) j)
     (= (t2tb2017 (tb2t2017 j)) j)) :pattern ((t2tb2017 (tb2t2017 j))) )))

(declare-fun t2tb2018 ((tuple21 (tuple21 b a) (tuple21 c (tuple21 b
  c)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 b a) (tuple21 c (tuple21 b c))))) (sort
  (tuple2 (tuple2 b1 a1) (tuple2 c1 (tuple2 b1 c1))) (t2tb2018 x))))

(declare-fun tb2t2018 (uni) (tuple21 (tuple21 b a) (tuple21 c (tuple21 b
  c))))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b a) (tuple21 c (tuple21 b c)))))
  (! (= (tb2t2018 (t2tb2018 i)) i) :pattern ((t2tb2018 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 a1) (tuple2 c1 (tuple2 b1 c1))) j)
     (= (t2tb2018 (tb2t2018 j)) j)) :pattern ((t2tb2018 (tb2t2018 j))) )))
...
(declare-fun t2tb2019 ((set (tuple21 (tuple21 b b) (tuple21 a c)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b b) (tuple21 a c))))) (sort
  (set1 (tuple2 (tuple2 b1 b1) (tuple2 a1 c1))) (t2tb2019 x))))

(declare-fun tb2t2019 (uni) (set (tuple21 (tuple21 b b) (tuple21 a c))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b b) (tuple21 a c)))))
  (! (= (tb2t2019 (t2tb2019 i)) i) :pattern ((t2tb2019 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 b1) (tuple2 a1 c1))) j)
     (= (t2tb2019 (tb2t2019 j)) j)) :pattern ((t2tb2019 (tb2t2019 j))) )))

(declare-fun t2tb2020 ((tuple21 (tuple21 b b) (tuple21 a c))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 b b) (tuple21 a c)))) (sort
  (tuple2 (tuple2 b1 b1) (tuple2 a1 c1)) (t2tb2020 x))))

(declare-fun tb2t2020 (uni) (tuple21 (tuple21 b b) (tuple21 a c)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b b) (tuple21 a c))))
  (! (= (tb2t2020 (t2tb2020 i)) i) :pattern ((t2tb2020 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 b1) (tuple2 a1 c1)) j)
     (= (t2tb2020 (tb2t2020 j)) j)) :pattern ((t2tb2020 (tb2t2020 j))) )))
...
(declare-fun t2tb2021 ((set (tuple21 (tuple21 a b) (tuple21 (tuple21 b c)
  c)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 a b) (tuple21 (tuple21 b c) c))))) (sort
  (set1 (tuple2 (tuple2 a1 b1) (tuple2 (tuple2 b1 c1) c1))) (t2tb2021 x))))

(declare-fun tb2t2021 (uni) (set (tuple21 (tuple21 a b) (tuple21 (tuple21 b
  c) c))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 a b) (tuple21 (tuple21 b c) c)))))
  (! (= (tb2t2021 (t2tb2021 i)) i) :pattern ((t2tb2021 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 a1 b1) (tuple2 (tuple2 b1 c1) c1))) j)
     (= (t2tb2021 (tb2t2021 j)) j)) :pattern ((t2tb2021 (tb2t2021 j))) )))

(declare-fun t2tb2022 ((tuple21 (tuple21 a b) (tuple21 (tuple21 b c)
  c))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 a b) (tuple21 (tuple21 b c) c)))) (sort
  (tuple2 (tuple2 a1 b1) (tuple2 (tuple2 b1 c1) c1)) (t2tb2022 x))))

(declare-fun tb2t2022 (uni) (tuple21 (tuple21 a b) (tuple21 (tuple21 b c)
  c)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 a b) (tuple21 (tuple21 b c) c))))
  (! (= (tb2t2022 (t2tb2022 i)) i) :pattern ((t2tb2022 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 a1 b1) (tuple2 (tuple2 b1 c1) c1)) j)
     (= (t2tb2022 (tb2t2022 j)) j)) :pattern ((t2tb2022 (tb2t2022 j))) )))
...
(declare-fun t2tb2023 ((set (tuple21 (tuple21 a b) (tuple21 (tuple21 b c)
  a)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 a b) (tuple21 (tuple21 b c) a))))) (sort
  (set1 (tuple2 (tuple2 a1 b1) (tuple2 (tuple2 b1 c1) a1))) (t2tb2023 x))))

(declare-fun tb2t2023 (uni) (set (tuple21 (tuple21 a b) (tuple21 (tuple21 b
  c) a))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 a b) (tuple21 (tuple21 b c) a)))))
  (! (= (tb2t2023 (t2tb2023 i)) i) :pattern ((t2tb2023 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 a1 b1) (tuple2 (tuple2 b1 c1) a1))) j)
     (= (t2tb2023 (tb2t2023 j)) j)) :pattern ((t2tb2023 (tb2t2023 j))) )))

(declare-fun t2tb2024 ((tuple21 (tuple21 a b) (tuple21 (tuple21 b c)
  a))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 a b) (tuple21 (tuple21 b c) a)))) (sort
  (tuple2 (tuple2 a1 b1) (tuple2 (tuple2 b1 c1) a1)) (t2tb2024 x))))

(declare-fun tb2t2024 (uni) (tuple21 (tuple21 a b) (tuple21 (tuple21 b c)
  a)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 a b) (tuple21 (tuple21 b c) a))))
  (! (= (tb2t2024 (t2tb2024 i)) i) :pattern ((t2tb2024 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 a1 b1) (tuple2 (tuple2 b1 c1) a1)) j)
     (= (t2tb2024 (tb2t2024 j)) j)) :pattern ((t2tb2024 (tb2t2024 j))) )))
...
(declare-fun t2tb2025 ((set (tuple21 (tuple21 a b) (tuple21 c a)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 a b) (tuple21 c a))))) (sort
  (set1 (tuple2 (tuple2 a1 b1) (tuple2 c1 a1))) (t2tb2025 x))))

(declare-fun tb2t2025 (uni) (set (tuple21 (tuple21 a b) (tuple21 c a))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 a b) (tuple21 c a)))))
  (! (= (tb2t2025 (t2tb2025 i)) i) :pattern ((t2tb2025 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 a1 b1) (tuple2 c1 a1))) j)
     (= (t2tb2025 (tb2t2025 j)) j)) :pattern ((t2tb2025 (tb2t2025 j))) )))

(declare-fun t2tb2026 ((tuple21 (tuple21 a b) (tuple21 c a))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 a b) (tuple21 c a)))) (sort
  (tuple2 (tuple2 a1 b1) (tuple2 c1 a1)) (t2tb2026 x))))

(declare-fun tb2t2026 (uni) (tuple21 (tuple21 a b) (tuple21 c a)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 a b) (tuple21 c a))))
  (! (= (tb2t2026 (t2tb2026 i)) i) :pattern ((t2tb2026 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 a1 b1) (tuple2 c1 a1)) j)
     (= (t2tb2026 (tb2t2026 j)) j)) :pattern ((t2tb2026 (tb2t2026 j))) )))
...
;; mem_partial_surjection_set
  ...
  (infix_plmngtgt c1 b1 (t2tb12 s) (t2tb132 t)))
  (and (mem (set1 (tuple2 b1 c1)) (t2tb131 x)
  (infix_plmngt c1 b1 (t2tb12 s) (t2tb132 t))) (infix_eqeq7 (ran4 x) t)))))

;; mem_partial_surjection_set
  (assert
  (forall ((s (set b)) (t (set a)) (x (set (tuple21 b a))))
  (= (mem (set1 (tuple2 b1 a1)) (t2tb37 x)
  (infix_plmngtgt a1 b1 (t2tb12 s) (t2tb1 t)))
  (and (mem (set1 (tuple2 b1 a1)) (t2tb37 x)
  (infix_plmngt a1 b1 (t2tb12 s) (t2tb1 t))) (infix_eqeq1 (ran2 x) t)))))
...
;; mem_partial_surjection_set
  ...
  (infix_plmngtgt (tuple2 b1 c1) a1 (t2tb1 s) (t2tb131 t)))
  (and (mem (set1 (tuple2 a1 (tuple2 b1 c1))) (t2tb261 x)
  (infix_plmngt (tuple2 b1 c1) a1 (t2tb1 s) (t2tb131 t))) (infix_eqeq8
  (ran7 x) t)))))
...
(assert
;; equal_range_11
 ;; File "lemmes_bbook.why", line 1436, characters 7-21
  (not
  (forall ((s (set a)) (t (set b)) (u (set c)) (p (set (tuple21 a b)))
  (q (set (tuple21 a c))))
  (=> (and (mem4 p (relation1 s t)) (mem11 q (relation3 s u))) (infix_eqeq8
  (ran7 (direct_product1 p q)) (semicolon12 (inverse2 p) q))))))
(check-sat)
