...
tff(equal_semicolon_6, conjecture, ![A : $tType, B : $tType, C : $tType]:
  ...
  => infix_eqeq(tuple2(A, C), semicolon(A, B, C, R, domain_restriction(B,
  C, V, P)), semicolon(A, B, C, range_restriction(A, B, R, V), P)))).
