...
;; mem_dom
  ...
  (= (mem1 x (dom1 p)) (exists ((b2 b)) (mem3 (Tuple21 x b2) p)))))
...
;; mem_overriding
  ...
  (or (and (mem3 (Tuple21 x y) q) (not (mem1 x (dom1 p)))) (mem3
  (Tuple21 x y) p)))))
...
(assert
;; equal_domain_16
 ;; File "lemmes_bbook.why", line 1335, characters 7-22
  (not
  (forall ((s (set a)) (t (set b)) (x a) (y b))
  (=> (and (mem1 x s) (mem2 y t)) (infix_eqeq1
  (dom1 (singleton3 (Tuple21 x y))) (singleton1 x))))))
(check-sat)
