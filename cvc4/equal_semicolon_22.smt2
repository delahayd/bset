...
(declare-fun t2tb2741 ((set (tuple21 (set (tuple21 b a)) (set (tuple21 a
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (set (tuple21 b a)) (set (tuple21 a b)))))) (sort
  (set1 (tuple2 (set1 (tuple2 b1 a1)) (set1 (tuple2 a1 b1)))) (t2tb2741 x))))

(declare-fun tb2t2741 (uni) (set (tuple21 (set (tuple21 b a)) (set (tuple21 a
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (set (tuple21 b a)) (set (tuple21 a b))))))
  (! (= (tb2t2741 (t2tb2741 i)) i) :pattern ((t2tb2741 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (set1 (tuple2 b1 a1)) (set1 (tuple2 a1 b1)))) j)
     (= (t2tb2741 (tb2t2741 j)) j)) :pattern ((t2tb2741 (tb2t2741 j))) )))

(declare-fun t2tb2742 ((tuple21 (set (tuple21 b a)) (set (tuple21 a
  b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (set (tuple21 b a)) (set (tuple21 a b))))) (sort
  (tuple2 (set1 (tuple2 b1 a1)) (set1 (tuple2 a1 b1))) (t2tb2742 x))))

(declare-fun tb2t2742 (uni) (tuple21 (set (tuple21 b a)) (set (tuple21 a
  b))))

;; BridgeL
  (assert
  (forall ((i (tuple21 (set (tuple21 b a)) (set (tuple21 a b)))))
  (! (= (tb2t2742 (t2tb2742 i)) i) :pattern ((t2tb2742 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (set1 (tuple2 b1 a1)) (set1 (tuple2 a1 b1))) j)
     (= (t2tb2742 (tb2t2742 j)) j)) :pattern ((t2tb2742 (tb2t2742 j))) )))
...
(declare-fun t2tb2743 ((set (tuple21 (set (tuple21 b a)) (tuple21 a
  a)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (set (tuple21 b a)) (tuple21 a a))))) (sort
  (set1 (tuple2 (set1 (tuple2 b1 a1)) (tuple2 a1 a1))) (t2tb2743 x))))

(declare-fun tb2t2743 (uni) (set (tuple21 (set (tuple21 b a)) (tuple21 a
  a))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (set (tuple21 b a)) (tuple21 a a)))))
  (! (= (tb2t2743 (t2tb2743 i)) i) :pattern ((t2tb2743 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (set1 (tuple2 b1 a1)) (tuple2 a1 a1))) j)
     (= (t2tb2743 (tb2t2743 j)) j)) :pattern ((t2tb2743 (tb2t2743 j))) )))

(declare-fun t2tb2744 ((tuple21 (set (tuple21 b a)) (tuple21 a a))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (set (tuple21 b a)) (tuple21 a a)))) (sort
  (tuple2 (set1 (tuple2 b1 a1)) (tuple2 a1 a1)) (t2tb2744 x))))

(declare-fun tb2t2744 (uni) (tuple21 (set (tuple21 b a)) (tuple21 a a)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (set (tuple21 b a)) (tuple21 a a))))
  (! (= (tb2t2744 (t2tb2744 i)) i) :pattern ((t2tb2744 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (set1 (tuple2 b1 a1)) (tuple2 a1 a1)) j)
     (= (t2tb2744 (tb2t2744 j)) j)) :pattern ((t2tb2744 (tb2t2744 j))) )))

;; mem_times
  (assert
  (forall ((s (set (set (tuple21 b a)))) (t (set (tuple21 a a)))
  (x (set (tuple21 b a))) (y (tuple21 a a)))
  (= (mem (tuple2 (set1 (tuple2 b1 a1)) (tuple2 a1 a1))
  (Tuple2 (set1 (tuple2 b1 a1)) (tuple2 a1 a1) (t2tb37 x) (t2tb5 y))
  (times (tuple2 a1 a1) (set1 (tuple2 b1 a1)) (t2tb56 s) (t2tb4 t)))
  (and (mem6 x s) (mem12 y t)))))
...
(declare-fun t2tb2745 ((set (tuple21 (tuple21 b a) (tuple21 a a)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b a) (tuple21 a a))))) (sort
  (set1 (tuple2 (tuple2 b1 a1) (tuple2 a1 a1))) (t2tb2745 x))))

(declare-fun tb2t2745 (uni) (set (tuple21 (tuple21 b a) (tuple21 a a))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b a) (tuple21 a a)))))
  (! (= (tb2t2745 (t2tb2745 i)) i) :pattern ((t2tb2745 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 a1) (tuple2 a1 a1))) j)
     (= (t2tb2745 (tb2t2745 j)) j)) :pattern ((t2tb2745 (tb2t2745 j))) )))

(declare-fun t2tb2746 ((tuple21 (tuple21 b a) (tuple21 a a))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 b a) (tuple21 a a)))) (sort
  (tuple2 (tuple2 b1 a1) (tuple2 a1 a1)) (t2tb2746 x))))

(declare-fun tb2t2746 (uni) (tuple21 (tuple21 b a) (tuple21 a a)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b a) (tuple21 a a))))
  (! (= (tb2t2746 (t2tb2746 i)) i) :pattern ((t2tb2746 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 a1) (tuple2 a1 a1)) j)
     (= (t2tb2746 (tb2t2746 j)) j)) :pattern ((t2tb2746 (tb2t2746 j))) )))
...
(declare-fun t2tb2747 ((set (tuple21 (set (tuple21 a b)) (set (tuple21 b
  a))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (set (tuple21 a b)) (set (tuple21 b a)))))) (sort
  (set1 (tuple2 (set1 (tuple2 a1 b1)) (set1 (tuple2 b1 a1)))) (t2tb2747 x))))

(declare-fun tb2t2747 (uni) (set (tuple21 (set (tuple21 a b)) (set (tuple21 b
  a)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (set (tuple21 a b)) (set (tuple21 b a))))))
  (! (= (tb2t2747 (t2tb2747 i)) i) :pattern ((t2tb2747 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (set1 (tuple2 a1 b1)) (set1 (tuple2 b1 a1)))) j)
     (= (t2tb2747 (tb2t2747 j)) j)) :pattern ((t2tb2747 (tb2t2747 j))) )))

(declare-fun t2tb2748 ((tuple21 (set (tuple21 a b)) (set (tuple21 b
  a)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (set (tuple21 a b)) (set (tuple21 b a))))) (sort
  (tuple2 (set1 (tuple2 a1 b1)) (set1 (tuple2 b1 a1))) (t2tb2748 x))))

(declare-fun tb2t2748 (uni) (tuple21 (set (tuple21 a b)) (set (tuple21 b
  a))))

;; BridgeL
  (assert
  (forall ((i (tuple21 (set (tuple21 a b)) (set (tuple21 b a)))))
  (! (= (tb2t2748 (t2tb2748 i)) i) :pattern ((t2tb2748 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (set1 (tuple2 a1 b1)) (set1 (tuple2 b1 a1))) j)
     (= (t2tb2748 (tb2t2748 j)) j)) :pattern ((t2tb2748 (tb2t2748 j))) )))
...
(declare-fun t2tb2714 ((set (tuple21 (set (tuple21 a b)) (tuple21 a
  a)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (set (tuple21 a b)) (tuple21 a a))))) (sort
  (set1 (tuple2 (set1 (tuple2 a1 b1)) (tuple2 a1 a1))) (t2tb2714 x))))

(declare-fun tb2t2714 (uni) (set (tuple21 (set (tuple21 a b)) (tuple21 a
  a))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (set (tuple21 a b)) (tuple21 a a)))))
  (! (= (tb2t2714 (t2tb2714 i)) i) :pattern ((t2tb2714 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (set1 (tuple2 a1 b1)) (tuple2 a1 a1))) j)
     (= (t2tb2714 (tb2t2714 j)) j)) :pattern ((t2tb2714 (tb2t2714 j))) )))

(declare-fun t2tb2715 ((tuple21 (set (tuple21 a b)) (tuple21 a a))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (set (tuple21 a b)) (tuple21 a a)))) (sort
  (tuple2 (set1 (tuple2 a1 b1)) (tuple2 a1 a1)) (t2tb2715 x))))

(declare-fun tb2t2715 (uni) (tuple21 (set (tuple21 a b)) (tuple21 a a)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (set (tuple21 a b)) (tuple21 a a))))
  (! (= (tb2t2715 (t2tb2715 i)) i) :pattern ((t2tb2715 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (set1 (tuple2 a1 b1)) (tuple2 a1 a1)) j)
     (= (t2tb2715 (tb2t2715 j)) j)) :pattern ((t2tb2715 (tb2t2715 j))) )))
...
(declare-fun t2tb2749 ((set (tuple21 (tuple21 a a) (set (tuple21 b
  a))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 a a) (set (tuple21 b a)))))) (sort
  (set1 (tuple2 (tuple2 a1 a1) (set1 (tuple2 b1 a1)))) (t2tb2749 x))))

(declare-fun tb2t2749 (uni) (set (tuple21 (tuple21 a a) (set (tuple21 b
  a)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 a a) (set (tuple21 b a))))))
  (! (= (tb2t2749 (t2tb2749 i)) i) :pattern ((t2tb2749 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 a1 a1) (set1 (tuple2 b1 a1)))) j)
     (= (t2tb2749 (tb2t2749 j)) j)) :pattern ((t2tb2749 (tb2t2749 j))) )))

(declare-fun t2tb2750 ((tuple21 (tuple21 a a) (set (tuple21 b a)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 a a) (set (tuple21 b a))))) (sort
  (tuple2 (tuple2 a1 a1) (set1 (tuple2 b1 a1))) (t2tb2750 x))))

(declare-fun tb2t2750 (uni) (tuple21 (tuple21 a a) (set (tuple21 b a))))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 a a) (set (tuple21 b a)))))
  (! (= (tb2t2750 (t2tb2750 i)) i) :pattern ((t2tb2750 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 a1 a1) (set1 (tuple2 b1 a1))) j)
     (= (t2tb2750 (tb2t2750 j)) j)) :pattern ((t2tb2750 (tb2t2750 j))) )))

;; mem_times
  (assert
  (forall ((s (set (tuple21 a a))) (t (set (set (tuple21 b a))))
  (x (tuple21 a a)) (y (set (tuple21 b a))))
  (= (mem (tuple2 (tuple2 a1 a1) (set1 (tuple2 b1 a1)))
  (Tuple2 (tuple2 a1 a1) (set1 (tuple2 b1 a1)) (t2tb5 x) (t2tb37 y))
  (times (set1 (tuple2 b1 a1)) (tuple2 a1 a1) (t2tb4 s) (t2tb56 t)))
  (and (mem12 x s) (mem6 y t)))))
...
(declare-fun t2tb2718 ((set (tuple21 (tuple21 a a) (set (tuple21 a
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 a a) (set (tuple21 a b)))))) (sort
  (set1 (tuple2 (tuple2 a1 a1) (set1 (tuple2 a1 b1)))) (t2tb2718 x))))

(declare-fun tb2t2718 (uni) (set (tuple21 (tuple21 a a) (set (tuple21 a
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 a a) (set (tuple21 a b))))))
  (! (= (tb2t2718 (t2tb2718 i)) i) :pattern ((t2tb2718 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 a1 a1) (set1 (tuple2 a1 b1)))) j)
     (= (t2tb2718 (tb2t2718 j)) j)) :pattern ((t2tb2718 (tb2t2718 j))) )))

(declare-fun t2tb2719 ((tuple21 (tuple21 a a) (set (tuple21 a b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 a a) (set (tuple21 a b))))) (sort
  (tuple2 (tuple2 a1 a1) (set1 (tuple2 a1 b1))) (t2tb2719 x))))

(declare-fun tb2t2719 (uni) (tuple21 (tuple21 a a) (set (tuple21 a b))))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 a a) (set (tuple21 a b)))))
  (! (= (tb2t2719 (t2tb2719 i)) i) :pattern ((t2tb2719 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 a1 a1) (set1 (tuple2 a1 b1))) j)
     (= (t2tb2719 (tb2t2719 j)) j)) :pattern ((t2tb2719 (tb2t2719 j))) )))
...
(declare-fun relation2 ((set b) (set a)) (set (set (tuple21 b a))))
...
(declare-fun t2tb2751 ((set (set (tuple21 (set (tuple21 b a)) (set (tuple21 a
  b)))))) uni)
...
(declare-fun tb2t2751 (uni) (set (set (tuple21 (set (tuple21 b a))
  (set (tuple21 a b))))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (set (tuple21 b a)) (set (tuple21 a b)))))))
  (! (= (tb2t2751 (t2tb2751 i)) i) :pattern ((t2tb2751 i)) )))
...
;; BridgeR
  ...
  (! (=> (sort
     ...
     (= (t2tb2751 (tb2t2751 j)) j)) :pattern ((t2tb2751 (tb2t2751 j))) )))
...
;; mem_relation
  ...
  (=> (mem (tuple2 (set1 (tuple2 b1 a1)) (set1 (tuple2 a1 b1)))
  (Tuple2 (set1 (tuple2 b1 a1)) (set1 (tuple2 a1 b1)) (t2tb37 x) (t2tb11 y))
  (t2tb2741 r)) (and (mem6 x u) (mem4 y v)))))))
...
(declare-fun t2tb2752 ((set (set (tuple21 (set (tuple21 b a)) (tuple21 a
  a))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (set (tuple21 b a)) (tuple21 a a)))))) (sort
  (set1 (set1 (tuple2 (set1 (tuple2 b1 a1)) (tuple2 a1 a1)))) (t2tb2752 x))))

(declare-fun tb2t2752 (uni) (set (set (tuple21 (set (tuple21 b a)) (tuple21 a
  a)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (set (tuple21 b a)) (tuple21 a a))))))
  (! (= (tb2t2752 (t2tb2752 i)) i) :pattern ((t2tb2752 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (set1 (tuple2 b1 a1)) (tuple2 a1 a1)))) j)
     (= (t2tb2752 (tb2t2752 j)) j)) :pattern ((t2tb2752 (tb2t2752 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (set (tuple21 b a)))) (v (set (tuple21 a a)))
  (r (set (tuple21 (set (tuple21 b a)) (tuple21 a a)))))
  (= (mem (set1 (tuple2 (set1 (tuple2 b1 a1)) (tuple2 a1 a1))) (t2tb2743 r)
  (relation (tuple2 a1 a1) (set1 (tuple2 b1 a1)) (t2tb56 u) (t2tb4 v)))
  (forall ((x (set (tuple21 b a))) (y (tuple21 a a)))
  (=> (mem (tuple2 (set1 (tuple2 b1 a1)) (tuple2 a1 a1))
  (Tuple2 (set1 (tuple2 b1 a1)) (tuple2 a1 a1) (t2tb37 x) (t2tb5 y))
  (t2tb2743 r)) (and (mem6 x u) (mem12 y v)))))))
...
(declare-fun t2tb2753 ((set (set (tuple21 (tuple21 b a) (tuple21 a
  a))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 b a) (tuple21 a a)))))) (sort
  (set1 (set1 (tuple2 (tuple2 b1 a1) (tuple2 a1 a1)))) (t2tb2753 x))))

(declare-fun tb2t2753 (uni) (set (set (tuple21 (tuple21 b a) (tuple21 a
  a)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 b a) (tuple21 a a))))))
  (! (= (tb2t2753 (t2tb2753 i)) i) :pattern ((t2tb2753 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 b1 a1) (tuple2 a1 a1)))) j)
     (= (t2tb2753 (tb2t2753 j)) j)) :pattern ((t2tb2753 (tb2t2753 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 b a))) (v (set (tuple21 a a)))
  (r (set (tuple21 (tuple21 b a) (tuple21 a a)))))
  (= (mem (set1 (tuple2 (tuple2 b1 a1) (tuple2 a1 a1))) (t2tb2745 r)
  (relation (tuple2 a1 a1) (tuple2 b1 a1) (t2tb37 u) (t2tb4 v)))
  (forall ((x (tuple21 b a)) (y (tuple21 a a)))
  (=> (mem (tuple2 (tuple2 b1 a1) (tuple2 a1 a1))
  (Tuple2 (tuple2 b1 a1) (tuple2 a1 a1) (t2tb38 x) (t2tb5 y)) (t2tb2745 r))
...
(declare-fun t2tb2754 ((set (set (tuple21 (set (tuple21 a b)) (set (tuple21 b
  a)))))) uni)
...
(declare-fun tb2t2754 (uni) (set (set (tuple21 (set (tuple21 a b))
  (set (tuple21 b a))))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (set (tuple21 a b)) (set (tuple21 b a)))))))
  (! (= (tb2t2754 (t2tb2754 i)) i) :pattern ((t2tb2754 i)) )))
...
;; BridgeR
  ...
  (! (=> (sort
     ...
     (= (t2tb2754 (tb2t2754 j)) j)) :pattern ((t2tb2754 (tb2t2754 j))) )))
...
;; mem_relation
  ...
  (=> (mem (tuple2 (set1 (tuple2 a1 b1)) (set1 (tuple2 b1 a1)))
  (Tuple2 (set1 (tuple2 a1 b1)) (set1 (tuple2 b1 a1)) (t2tb11 x) (t2tb37 y))
  (t2tb2747 r)) (and (mem4 x u) (mem6 y v)))))))
...
(declare-fun t2tb2730 ((set (set (tuple21 (set (tuple21 a b)) (tuple21 a
  a))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (set (tuple21 a b)) (tuple21 a a)))))) (sort
  (set1 (set1 (tuple2 (set1 (tuple2 a1 b1)) (tuple2 a1 a1)))) (t2tb2730 x))))

(declare-fun tb2t2730 (uni) (set (set (tuple21 (set (tuple21 a b)) (tuple21 a
  a)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (set (tuple21 a b)) (tuple21 a a))))))
  (! (= (tb2t2730 (t2tb2730 i)) i) :pattern ((t2tb2730 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (set1 (tuple2 a1 b1)) (tuple2 a1 a1)))) j)
     (= (t2tb2730 (tb2t2730 j)) j)) :pattern ((t2tb2730 (tb2t2730 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (set (tuple21 a b)))) (v (set (tuple21 a a)))
  (r (set (tuple21 (set (tuple21 a b)) (tuple21 a a)))))
  (= (mem (set1 (tuple2 (set1 (tuple2 a1 b1)) (tuple2 a1 a1))) (t2tb2714 r)
  (relation (tuple2 a1 a1) (set1 (tuple2 a1 b1)) (t2tb10 u) (t2tb4 v)))
  (forall ((x (set (tuple21 a b))) (y (tuple21 a a)))
  (=> (mem (tuple2 (set1 (tuple2 a1 b1)) (tuple2 a1 a1))
  (Tuple2 (set1 (tuple2 a1 b1)) (tuple2 a1 a1) (t2tb11 x) (t2tb5 y))
  (t2tb2714 r)) (and (mem4 x u) (mem12 y v)))))))
...
(declare-fun t2tb2755 ((set (set (tuple21 (tuple21 a a) (set (tuple21 b
  a)))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 a a) (set (tuple21 b a))))))) (sort
  (set1 (set1 (tuple2 (tuple2 a1 a1) (set1 (tuple2 b1 a1))))) (t2tb2755 x))))

(declare-fun tb2t2755 (uni) (set (set (tuple21 (tuple21 a a) (set (tuple21 b
  a))))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 a a) (set (tuple21 b a)))))))
  (! (= (tb2t2755 (t2tb2755 i)) i) :pattern ((t2tb2755 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 a1 a1) (set1 (tuple2 b1 a1))))) j)
     (= (t2tb2755 (tb2t2755 j)) j)) :pattern ((t2tb2755 (tb2t2755 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 a a))) (v (set (set (tuple21 b a))))
  (r (set (tuple21 (tuple21 a a) (set (tuple21 b a))))))
  (= (mem (set1 (tuple2 (tuple2 a1 a1) (set1 (tuple2 b1 a1)))) (t2tb2749 r)
  (relation (set1 (tuple2 b1 a1)) (tuple2 a1 a1) (t2tb4 u) (t2tb56 v)))
  (forall ((x (tuple21 a a)) (y (set (tuple21 b a))))
  (=> (mem (tuple2 (tuple2 a1 a1) (set1 (tuple2 b1 a1)))
  (Tuple2 (tuple2 a1 a1) (set1 (tuple2 b1 a1)) (t2tb5 x) (t2tb37 y))
  (t2tb2749 r)) (and (mem12 x u) (mem6 y v)))))))

(declare-fun t2tb2756 ((set (set (tuple21 (tuple21 a a) (tuple21 b
  a))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 a a) (tuple21 b a)))))) (sort
  (set1 (set1 (tuple2 (tuple2 a1 a1) (tuple2 b1 a1)))) (t2tb2756 x))))

(declare-fun tb2t2756 (uni) (set (set (tuple21 (tuple21 a a) (tuple21 b
  a)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 a a) (tuple21 b a))))))
  (! (= (tb2t2756 (t2tb2756 i)) i) :pattern ((t2tb2756 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 a1 a1) (tuple2 b1 a1)))) j)
     (= (t2tb2756 (tb2t2756 j)) j)) :pattern ((t2tb2756 (tb2t2756 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 a a))) (v (set (tuple21 b a)))
  (r (set (tuple21 (tuple21 a a) (tuple21 b a)))))
  (= (mem (set1 (tuple2 (tuple2 a1 a1) (tuple2 b1 a1))) (t2tb2739 r)
  (relation (tuple2 b1 a1) (tuple2 a1 a1) (t2tb4 u) (t2tb37 v)))
  (forall ((x (tuple21 a a)) (y (tuple21 b a)))
  (=> (mem (tuple2 (tuple2 a1 a1) (tuple2 b1 a1))
  (Tuple2 (tuple2 a1 a1) (tuple2 b1 a1) (t2tb5 x) (t2tb38 y)) (t2tb2739 r))
  (and (mem12 x u) (mem5 y v)))))))

(declare-fun t2tb2733 ((set (set (tuple21 (tuple21 a a) (set (tuple21 a
  b)))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 a a) (set (tuple21 a b))))))) (sort
  (set1 (set1 (tuple2 (tuple2 a1 a1) (set1 (tuple2 a1 b1))))) (t2tb2733 x))))

(declare-fun tb2t2733 (uni) (set (set (tuple21 (tuple21 a a) (set (tuple21 a
  b))))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 a a) (set (tuple21 a b)))))))
  (! (= (tb2t2733 (t2tb2733 i)) i) :pattern ((t2tb2733 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 a1 a1) (set1 (tuple2 a1 b1))))) j)
     (= (t2tb2733 (tb2t2733 j)) j)) :pattern ((t2tb2733 (tb2t2733 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 a a))) (v (set (set (tuple21 a b))))
  (r (set (tuple21 (tuple21 a a) (set (tuple21 a b))))))
  (= (mem (set1 (tuple2 (tuple2 a1 a1) (set1 (tuple2 a1 b1)))) (t2tb2718 r)
  (relation (set1 (tuple2 a1 b1)) (tuple2 a1 a1) (t2tb4 u) (t2tb10 v)))
  (forall ((x (tuple21 a a)) (y (set (tuple21 a b))))
  (=> (mem (tuple2 (tuple2 a1 a1) (set1 (tuple2 a1 b1)))
  (Tuple2 (tuple2 a1 a1) (set1 (tuple2 a1 b1)) (t2tb5 x) (t2tb11 y))
  (t2tb2718 r)) (and (mem12 x u) (mem4 y v)))))))
...
;; mem_inverse
  ...
  (= (mem3 (tb2t13 (Tuple2 a1 b1 (t2tb2 x) (t2tb14 y)))
  (tb2t11 (inverse a1 b1 (t2tb37 p)))) (mem5
...
;; mem_inverse
  ...
  (= (mem5 (tb2t38 (Tuple2 b1 a1 (t2tb14 x) (t2tb2 y)))
  (tb2t37 (inverse b1 a1 (t2tb11 p)))) (mem3
...
;; mem_id
  ...
  (= (mem12 (tb2t5 (Tuple2 a1 a1 (t2tb2 x) (t2tb2 y)))
  (tb2t4 (id a1 (t2tb1 u)))) (and (mem1 x u) (= x y)))))
...
(declare-fun domain_substraction5 ((set a) (set (tuple21 a
  a))) (set (tuple21 a a)))
...
;; mem_image
  ...
  (= (mem4 x
  (tb2t10
  (image (set1 (tuple2 a1 b1)) (set1 (tuple2 b1 a1)) (t2tb2741 p) (t2tb56 w))))
  (exists ((a2 (set (tuple21 b a))))
...
;; mem_image
  (assert
  (forall ((p (set (tuple21 (set (tuple21 b a)) (tuple21 a a))))
  (w (set (set (tuple21 b a)))) (x (tuple21 a a)))
  (= (mem12 x
  (tb2t4
  (image (tuple2 a1 a1) (set1 (tuple2 b1 a1)) (t2tb2743 p) (t2tb56 w))))
  (exists ((a2 (set (tuple21 b a))))
  (and (mem6 a2 w) (mem (tuple2 (set1 (tuple2 b1 a1)) (tuple2 a1 a1))
  (Tuple2 (set1 (tuple2 b1 a1)) (tuple2 a1 a1) (t2tb37 a2) (t2tb5 x))
  (t2tb2743 p)))))))
...
;; mem_image
  ...
  a))) (x (tuple21 a a)))
  (= (mem12 x
  (tb2t4 (image (tuple2 a1 a1) (tuple2 b1 a1) (t2tb2745 p) (t2tb37 w))))
  (exists ((a2 (tuple21 b a)))
  (and (mem5 a2 w) (mem (tuple2 (tuple2 b1 a1) (tuple2 a1 a1))
  (Tuple2 (tuple2 b1 a1) (tuple2 a1 a1) (t2tb38 a2) (t2tb5 x)) (t2tb2745 p)))))))
...
;; mem_image
  ...
  (= (mem6 x
  (tb2t56
  (image (set1 (tuple2 b1 a1)) (set1 (tuple2 a1 b1)) (t2tb2747 p) (t2tb10 w))))
...
;; mem_image
  ...
  (= (mem12 x
  (tb2t4
  (image (tuple2 a1 a1) (set1 (tuple2 a1 b1)) (t2tb2714 p) (t2tb10 w))))
  (exists ((a2 (set (tuple21 a b))))
...
;; mem_image
  (assert
  (forall ((p (set (tuple21 (tuple21 a a) (set (tuple21 b a)))))
  (w (set (tuple21 a a))) (x (set (tuple21 b a))))
  (= (mem6 x
  (tb2t56
  (image (set1 (tuple2 b1 a1)) (tuple2 a1 a1) (t2tb2749 p) (t2tb4 w))))
  (exists ((a2 (tuple21 a a)))
  (and (mem12 a2 w) (mem (tuple2 (tuple2 a1 a1) (set1 (tuple2 b1 a1)))
  (Tuple2 (tuple2 a1 a1) (set1 (tuple2 b1 a1)) (t2tb5 a2) (t2tb37 x))
  (t2tb2749 p)))))))
...
;; mem_image
  ...
  a))) (x (tuple21 b a)))
  (= (mem5 x
  (tb2t37 (image (tuple2 b1 a1) (tuple2 a1 a1) (t2tb2739 p) (t2tb4 w))))
  (exists ((a2 (tuple21 a a)))
  (and (mem12 a2 w) (mem (tuple2 (tuple2 a1 a1) (tuple2 b1 a1))
  (Tuple2 (tuple2 a1 a1) (tuple2 b1 a1) (t2tb5 a2) (t2tb38 x)) (t2tb2739 p)))))))
...
;; mem_image
  ...
  (= (mem4 x
  (tb2t10
  (image (set1 (tuple2 a1 b1)) (tuple2 a1 a1) (t2tb2718 p) (t2tb4 w))))
  (exists ((a2 (tuple21 a a)))
...
;; mem_total_function_set
  ...
  (infix_eqeq3 (tb2t12 (dom a1 b1 (t2tb37 x))) s)))))
...
;; mem_partial_injection_set
  ...
  (tb2t37 (inverse b1 a1 (t2tb11 x)))
  (tb2t56 (infix_plmngt a1 b1 (t2tb12 t) (t2tb1 s))))))))
...
;; mem_partial_surjection_set
  ...
  (and (mem6 x (tb2t56 (infix_plmngt a1 b1 (t2tb12 s) (t2tb1 t))))
  (infix_eqeq1 (tb2t1 (ran a1 b1 (t2tb37 x))) t)))))
...
(assert
;; equal_semicolon_22
 ;; File "lemmes_bbook.why", line 1693, characters 7-25
  (not
  (forall ((s (set a)) (u (set a)) (t (set b)) (p (set (tuple21 a b)))
  (r (set (tuple21 b a))))
  (=>
  (and (subset2 u s) (and (mem4 p (relation1 s t)) (mem6 r (relation2 t u))))
  (infix_eqeq2 (semicolon3 (domain_substraction1 u p) r)
  (domain_substraction5 u (semicolon3 p r)))))))
(check-sat)
