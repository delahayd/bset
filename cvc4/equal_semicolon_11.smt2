...
(declare-fun union8 ((set c) (set c)) (set c))

(declare-fun union9 ((set (tuple21 b c)) (set (tuple21 b c))) (set (tuple21 b
  c)))

(declare-fun union10 ((set (tuple21 a c)) (set (tuple21 a
  c))) (set (tuple21 a c)))

(declare-fun union11 ((set (set (tuple21 b c))) (set (set (tuple21 b
  c)))) (set (set (tuple21 b c))))

;; mem_union
  (assert
  (forall ((s (set (tuple21 a c))) (t (set (tuple21 a c))) (x (tuple21 a c)))
  (= (mem10 x (union10 s t)) (or (mem10 x s) (mem10 x t)))))

;; mem_union
  (assert
  (forall ((s (set (set (tuple21 b c)))) (t (set (set (tuple21 b c))))
  (x (set (tuple21 b c))))
  (= (mem9 x (union11 s t)) (or (mem9 x s) (mem9 x t)))))

;; mem_union
  (assert
  (forall ((s (set (tuple21 b c))) (t (set (tuple21 b c))) (x (tuple21 b c)))
  (= (mem8 x (union9 s t)) (or (mem8 x s) (mem8 x t)))))

;; mem_union
  (assert
  (forall ((s (set c)) (t (set c)) (x c))
  (= (mem7 x (union8 s t)) (or (mem7 x s) (mem7 x t)))))
...
(assert
;; equal_semicolon_11
 ;; File "lemmes_bbook.why", line 1594, characters 7-25
  (not
  ...
  (semicolon1 r (union9 p q)) (union10 (semicolon1 r p) (semicolon1 r q)))))))
(check-sat)
