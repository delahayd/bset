...
fof(equal_semicolon_25, conjecture, ![S, T, U, P, Q, R]: ((sort(set(a),
  ...
  & mem(set(tuple2(b, c)), R, relation(c, b, T, U)))) => infix_eqeq(tuple2(a,
  c), semicolon(c, b, a, union(tuple2(a, b), P, Q), R), union(tuple2(a, c),
  semicolon(c, b, a, P, R), semicolon(c, b, a, Q, R))))))))))).
