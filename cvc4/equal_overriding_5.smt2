...
(assert
;; equal_overriding_5
 ;; File "lemmes_bbook.why", line 2540, characters 7-25
  (not
  (forall ((s (set a)) (t (set b)) (v (set b)) (x a) (y b))
  (=> (and (mem1 x s) (and (subset5 v t) (mem2 y t))) (infix_eqeq4
  (infix_lspl1 (times2 (singleton1 x) v) (singleton3 (Tuple21 x y)))
