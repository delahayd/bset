...
tff(inclusion_semicolon_2, conjecture, ![A : $tType, B : $tType, C : $tType]:
  ...
  => subset(tuple2(A, C), diff(tuple2(A, C), semicolon(A, B, C, R, P),
  semicolon(A, B, C, R, Q)), semicolon(A, B, C, R, diff(tuple2(B, C), P,
  Q))))).
