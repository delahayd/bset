...
(declare-fun empty4 () (set (set (tuple21 a b))))

(declare-fun empty5 () (set (tuple21 b a)))
...
;; empty_def1
  (assert (is_empty (tuple2 b1 a1) (t2tb37 empty5)))

;; empty_def1
  (assert (is_empty (set1 (tuple2 a1 b1)) (t2tb10 empty4)))
...
;; empty
  (assert (forall ((x (tuple21 b a))) (not (mem5 x empty5))))

;; empty
  (assert (forall ((x (set (tuple21 a b)))) (not (mem4 x empty4))))

;; empty
  (assert (forall ((x (tuple21 a b))) (not (mem3 x empty3))))

;; empty
  (assert (forall ((x b)) (not (mem2 x empty2))))

;; empty
  (assert (forall ((x a)) (not (mem1 x empty1))))
...
(assert
;; equal_inverse_14
 ;; File "lemmes_bbook.why", line 1199, characters 7-23
  (not
  (forall ((s (set a)) (t (set b)) (r (set (tuple21 a b))))
  (=> (and (mem4 r (relation1 s t)) (infix_eqeq4 r empty3)) (infix_eqeq6
  (inverse2 r) empty5)))))
(check-sat)
