...
(declare-fun t2tb2027 ((set (tuple21 (tuple21 (tuple21 a c) (tuple21 b d))
  (tuple21 b d)))) uni)
...
(declare-fun tb2t2027 (uni) (set (tuple21 (tuple21 (tuple21 a c) (tuple21 b
  d)) (tuple21 b d))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 (tuple21 a c) (tuple21 b d)) (tuple21 b
  d))))) (! (= (tb2t2027 (t2tb2027 i)) i) :pattern ((t2tb2027 i)) )))
...
;; BridgeR
  ...
  (! (=> (sort
     ...
     (= (t2tb2027 (tb2t2027 j)) j)) :pattern ((t2tb2027 (tb2t2027 j))) )))

(declare-fun t2tb2028 ((tuple21 (tuple21 (tuple21 a c) (tuple21 b d))
  (tuple21 b d))) uni)
...
(declare-fun tb2t2028 (uni) (tuple21 (tuple21 (tuple21 a c) (tuple21 b d))
  (tuple21 b d)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 (tuple21 a c) (tuple21 b d)) (tuple21 b d))))
  (! (= (tb2t2028 (t2tb2028 i)) i) :pattern ((t2tb2028 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 (tuple2 a1 c1) (tuple2 b1 d1)) (tuple2 b1 d1))
     j) (= (t2tb2028 (tb2t2028 j)) j)) :pattern ((t2tb2028 (tb2t2028 j))) )))
...
(declare-fun t2tb2029 ((set (tuple21 (tuple21 b d) (tuple21 (tuple21 a c)
  (tuple21 b d))))) uni)
...
(declare-fun tb2t2029 (uni) (set (tuple21 (tuple21 b d) (tuple21 (tuple21 a
  c) (tuple21 b d)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b d) (tuple21 (tuple21 a c) (tuple21 b
  d)))))) (! (= (tb2t2029 (t2tb2029 i)) i) :pattern ((t2tb2029 i)) )))
...
;; BridgeR
  ...
  (! (=> (sort
     ...
     (= (t2tb2029 (tb2t2029 j)) j)) :pattern ((t2tb2029 (tb2t2029 j))) )))

(declare-fun t2tb2030 ((tuple21 (tuple21 b d) (tuple21 (tuple21 a c)
  (tuple21 b d)))) uni)
...
(declare-fun tb2t2030 (uni) (tuple21 (tuple21 b d) (tuple21 (tuple21 a c)
  (tuple21 b d))))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b d) (tuple21 (tuple21 a c) (tuple21 b d)))))
  (! (= (tb2t2030 (t2tb2030 i)) i) :pattern ((t2tb2030 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 d1) (tuple2 (tuple2 a1 c1) (tuple2 b1 d1)))
     j) (= (t2tb2030 (tb2t2030 j)) j)) :pattern ((t2tb2030 (tb2t2030 j))) )))
...
;; mem_times
  ...
  (and (mem (tuple2 a1 c1) (t2tb133 x) (t2tb129 s)) (mem23 y t)))))
...
(declare-fun t2tb2057 ((set (set (tuple21 (tuple21 (tuple21 a c) (tuple21 b
  d)) (tuple21 b d))))) uni)
...
(declare-fun tb2t2057 (uni) (set (set (tuple21 (tuple21 (tuple21 a c)
...
;; BridgeL
  ...
  (forall ((i (set (set (tuple21 (tuple21 (tuple21 a c) (tuple21 b d))
  (tuple21 b d))))))
  (! (= (tb2t2057 (t2tb2057 i)) i) :pattern ((t2tb2057 i)) )))
...
;; BridgeR
  ...
  (! (=> (sort
     (set1
     (set1 (tuple2 (tuple2 (tuple2 a1 c1) (tuple2 b1 d1)) (tuple2 b1 d1))))
     j) (= (t2tb2057 (tb2t2057 j)) j)) :pattern ((t2tb2057 (tb2t2057 j))) )))
...
;; mem_relation
  ...
  (=> (mem (tuple2 (tuple2 (tuple2 a1 c1) (tuple2 b1 d1)) (tuple2 b1 d1))
  (Tuple2 (tuple2 (tuple2 a1 c1) (tuple2 b1 d1)) (tuple2 b1 d1) (t2tb691 x)
  (t2tb692 y)) (t2tb2027 r)) (and (mem24 x u) (mem23 y v)))))))
...
(declare-fun t2tb2058 ((set (set (tuple21 (tuple21 b d) (tuple21 (tuple21 a
  c) (tuple21 b d)))))) uni)
...
(declare-fun tb2t2058 (uni) (set (set (tuple21 (tuple21 b d)
  (tuple21 (tuple21 a c) (tuple21 b d))))))
...
;; BridgeL
  ...
  (tuple21 b d)))))))
  (! (= (tb2t2058 (t2tb2058 i)) i) :pattern ((t2tb2058 i)) )))
...
;; BridgeR
  ...
  (! (=> (sort
     (set1
     (set1 (tuple2 (tuple2 b1 d1) (tuple2 (tuple2 a1 c1) (tuple2 b1 d1)))))
     j) (= (t2tb2058 (tb2t2058 j)) j)) :pattern ((t2tb2058 (tb2t2058 j))) )))
...
;; mem_relation
  ...
  (=> (mem (tuple2 (tuple2 b1 d1) (tuple2 (tuple2 a1 c1) (tuple2 b1 d1)))
  (Tuple2 (tuple2 b1 d1) (tuple2 (tuple2 a1 c1) (tuple2 b1 d1)) (t2tb692 x)
  (t2tb691 y)) (t2tb2029 r)) (and (mem23 x u) (mem24 y v)))))))
...
;; mem_relation
  ...
  (and (mem (tuple2 a1 c1) (t2tb133 x) (t2tb129 u)) (mem23 y v)))))))
...
(declare-fun ran8 ((set (tuple21 c d))) (set d))

(declare-fun ran9 ((set (tuple21 b d))) (set d))

(declare-fun ran10 ((set (tuple21 (tuple21 a c) (tuple21 b
  d)))) (set (tuple21 b d)))
...
;; mem_image
  ...
  (= (mem24 x
  (tb2t686
  (image (tuple2 (tuple2 a1 c1) (tuple2 b1 d1)) (tuple2 b1 d1) (t2tb2029 p)
  (t2tb687 w))))
...
(declare-fun t2tb2078 ((tuple21 (set b) (set d))) uni)
...
(declare-fun tb2t2078 (uni) (tuple21 (set b) (set d)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (set b) (set d))))
  (! (= (tb2t2078 (t2tb2078 i)) i) :pattern ((t2tb2078 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (set1 b1) (set1 d1)) j) (= (t2tb2078 (tb2t2078 j)) j)) :pattern (
  (t2tb2078 (tb2t2078 j))) )))
...
(declare-fun t2tb2079 ((set (tuple21 (tuple21 (tuple21 a c) b)
  (tuple21 (tuple21 b d) d)))) uni)
...
(declare-fun tb2t2079 (uni) (set (tuple21 (tuple21 (tuple21 a c) b)
  (tuple21 (tuple21 b d) d))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 (tuple21 a c) b) (tuple21 (tuple21 b d)
  d))))) (! (= (tb2t2079 (t2tb2079 i)) i) :pattern ((t2tb2079 i)) )))
...
;; BridgeR
  ...
  (! (=> (sort
     ...
     (= (t2tb2079 (tb2t2079 j)) j)) :pattern ((t2tb2079 (tb2t2079 j))) )))

(declare-fun t2tb2080 ((tuple21 (tuple21 (tuple21 a c) b) (tuple21 (tuple21 b
  d) d))) uni)
...
(declare-fun tb2t2080 (uni) (tuple21 (tuple21 (tuple21 a c) b)
  (tuple21 (tuple21 b d) d)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 (tuple21 a c) b) (tuple21 (tuple21 b d) d))))
  (! (= (tb2t2080 (t2tb2080 i)) i) :pattern ((t2tb2080 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 (tuple2 a1 c1) b1) (tuple2 (tuple2 b1 d1) d1))
     j) (= (t2tb2080 (tb2t2080 j)) j)) :pattern ((t2tb2080 (tb2t2080 j))) )))
...
(declare-fun t2tb2083 ((set (tuple21 (tuple21 b (tuple21 a c)) (tuple21 d
  (tuple21 b d))))) uni)
...
(declare-fun tb2t2083 (uni) (set (tuple21 (tuple21 b (tuple21 a c))
  (tuple21 d (tuple21 b d)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b (tuple21 a c)) (tuple21 d (tuple21 b
  d)))))) (! (= (tb2t2083 (t2tb2083 i)) i) :pattern ((t2tb2083 i)) )))
...
;; BridgeR
  ...
  (! (=> (sort
     ...
     (= (t2tb2083 (tb2t2083 j)) j)) :pattern ((t2tb2083 (tb2t2083 j))) )))

(declare-fun t2tb2084 ((tuple21 (tuple21 b (tuple21 a c)) (tuple21 d
  (tuple21 b d)))) uni)
...
(declare-fun tb2t2084 (uni) (tuple21 (tuple21 b (tuple21 a c)) (tuple21 d
  (tuple21 b d))))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b (tuple21 a c)) (tuple21 d (tuple21 b d)))))
  (! (= (tb2t2084 (t2tb2084 i)) i) :pattern ((t2tb2084 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 (tuple2 a1 c1)) (tuple2 d1 (tuple2 b1 d1)))
     j) (= (t2tb2084 (tb2t2084 j)) j)) :pattern ((t2tb2084 (tb2t2084 j))) )))
...
;; mem_partial_surjection_set
  ...
  (and (mem22 x (tb2t688 (infix_plmngt d1 c1 (t2tb132 s) (t2tb690 t))))
  (infix_eqeq13 (ran8 x) t)))))

;; mem_partial_surjection_set
  (assert
  (forall ((s (set b)) (t (set d)) (x (set (tuple21 b d))))
  (= (mem (set1 (tuple2 b1 d1)) (t2tb687 x)
  (infix_plmngtgt d1 b1 (t2tb12 s) (t2tb690 t)))
  (and (mem (set1 (tuple2 b1 d1)) (t2tb687 x)
  (infix_plmngt d1 b1 (t2tb12 s) (t2tb690 t))) (infix_eqeq13 (ran9 x) t)))))
...
(assert
;; equal_range_12
 ;; File "lemmes_bbook.why", line 1444, characters 7-21
  (not
  (forall ((s (set a)) (t (set b)) (u (set c)) (v (set d)) (p (set (tuple21 a
  b))) (q (set (tuple21 c d))))
  (=> (and (mem4 p (relation1 s t)) (mem22 q (relation7 u v))) (infix_eqeq22
  (ran10 (parallel_product1 p q)) (times10 (ran1 p) (ran8 q)))))))
(check-sat)
