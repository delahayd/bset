...
fof(equal_substraction_13, conjecture, ![S, U, T, P, Q]: ((sort(set(a),
  ...
  b), domain_substraction(b, a, U, union(tuple2(a, b), P, Q)),
  union(tuple2(a, b), domain_substraction(b, a, U, P), domain_substraction(b,
  a, U, Q)))))))))).
