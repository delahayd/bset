...
(assert
;; equal_image_15
 ;; File "lemmes_bbook.why", line 2409, characters 7-21
  (not
  (forall ((s (set a)) (u (set a)) (t (set b)) (x a) (y b))
  (=> (and (mem1 x s) (and (mem2 y t) (and (subset2 u s) (mem1 x u))))
  (infix_eqeq3 (image1 (singleton3 (Tuple21 x y)) u) (singleton2 y))))))
(check-sat)
