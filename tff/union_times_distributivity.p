...
tff(union_times_distributivity, conjecture, ![A : $tType]: ![A1:set(A), B:
  set(A), T:set(A)]: infix_eqeq(tuple2(A, A), times(A, A, union(A, A1, B),
  T), union(tuple2(A, A), times(A, A, A1, T), times(A, A, B, T)))).
