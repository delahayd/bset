...
(assert
;; equal_inverse_5
 ;; File "lemmes_bbook.why", line 1127, characters 7-22
  (not
  (forall ((s (set a)) (t (set b)) (v (set b)) (r (set (tuple21 a b))))
  (=> (and (mem4 r (relation1 s t)) (subset5 v t)) (infix_eqeq6
  (inverse2 (range_restriction1 r v)) (domain_restriction2 v (inverse2 r)))))))
(check-sat)
