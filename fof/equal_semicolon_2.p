...
fof(equal_semicolon_2, conjecture, ![S, T, U, P, Q, R]: ((sort(set(a),
  ...
  & (mem(set(tuple2(c, b)), inverse(c, b, R), infix_plmngtgt(b, c, U, T))
  & infix_eqeq(tuple2(a, c), semicolon(c, b, a, P, R), semicolon(c, b, a, Q,
  R))))) => infix_eqeq(tuple2(a, b), P, Q))))))))).
