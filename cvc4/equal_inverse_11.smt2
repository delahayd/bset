...
(declare-fun inter10 ((set (tuple21 b a)) (set (tuple21 b
  a))) (set (tuple21 b a)))

;; mem_inter
  (assert
  (forall ((s (set (tuple21 b a))) (t (set (tuple21 b a))) (x (tuple21 b a)))
  (= (mem5 x (inter10 s t)) (and (mem5 x s) (mem5 x t)))))
