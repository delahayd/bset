...
(declare-fun infix_eqeq25 ((set (tuple21 b b)) (set (tuple21 b b))) Bool)
...
;; subsetnoteq_def
  ...
  (and (subset1 (tuple2 b1 b1) (t2tb35 s) (t2tb35 t))
  (not (infix_eqeq25 s t))))))
...
(declare-fun t2tb2907 ((tuple21 (tuple21 b b) (tuple21 b b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 b b) (tuple21 b b)))) (sort
  (tuple2 (tuple2 b1 b1) (tuple2 b1 b1)) (t2tb2907 x))))

(declare-fun tb2t2907 (uni) (tuple21 (tuple21 b b) (tuple21 b b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b b) (tuple21 b b))))
  (! (= (tb2t2907 (t2tb2907 i)) i) :pattern ((t2tb2907 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 b1) (tuple2 b1 b1)) j)
     (= (t2tb2907 (tb2t2907 j)) j)) :pattern ((t2tb2907 (tb2t2907 j))) )))

(declare-fun t2tb2908 ((set (tuple21 (tuple21 b b) (tuple21 b b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b b) (tuple21 b b))))) (sort
  (set1 (tuple2 (tuple2 b1 b1) (tuple2 b1 b1))) (t2tb2908 x))))

(declare-fun tb2t2908 (uni) (set (tuple21 (tuple21 b b) (tuple21 b b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b b) (tuple21 b b)))))
  (! (= (tb2t2908 (t2tb2908 i)) i) :pattern ((t2tb2908 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 b1) (tuple2 b1 b1))) j)
     (= (t2tb2908 (tb2t2908 j)) j)) :pattern ((t2tb2908 (tb2t2908 j))) )))
...
(declare-fun t2tb2909 ((set (tuple21 (tuple21 b b) (tuple21 b a)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b b) (tuple21 b a))))) (sort
  (set1 (tuple2 (tuple2 b1 b1) (tuple2 b1 a1))) (t2tb2909 x))))

(declare-fun tb2t2909 (uni) (set (tuple21 (tuple21 b b) (tuple21 b a))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b b) (tuple21 b a)))))
  (! (= (tb2t2909 (t2tb2909 i)) i) :pattern ((t2tb2909 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 b1) (tuple2 b1 a1))) j)
     (= (t2tb2909 (tb2t2909 j)) j)) :pattern ((t2tb2909 (tb2t2909 j))) )))

(declare-fun t2tb2910 ((tuple21 (tuple21 b b) (tuple21 b a))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 b b) (tuple21 b a)))) (sort
  (tuple2 (tuple2 b1 b1) (tuple2 b1 a1)) (t2tb2910 x))))

(declare-fun tb2t2910 (uni) (tuple21 (tuple21 b b) (tuple21 b a)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b b) (tuple21 b a))))
  (! (= (tb2t2910 (t2tb2910 i)) i) :pattern ((t2tb2910 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 b1) (tuple2 b1 a1)) j)
     (= (t2tb2910 (tb2t2910 j)) j)) :pattern ((t2tb2910 (tb2t2910 j))) )))
...
(declare-fun t2tb2911 ((set (tuple21 (tuple21 b b) (set (tuple21 a
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b b) (set (tuple21 a b)))))) (sort
  (set1 (tuple2 (tuple2 b1 b1) (set1 (tuple2 a1 b1)))) (t2tb2911 x))))

(declare-fun tb2t2911 (uni) (set (tuple21 (tuple21 b b) (set (tuple21 a
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b b) (set (tuple21 a b))))))
  (! (= (tb2t2911 (t2tb2911 i)) i) :pattern ((t2tb2911 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 b1) (set1 (tuple2 a1 b1)))) j)
     (= (t2tb2911 (tb2t2911 j)) j)) :pattern ((t2tb2911 (tb2t2911 j))) )))

(declare-fun t2tb2912 ((tuple21 (tuple21 b b) (set (tuple21 a b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 b b) (set (tuple21 a b))))) (sort
  (tuple2 (tuple2 b1 b1) (set1 (tuple2 a1 b1))) (t2tb2912 x))))

(declare-fun tb2t2912 (uni) (tuple21 (tuple21 b b) (set (tuple21 a b))))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b b) (set (tuple21 a b)))))
  (! (= (tb2t2912 (t2tb2912 i)) i) :pattern ((t2tb2912 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 b1) (set1 (tuple2 a1 b1))) j)
     (= (t2tb2912 (tb2t2912 j)) j)) :pattern ((t2tb2912 (tb2t2912 j))) )))
...
(declare-fun t2tb2913 ((set (tuple21 (tuple21 b b) (tuple21 a b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b b) (tuple21 a b))))) (sort
  (set1 (tuple2 (tuple2 b1 b1) (tuple2 a1 b1))) (t2tb2913 x))))

(declare-fun tb2t2913 (uni) (set (tuple21 (tuple21 b b) (tuple21 a b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b b) (tuple21 a b)))))
  (! (= (tb2t2913 (t2tb2913 i)) i) :pattern ((t2tb2913 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 b1) (tuple2 a1 b1))) j)
     (= (t2tb2913 (tb2t2913 j)) j)) :pattern ((t2tb2913 (tb2t2913 j))) )))

(declare-fun t2tb2914 ((tuple21 (tuple21 b b) (tuple21 a b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 b b) (tuple21 a b)))) (sort
  (tuple2 (tuple2 b1 b1) (tuple2 a1 b1)) (t2tb2914 x))))

(declare-fun tb2t2914 (uni) (tuple21 (tuple21 b b) (tuple21 a b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b b) (tuple21 a b))))
  (! (= (tb2t2914 (t2tb2914 i)) i) :pattern ((t2tb2914 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 b1) (tuple2 a1 b1)) j)
     (= (t2tb2914 (tb2t2914 j)) j)) :pattern ((t2tb2914 (tb2t2914 j))) )))
...
(declare-fun t2tb2915 ((set (tuple21 (tuple21 b b) b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b b) b)))) (sort
  (set1 (tuple2 (tuple2 b1 b1) b1)) (t2tb2915 x))))

(declare-fun tb2t2915 (uni) (set (tuple21 (tuple21 b b) b)))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b b) b))))
  (! (= (tb2t2915 (t2tb2915 i)) i) :pattern ((t2tb2915 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 b1) b1)) j)
     (= (t2tb2915 (tb2t2915 j)) j)) :pattern ((t2tb2915 (tb2t2915 j))) )))

(declare-fun t2tb2916 ((tuple21 (tuple21 b b) b)) uni)
...
(declare-fun tb2t2916 (uni) (tuple21 (tuple21 b b) b))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b b) b)))
  (! (= (tb2t2916 (t2tb2916 i)) i) :pattern ((t2tb2916 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 b1) b1) j) (= (t2tb2916 (tb2t2916 j)) j)) :pattern (
  (t2tb2916 (tb2t2916 j))) )))
...
(declare-fun t2tb2917 ((set (tuple21 (tuple21 b b) a))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b b) a)))) (sort
  (set1 (tuple2 (tuple2 b1 b1) a1)) (t2tb2917 x))))

(declare-fun tb2t2917 (uni) (set (tuple21 (tuple21 b b) a)))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b b) a))))
  (! (= (tb2t2917 (t2tb2917 i)) i) :pattern ((t2tb2917 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 b1) a1)) j)
     (= (t2tb2917 (tb2t2917 j)) j)) :pattern ((t2tb2917 (tb2t2917 j))) )))

(declare-fun t2tb2918 ((tuple21 (tuple21 b b) a)) uni)
...
(declare-fun tb2t2918 (uni) (tuple21 (tuple21 b b) a))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b b) a)))
  (! (= (tb2t2918 (t2tb2918 i)) i) :pattern ((t2tb2918 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 b1) a1) j) (= (t2tb2918 (tb2t2918 j)) j)) :pattern (
  (t2tb2918 (tb2t2918 j))) )))
...
(declare-fun t2tb2919 ((set (tuple21 (tuple21 b a) (tuple21 b b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b a) (tuple21 b b))))) (sort
  (set1 (tuple2 (tuple2 b1 a1) (tuple2 b1 b1))) (t2tb2919 x))))

(declare-fun tb2t2919 (uni) (set (tuple21 (tuple21 b a) (tuple21 b b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b a) (tuple21 b b)))))
  (! (= (tb2t2919 (t2tb2919 i)) i) :pattern ((t2tb2919 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 a1) (tuple2 b1 b1))) j)
     (= (t2tb2919 (tb2t2919 j)) j)) :pattern ((t2tb2919 (tb2t2919 j))) )))

(declare-fun t2tb2920 ((tuple21 (tuple21 b a) (tuple21 b b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 b a) (tuple21 b b)))) (sort
  (tuple2 (tuple2 b1 a1) (tuple2 b1 b1)) (t2tb2920 x))))

(declare-fun tb2t2920 (uni) (tuple21 (tuple21 b a) (tuple21 b b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b a) (tuple21 b b))))
  (! (= (tb2t2920 (t2tb2920 i)) i) :pattern ((t2tb2920 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 a1) (tuple2 b1 b1)) j)
     (= (t2tb2920 (tb2t2920 j)) j)) :pattern ((t2tb2920 (tb2t2920 j))) )))
...
(declare-fun t2tb2921 ((tuple21 (set (tuple21 a b)) (tuple21 b b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (set (tuple21 a b)) (tuple21 b b)))) (sort
  (tuple2 (set1 (tuple2 a1 b1)) (tuple2 b1 b1)) (t2tb2921 x))))

(declare-fun tb2t2921 (uni) (tuple21 (set (tuple21 a b)) (tuple21 b b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (set (tuple21 a b)) (tuple21 b b))))
  (! (= (tb2t2921 (t2tb2921 i)) i) :pattern ((t2tb2921 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (set1 (tuple2 a1 b1)) (tuple2 b1 b1)) j)
     (= (t2tb2921 (tb2t2921 j)) j)) :pattern ((t2tb2921 (tb2t2921 j))) )))

(declare-fun t2tb2922 ((set (tuple21 (set (tuple21 a b)) (tuple21 b
  b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (set (tuple21 a b)) (tuple21 b b))))) (sort
  (set1 (tuple2 (set1 (tuple2 a1 b1)) (tuple2 b1 b1))) (t2tb2922 x))))

(declare-fun tb2t2922 (uni) (set (tuple21 (set (tuple21 a b)) (tuple21 b
  b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (set (tuple21 a b)) (tuple21 b b)))))
  (! (= (tb2t2922 (t2tb2922 i)) i) :pattern ((t2tb2922 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (set1 (tuple2 a1 b1)) (tuple2 b1 b1))) j)
     (= (t2tb2922 (tb2t2922 j)) j)) :pattern ((t2tb2922 (tb2t2922 j))) )))
...
(declare-fun t2tb2923 ((set (tuple21 (tuple21 a b) (tuple21 b b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 a b) (tuple21 b b))))) (sort
  (set1 (tuple2 (tuple2 a1 b1) (tuple2 b1 b1))) (t2tb2923 x))))

(declare-fun tb2t2923 (uni) (set (tuple21 (tuple21 a b) (tuple21 b b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 a b) (tuple21 b b)))))
  (! (= (tb2t2923 (t2tb2923 i)) i) :pattern ((t2tb2923 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 a1 b1) (tuple2 b1 b1))) j)
     (= (t2tb2923 (tb2t2923 j)) j)) :pattern ((t2tb2923 (tb2t2923 j))) )))

(declare-fun t2tb2924 ((tuple21 (tuple21 a b) (tuple21 b b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 a b) (tuple21 b b)))) (sort
  (tuple2 (tuple2 a1 b1) (tuple2 b1 b1)) (t2tb2924 x))))

(declare-fun tb2t2924 (uni) (tuple21 (tuple21 a b) (tuple21 b b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 a b) (tuple21 b b))))
  (! (= (tb2t2924 (t2tb2924 i)) i) :pattern ((t2tb2924 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 a1 b1) (tuple2 b1 b1)) j)
     (= (t2tb2924 (tb2t2924 j)) j)) :pattern ((t2tb2924 (tb2t2924 j))) )))
...
(declare-fun t2tb2925 ((set (tuple21 b (tuple21 b b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 b (tuple21 b b))))) (sort
  (set1 (tuple2 b1 (tuple2 b1 b1))) (t2tb2925 x))))

(declare-fun tb2t2925 (uni) (set (tuple21 b (tuple21 b b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 b (tuple21 b b)))))
  (! (= (tb2t2925 (t2tb2925 i)) i) :pattern ((t2tb2925 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 b1 (tuple2 b1 b1))) j)
     (= (t2tb2925 (tb2t2925 j)) j)) :pattern ((t2tb2925 (tb2t2925 j))) )))

(declare-fun t2tb2926 ((tuple21 b (tuple21 b b))) uni)
...
(declare-fun tb2t2926 (uni) (tuple21 b (tuple21 b b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 b (tuple21 b b))))
  (! (= (tb2t2926 (t2tb2926 i)) i) :pattern ((t2tb2926 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 b1 (tuple2 b1 b1)) j) (= (t2tb2926 (tb2t2926 j)) j)) :pattern (
  (t2tb2926 (tb2t2926 j))) )))
...
;; mem_non_empty_power
  ...
  (not (infix_eqeq25 s (tb2t35 (empty (tuple2 b1 b1)))))))))
...
(declare-fun t2tb2927 ((set (set (tuple21 (tuple21 b b) (tuple21 b
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 b b) (tuple21 b b)))))) (sort
  (set1 (set1 (tuple2 (tuple2 b1 b1) (tuple2 b1 b1)))) (t2tb2927 x))))

(declare-fun tb2t2927 (uni) (set (set (tuple21 (tuple21 b b) (tuple21 b
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 b b) (tuple21 b b))))))
  (! (= (tb2t2927 (t2tb2927 i)) i) :pattern ((t2tb2927 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 b1 b1) (tuple2 b1 b1)))) j)
     (= (t2tb2927 (tb2t2927 j)) j)) :pattern ((t2tb2927 (tb2t2927 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 b b))) (v (set (tuple21 b b)))
  (r (set (tuple21 (tuple21 b b) (tuple21 b b)))))
  (= (mem (set1 (tuple2 (tuple2 b1 b1) (tuple2 b1 b1))) (t2tb2908 r)
  (relation (tuple2 b1 b1) (tuple2 b1 b1) (t2tb35 u) (t2tb35 v)))
  (forall ((x (tuple21 b b)) (y (tuple21 b b)))
  (=> (mem (tuple2 (tuple2 b1 b1) (tuple2 b1 b1))
  (Tuple2 (tuple2 b1 b1) (tuple2 b1 b1) (t2tb36 x) (t2tb36 y)) (t2tb2908 r))
  (and (mem26 x u) (mem26 y v)))))))

(declare-fun t2tb2928 ((set (set (tuple21 (tuple21 b b) (tuple21 b
  a))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 b b) (tuple21 b a)))))) (sort
  (set1 (set1 (tuple2 (tuple2 b1 b1) (tuple2 b1 a1)))) (t2tb2928 x))))

(declare-fun tb2t2928 (uni) (set (set (tuple21 (tuple21 b b) (tuple21 b
  a)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 b b) (tuple21 b a))))))
  (! (= (tb2t2928 (t2tb2928 i)) i) :pattern ((t2tb2928 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 b1 b1) (tuple2 b1 a1)))) j)
     (= (t2tb2928 (tb2t2928 j)) j)) :pattern ((t2tb2928 (tb2t2928 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 b b))) (v (set (tuple21 b a)))
  (r (set (tuple21 (tuple21 b b) (tuple21 b a)))))
  (= (mem (set1 (tuple2 (tuple2 b1 b1) (tuple2 b1 a1))) (t2tb2909 r)
  (relation (tuple2 b1 a1) (tuple2 b1 b1) (t2tb35 u) (t2tb37 v)))
  (forall ((x (tuple21 b b)) (y (tuple21 b a)))
  (=> (mem (tuple2 (tuple2 b1 b1) (tuple2 b1 a1))
  (Tuple2 (tuple2 b1 b1) (tuple2 b1 a1) (t2tb36 x) (t2tb38 y)) (t2tb2909 r))
  (and (mem26 x u) (mem5 y v)))))))

(declare-fun t2tb2929 ((set (set (tuple21 (tuple21 b b) (set (tuple21 a
  b)))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 b b) (set (tuple21 a b))))))) (sort
  (set1 (set1 (tuple2 (tuple2 b1 b1) (set1 (tuple2 a1 b1))))) (t2tb2929 x))))

(declare-fun tb2t2929 (uni) (set (set (tuple21 (tuple21 b b) (set (tuple21 a
  b))))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 b b) (set (tuple21 a b)))))))
  (! (= (tb2t2929 (t2tb2929 i)) i) :pattern ((t2tb2929 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 b1 b1) (set1 (tuple2 a1 b1))))) j)
     (= (t2tb2929 (tb2t2929 j)) j)) :pattern ((t2tb2929 (tb2t2929 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 b b))) (v (set (set (tuple21 a b))))
  (r (set (tuple21 (tuple21 b b) (set (tuple21 a b))))))
  (= (mem (set1 (tuple2 (tuple2 b1 b1) (set1 (tuple2 a1 b1)))) (t2tb2911 r)
  (relation (set1 (tuple2 a1 b1)) (tuple2 b1 b1) (t2tb35 u) (t2tb10 v)))
  (forall ((x (tuple21 b b)) (y (set (tuple21 a b))))
  (=> (mem (tuple2 (tuple2 b1 b1) (set1 (tuple2 a1 b1)))
  (Tuple2 (tuple2 b1 b1) (set1 (tuple2 a1 b1)) (t2tb36 x) (t2tb11 y))
  (t2tb2911 r)) (and (mem26 x u) (mem4 y v)))))))

(declare-fun t2tb2930 ((set (set (tuple21 (tuple21 b b) (tuple21 a
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 b b) (tuple21 a b)))))) (sort
  (set1 (set1 (tuple2 (tuple2 b1 b1) (tuple2 a1 b1)))) (t2tb2930 x))))

(declare-fun tb2t2930 (uni) (set (set (tuple21 (tuple21 b b) (tuple21 a
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 b b) (tuple21 a b))))))
  (! (= (tb2t2930 (t2tb2930 i)) i) :pattern ((t2tb2930 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 b1 b1) (tuple2 a1 b1)))) j)
     (= (t2tb2930 (tb2t2930 j)) j)) :pattern ((t2tb2930 (tb2t2930 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 b b))) (v (set (tuple21 a b)))
  (r (set (tuple21 (tuple21 b b) (tuple21 a b)))))
  (= (mem (set1 (tuple2 (tuple2 b1 b1) (tuple2 a1 b1))) (t2tb2913 r)
  (relation (tuple2 a1 b1) (tuple2 b1 b1) (t2tb35 u) (t2tb11 v)))
  (forall ((x (tuple21 b b)) (y (tuple21 a b)))
  (=> (mem (tuple2 (tuple2 b1 b1) (tuple2 a1 b1))
  (Tuple2 (tuple2 b1 b1) (tuple2 a1 b1) (t2tb36 x) (t2tb13 y)) (t2tb2913 r))
  (and (mem26 x u) (mem3 y v)))))))

(declare-fun t2tb2931 ((set (set (tuple21 (tuple21 b b) b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 b b) b))))) (sort
  (set1 (set1 (tuple2 (tuple2 b1 b1) b1))) (t2tb2931 x))))

(declare-fun tb2t2931 (uni) (set (set (tuple21 (tuple21 b b) b))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 b b) b)))))
  (! (= (tb2t2931 (t2tb2931 i)) i) :pattern ((t2tb2931 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 b1 b1) b1))) j)
     (= (t2tb2931 (tb2t2931 j)) j)) :pattern ((t2tb2931 (tb2t2931 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 b b))) (v (set b)) (r (set (tuple21 (tuple21 b b)
  b))))
  (= (mem (set1 (tuple2 (tuple2 b1 b1) b1)) (t2tb2915 r)
  (relation b1 (tuple2 b1 b1) (t2tb35 u) (t2tb12 v)))
  (forall ((x (tuple21 b b)) (y b))
  (=> (mem (tuple2 (tuple2 b1 b1) b1)
  (Tuple2 (tuple2 b1 b1) b1 (t2tb36 x) (t2tb14 y)) (t2tb2915 r))
  (and (mem26 x u) (mem2 y v)))))))

(declare-fun t2tb2932 ((set (set (tuple21 (tuple21 b b) a)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 b b) a))))) (sort
  (set1 (set1 (tuple2 (tuple2 b1 b1) a1))) (t2tb2932 x))))

(declare-fun tb2t2932 (uni) (set (set (tuple21 (tuple21 b b) a))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 b b) a)))))
  (! (= (tb2t2932 (t2tb2932 i)) i) :pattern ((t2tb2932 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 b1 b1) a1))) j)
     (= (t2tb2932 (tb2t2932 j)) j)) :pattern ((t2tb2932 (tb2t2932 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 b b))) (v (set a)) (r (set (tuple21 (tuple21 b b)
  a))))
  (= (mem (set1 (tuple2 (tuple2 b1 b1) a1)) (t2tb2917 r)
  (relation a1 (tuple2 b1 b1) (t2tb35 u) (t2tb1 v)))
  (forall ((x (tuple21 b b)) (y a))
  (=> (mem (tuple2 (tuple2 b1 b1) a1)
  (Tuple2 (tuple2 b1 b1) a1 (t2tb36 x) (t2tb2 y)) (t2tb2917 r))
...
(declare-fun t2tb2933 ((set (set (tuple21 (tuple21 b a) (tuple21 b
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 b a) (tuple21 b b)))))) (sort
  (set1 (set1 (tuple2 (tuple2 b1 a1) (tuple2 b1 b1)))) (t2tb2933 x))))

(declare-fun tb2t2933 (uni) (set (set (tuple21 (tuple21 b a) (tuple21 b
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 b a) (tuple21 b b))))))
  (! (= (tb2t2933 (t2tb2933 i)) i) :pattern ((t2tb2933 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 b1 a1) (tuple2 b1 b1)))) j)
     (= (t2tb2933 (tb2t2933 j)) j)) :pattern ((t2tb2933 (tb2t2933 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 b a))) (v (set (tuple21 b b)))
  (r (set (tuple21 (tuple21 b a) (tuple21 b b)))))
  (= (mem (set1 (tuple2 (tuple2 b1 a1) (tuple2 b1 b1))) (t2tb2919 r)
  (relation (tuple2 b1 b1) (tuple2 b1 a1) (t2tb37 u) (t2tb35 v)))
  (forall ((x (tuple21 b a)) (y (tuple21 b b)))
  (=> (mem (tuple2 (tuple2 b1 a1) (tuple2 b1 b1))
  (Tuple2 (tuple2 b1 a1) (tuple2 b1 b1) (t2tb38 x) (t2tb36 y)) (t2tb2919 r))
...
(declare-fun t2tb2934 ((set (set (tuple21 (set (tuple21 a b)) (tuple21 b
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (set (tuple21 a b)) (tuple21 b b)))))) (sort
  (set1 (set1 (tuple2 (set1 (tuple2 a1 b1)) (tuple2 b1 b1)))) (t2tb2934 x))))

(declare-fun tb2t2934 (uni) (set (set (tuple21 (set (tuple21 a b)) (tuple21 b
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (set (tuple21 a b)) (tuple21 b b))))))
  (! (= (tb2t2934 (t2tb2934 i)) i) :pattern ((t2tb2934 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (set1 (tuple2 a1 b1)) (tuple2 b1 b1)))) j)
     (= (t2tb2934 (tb2t2934 j)) j)) :pattern ((t2tb2934 (tb2t2934 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (set (tuple21 a b)))) (v (set (tuple21 b b)))
  (r (set (tuple21 (set (tuple21 a b)) (tuple21 b b)))))
  (= (mem (set1 (tuple2 (set1 (tuple2 a1 b1)) (tuple2 b1 b1))) (t2tb2922 r)
  (relation (tuple2 b1 b1) (set1 (tuple2 a1 b1)) (t2tb10 u) (t2tb35 v)))
  (forall ((x (set (tuple21 a b))) (y (tuple21 b b)))
  (=> (mem (tuple2 (set1 (tuple2 a1 b1)) (tuple2 b1 b1))
  (Tuple2 (set1 (tuple2 a1 b1)) (tuple2 b1 b1) (t2tb11 x) (t2tb36 y))
  (t2tb2922 r)) (and (mem4 x u) (mem26 y v)))))))
...
(declare-fun t2tb2935 ((set (set (tuple21 (tuple21 a b) (tuple21 b
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 a b) (tuple21 b b)))))) (sort
  (set1 (set1 (tuple2 (tuple2 a1 b1) (tuple2 b1 b1)))) (t2tb2935 x))))

(declare-fun tb2t2935 (uni) (set (set (tuple21 (tuple21 a b) (tuple21 b
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 a b) (tuple21 b b))))))
  (! (= (tb2t2935 (t2tb2935 i)) i) :pattern ((t2tb2935 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 a1 b1) (tuple2 b1 b1)))) j)
     (= (t2tb2935 (tb2t2935 j)) j)) :pattern ((t2tb2935 (tb2t2935 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 a b))) (v (set (tuple21 b b)))
  (r (set (tuple21 (tuple21 a b) (tuple21 b b)))))
  (= (mem (set1 (tuple2 (tuple2 a1 b1) (tuple2 b1 b1))) (t2tb2923 r)
  (relation (tuple2 b1 b1) (tuple2 a1 b1) (t2tb11 u) (t2tb35 v)))
  (forall ((x (tuple21 a b)) (y (tuple21 b b)))
  (=> (mem (tuple2 (tuple2 a1 b1) (tuple2 b1 b1))
  (Tuple2 (tuple2 a1 b1) (tuple2 b1 b1) (t2tb13 x) (t2tb36 y)) (t2tb2923 r))
...
(declare-fun t2tb2936 ((set (set (tuple21 b (tuple21 b b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 b (tuple21 b b)))))) (sort
  (set1 (set1 (tuple2 b1 (tuple2 b1 b1)))) (t2tb2936 x))))

(declare-fun tb2t2936 (uni) (set (set (tuple21 b (tuple21 b b)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 b (tuple21 b b))))))
  (! (= (tb2t2936 (t2tb2936 i)) i) :pattern ((t2tb2936 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 b1 (tuple2 b1 b1)))) j)
     (= (t2tb2936 (tb2t2936 j)) j)) :pattern ((t2tb2936 (tb2t2936 j))) )))

;; mem_relation
  (assert
  (forall ((u (set b)) (v (set (tuple21 b b))) (r (set (tuple21 b (tuple21 b
  b)))))
  (= (mem (set1 (tuple2 b1 (tuple2 b1 b1))) (t2tb2925 r)
  (relation (tuple2 b1 b1) b1 (t2tb12 u) (t2tb35 v)))
  (forall ((x b) (y (tuple21 b b)))
  (=> (mem (tuple2 b1 (tuple2 b1 b1))
  (Tuple2 b1 (tuple2 b1 b1) (t2tb14 x) (t2tb36 y)) (t2tb2925 r))
...
(declare-fun t2tb2937 ((set (set (tuple21 a (tuple21 b b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 a (tuple21 b b)))))) (sort
  (set1 (set1 (tuple2 a1 (tuple2 b1 b1)))) (t2tb2937 x))))

(declare-fun tb2t2937 (uni) (set (set (tuple21 a (tuple21 b b)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 a (tuple21 b b))))))
  (! (= (tb2t2937 (t2tb2937 i)) i) :pattern ((t2tb2937 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 a1 (tuple2 b1 b1)))) j)
     (= (t2tb2937 (tb2t2937 j)) j)) :pattern ((t2tb2937 (tb2t2937 j))) )))
...
;; mem_image
  ...
  b))) (x (tuple21 b b)))
  (= (mem26 x
  (tb2t35 (image (tuple2 b1 b1) (tuple2 b1 b1) (t2tb2908 p) (t2tb35 w))))
...
;; mem_image
  ...
  b))) (x (tuple21 b a)))
  (= (mem5 x
  (tb2t37 (image (tuple2 b1 a1) (tuple2 b1 b1) (t2tb2909 p) (t2tb35 w))))
  (exists ((a2 (tuple21 b b)))
...
;; mem_image
  ...
  (= (mem4 x
  (tb2t10
  (image (set1 (tuple2 a1 b1)) (tuple2 b1 b1) (t2tb2911 p) (t2tb35 w))))
  (exists ((a2 (tuple21 b b)))
...
;; mem_image
  ...
  b))) (x (tuple21 a b)))
  (= (mem3 x
  (tb2t11 (image (tuple2 a1 b1) (tuple2 b1 b1) (t2tb2913 p) (t2tb35 w))))
  (exists ((a2 (tuple21 b b)))
...
;; mem_image
  ...
  (= (mem2 x (tb2t12 (image b1 (tuple2 b1 b1) (t2tb2915 p) (t2tb35 w))))
  (exists ((a2 (tuple21 b b)))
  (and (mem26 a2 w) (mem (tuple2 (tuple2 b1 b1) b1)
  (Tuple2 (tuple2 b1 b1) b1 (t2tb36 a2) (t2tb14 x)) (t2tb2915 p)))))))

;; mem_image
  (assert
  (forall ((p (set (tuple21 (tuple21 b b) a))) (w (set (tuple21 b b))) (x a))
  (= (mem1 x (tb2t1 (image a1 (tuple2 b1 b1) (t2tb2917 p) (t2tb35 w))))
  (exists ((a2 (tuple21 b b)))
  (and (mem26 a2 w) (mem (tuple2 (tuple2 b1 b1) a1)
  (Tuple2 (tuple2 b1 b1) a1 (t2tb36 a2) (t2tb2 x)) (t2tb2917 p)))))))
...
;; mem_image
  ...
  a))) (x (tuple21 b b)))
  (= (mem26 x
  (tb2t35 (image (tuple2 b1 b1) (tuple2 b1 a1) (t2tb2919 p) (t2tb37 w))))
...
;; mem_image
  ...
  (= (mem26 x
  (tb2t35
  (image (tuple2 b1 b1) (set1 (tuple2 a1 b1)) (t2tb2922 p) (t2tb10 w))))
...
;; mem_image
  ...
  b))) (x (tuple21 b b)))
  (= (mem26 x
  (tb2t35 (image (tuple2 b1 b1) (tuple2 a1 b1) (t2tb2923 p) (t2tb11 w))))
...
;; mem_image
  ...
  (= (mem26 x (tb2t35 (image (tuple2 b1 b1) b1 (t2tb2925 p) (t2tb12 w))))
  (exists ((a2 b))
  (and (mem2 a2 w) (mem (tuple2 b1 (tuple2 b1 b1))
  (Tuple2 b1 (tuple2 b1 b1) (t2tb14 a2) (t2tb36 x)) (t2tb2925 p)))))))
...
;; mem_total_function_set
  (assert
  (forall ((b2 ty))
  (forall ((s (set (tuple21 b b))) (t uni) (x uni))
  (= (mem (set1 (tuple2 (tuple2 b1 b1) b2)) x
  (infix_mnmngt b2 (tuple2 b1 b1) (t2tb35 s) t))
  (and (mem (set1 (tuple2 (tuple2 b1 b1) b2)) x
  (infix_plmngt b2 (tuple2 b1 b1) (t2tb35 s) t)) (infix_eqeq25
  (tb2t35 (dom b2 (tuple2 b1 b1) x)) s))))))
...
;; mem_partial_surjection_set
  (assert
  (forall ((a2 ty))
  (forall ((s uni) (t (set (tuple21 b b))) (x uni))
  (= (mem (set1 (tuple2 a2 (tuple2 b1 b1))) x
  (infix_plmngtgt (tuple2 b1 b1) a2 s (t2tb35 t)))
  (and (mem (set1 (tuple2 a2 (tuple2 b1 b1))) x
  (infix_plmngt (tuple2 b1 b1) a2 s (t2tb35 t))) (infix_eqeq25
  (tb2t35 (ran (tuple2 b1 b1) a2 x)) t))))))
...
;; mem_partial_surjection_set
  ...
  (and (mem (set1 (tuple2 b1 b1)) (t2tb35 x)
  (infix_plmngt b1 b1 (t2tb12 s) (t2tb12 t))) (infix_eqeq3 (ran3 x) t)))))
...
;; mem_partial_surjection_set
  ...
  (and (mem4 x (infix_plmngt1 s t)) (infix_eqeq3 (ran1 x) t)))))
...
(assert
;; equal_semicolon_31
 ;; File "lemmes_bbook.why", line 1775, characters 7-25
  (not
  (forall ((s (set a)) (t (set b)) (f (set (tuple21 a b))))
  (=> (mem4 f (infix_plmngt1 s t)) (infix_eqeq25 (semicolon8 (inverse2 f) f)
  (id2 (ran1 f)))))))
(check-sat)
