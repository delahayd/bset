...
(declare-fun subset12 ((set (set (tuple21 b c))) (set (set (tuple21 b
  c)))) Bool)
...
;; subset_def
  (assert
  (forall ((s (set (set (tuple21 b c)))) (t (set (set (tuple21 b c)))))
  (= (subset12 s t) (mem (set1 (set1 (tuple2 b1 c1))) (t2tb130 s)
...
;; subset_def
  (assert
  (forall ((s (set (tuple21 b c))) (t (set (tuple21 b c))))
  (= (subset10 s t) (mem9 s (tb2t130 (power (tuple2 b1 c1) (t2tb131 t)))))))
...
;; subsetnoteq_def
  ...
  (and (subset12 s t) (not (infix_eqeq10 s t))))))
...
(declare-fun infix_lspl3 ((set (tuple21 b c)) (set (tuple21 b
  c))) (set (tuple21 b c)))

(declare-fun infix_lspl4 ((set (tuple21 a c)) (set (tuple21 a
  c))) (set (tuple21 a c)))
...
;; mem_overriding
  ...
  (= (mem8 (tb2t134 (Tuple2 b1 c1 (t2tb14 x) (t2tb135 y))) (infix_lspl3 q p))
  (or
...
;; mem_overriding
  ...
  (= (mem10 (tb2t133 (Tuple2 a1 c1 (t2tb2 x) (t2tb135 y))) (infix_lspl4 q p))
  (or
...
;; mem_partial_surjection_set
  ...
  (and (mem9 x (tb2t130 (infix_plmngt c1 b1 (t2tb12 s) (t2tb132 t))))
  (infix_eqeq7 (ran4 x) t)))))

;; mem_partial_surjection_set
  (assert
  (forall ((s (set a)) (t (set c)) (x (set (tuple21 a c))))
  (= (mem (set1 (tuple2 a1 c1)) (t2tb129 x)
  (infix_plmngtgt c1 a1 (t2tb1 s) (t2tb132 t)))
  (and (mem (set1 (tuple2 a1 c1)) (t2tb129 x)
  (infix_plmngt c1 a1 (t2tb1 s) (t2tb132 t))) (infix_eqeq7 (ran5 x) t)))))
...
(assert
;; equal_semicolon_24
 ;; File "lemmes_bbook.why", line 1711, characters 7-25
  (not
  ...
  (and (mem9 r (relation4 t u)) (subset5 (ran1 q) (dom5 r))))) (infix_eqeq9
  (semicolon1 (infix_lspl1 p q) r)
  (infix_lspl4 (semicolon1 p r) (semicolon1 q r)))))))
(check-sat)
