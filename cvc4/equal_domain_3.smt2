...
(declare-fun dom5 ((set (tuple21 b c))) (set b))
...
;; mem_total_function_set
  ...
  (infix_plmngt a1 b1 (t2tb12 s) (t2tb1 t))) (infix_eqeq3 (dom3 x) s)))))
...
;; mem_total_function_set
  ...
  (infix_mnmngt c1 a1 (t2tb1 s) (t2tb132 t)))
  (and (mem (set1 (tuple2 a1 c1)) (t2tb129 x)
  (infix_plmngt c1 a1 (t2tb1 s) (t2tb132 t))) (infix_eqeq1 (dom4 x) s)))))
...
;; apply_def0
  ...
  (=>
  (and (mem (set1 (tuple2 a1 c1)) (t2tb129 f)
  (infix_plmngt c1 a1 (t2tb1 s) (t2tb132 t))) (mem1 a2 (dom4 f))) (mem10
...
(assert
;; equal_domain_3
 ;; File "lemmes_bbook.why", line 1229, characters 7-21
  (not
  (forall ((s (set a)) (t (set b)) (u (set c)) (p (set (tuple21 a b)))
  (q (set (tuple21 b c))))
  (=> (and (mem4 p (relation1 s t)) (mem9 q (relation4 t u))) (infix_eqeq1
  (dom4 (semicolon1 p q)) (image2 (inverse2 p) (dom5 q)))))))
(check-sat)
