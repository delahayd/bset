...
tff(equal_substraction_9, conjecture, ![A : $tType, B : $tType]: ![S:
  ...
  => infix_eqeq(tuple2(A, B), domain_substraction(A, B, U, infix_lspl(A,
  B, P, Q)), infix_lspl(A, B, domain_substraction(A, B, U, P),
  domain_substraction(A, B, U, Q))))).
