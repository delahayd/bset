...
(assert
;; subset_monotonicity_1
 ;; File "lemmes_bbook.why", line 45, characters 7-28
  (not
  (forall ((s (set a)) (t (set a)) (u (set a)) (v (set a)))
  (=> (and (subset2 u s) (subset2 v t)) (subset3 (times1 u v) (times1 s t))))))
(check-sat)
