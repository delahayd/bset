...
(declare-fun ran6 ((set (tuple21 a a))) (set a))

;; mem_ran
  (assert
  (forall ((p (set (tuple21 a a))) (x a))
  (= (mem a1 (t2tb2 x) (t2tb1 (ran6 p)))
  (exists ((a2 a)) (mem (tuple2 a1 a1) (Tuple2 a1 a1 (t2tb2 a2) (t2tb2 x))
  (t2tb4 p))))))
...
;; mem_partial_surjection_set
  ...
  (infix_plmngtgt a1 a1 (t2tb1 s) (t2tb1 t)))
  (and (mem (set1 (tuple2 a1 a1)) (t2tb4 x)
  (infix_plmngt a1 a1 (t2tb1 s) (t2tb1 t))) (infix_eqeq1 (ran6 x) t)))))
...
(assert
;; equal_range_5
 ;; File "lemmes_bbook.why", line 1391, characters 7-20
  (not (forall ((s (set a))) (infix_eqeq1 (ran6 (id1 s)) s))))
(check-sat)
