...
(declare-fun diff6 ((set c) (set c)) (set c))

(declare-fun diff7 ((set (tuple21 b c)) (set (tuple21 b c))) (set (tuple21 b
  c)))

(declare-fun diff8 ((set (tuple21 a c)) (set (tuple21 a c))) (set (tuple21 a
  c)))

(declare-fun diff12 ((set (tuple21 c b)) (set (tuple21 c b))) (set (tuple21 c
  b)))

(declare-fun diff13 ((set (set (tuple21 c b))) (set (set (tuple21 c
...
;; mem_diff
  ...
  (forall ((s (set (set (tuple21 c b)))) (t (set (set (tuple21 c b))))
  (x (set (tuple21 c b))))
  (= (mem31 x (diff13 s t)) (and (mem31 x s) (not (mem31 x t))))))

;; mem_diff
  (assert
  (forall ((s (set (tuple21 c b))) (t (set (tuple21 c b))) (x (tuple21 c b)))
  (= (mem28 x (diff12 s t)) (and (mem28 x s) (not (mem28 x t))))))

;; mem_diff
  (assert
  (forall ((s (set (tuple21 a c))) (t (set (tuple21 a c))) (x (tuple21 a c)))
  (= (mem10 x (diff8 s t)) (and (mem10 x s) (not (mem10 x t))))))

;; mem_diff
  (assert
  (forall ((s (set (tuple21 b c))) (t (set (tuple21 b c))) (x (tuple21 b c)))
  (= (mem8 x (diff7 s t)) (and (mem8 x s) (not (mem8 x t))))))

;; mem_diff
  (assert
  (forall ((s (set c)) (t (set c)) (x c))
  (= (mem7 x (diff6 s t)) (and (mem7 x s) (not (mem7 x t))))))
...
(assert
;; equal_semicolon_27
 ;; File "lemmes_bbook.why", line 1739, characters 7-25
  (not
  ...
  (infix_eqeq9 (semicolon1 (diff4 p q) r)
  (diff8 (semicolon1 p r) (semicolon1 q r)))))))
(check-sat)
