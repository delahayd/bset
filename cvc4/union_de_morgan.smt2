...
(assert
;; union_de_morgan
 ;; File "lemmes_bbook.why", line 263, characters 7-22
  (not
  (forall ((s (set a)) (a2 (set a)) (b (set a)))
  (=> (and (subset2 a2 s) (subset2 b s)) (infix_eqeq1 (diff1 s (union2 a2 b))
  (inter1 (diff1 s a2) (diff1 s b)))))))
(check-sat)
