...
(declare-fun infix_gtplgt3 ((set a) (set c)) (set (set (tuple21 a c))))

(declare-fun infix_gtplgt4 ((set b) (set c)) (set (set (tuple21 b c))))
...
;; mem_total_injection_set
  ...
  (and (mem9 x (infix_gtplgt4 s t)) (mem9 x
...
;; mem_total_injection_set
  ...
  (and (mem11 x (infix_gtplgt3 s t)) (mem11 x
...
;; mem_partial_bijection_set
  ...
  (and (mem11 x (infix_gtplgt3 s t)) (mem11 x
  (tb2t128 (infix_plmngtgt c1 a1 (t2tb1 s) (t2tb132 t))))))))
...
(assert
;; mem_semicolon_3
 ;; File "lemmes_bbook.why", line 361, characters 7-22
  (not
  (forall ((s (set a)) (t (set b)) (u (set c)) (f (set (tuple21 a b)))
  (g (set (tuple21 b c))))
  (=> (and (mem4 f (infix_gtplgt1 s t)) (mem9 g (infix_gtplgt4 t u))) (mem11
  (semicolon1 f g) (infix_gtplgt3 s u))))))
(check-sat)
