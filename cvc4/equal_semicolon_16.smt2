...
;; mem_times
  ...
  (= (mem5 (tb2t38 (Tuple2 b1 a1 (t2tb14 x) (t2tb2 y))) (times11 s t))
...
(assert
;; equal_semicolon_16
 ;; File "lemmes_bbook.why", line 1641, characters 7-25
  (not
  (forall ((s (set a)) (t (set b)) (u (set b)) (v (set c)) (r (set (tuple21 a
  b))))
  (=> (and (mem4 r (relation1 s t)) (subset5 u t)) (infix_eqeq9
  (semicolon1 r (times3 u v)) (times4 (image2 (inverse2 r) u) v))))))
(check-sat)
