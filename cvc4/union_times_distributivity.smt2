...
(declare-fun union3 ((set (tuple21 a a)) (set (tuple21 a a))) (set (tuple21 a
  a)))

;; mem_union
  (assert
  (forall ((s (set (tuple21 a a))) (t (set (tuple21 a a))) (x (tuple21 a a)))
  (= (mem (tuple2 a1 a1) (t2tb5 x) (t2tb4 (union3 s t)))
  (or (mem (tuple2 a1 a1) (t2tb5 x) (t2tb4 s)) (mem (tuple2 a1 a1) (t2tb5 x)
  (t2tb4 t))))))

;; mem_union
  (assert
  (forall ((s (set a)) (t (set a)) (x a))
  (= (mem a1 (t2tb2 x) (t2tb1 (union2 s t)))
  (or (mem a1 (t2tb2 x) (t2tb1 s)) (mem a1 (t2tb2 x) (t2tb1 t))))))
...
(assert
;; union_times_distributivity
 ;; File "lemmes_bbook.why", line 128, characters 7-33
  (not
  (forall ((a2 (set a)) (b (set a)) (t (set a))) (infix_eqeq2
  (times1 (union2 a2 b) t) (union3 (times1 a2 t) (times1 b t))))))
(check-sat)
