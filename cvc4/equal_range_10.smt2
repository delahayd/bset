...
(assert
;; equal_range_10
 ;; File "lemmes_bbook.why", line 1428, characters 7-21
  (not
  (forall ((s (set a)) (t (set b)) (p (set (tuple21 a b))) (q (set (tuple21 a
  b))))
  (=> (and (mem4 p (relation1 s t)) (mem4 q (relation1 s t))) (infix_eqeq3
  (ran1 (infix_lspl1 p q))
  (union4 (ran1 (domain_substraction1 (dom1 q) p)) (ran1 q)))))))
(check-sat)
