...
tff(equal_semicolon_11, conjecture, ![A : $tType, B : $tType, C : $tType]:
  ...
  => infix_eqeq(tuple2(A, C), semicolon(A, B, C, R, union(tuple2(B, C), P,
  Q)), union(tuple2(A, C), semicolon(A, B, C, R, P), semicolon(A, B, C, R,
  Q))))).
