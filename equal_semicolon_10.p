...
tff(equal_semicolon_10, conjecture, ![A : $tType, B : $tType, C : $tType]:
  ...
  => infix_eqeq(tuple2(A, C), semicolon(A, B, C, F, infix_lspl(B, C, P, Q)),
  infix_lspl(A, C, semicolon(A, B, C, F, P), semicolon(A, B, C, F, Q))))).
