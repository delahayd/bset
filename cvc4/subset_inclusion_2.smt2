...
;; mem_times
  ...
  (= (mem (tuple2 a1 b) (Tuple2 a1 b (t2tb2 x) y) (times b a1 (t2tb1 s) t))
...
;; mem_relation
  ...
  (and
  (=> (mem (set1 (tuple2 a1 b)) r (relation b a1 (t2tb1 u) v))
  (forall ((x a) (y uni))
  (=> (mem (tuple2 a1 b) (Tuple2 a1 b (t2tb2 x) y) r)
  (and (mem1 x u) (mem b y v)))))
  (=>
  (forall ((x a) (y uni))
  (=> (sort b y)
  (=> (mem (tuple2 a1 b) (Tuple2 a1 b (t2tb2 x) y) r)
  (and (mem1 x u) (mem b y v))))) (mem (set1 (tuple2 a1 b)) r
  (relation b a1 (t2tb1 u) v)))))))
...
;; mem_dom
  ...
  (forall ((p uni) (x a))
  (and
  (=> (mem1 x (tb2t1 (dom b a1 p)))
  (exists ((b1 uni))
  (and (sort b b1) (mem (tuple2 a1 b) (Tuple2 a1 b (t2tb2 x) b1) p))))
  (=> (exists ((b1 uni)) (mem (tuple2 a1 b) (Tuple2 a1 b (t2tb2 x) b1) p))
  (mem1 x (tb2t1 (dom b a1 p))))))))
...
;; mem_domain_restriction
  ...
  (= (mem (tuple2 a1 b) (Tuple2 a1 b (t2tb2 x) y)
  (domain_restriction b a1 (t2tb1 s) p))
  (and (mem (tuple2 a1 b) (Tuple2 a1 b (t2tb2 x) y) p) (mem1 x s))))))
...
;; mem_domain_substraction
  ...
  (forall ((p uni) (s (set a)) (x a) (y uni))
  (= (mem (tuple2 a1 b) (Tuple2 a1 b (t2tb2 x) y)
  (domain_substraction b a1 (t2tb1 s) p))
  (and (mem (tuple2 a1 b) (Tuple2 a1 b (t2tb2 x) y) p) (not (mem1 x s)))))))
...
;; mem_image
  ...
  (= (mem b x (image b a1 p (t2tb1 w)))
  (exists ((a2 a))
  (and (mem1 a2 w) (mem (tuple2 a1 b) (Tuple2 a1 b (t2tb2 a2) x) p)))))))
...
;; mem_overriding
  ...
  (= (mem (tuple2 a1 b) (Tuple2 a1 b (t2tb2 x) y) (infix_lspl b a1 q p))
  (or
  (and (mem (tuple2 a1 b) (Tuple2 a1 b (t2tb2 x) y) q)
  (not (mem1 x (tb2t1 (dom b a1 p))))) (mem (tuple2 a1 b)
  (Tuple2 a1 b (t2tb2 x) y) p))))))
...
;; apply_def0
  ...
  (=>
  (and (mem (set1 (tuple2 a1 b)) f (infix_plmngt b a1 (t2tb1 s) t)) (mem1 a2
  (tb2t1 (dom b a1 f)))) (mem (tuple2 a1 b)
  (Tuple2 a1 b (t2tb2 a2) (apply b a1 f (t2tb2 a2))) f)))))
...
(assert
;; subset_inclusion_2
 ;; File "lemmes_bbook.why", line 56, characters 7-25
  (not
  (forall ((e a) (s (set a)) (t (set a)))
  (=> (and (mem1 e s) (subset2 s t)) (mem1 e t)))))
(check-sat)
