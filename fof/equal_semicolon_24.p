...
fof(equal_semicolon_24, conjecture, ![S, T, U, P, Q, R]: ((sort(set(a),
  ...
  & (mem(set(tuple2(b, c)), R, relation(c, b, T, U)) & subset(b, ran(b, a,
  Q), dom(c, b, R))))) => infix_eqeq(tuple2(a, c), semicolon(c, b, a,
  infix_lspl(b, a, P, Q), R), infix_lspl(c, a, semicolon(c, b, a, P, R),
  semicolon(c, b, a, Q, R))))))))))).
