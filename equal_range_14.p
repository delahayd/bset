...
tff(equal_range_14, conjecture, ![A : $tType, B : $tType]: ![S:set(A), T:
  set(B), P:set(tuple2(A, B)), Q:set(tuple2(A, B))]:
  ((mem(set(tuple2(B, A)), inverse(A, B, P), infix_plmngt(B, A, T, S))
  & (mem(set(tuple2(B, A)), inverse(A, B, Q), infix_plmngt(B, A, T, S))
  & infix_eqeq(tuple2(A, B), range_restriction(A, B, Q, ran(A, B, P)),
  range_restriction(A, B, P, ran(A, B, Q))))) => infix_eqeq(B, ran(A,
  B, inter(tuple2(A, B), P, Q)), inter(B, ran(A, B, P), ran(A, B, Q))))).
