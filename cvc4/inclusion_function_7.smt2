...
;; mem_partial_function_set
  ...
  (= (mem (set1 (tuple2 a1 b1)) (t2tb11 f) (t2tb10 (infix_plmngt1 s t)))
  (and (mem (set1 (tuple2 a1 b1)) (t2tb11 f)
  (relation b1 a1 (t2tb1 s) (t2tb12 t)))
  (forall ((x a) (y1 b) (y2 b))
  (=>
  (and (mem (tuple2 a1 b1) (Tuple2 a1 b1 (t2tb2 x) (t2tb14 y1)) (t2tb11 f))
  (mem (tuple2 a1 b1) (Tuple2 a1 b1 (t2tb2 x) (t2tb14 y2)) (t2tb11 f)))
  (= y1 y2)))))))
...
;; mem_total_function_set
  ...
  (and (mem (set1 (tuple2 a1 b1)) (t2tb11 x) (t2tb10 (infix_plmngt1 s t)))
...
;; mem_partial_injection_set
  ...
  (inverse a1 b1 (t2tb37 x)) (t2tb10 (infix_plmngt1 t s)))))))
...
;; mem_partial_injection_set
  ...
  (and (mem (set1 (tuple2 a1 b1)) (t2tb11 x) (t2tb10 (infix_plmngt1 s t)))
  (mem (set1 (tuple2 b1 a1)) (inverse b1 a1 (t2tb11 x))
...
;; mem_partial_surjection_set
  (assert
  (forall ((s (set a)) (t (set b)) (x (set (tuple21 a b))))
  (= (mem (set1 (tuple2 a1 b1)) (t2tb11 x) (t2tb10 (infix_plmngtgt1 s t)))
  (and (mem (set1 (tuple2 a1 b1)) (t2tb11 x) (t2tb10 (infix_plmngt1 s t)))
...
;; mem_total_surjection_set
  ...
  (and (mem (set1 (tuple2 a1 b1)) (t2tb11 x) (t2tb10 (infix_plmngtgt1 s t)))
  (mem (set1 (tuple2 a1 b1)) (t2tb11 x)
  (infix_mnmngt b1 a1 (t2tb1 s) (t2tb12 t)))))))
...
;; apply_def0
  ...
  (=>
  (and (mem (set1 (tuple2 a1 b1)) (t2tb11 f) (t2tb10 (infix_plmngt1 s t)))
  (mem a1 (t2tb2 a2) (dom b1 a1 (t2tb11 f)))) (mem (tuple2 a1 b1)
...
(assert
;; inclusion_function_7
 ;; File "lemmes_bbook.why", line 917, characters 7-27
  (not
  (forall ((s (set a)) (t (set b))) (subset7 (infix_plmngtgt1 s t)
  (infix_plmngt1 s t)))))
(check-sat)
