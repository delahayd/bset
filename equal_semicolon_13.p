...
tff(equal_semicolon_13, conjecture, ![A : $tType, B : $tType, C : $tType]:
  ...
  => infix_eqeq(tuple2(A, C), semicolon(A, B, C, F, diff(tuple2(B, C), P,
  Q)), diff(tuple2(A, C), semicolon(A, B, C, F, P), semicolon(A, B, C, F,
  Q))))).
