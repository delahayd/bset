...
;; mem_domain_restriction
  ...
  (= (mem3 (Tuple21 x y) (domain_restriction1 s p))
...
;; mem_direct_product
  (assert
  (forall ((a2 ty))
  (forall ((f2 uni) (g uni) (x uni) (y a) (z b))
  (= (mem (tuple2 a2 (tuple2 a1 b1))
  (Tuple2 a2 (tuple2 a1 b1) x (t2tb13 (Tuple21 y z)))
  (direct_product b1 a1 a2 f2 g))
  (and (mem (tuple2 a2 a1) (Tuple2 a2 a1 x (t2tb2 y)) f2) (mem (tuple2 a2 b1)
...
;; mem_direct_product
  ...
  (and (mem (tuple2 a1 b2) (Tuple2 a1 b2 (t2tb2 x) y) f2) (mem3 (Tuple21 x z)
  g))))))
...
;; mem_direct_product
  ...
  (and (mem3 (Tuple21 x y) f2) (mem3 (Tuple21 x z) g)))))
...
;; mem_direct_product
  ...
  (and (mem3 (Tuple21 x y) f2) (mem (tuple2 a1 c2) (Tuple2 a1 c2 (t2tb2 x) z)
  g))))))
...
;; mem_direct_product
  ...
  (and (mem (tuple2 a1 a1) (Tuple2 a1 a1 (t2tb2 x) (t2tb2 y)) (t2tb4 f2))
  (mem3 (Tuple21 x z) g)))))
...
;; mem_partial_function_set
  ...
  (=> (and (mem3 (Tuple21 x y1) f2) (mem3 (Tuple21 x y2) f2)) (= y1 y2)))))))
...
;; apply_def0
  ...
  (Tuple21 a2 (tb2t14 (apply b1 a1 (t2tb11 f2) (t2tb2 a2)))) f2))))
...
(assert
;; equal_restriction_16
 ;; File "lemmes_bbook.why", line 1991, characters 7-27
  (not
  (forall ((s (set a)) (u (set a)) (t (set b)) (x a) (y b))
  (=> (and (subset2 u s) (and (mem1 x s) (and (mem2 y t) (not (mem1 x u)))))
  (infix_eqeq4 (domain_restriction1 u (singleton3 (Tuple21 x y))) empty3)))))
(check-sat)
