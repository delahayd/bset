...
(assert
;; equal_substraction_9
 ;; File "lemmes_bbook.why", line 2148, characters 7-27
  (not
  (forall ((s (set a)) (u (set a)) (t (set b)) (p (set (tuple21 a b)))
  (q (set (tuple21 a b))))
  (=>
  (and (subset2 u s) (and (mem4 p (relation1 s t)) (mem4 q (relation1 s t))))
  (infix_eqeq4 (domain_substraction1 u (infix_lspl1 p q))
  (infix_lspl1 (domain_substraction1 u p) (domain_substraction1 u q)))))))
(check-sat)
