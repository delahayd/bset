...
fof(equal_inverse_10, conjecture, ![S, T, P, Q]: ((sort(set(a), S) = S)
  ...
  => infix_eqeq(tuple2(b, a), inverse(b, a, union(tuple2(a, b), P, Q)),
  union(tuple2(b, a), inverse(b, a, P), inverse(b, a, Q))))))))).
