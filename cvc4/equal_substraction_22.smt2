...
(assert
;; equal_substraction_22
 ;; File "lemmes_bbook.why", line 2247, characters 7-28
  (not
  (forall ((s (set a)) (u (set a)) (v (set a)) (t (set b)) (r (set (tuple21 a
  b))))
  (=> (and (subset2 u s) (and (subset2 v s) (mem4 r (relation1 s t))))
  (infix_eqeq4 (domain_substraction1 (diff1 u v) r)
  (union5 (domain_substraction1 u r) (domain_restriction1 v r)))))))
(check-sat)
