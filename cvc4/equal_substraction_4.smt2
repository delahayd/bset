...
;; mem_domain_substraction
  ...
  (t2tb4 (domain_substraction5 s p)))
  (and (mem (tuple2 a1 a1) (Tuple2 a1 a1 (t2tb2 x) (t2tb2 y)) (t2tb4 p))
...
(assert
;; equal_substraction_4
 ;; File "lemmes_bbook.why", line 2105, characters 7-27
  (not
  (forall ((s (set a)) (u (set a)) (v (set a)))
  (=> (and (subset2 u s) (subset2 v s)) (infix_eqeq2
  (domain_substraction5 u (id1 v)) (id1 (diff1 v u)))))))
(check-sat)
