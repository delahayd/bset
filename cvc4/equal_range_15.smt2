...
(declare-fun diff11 ((set (set (tuple21 b a))) (set (set (tuple21 b
...
;; mem_diff
  ...
  (forall ((s (set (set (tuple21 b a)))) (t (set (set (tuple21 b a))))
  (x (set (tuple21 b a))))
  (= (mem6 x (diff11 s t)) (and (mem6 x s) (not (mem6 x t))))))
...
(assert
;; equal_range_15
 ;; File "lemmes_bbook.why", line 1470, characters 7-21
  (not
  ...
  (infix_eqeq3 (ran1 (diff4 p q)) (diff3 (ran1 p) (ran1 q)))))))
(check-sat)
