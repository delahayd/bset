...
tff(equal_semicolon_7, conjecture, ![A : $tType, B : $tType, C : $tType]:
  ...
  => infix_eqeq(tuple2(A, C), semicolon(A, B, C, R, range_restriction(B,
  C, P, W)), range_restriction(A, C, semicolon(A, B, C, R, P), W)))).
