...
(assert
;; monot_inverse
 ;; File "lemmes_bbook.why", line 746, characters 7-20
  (not
  (forall ((s (set a)) (t (set b)) (p (set (tuple21 a b))) (r (set (tuple21 a
  b))))
  (=> (mem4 p (relation1 s t))
  (=> (subset6 r p) (subset8 (inverse2 r) (inverse2 p)))))))
(check-sat)
