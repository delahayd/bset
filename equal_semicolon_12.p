...
tff(equal_semicolon_12, conjecture, ![A : $tType, B : $tType, C : $tType]:
  ![S:set(A), T:set(B), U:set(C), F:set(tuple2(A, B)), P:set(tuple2(B, C)),
  Q:set(tuple2(B, C))]: ((mem(set(tuple2(A, B)), F, infix_plmngt(A, B, S, T))
  & (mem(set(tuple2(B, C)), P, relation(B, C, T, U))
  & mem(set(tuple2(B, C)), Q, relation(B, C, T, U))))
  => infix_eqeq(tuple2(A, C), semicolon(A, B, C, F, inter(tuple2(B, C), P,
  Q)), inter(tuple2(A, C), semicolon(A, B, C, F, P), semicolon(A, B, C, F,
  Q))))).
