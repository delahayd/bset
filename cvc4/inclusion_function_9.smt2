...
;; mem_total_function_set
  ...
  (= (mem (set1 (tuple2 a1 b1)) (t2tb11 x) (t2tb10 (infix_mnmngt1 s t)))
...
;; mem_total_injection_set
  ...
  (t2tb11 x) (t2tb10 (infix_mnmngt1 s t)))))))
...
;; mem_total_surjection_set
  ...
  (and (mem (set1 (tuple2 a1 b1)) (t2tb11 x)
  (infix_plmngtgt b1 a1 (t2tb1 s) (t2tb12 t))) (mem (set1 (tuple2 a1 b1))
  (t2tb11 x) (t2tb10 (infix_mnmngt1 s t)))))))
...
(assert
;; inclusion_function_9
 ;; File "lemmes_bbook.why", line 927, characters 7-27
  (not
  (forall ((s (set a)) (t (set b))) (subset7 (infix_mnmngt1 s t)
  (infix_plmngt1 s t)))))
(check-sat)
