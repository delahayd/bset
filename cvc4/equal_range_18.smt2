...
;; mem_ran
  ...
  (= (mem b1 (t2tb14 x) (t2tb12 (ran1 p)))
  (exists ((a2 a)) (mem (tuple2 a1 b1) (Tuple2 a1 b1 (t2tb2 a2) (t2tb14 x))
  (t2tb11 p))))))
...
(assert
;; equal_range_18
 ;; File "lemmes_bbook.why", line 1496, characters 7-21
  (not
  (forall ((s (set a)) (t (set b)))
  (=> (not (infix_eqeq1 s empty1)) (infix_eqeq3 (ran1 (times2 s t)) t)))))
(check-sat)
