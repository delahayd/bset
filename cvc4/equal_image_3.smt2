...
;; mem_image
  ...
  (= (mem a1 (t2tb2 x) (t2tb1 (image7 p w)))
  (exists ((a2 a))
  (and (mem a1 (t2tb2 a2) (t2tb1 w)) (mem (tuple2 a1 a1)
  (Tuple2 a1 a1 (t2tb2 a2) (t2tb2 x)) (t2tb4 p)))))))
...
(assert
;; equal_image_3
 ;; File "lemmes_bbook.why", line 2298, characters 7-20
  (not
  (forall ((s (set a)) (u (set a)) (v (set a)))
  (=> (and (subset2 u s) (subset2 v s)) (infix_eqeq1 (image7 (id1 u) v)
  (inter1 u v))))))
(check-sat)
