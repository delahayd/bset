...
(declare-fun union2 ((set a) (set a)) (set a))

(declare-fun union4 ((set b) (set b)) (set b))

(declare-fun union5 ((set (tuple21 a b)) (set (tuple21 a b))) (set (tuple21 a
  b)))

(declare-fun union6 ((set (set (tuple21 a b))) (set (set (tuple21 a
  b)))) (set (set (tuple21 a b))))

(declare-fun union7 ((set (tuple21 b a)) (set (tuple21 b a))) (set (tuple21 b
  a)))

;; mem_union
  (assert
  (forall ((s (set (tuple21 b a))) (t (set (tuple21 b a))) (x (tuple21 b a)))
  (= (mem5 x (union7 s t)) (or (mem5 x s) (mem5 x t)))))

;; mem_union
  (assert
  (forall ((s (set (set (tuple21 a b)))) (t (set (set (tuple21 a b))))
  (x (set (tuple21 a b))))
  (= (mem4 x (union6 s t)) (or (mem4 x s) (mem4 x t)))))

;; mem_union
  (assert
  (forall ((s (set (tuple21 a b))) (t (set (tuple21 a b))) (x (tuple21 a b)))
  (= (mem3 x (union5 s t)) (or (mem3 x s) (mem3 x t)))))

;; mem_union
  (assert
  (forall ((s (set b)) (t (set b)) (x b))
  (= (mem2 x (union4 s t)) (or (mem2 x s) (mem2 x t)))))

;; mem_union
  (assert
  (forall ((s (set a)) (t (set a)) (x a))
  (= (mem1 x (union2 s t)) (or (mem1 x s) (mem1 x t)))))
...
(declare-fun infix_lspl1 ((set (tuple21 a b)) (set (tuple21 a
  b))) (set (tuple21 a b)))

(declare-fun infix_lspl2 ((set (tuple21 b a)) (set (tuple21 b
  a))) (set (tuple21 b a)))
...
;; mem_overriding
  ...
  (= (mem5 (tb2t38 (Tuple2 b1 a1 (t2tb14 x) (t2tb2 y))) (infix_lspl2 q p))
  (or
...
;; mem_overriding
  ...
  (= (mem3 (tb2t13 (Tuple2 a1 b1 (t2tb2 x) (t2tb14 y))) (infix_lspl1 q p))
  (or
...
(assert
;; equal_inverse_8
 ;; File "lemmes_bbook.why", line 1151, characters 7-22
  (not
  (forall ((s (set a)) (t (set b)) (p (set (tuple21 a b))) (q (set (tuple21 a
  b))))
  (=> (and (mem4 p (relation1 s t)) (mem4 q (relation1 s t))) (infix_eqeq6
  (inverse2 (infix_lspl1 p q))
  (union7 (range_substraction2 (inverse2 p) (dom1 q)) (inverse2 q)))))))
(check-sat)
