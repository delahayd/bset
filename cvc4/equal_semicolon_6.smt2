...
(declare-fun range_restriction4 ((set (tuple21 b c)) (set c)) (set (tuple21 b
  c)))

(declare-fun range_restriction5 ((set (tuple21 a c)) (set c)) (set (tuple21 a
  c)))
...
(assert
;; equal_semicolon_6
 ;; File "lemmes_bbook.why", line 1549, characters 7-24
  (not
  (forall ((s (set a)) (t (set b)) (v (set b)) (u (set c)) (r (set (tuple21 a
  b))) (p (set (tuple21 b c))))
  (=>
  (and (mem4 r (relation1 s t)) (and (subset5 v t) (mem9 p (relation4 t u))))
  (infix_eqeq9 (semicolon1 r (domain_restriction3 v p))
  (semicolon1 (range_restriction1 r v) p))))))
(check-sat)
