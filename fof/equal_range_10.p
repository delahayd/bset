...
fof(equal_range_10, conjecture, ![S, T, P, Q]: ((sort(set(a), S) = S)
  ...
  => infix_eqeq(b, ran(b, a, infix_lspl(b, a, P, Q)), union(b, ran(b, a,
  domain_substraction(b, a, dom(b, a, Q), P)), ran(b, a, Q))))))))).
