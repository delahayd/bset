...
(assert
;; monot_restriction_1
 ;; File "lemmes_bbook.why", line 786, characters 7-26
  (not
  (forall ((s (set a)) (u (set a)) (v (set a)) (t (set b)) (p (set (tuple21 a
  b))) (r (set (tuple21 a b))))
  (=> (and (mem4 p (relation1 s t)) (subset2 v s))
  (=> (and (subset2 u v) (subset6 r p)) (subset6 (domain_restriction1 u r)
  (domain_restriction1 v p)))))))
(check-sat)
