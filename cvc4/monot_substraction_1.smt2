...
(assert
;; monot_substraction_1
 ;; File "lemmes_bbook.why", line 806, characters 7-27
  (not
  (forall ((s (set a)) (u (set a)) (v (set a)) (t (set b)) (p (set (tuple21 a
  b))) (r (set (tuple21 a b))))
  (=> (and (mem4 p (relation1 s t)) (subset2 u s))
  (=> (and (subset2 v u) (subset6 r p)) (subset6 (domain_substraction1 u r)
  (domain_substraction1 v p)))))))
(check-sat)
