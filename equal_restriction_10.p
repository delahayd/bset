...
tff(equal_restriction_10, conjecture, ![A : $tType, B : $tType, C : $tType]:
  ...
  => infix_eqeq(tuple2(A, tuple2(B, C)), domain_restriction(A,
  tuple2(B, C), U, direct_product(A, B, C, P, Q)), direct_product(A, B,
  C, domain_restriction(A, B, U, P), domain_restriction(A, C, U, Q))))).
