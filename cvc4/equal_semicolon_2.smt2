...
(declare-fun mem31 ((set (tuple21 c b)) (set (set (tuple21 c b)))) Bool)
...
(declare-fun infix_eqeq23 ((set (set (tuple21 c b))) (set (set (tuple21 c
  b)))) Bool)

;; infix ==_def
  (assert
  (forall ((s (set (set (tuple21 c b)))) (t (set (set (tuple21 c b)))))
  (= (infix_eqeq23 s t)
  (forall ((x (set (tuple21 c b)))) (= (mem31 x s) (mem31 x t))))))
...
;; subset_def
  (assert
  (forall ((s (set (tuple21 c b))) (t (set (tuple21 c b))))
  (= (subset1 (tuple2 c1 b1) (t2tb222 s) (t2tb222 t)) (mem31 s
  (tb2t308 (power (tuple2 c1 b1) (t2tb222 t)))))))
...
;; subsetnoteq_def
  (assert
  (forall ((s (set (set (tuple21 c b)))) (t (set (set (tuple21 c b)))))
  (= (subsetnoteq (set1 (tuple2 c1 b1)) (t2tb308 s) (t2tb308 t))
  (and (subset1 (set1 (tuple2 c1 b1)) (t2tb308 s) (t2tb308 t))
  (not (infix_eqeq23 s t))))))
...
;; is_empty_def
  (assert
  (forall ((s (set (set (tuple21 c b)))))
  (= (is_empty (set1 (tuple2 c1 b1)) (t2tb308 s))
  (forall ((x (set (tuple21 c b)))) (not (mem31 x s))))))
...
;; empty
  (assert
  (forall ((x (set (tuple21 c b))))
  (not (mem31 x (tb2t308 (empty (set1 (tuple2 c1 b1))))))))
...
;; add_def1
  (assert
  (forall ((x (set (tuple21 c b))) (y (set (tuple21 c b))))
  (forall ((s (set (set (tuple21 c b)))))
  (= (mem31 x (tb2t308 (add (set1 (tuple2 c1 b1)) (t2tb222 y) (t2tb308 s))))
  (or (= x y) (mem31 x s))))))
...
;; mem_singleton
  (assert
  (forall ((x (set (tuple21 c b))) (y (set (tuple21 c b))))
  (= (mem31 x (tb2t308 (singleton (set1 (tuple2 c1 b1)) (t2tb222 y))))
  (= x y))))
...
;; remove_def1
  (assert
  (forall ((x (set (tuple21 c b))) (y (set (tuple21 c b)))
  (s (set (set (tuple21 c b)))))
  (= (mem31 x
  (tb2t308 (remove (set1 (tuple2 c1 b1)) (t2tb222 y) (t2tb308 s))))
  (and (not (= x y)) (mem31 x s)))))
...
;; all_def
  (assert
  (forall ((x (set (tuple21 c b)))) (mem31 x
  (tb2t308 (all (set1 (tuple2 c1 b1)))))))
...
;; mem_union
  ...
  (x (set (tuple21 c b))))
  (= (mem31 x
  (tb2t308 (union1 (set1 (tuple2 c1 b1)) (t2tb308 s) (t2tb308 t))))
  (or (mem31 x s) (mem31 x t)))))
...
;; mem_inter
  ...
  (x (set (tuple21 c b))))
  (= (mem31 x
  (tb2t308 (inter (set1 (tuple2 c1 b1)) (t2tb308 s) (t2tb308 t))))
  (and (mem31 x s) (mem31 x t)))))
...
;; mem_diff
  ...
  (forall ((s (set (set (tuple21 c b)))) (t (set (set (tuple21 c b))))
  (x (set (tuple21 c b))))
  (= (mem31 x (tb2t308 (diff (set1 (tuple2 c1 b1)) (t2tb308 s) (t2tb308 t))))
  (and (mem31 x s) (not (mem31 x t))))))
...
;; mem_times
  (assert
  (forall ((a2 ty))
  (forall ((s uni) (t (set (set (tuple21 c b)))) (x uni) (y (set (tuple21 c
  b))))
  (= (mem (tuple2 a2 (set1 (tuple2 c1 b1)))
  (Tuple2 a2 (set1 (tuple2 c1 b1)) x (t2tb222 y))
  (times (set1 (tuple2 c1 b1)) a2 s (t2tb308 t)))
  (and (mem a2 x s) (mem31 y t))))))
...
(declare-fun t2tb2091 ((set (tuple21 (set (tuple21 c b)) (set (tuple21 c
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (set (tuple21 c b)) (set (tuple21 c b)))))) (sort
  (set1 (tuple2 (set1 (tuple2 c1 b1)) (set1 (tuple2 c1 b1)))) (t2tb2091 x))))

(declare-fun tb2t2091 (uni) (set (tuple21 (set (tuple21 c b)) (set (tuple21 c
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (set (tuple21 c b)) (set (tuple21 c b))))))
  (! (= (tb2t2091 (t2tb2091 i)) i) :pattern ((t2tb2091 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (set1 (tuple2 c1 b1)) (set1 (tuple2 c1 b1)))) j)
     (= (t2tb2091 (tb2t2091 j)) j)) :pattern ((t2tb2091 (tb2t2091 j))) )))

(declare-fun t2tb2092 ((tuple21 (set (tuple21 c b)) (set (tuple21 c
  b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (set (tuple21 c b)) (set (tuple21 c b))))) (sort
  (tuple2 (set1 (tuple2 c1 b1)) (set1 (tuple2 c1 b1))) (t2tb2092 x))))

(declare-fun tb2t2092 (uni) (tuple21 (set (tuple21 c b)) (set (tuple21 c
  b))))

;; BridgeL
  (assert
  (forall ((i (tuple21 (set (tuple21 c b)) (set (tuple21 c b)))))
  (! (= (tb2t2092 (t2tb2092 i)) i) :pattern ((t2tb2092 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (set1 (tuple2 c1 b1)) (set1 (tuple2 c1 b1))) j)
     (= (t2tb2092 (tb2t2092 j)) j)) :pattern ((t2tb2092 (tb2t2092 j))) )))

;; mem_times
  (assert
  (forall ((s (set (set (tuple21 c b)))) (t (set (set (tuple21 c b))))
  (x (set (tuple21 c b))) (y (set (tuple21 c b))))
  (= (mem (tuple2 (set1 (tuple2 c1 b1)) (set1 (tuple2 c1 b1)))
  (Tuple2 (set1 (tuple2 c1 b1)) (set1 (tuple2 c1 b1)) (t2tb222 x)
  (t2tb222 y))
  (times (set1 (tuple2 c1 b1)) (set1 (tuple2 c1 b1)) (t2tb308 s) (t2tb308 t)))
  (and (mem31 x s) (mem31 y t)))))

(declare-fun t2tb2093 ((set (tuple21 (set (tuple21 c b)) (tuple21 c
  b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (set (tuple21 c b)) (tuple21 c b))))) (sort
  (set1 (tuple2 (set1 (tuple2 c1 b1)) (tuple2 c1 b1))) (t2tb2093 x))))

(declare-fun tb2t2093 (uni) (set (tuple21 (set (tuple21 c b)) (tuple21 c
  b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (set (tuple21 c b)) (tuple21 c b)))))
  (! (= (tb2t2093 (t2tb2093 i)) i) :pattern ((t2tb2093 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (set1 (tuple2 c1 b1)) (tuple2 c1 b1))) j)
     (= (t2tb2093 (tb2t2093 j)) j)) :pattern ((t2tb2093 (tb2t2093 j))) )))

(declare-fun t2tb2094 ((tuple21 (set (tuple21 c b)) (tuple21 c b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (set (tuple21 c b)) (tuple21 c b)))) (sort
  (tuple2 (set1 (tuple2 c1 b1)) (tuple2 c1 b1)) (t2tb2094 x))))

(declare-fun tb2t2094 (uni) (tuple21 (set (tuple21 c b)) (tuple21 c b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (set (tuple21 c b)) (tuple21 c b))))
  (! (= (tb2t2094 (t2tb2094 i)) i) :pattern ((t2tb2094 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (set1 (tuple2 c1 b1)) (tuple2 c1 b1)) j)
     (= (t2tb2094 (tb2t2094 j)) j)) :pattern ((t2tb2094 (tb2t2094 j))) )))

;; mem_times
  (assert
  (forall ((s (set (set (tuple21 c b)))) (t (set (tuple21 c b)))
  (x (set (tuple21 c b))) (y (tuple21 c b)))
  (= (mem (tuple2 (set1 (tuple2 c1 b1)) (tuple2 c1 b1))
  (Tuple2 (set1 (tuple2 c1 b1)) (tuple2 c1 b1) (t2tb222 x) (t2tb223 y))
  (times (tuple2 c1 b1) (set1 (tuple2 c1 b1)) (t2tb308 s) (t2tb222 t)))
  (and (mem31 x s) (mem28 y t)))))

(declare-fun t2tb2095 ((set (tuple21 (set (tuple21 c b)) (tuple21 a
  c)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (set (tuple21 c b)) (tuple21 a c))))) (sort
  (set1 (tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 c1))) (t2tb2095 x))))

(declare-fun tb2t2095 (uni) (set (tuple21 (set (tuple21 c b)) (tuple21 a
  c))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (set (tuple21 c b)) (tuple21 a c)))))
  (! (= (tb2t2095 (t2tb2095 i)) i) :pattern ((t2tb2095 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 c1))) j)
     (= (t2tb2095 (tb2t2095 j)) j)) :pattern ((t2tb2095 (tb2t2095 j))) )))

(declare-fun t2tb2096 ((tuple21 (set (tuple21 c b)) (tuple21 a c))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (set (tuple21 c b)) (tuple21 a c)))) (sort
  (tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 c1)) (t2tb2096 x))))

(declare-fun tb2t2096 (uni) (tuple21 (set (tuple21 c b)) (tuple21 a c)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (set (tuple21 c b)) (tuple21 a c))))
  (! (= (tb2t2096 (t2tb2096 i)) i) :pattern ((t2tb2096 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 c1)) j)
     (= (t2tb2096 (tb2t2096 j)) j)) :pattern ((t2tb2096 (tb2t2096 j))) )))

;; mem_times
  (assert
  (forall ((s (set (set (tuple21 c b)))) (t (set (tuple21 a c)))
  (x (set (tuple21 c b))) (y (tuple21 a c)))
  (= (mem (tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 c1))
  (Tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 c1) (t2tb222 x) (t2tb133 y))
  (times (tuple2 a1 c1) (set1 (tuple2 c1 b1)) (t2tb308 s) (t2tb129 t)))
  (and (mem31 x s) (mem10 y t)))))

(declare-fun t2tb2097 ((set (tuple21 (set (tuple21 c b)) (tuple21 b
  c)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (set (tuple21 c b)) (tuple21 b c))))) (sort
  (set1 (tuple2 (set1 (tuple2 c1 b1)) (tuple2 b1 c1))) (t2tb2097 x))))

(declare-fun tb2t2097 (uni) (set (tuple21 (set (tuple21 c b)) (tuple21 b
  c))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (set (tuple21 c b)) (tuple21 b c)))))
  (! (= (tb2t2097 (t2tb2097 i)) i) :pattern ((t2tb2097 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (set1 (tuple2 c1 b1)) (tuple2 b1 c1))) j)
     (= (t2tb2097 (tb2t2097 j)) j)) :pattern ((t2tb2097 (tb2t2097 j))) )))

(declare-fun t2tb2098 ((tuple21 (set (tuple21 c b)) (tuple21 b c))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (set (tuple21 c b)) (tuple21 b c)))) (sort
  (tuple2 (set1 (tuple2 c1 b1)) (tuple2 b1 c1)) (t2tb2098 x))))

(declare-fun tb2t2098 (uni) (tuple21 (set (tuple21 c b)) (tuple21 b c)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (set (tuple21 c b)) (tuple21 b c))))
  (! (= (tb2t2098 (t2tb2098 i)) i) :pattern ((t2tb2098 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (set1 (tuple2 c1 b1)) (tuple2 b1 c1)) j)
     (= (t2tb2098 (tb2t2098 j)) j)) :pattern ((t2tb2098 (tb2t2098 j))) )))

;; mem_times
  (assert
  (forall ((s (set (set (tuple21 c b)))) (t (set (tuple21 b c)))
  (x (set (tuple21 c b))) (y (tuple21 b c)))
  (= (mem (tuple2 (set1 (tuple2 c1 b1)) (tuple2 b1 c1))
  (Tuple2 (set1 (tuple2 c1 b1)) (tuple2 b1 c1) (t2tb222 x) (t2tb134 y))
  (times (tuple2 b1 c1) (set1 (tuple2 c1 b1)) (t2tb308 s) (t2tb131 t)))
  (and (mem31 x s) (mem8 y t)))))

(declare-fun t2tb2099 ((set (tuple21 (set (tuple21 c b)) c))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (set (tuple21 c b)) c)))) (sort
  (set1 (tuple2 (set1 (tuple2 c1 b1)) c1)) (t2tb2099 x))))

(declare-fun tb2t2099 (uni) (set (tuple21 (set (tuple21 c b)) c)))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (set (tuple21 c b)) c))))
  (! (= (tb2t2099 (t2tb2099 i)) i) :pattern ((t2tb2099 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (set1 (tuple2 c1 b1)) c1)) j)
     (= (t2tb2099 (tb2t2099 j)) j)) :pattern ((t2tb2099 (tb2t2099 j))) )))

(declare-fun t2tb2100 ((tuple21 (set (tuple21 c b)) c)) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (set (tuple21 c b)) c))) (sort
  (tuple2 (set1 (tuple2 c1 b1)) c1) (t2tb2100 x))))

(declare-fun tb2t2100 (uni) (tuple21 (set (tuple21 c b)) c))

;; BridgeL
  (assert
  (forall ((i (tuple21 (set (tuple21 c b)) c)))
  (! (= (tb2t2100 (t2tb2100 i)) i) :pattern ((t2tb2100 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (set1 (tuple2 c1 b1)) c1) j)
     (= (t2tb2100 (tb2t2100 j)) j)) :pattern ((t2tb2100 (tb2t2100 j))) )))

;; mem_times
  (assert
  (forall ((s (set (set (tuple21 c b)))) (t (set c)) (x (set (tuple21 c b)))
  (y c))
  (= (mem (tuple2 (set1 (tuple2 c1 b1)) c1)
  (Tuple2 (set1 (tuple2 c1 b1)) c1 (t2tb222 x) (t2tb135 y))
  (times c1 (set1 (tuple2 c1 b1)) (t2tb308 s) (t2tb132 t)))
  (and (mem31 x s) (mem7 y t)))))

(declare-fun t2tb2101 ((set (tuple21 (set (tuple21 c b)) (set (tuple21 a
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (set (tuple21 c b)) (set (tuple21 a b)))))) (sort
  (set1 (tuple2 (set1 (tuple2 c1 b1)) (set1 (tuple2 a1 b1)))) (t2tb2101 x))))

(declare-fun tb2t2101 (uni) (set (tuple21 (set (tuple21 c b)) (set (tuple21 a
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (set (tuple21 c b)) (set (tuple21 a b))))))
  (! (= (tb2t2101 (t2tb2101 i)) i) :pattern ((t2tb2101 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (set1 (tuple2 c1 b1)) (set1 (tuple2 a1 b1)))) j)
     (= (t2tb2101 (tb2t2101 j)) j)) :pattern ((t2tb2101 (tb2t2101 j))) )))

(declare-fun t2tb2102 ((tuple21 (set (tuple21 c b)) (set (tuple21 a
  b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (set (tuple21 c b)) (set (tuple21 a b))))) (sort
  (tuple2 (set1 (tuple2 c1 b1)) (set1 (tuple2 a1 b1))) (t2tb2102 x))))

(declare-fun tb2t2102 (uni) (tuple21 (set (tuple21 c b)) (set (tuple21 a
  b))))

;; BridgeL
  (assert
  (forall ((i (tuple21 (set (tuple21 c b)) (set (tuple21 a b)))))
  (! (= (tb2t2102 (t2tb2102 i)) i) :pattern ((t2tb2102 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (set1 (tuple2 c1 b1)) (set1 (tuple2 a1 b1))) j)
     (= (t2tb2102 (tb2t2102 j)) j)) :pattern ((t2tb2102 (tb2t2102 j))) )))

;; mem_times
  (assert
  (forall ((s (set (set (tuple21 c b)))) (t (set (set (tuple21 a b))))
  (x (set (tuple21 c b))) (y (set (tuple21 a b))))
  (= (mem (tuple2 (set1 (tuple2 c1 b1)) (set1 (tuple2 a1 b1)))
  (Tuple2 (set1 (tuple2 c1 b1)) (set1 (tuple2 a1 b1)) (t2tb222 x) (t2tb11 y))
  (times (set1 (tuple2 a1 b1)) (set1 (tuple2 c1 b1)) (t2tb308 s) (t2tb10 t)))
  (and (mem31 x s) (mem4 y t)))))

(declare-fun t2tb2103 ((set (tuple21 (set (tuple21 c b)) (tuple21 a
  b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (set (tuple21 c b)) (tuple21 a b))))) (sort
  (set1 (tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 b1))) (t2tb2103 x))))

(declare-fun tb2t2103 (uni) (set (tuple21 (set (tuple21 c b)) (tuple21 a
  b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (set (tuple21 c b)) (tuple21 a b)))))
  (! (= (tb2t2103 (t2tb2103 i)) i) :pattern ((t2tb2103 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 b1))) j)
     (= (t2tb2103 (tb2t2103 j)) j)) :pattern ((t2tb2103 (tb2t2103 j))) )))

(declare-fun t2tb2104 ((tuple21 (set (tuple21 c b)) (tuple21 a b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (set (tuple21 c b)) (tuple21 a b)))) (sort
  (tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 b1)) (t2tb2104 x))))

(declare-fun tb2t2104 (uni) (tuple21 (set (tuple21 c b)) (tuple21 a b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (set (tuple21 c b)) (tuple21 a b))))
  (! (= (tb2t2104 (t2tb2104 i)) i) :pattern ((t2tb2104 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 b1)) j)
     (= (t2tb2104 (tb2t2104 j)) j)) :pattern ((t2tb2104 (tb2t2104 j))) )))

;; mem_times
  (assert
  (forall ((s (set (set (tuple21 c b)))) (t (set (tuple21 a b)))
  (x (set (tuple21 c b))) (y (tuple21 a b)))
  (= (mem (tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 b1))
  (Tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 b1) (t2tb222 x) (t2tb13 y))
  (times (tuple2 a1 b1) (set1 (tuple2 c1 b1)) (t2tb308 s) (t2tb11 t)))
  (and (mem31 x s) (mem3 y t)))))

(declare-fun t2tb2105 ((set (tuple21 (set (tuple21 c b)) b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (set (tuple21 c b)) b)))) (sort
  (set1 (tuple2 (set1 (tuple2 c1 b1)) b1)) (t2tb2105 x))))

(declare-fun tb2t2105 (uni) (set (tuple21 (set (tuple21 c b)) b)))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (set (tuple21 c b)) b))))
  (! (= (tb2t2105 (t2tb2105 i)) i) :pattern ((t2tb2105 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (set1 (tuple2 c1 b1)) b1)) j)
     (= (t2tb2105 (tb2t2105 j)) j)) :pattern ((t2tb2105 (tb2t2105 j))) )))

(declare-fun t2tb2106 ((tuple21 (set (tuple21 c b)) b)) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (set (tuple21 c b)) b))) (sort
  (tuple2 (set1 (tuple2 c1 b1)) b1) (t2tb2106 x))))

(declare-fun tb2t2106 (uni) (tuple21 (set (tuple21 c b)) b))

;; BridgeL
  (assert
  (forall ((i (tuple21 (set (tuple21 c b)) b)))
  (! (= (tb2t2106 (t2tb2106 i)) i) :pattern ((t2tb2106 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (set1 (tuple2 c1 b1)) b1) j)
     (= (t2tb2106 (tb2t2106 j)) j)) :pattern ((t2tb2106 (tb2t2106 j))) )))

;; mem_times
  (assert
  (forall ((s (set (set (tuple21 c b)))) (t (set b)) (x (set (tuple21 c b)))
  (y b))
  (= (mem (tuple2 (set1 (tuple2 c1 b1)) b1)
  (Tuple2 (set1 (tuple2 c1 b1)) b1 (t2tb222 x) (t2tb14 y))
  (times b1 (set1 (tuple2 c1 b1)) (t2tb308 s) (t2tb12 t)))
  (and (mem31 x s) (mem2 y t)))))

(declare-fun t2tb2107 ((set (tuple21 (set (tuple21 c b)) a))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (set (tuple21 c b)) a)))) (sort
  (set1 (tuple2 (set1 (tuple2 c1 b1)) a1)) (t2tb2107 x))))

(declare-fun tb2t2107 (uni) (set (tuple21 (set (tuple21 c b)) a)))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (set (tuple21 c b)) a))))
  (! (= (tb2t2107 (t2tb2107 i)) i) :pattern ((t2tb2107 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (set1 (tuple2 c1 b1)) a1)) j)
     (= (t2tb2107 (tb2t2107 j)) j)) :pattern ((t2tb2107 (tb2t2107 j))) )))

(declare-fun t2tb2108 ((tuple21 (set (tuple21 c b)) a)) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (set (tuple21 c b)) a))) (sort
  (tuple2 (set1 (tuple2 c1 b1)) a1) (t2tb2108 x))))

(declare-fun tb2t2108 (uni) (tuple21 (set (tuple21 c b)) a))

;; BridgeL
  (assert
  (forall ((i (tuple21 (set (tuple21 c b)) a)))
  (! (= (tb2t2108 (t2tb2108 i)) i) :pattern ((t2tb2108 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (set1 (tuple2 c1 b1)) a1) j)
     (= (t2tb2108 (tb2t2108 j)) j)) :pattern ((t2tb2108 (tb2t2108 j))) )))

;; mem_times
  (assert
  (forall ((s (set (set (tuple21 c b)))) (t (set a)) (x (set (tuple21 c b)))
  (y a))
  (= (mem (tuple2 (set1 (tuple2 c1 b1)) a1)
  (Tuple2 (set1 (tuple2 c1 b1)) a1 (t2tb222 x) (t2tb2 y))
  (times a1 (set1 (tuple2 c1 b1)) (t2tb308 s) (t2tb1 t)))
  (and (mem31 x s) (mem1 y t)))))

;; mem_times
  (assert
  (forall ((b2 ty))
  (forall ((s (set (set (tuple21 c b)))) (t uni) (x (set (tuple21 c b)))
  (y uni))
  (= (mem (tuple2 (set1 (tuple2 c1 b1)) b2)
  (Tuple2 (set1 (tuple2 c1 b1)) b2 (t2tb222 x) y)
  (times b2 (set1 (tuple2 c1 b1)) (t2tb308 s) t))
  (and (mem31 x s) (mem b2 y t))))))

(declare-fun t2tb2109 ((set (tuple21 (tuple21 c b) (set (tuple21 c
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 c b) (set (tuple21 c b)))))) (sort
  (set1 (tuple2 (tuple2 c1 b1) (set1 (tuple2 c1 b1)))) (t2tb2109 x))))

(declare-fun tb2t2109 (uni) (set (tuple21 (tuple21 c b) (set (tuple21 c
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 c b) (set (tuple21 c b))))))
  (! (= (tb2t2109 (t2tb2109 i)) i) :pattern ((t2tb2109 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 c1 b1) (set1 (tuple2 c1 b1)))) j)
     (= (t2tb2109 (tb2t2109 j)) j)) :pattern ((t2tb2109 (tb2t2109 j))) )))

(declare-fun t2tb2110 ((tuple21 (tuple21 c b) (set (tuple21 c b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 c b) (set (tuple21 c b))))) (sort
  (tuple2 (tuple2 c1 b1) (set1 (tuple2 c1 b1))) (t2tb2110 x))))

(declare-fun tb2t2110 (uni) (tuple21 (tuple21 c b) (set (tuple21 c b))))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 c b) (set (tuple21 c b)))))
  (! (= (tb2t2110 (t2tb2110 i)) i) :pattern ((t2tb2110 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 c1 b1) (set1 (tuple2 c1 b1))) j)
     (= (t2tb2110 (tb2t2110 j)) j)) :pattern ((t2tb2110 (tb2t2110 j))) )))

;; mem_times
  (assert
  (forall ((s (set (tuple21 c b))) (t (set (set (tuple21 c b))))
  (x (tuple21 c b)) (y (set (tuple21 c b))))
  (= (mem (tuple2 (tuple2 c1 b1) (set1 (tuple2 c1 b1)))
  (Tuple2 (tuple2 c1 b1) (set1 (tuple2 c1 b1)) (t2tb223 x) (t2tb222 y))
  (times (set1 (tuple2 c1 b1)) (tuple2 c1 b1) (t2tb222 s) (t2tb308 t)))
  (and (mem28 x s) (mem31 y t)))))

(declare-fun t2tb2111 ((set (tuple21 (tuple21 c b) (tuple21 c b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 c b) (tuple21 c b))))) (sort
  (set1 (tuple2 (tuple2 c1 b1) (tuple2 c1 b1))) (t2tb2111 x))))

(declare-fun tb2t2111 (uni) (set (tuple21 (tuple21 c b) (tuple21 c b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 c b) (tuple21 c b)))))
  (! (= (tb2t2111 (t2tb2111 i)) i) :pattern ((t2tb2111 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 c1 b1) (tuple2 c1 b1))) j)
     (= (t2tb2111 (tb2t2111 j)) j)) :pattern ((t2tb2111 (tb2t2111 j))) )))

(declare-fun t2tb2112 ((tuple21 (tuple21 c b) (tuple21 c b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 c b) (tuple21 c b)))) (sort
  (tuple2 (tuple2 c1 b1) (tuple2 c1 b1)) (t2tb2112 x))))

(declare-fun tb2t2112 (uni) (tuple21 (tuple21 c b) (tuple21 c b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 c b) (tuple21 c b))))
  (! (= (tb2t2112 (t2tb2112 i)) i) :pattern ((t2tb2112 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 c1 b1) (tuple2 c1 b1)) j)
     (= (t2tb2112 (tb2t2112 j)) j)) :pattern ((t2tb2112 (tb2t2112 j))) )))
...
(declare-fun t2tb2113 ((set (tuple21 (tuple21 c b) (tuple21 a c)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 c b) (tuple21 a c))))) (sort
  (set1 (tuple2 (tuple2 c1 b1) (tuple2 a1 c1))) (t2tb2113 x))))

(declare-fun tb2t2113 (uni) (set (tuple21 (tuple21 c b) (tuple21 a c))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 c b) (tuple21 a c)))))
  (! (= (tb2t2113 (t2tb2113 i)) i) :pattern ((t2tb2113 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 c1 b1) (tuple2 a1 c1))) j)
     (= (t2tb2113 (tb2t2113 j)) j)) :pattern ((t2tb2113 (tb2t2113 j))) )))

(declare-fun t2tb2114 ((tuple21 (tuple21 c b) (tuple21 a c))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 c b) (tuple21 a c)))) (sort
  (tuple2 (tuple2 c1 b1) (tuple2 a1 c1)) (t2tb2114 x))))

(declare-fun tb2t2114 (uni) (tuple21 (tuple21 c b) (tuple21 a c)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 c b) (tuple21 a c))))
  (! (= (tb2t2114 (t2tb2114 i)) i) :pattern ((t2tb2114 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 c1 b1) (tuple2 a1 c1)) j)
     (= (t2tb2114 (tb2t2114 j)) j)) :pattern ((t2tb2114 (tb2t2114 j))) )))
...
(declare-fun t2tb2115 ((set (tuple21 (tuple21 c b) (tuple21 b c)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 c b) (tuple21 b c))))) (sort
  (set1 (tuple2 (tuple2 c1 b1) (tuple2 b1 c1))) (t2tb2115 x))))

(declare-fun tb2t2115 (uni) (set (tuple21 (tuple21 c b) (tuple21 b c))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 c b) (tuple21 b c)))))
  (! (= (tb2t2115 (t2tb2115 i)) i) :pattern ((t2tb2115 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 c1 b1) (tuple2 b1 c1))) j)
     (= (t2tb2115 (tb2t2115 j)) j)) :pattern ((t2tb2115 (tb2t2115 j))) )))

(declare-fun t2tb2116 ((tuple21 (tuple21 c b) (tuple21 b c))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 c b) (tuple21 b c)))) (sort
  (tuple2 (tuple2 c1 b1) (tuple2 b1 c1)) (t2tb2116 x))))

(declare-fun tb2t2116 (uni) (tuple21 (tuple21 c b) (tuple21 b c)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 c b) (tuple21 b c))))
  (! (= (tb2t2116 (t2tb2116 i)) i) :pattern ((t2tb2116 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 c1 b1) (tuple2 b1 c1)) j)
     (= (t2tb2116 (tb2t2116 j)) j)) :pattern ((t2tb2116 (tb2t2116 j))) )))
...
(declare-fun t2tb2117 ((set (tuple21 (tuple21 c b) c))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 c b) c)))) (sort
  (set1 (tuple2 (tuple2 c1 b1) c1)) (t2tb2117 x))))

(declare-fun tb2t2117 (uni) (set (tuple21 (tuple21 c b) c)))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 c b) c))))
  (! (= (tb2t2117 (t2tb2117 i)) i) :pattern ((t2tb2117 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 c1 b1) c1)) j)
     (= (t2tb2117 (tb2t2117 j)) j)) :pattern ((t2tb2117 (tb2t2117 j))) )))

(declare-fun t2tb2118 ((tuple21 (tuple21 c b) c)) uni)
...
(declare-fun tb2t2118 (uni) (tuple21 (tuple21 c b) c))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 c b) c)))
  (! (= (tb2t2118 (t2tb2118 i)) i) :pattern ((t2tb2118 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 c1 b1) c1) j) (= (t2tb2118 (tb2t2118 j)) j)) :pattern (
  (t2tb2118 (tb2t2118 j))) )))
...
(declare-fun t2tb2119 ((set (tuple21 (tuple21 c b) (set (tuple21 a
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 c b) (set (tuple21 a b)))))) (sort
  (set1 (tuple2 (tuple2 c1 b1) (set1 (tuple2 a1 b1)))) (t2tb2119 x))))

(declare-fun tb2t2119 (uni) (set (tuple21 (tuple21 c b) (set (tuple21 a
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 c b) (set (tuple21 a b))))))
  (! (= (tb2t2119 (t2tb2119 i)) i) :pattern ((t2tb2119 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 c1 b1) (set1 (tuple2 a1 b1)))) j)
     (= (t2tb2119 (tb2t2119 j)) j)) :pattern ((t2tb2119 (tb2t2119 j))) )))

(declare-fun t2tb2120 ((tuple21 (tuple21 c b) (set (tuple21 a b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 c b) (set (tuple21 a b))))) (sort
  (tuple2 (tuple2 c1 b1) (set1 (tuple2 a1 b1))) (t2tb2120 x))))

(declare-fun tb2t2120 (uni) (tuple21 (tuple21 c b) (set (tuple21 a b))))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 c b) (set (tuple21 a b)))))
  (! (= (tb2t2120 (t2tb2120 i)) i) :pattern ((t2tb2120 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 c1 b1) (set1 (tuple2 a1 b1))) j)
     (= (t2tb2120 (tb2t2120 j)) j)) :pattern ((t2tb2120 (tb2t2120 j))) )))
...
(declare-fun t2tb2121 ((set (tuple21 (tuple21 c b) (tuple21 a b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 c b) (tuple21 a b))))) (sort
  (set1 (tuple2 (tuple2 c1 b1) (tuple2 a1 b1))) (t2tb2121 x))))

(declare-fun tb2t2121 (uni) (set (tuple21 (tuple21 c b) (tuple21 a b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 c b) (tuple21 a b)))))
  (! (= (tb2t2121 (t2tb2121 i)) i) :pattern ((t2tb2121 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 c1 b1) (tuple2 a1 b1))) j)
     (= (t2tb2121 (tb2t2121 j)) j)) :pattern ((t2tb2121 (tb2t2121 j))) )))

(declare-fun t2tb2122 ((tuple21 (tuple21 c b) (tuple21 a b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 c b) (tuple21 a b)))) (sort
  (tuple2 (tuple2 c1 b1) (tuple2 a1 b1)) (t2tb2122 x))))

(declare-fun tb2t2122 (uni) (tuple21 (tuple21 c b) (tuple21 a b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 c b) (tuple21 a b))))
  (! (= (tb2t2122 (t2tb2122 i)) i) :pattern ((t2tb2122 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 c1 b1) (tuple2 a1 b1)) j)
     (= (t2tb2122 (tb2t2122 j)) j)) :pattern ((t2tb2122 (tb2t2122 j))) )))
...
(declare-fun t2tb2123 ((set (tuple21 (tuple21 c b) b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 c b) b)))) (sort
  (set1 (tuple2 (tuple2 c1 b1) b1)) (t2tb2123 x))))

(declare-fun tb2t2123 (uni) (set (tuple21 (tuple21 c b) b)))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 c b) b))))
  (! (= (tb2t2123 (t2tb2123 i)) i) :pattern ((t2tb2123 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 c1 b1) b1)) j)
     (= (t2tb2123 (tb2t2123 j)) j)) :pattern ((t2tb2123 (tb2t2123 j))) )))

(declare-fun t2tb2124 ((tuple21 (tuple21 c b) b)) uni)
...
(declare-fun tb2t2124 (uni) (tuple21 (tuple21 c b) b))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 c b) b)))
  (! (= (tb2t2124 (t2tb2124 i)) i) :pattern ((t2tb2124 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 c1 b1) b1) j) (= (t2tb2124 (tb2t2124 j)) j)) :pattern (
  (t2tb2124 (tb2t2124 j))) )))
...
(declare-fun t2tb2125 ((set (tuple21 (tuple21 c b) a))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 c b) a)))) (sort
  (set1 (tuple2 (tuple2 c1 b1) a1)) (t2tb2125 x))))

(declare-fun tb2t2125 (uni) (set (tuple21 (tuple21 c b) a)))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 c b) a))))
  (! (= (tb2t2125 (t2tb2125 i)) i) :pattern ((t2tb2125 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 c1 b1) a1)) j)
     (= (t2tb2125 (tb2t2125 j)) j)) :pattern ((t2tb2125 (tb2t2125 j))) )))

(declare-fun t2tb2126 ((tuple21 (tuple21 c b) a)) uni)
...
(declare-fun tb2t2126 (uni) (tuple21 (tuple21 c b) a))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 c b) a)))
  (! (= (tb2t2126 (t2tb2126 i)) i) :pattern ((t2tb2126 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 c1 b1) a1) j) (= (t2tb2126 (tb2t2126 j)) j)) :pattern (
  (t2tb2126 (tb2t2126 j))) )))
...
(declare-fun t2tb2127 ((set (tuple21 (tuple21 a c) (set (tuple21 c
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 a c) (set (tuple21 c b)))))) (sort
  (set1 (tuple2 (tuple2 a1 c1) (set1 (tuple2 c1 b1)))) (t2tb2127 x))))

(declare-fun tb2t2127 (uni) (set (tuple21 (tuple21 a c) (set (tuple21 c
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 a c) (set (tuple21 c b))))))
  (! (= (tb2t2127 (t2tb2127 i)) i) :pattern ((t2tb2127 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 a1 c1) (set1 (tuple2 c1 b1)))) j)
     (= (t2tb2127 (tb2t2127 j)) j)) :pattern ((t2tb2127 (tb2t2127 j))) )))

(declare-fun t2tb2128 ((tuple21 (tuple21 a c) (set (tuple21 c b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 a c) (set (tuple21 c b))))) (sort
  (tuple2 (tuple2 a1 c1) (set1 (tuple2 c1 b1))) (t2tb2128 x))))

(declare-fun tb2t2128 (uni) (tuple21 (tuple21 a c) (set (tuple21 c b))))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 a c) (set (tuple21 c b)))))
  (! (= (tb2t2128 (t2tb2128 i)) i) :pattern ((t2tb2128 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 a1 c1) (set1 (tuple2 c1 b1))) j)
     (= (t2tb2128 (tb2t2128 j)) j)) :pattern ((t2tb2128 (tb2t2128 j))) )))

;; mem_times
  (assert
  (forall ((s (set (tuple21 a c))) (t (set (set (tuple21 c b))))
  (x (tuple21 a c)) (y (set (tuple21 c b))))
  (= (mem (tuple2 (tuple2 a1 c1) (set1 (tuple2 c1 b1)))
  (Tuple2 (tuple2 a1 c1) (set1 (tuple2 c1 b1)) (t2tb133 x) (t2tb222 y))
  (times (set1 (tuple2 c1 b1)) (tuple2 a1 c1) (t2tb129 s) (t2tb308 t)))
  (and (mem10 x s) (mem31 y t)))))

(declare-fun t2tb2129 ((set (tuple21 (tuple21 a c) (tuple21 c b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 a c) (tuple21 c b))))) (sort
  (set1 (tuple2 (tuple2 a1 c1) (tuple2 c1 b1))) (t2tb2129 x))))

(declare-fun tb2t2129 (uni) (set (tuple21 (tuple21 a c) (tuple21 c b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 a c) (tuple21 c b)))))
  (! (= (tb2t2129 (t2tb2129 i)) i) :pattern ((t2tb2129 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 a1 c1) (tuple2 c1 b1))) j)
     (= (t2tb2129 (tb2t2129 j)) j)) :pattern ((t2tb2129 (tb2t2129 j))) )))

(declare-fun t2tb2130 ((tuple21 (tuple21 a c) (tuple21 c b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 a c) (tuple21 c b)))) (sort
  (tuple2 (tuple2 a1 c1) (tuple2 c1 b1)) (t2tb2130 x))))

(declare-fun tb2t2130 (uni) (tuple21 (tuple21 a c) (tuple21 c b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 a c) (tuple21 c b))))
  (! (= (tb2t2130 (t2tb2130 i)) i) :pattern ((t2tb2130 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 a1 c1) (tuple2 c1 b1)) j)
     (= (t2tb2130 (tb2t2130 j)) j)) :pattern ((t2tb2130 (tb2t2130 j))) )))
...
(declare-fun t2tb2131 ((set (tuple21 (tuple21 b c) (set (tuple21 c
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b c) (set (tuple21 c b)))))) (sort
  (set1 (tuple2 (tuple2 b1 c1) (set1 (tuple2 c1 b1)))) (t2tb2131 x))))

(declare-fun tb2t2131 (uni) (set (tuple21 (tuple21 b c) (set (tuple21 c
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b c) (set (tuple21 c b))))))
  (! (= (tb2t2131 (t2tb2131 i)) i) :pattern ((t2tb2131 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 c1) (set1 (tuple2 c1 b1)))) j)
     (= (t2tb2131 (tb2t2131 j)) j)) :pattern ((t2tb2131 (tb2t2131 j))) )))

(declare-fun t2tb2132 ((tuple21 (tuple21 b c) (set (tuple21 c b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 b c) (set (tuple21 c b))))) (sort
  (tuple2 (tuple2 b1 c1) (set1 (tuple2 c1 b1))) (t2tb2132 x))))

(declare-fun tb2t2132 (uni) (tuple21 (tuple21 b c) (set (tuple21 c b))))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b c) (set (tuple21 c b)))))
  (! (= (tb2t2132 (t2tb2132 i)) i) :pattern ((t2tb2132 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 c1) (set1 (tuple2 c1 b1))) j)
     (= (t2tb2132 (tb2t2132 j)) j)) :pattern ((t2tb2132 (tb2t2132 j))) )))

;; mem_times
  (assert
  (forall ((s (set (tuple21 b c))) (t (set (set (tuple21 c b))))
  (x (tuple21 b c)) (y (set (tuple21 c b))))
  (= (mem (tuple2 (tuple2 b1 c1) (set1 (tuple2 c1 b1)))
  (Tuple2 (tuple2 b1 c1) (set1 (tuple2 c1 b1)) (t2tb134 x) (t2tb222 y))
  (times (set1 (tuple2 c1 b1)) (tuple2 b1 c1) (t2tb131 s) (t2tb308 t)))
  (and (mem8 x s) (mem31 y t)))))

(declare-fun t2tb2133 ((set (tuple21 (tuple21 b c) (tuple21 c b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b c) (tuple21 c b))))) (sort
  (set1 (tuple2 (tuple2 b1 c1) (tuple2 c1 b1))) (t2tb2133 x))))

(declare-fun tb2t2133 (uni) (set (tuple21 (tuple21 b c) (tuple21 c b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b c) (tuple21 c b)))))
  (! (= (tb2t2133 (t2tb2133 i)) i) :pattern ((t2tb2133 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 c1) (tuple2 c1 b1))) j)
     (= (t2tb2133 (tb2t2133 j)) j)) :pattern ((t2tb2133 (tb2t2133 j))) )))

(declare-fun t2tb2134 ((tuple21 (tuple21 b c) (tuple21 c b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 b c) (tuple21 c b)))) (sort
  (tuple2 (tuple2 b1 c1) (tuple2 c1 b1)) (t2tb2134 x))))

(declare-fun tb2t2134 (uni) (tuple21 (tuple21 b c) (tuple21 c b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b c) (tuple21 c b))))
  (! (= (tb2t2134 (t2tb2134 i)) i) :pattern ((t2tb2134 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 c1) (tuple2 c1 b1)) j)
     (= (t2tb2134 (tb2t2134 j)) j)) :pattern ((t2tb2134 (tb2t2134 j))) )))
...
(declare-fun t2tb2135 ((set (tuple21 c (set (tuple21 c b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 c (set (tuple21 c b)))))) (sort
  (set1 (tuple2 c1 (set1 (tuple2 c1 b1)))) (t2tb2135 x))))

(declare-fun tb2t2135 (uni) (set (tuple21 c (set (tuple21 c b)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 c (set (tuple21 c b))))))
  (! (= (tb2t2135 (t2tb2135 i)) i) :pattern ((t2tb2135 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 c1 (set1 (tuple2 c1 b1)))) j)
     (= (t2tb2135 (tb2t2135 j)) j)) :pattern ((t2tb2135 (tb2t2135 j))) )))

(declare-fun t2tb2136 ((tuple21 c (set (tuple21 c b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 c (set (tuple21 c b))))) (sort
  (tuple2 c1 (set1 (tuple2 c1 b1))) (t2tb2136 x))))

(declare-fun tb2t2136 (uni) (tuple21 c (set (tuple21 c b))))

;; BridgeL
  (assert
  (forall ((i (tuple21 c (set (tuple21 c b)))))
  (! (= (tb2t2136 (t2tb2136 i)) i) :pattern ((t2tb2136 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 c1 (set1 (tuple2 c1 b1))) j)
     (= (t2tb2136 (tb2t2136 j)) j)) :pattern ((t2tb2136 (tb2t2136 j))) )))

;; mem_times
  (assert
  (forall ((s (set c)) (t (set (set (tuple21 c b)))) (x c) (y (set (tuple21 c
  b))))
  (= (mem (tuple2 c1 (set1 (tuple2 c1 b1)))
  (Tuple2 c1 (set1 (tuple2 c1 b1)) (t2tb135 x) (t2tb222 y))
  (times (set1 (tuple2 c1 b1)) c1 (t2tb132 s) (t2tb308 t)))
  (and (mem7 x s) (mem31 y t)))))

(declare-fun t2tb2137 ((set (tuple21 c (tuple21 c b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 c (tuple21 c b))))) (sort
  (set1 (tuple2 c1 (tuple2 c1 b1))) (t2tb2137 x))))

(declare-fun tb2t2137 (uni) (set (tuple21 c (tuple21 c b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 c (tuple21 c b)))))
  (! (= (tb2t2137 (t2tb2137 i)) i) :pattern ((t2tb2137 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 c1 (tuple2 c1 b1))) j)
     (= (t2tb2137 (tb2t2137 j)) j)) :pattern ((t2tb2137 (tb2t2137 j))) )))

(declare-fun t2tb2138 ((tuple21 c (tuple21 c b))) uni)
...
(declare-fun tb2t2138 (uni) (tuple21 c (tuple21 c b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 c (tuple21 c b))))
  (! (= (tb2t2138 (t2tb2138 i)) i) :pattern ((t2tb2138 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 c1 (tuple2 c1 b1)) j) (= (t2tb2138 (tb2t2138 j)) j)) :pattern (
  (t2tb2138 (tb2t2138 j))) )))
...
(declare-fun t2tb2139 ((set (tuple21 (set (tuple21 a b)) (set (tuple21 c
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (set (tuple21 a b)) (set (tuple21 c b)))))) (sort
  (set1 (tuple2 (set1 (tuple2 a1 b1)) (set1 (tuple2 c1 b1)))) (t2tb2139 x))))

(declare-fun tb2t2139 (uni) (set (tuple21 (set (tuple21 a b)) (set (tuple21 c
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (set (tuple21 a b)) (set (tuple21 c b))))))
  (! (= (tb2t2139 (t2tb2139 i)) i) :pattern ((t2tb2139 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (set1 (tuple2 a1 b1)) (set1 (tuple2 c1 b1)))) j)
     (= (t2tb2139 (tb2t2139 j)) j)) :pattern ((t2tb2139 (tb2t2139 j))) )))

(declare-fun t2tb2140 ((tuple21 (set (tuple21 a b)) (set (tuple21 c
  b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (set (tuple21 a b)) (set (tuple21 c b))))) (sort
  (tuple2 (set1 (tuple2 a1 b1)) (set1 (tuple2 c1 b1))) (t2tb2140 x))))

(declare-fun tb2t2140 (uni) (tuple21 (set (tuple21 a b)) (set (tuple21 c
  b))))

;; BridgeL
  (assert
  (forall ((i (tuple21 (set (tuple21 a b)) (set (tuple21 c b)))))
  (! (= (tb2t2140 (t2tb2140 i)) i) :pattern ((t2tb2140 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (set1 (tuple2 a1 b1)) (set1 (tuple2 c1 b1))) j)
     (= (t2tb2140 (tb2t2140 j)) j)) :pattern ((t2tb2140 (tb2t2140 j))) )))

;; mem_times
  (assert
  (forall ((s (set (set (tuple21 a b)))) (t (set (set (tuple21 c b))))
  (x (set (tuple21 a b))) (y (set (tuple21 c b))))
  (= (mem (tuple2 (set1 (tuple2 a1 b1)) (set1 (tuple2 c1 b1)))
  (Tuple2 (set1 (tuple2 a1 b1)) (set1 (tuple2 c1 b1)) (t2tb11 x) (t2tb222 y))
  (times (set1 (tuple2 c1 b1)) (set1 (tuple2 a1 b1)) (t2tb10 s) (t2tb308 t)))
  (and (mem4 x s) (mem31 y t)))))

(declare-fun t2tb2141 ((set (tuple21 (set (tuple21 a b)) (tuple21 c
  b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (set (tuple21 a b)) (tuple21 c b))))) (sort
  (set1 (tuple2 (set1 (tuple2 a1 b1)) (tuple2 c1 b1))) (t2tb2141 x))))

(declare-fun tb2t2141 (uni) (set (tuple21 (set (tuple21 a b)) (tuple21 c
  b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (set (tuple21 a b)) (tuple21 c b)))))
  (! (= (tb2t2141 (t2tb2141 i)) i) :pattern ((t2tb2141 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (set1 (tuple2 a1 b1)) (tuple2 c1 b1))) j)
     (= (t2tb2141 (tb2t2141 j)) j)) :pattern ((t2tb2141 (tb2t2141 j))) )))

(declare-fun t2tb2142 ((tuple21 (set (tuple21 a b)) (tuple21 c b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (set (tuple21 a b)) (tuple21 c b)))) (sort
  (tuple2 (set1 (tuple2 a1 b1)) (tuple2 c1 b1)) (t2tb2142 x))))

(declare-fun tb2t2142 (uni) (tuple21 (set (tuple21 a b)) (tuple21 c b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (set (tuple21 a b)) (tuple21 c b))))
  (! (= (tb2t2142 (t2tb2142 i)) i) :pattern ((t2tb2142 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (set1 (tuple2 a1 b1)) (tuple2 c1 b1)) j)
     (= (t2tb2142 (tb2t2142 j)) j)) :pattern ((t2tb2142 (tb2t2142 j))) )))
...
(declare-fun t2tb2143 ((set (tuple21 (tuple21 a b) (set (tuple21 c
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 a b) (set (tuple21 c b)))))) (sort
  (set1 (tuple2 (tuple2 a1 b1) (set1 (tuple2 c1 b1)))) (t2tb2143 x))))

(declare-fun tb2t2143 (uni) (set (tuple21 (tuple21 a b) (set (tuple21 c
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 a b) (set (tuple21 c b))))))
  (! (= (tb2t2143 (t2tb2143 i)) i) :pattern ((t2tb2143 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 a1 b1) (set1 (tuple2 c1 b1)))) j)
     (= (t2tb2143 (tb2t2143 j)) j)) :pattern ((t2tb2143 (tb2t2143 j))) )))

(declare-fun t2tb2144 ((tuple21 (tuple21 a b) (set (tuple21 c b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 a b) (set (tuple21 c b))))) (sort
  (tuple2 (tuple2 a1 b1) (set1 (tuple2 c1 b1))) (t2tb2144 x))))

(declare-fun tb2t2144 (uni) (tuple21 (tuple21 a b) (set (tuple21 c b))))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 a b) (set (tuple21 c b)))))
  (! (= (tb2t2144 (t2tb2144 i)) i) :pattern ((t2tb2144 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 a1 b1) (set1 (tuple2 c1 b1))) j)
     (= (t2tb2144 (tb2t2144 j)) j)) :pattern ((t2tb2144 (tb2t2144 j))) )))

;; mem_times
  (assert
  (forall ((s (set (tuple21 a b))) (t (set (set (tuple21 c b))))
  (x (tuple21 a b)) (y (set (tuple21 c b))))
  (= (mem (tuple2 (tuple2 a1 b1) (set1 (tuple2 c1 b1)))
  (Tuple2 (tuple2 a1 b1) (set1 (tuple2 c1 b1)) (t2tb13 x) (t2tb222 y))
  (times (set1 (tuple2 c1 b1)) (tuple2 a1 b1) (t2tb11 s) (t2tb308 t)))
  (and (mem3 x s) (mem31 y t)))))

(declare-fun t2tb2145 ((set (tuple21 (tuple21 a b) (tuple21 c b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 a b) (tuple21 c b))))) (sort
  (set1 (tuple2 (tuple2 a1 b1) (tuple2 c1 b1))) (t2tb2145 x))))

(declare-fun tb2t2145 (uni) (set (tuple21 (tuple21 a b) (tuple21 c b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 a b) (tuple21 c b)))))
  (! (= (tb2t2145 (t2tb2145 i)) i) :pattern ((t2tb2145 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 a1 b1) (tuple2 c1 b1))) j)
     (= (t2tb2145 (tb2t2145 j)) j)) :pattern ((t2tb2145 (tb2t2145 j))) )))

(declare-fun t2tb2146 ((tuple21 (tuple21 a b) (tuple21 c b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 a b) (tuple21 c b)))) (sort
  (tuple2 (tuple2 a1 b1) (tuple2 c1 b1)) (t2tb2146 x))))

(declare-fun tb2t2146 (uni) (tuple21 (tuple21 a b) (tuple21 c b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 a b) (tuple21 c b))))
  (! (= (tb2t2146 (t2tb2146 i)) i) :pattern ((t2tb2146 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 a1 b1) (tuple2 c1 b1)) j)
     (= (t2tb2146 (tb2t2146 j)) j)) :pattern ((t2tb2146 (tb2t2146 j))) )))
...
(declare-fun t2tb2147 ((set (tuple21 b (set (tuple21 c b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 b (set (tuple21 c b)))))) (sort
  (set1 (tuple2 b1 (set1 (tuple2 c1 b1)))) (t2tb2147 x))))

(declare-fun tb2t2147 (uni) (set (tuple21 b (set (tuple21 c b)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 b (set (tuple21 c b))))))
  (! (= (tb2t2147 (t2tb2147 i)) i) :pattern ((t2tb2147 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 b1 (set1 (tuple2 c1 b1)))) j)
     (= (t2tb2147 (tb2t2147 j)) j)) :pattern ((t2tb2147 (tb2t2147 j))) )))

(declare-fun t2tb2148 ((tuple21 b (set (tuple21 c b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 b (set (tuple21 c b))))) (sort
  (tuple2 b1 (set1 (tuple2 c1 b1))) (t2tb2148 x))))

(declare-fun tb2t2148 (uni) (tuple21 b (set (tuple21 c b))))

;; BridgeL
  (assert
  (forall ((i (tuple21 b (set (tuple21 c b)))))
  (! (= (tb2t2148 (t2tb2148 i)) i) :pattern ((t2tb2148 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 b1 (set1 (tuple2 c1 b1))) j)
     (= (t2tb2148 (tb2t2148 j)) j)) :pattern ((t2tb2148 (tb2t2148 j))) )))

;; mem_times
  (assert
  (forall ((s (set b)) (t (set (set (tuple21 c b)))) (x b) (y (set (tuple21 c
  b))))
  (= (mem (tuple2 b1 (set1 (tuple2 c1 b1)))
  (Tuple2 b1 (set1 (tuple2 c1 b1)) (t2tb14 x) (t2tb222 y))
  (times (set1 (tuple2 c1 b1)) b1 (t2tb12 s) (t2tb308 t)))
  (and (mem2 x s) (mem31 y t)))))

(declare-fun t2tb2149 ((set (tuple21 b (tuple21 c b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 b (tuple21 c b))))) (sort
  (set1 (tuple2 b1 (tuple2 c1 b1))) (t2tb2149 x))))

(declare-fun tb2t2149 (uni) (set (tuple21 b (tuple21 c b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 b (tuple21 c b)))))
  (! (= (tb2t2149 (t2tb2149 i)) i) :pattern ((t2tb2149 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 b1 (tuple2 c1 b1))) j)
     (= (t2tb2149 (tb2t2149 j)) j)) :pattern ((t2tb2149 (tb2t2149 j))) )))

(declare-fun t2tb2150 ((tuple21 b (tuple21 c b))) uni)
...
(declare-fun tb2t2150 (uni) (tuple21 b (tuple21 c b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 b (tuple21 c b))))
  (! (= (tb2t2150 (t2tb2150 i)) i) :pattern ((t2tb2150 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 b1 (tuple2 c1 b1)) j) (= (t2tb2150 (tb2t2150 j)) j)) :pattern (
  (t2tb2150 (tb2t2150 j))) )))
...
(declare-fun t2tb2151 ((set (tuple21 a (set (tuple21 c b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 a (set (tuple21 c b)))))) (sort
  (set1 (tuple2 a1 (set1 (tuple2 c1 b1)))) (t2tb2151 x))))

(declare-fun tb2t2151 (uni) (set (tuple21 a (set (tuple21 c b)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 a (set (tuple21 c b))))))
  (! (= (tb2t2151 (t2tb2151 i)) i) :pattern ((t2tb2151 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 a1 (set1 (tuple2 c1 b1)))) j)
     (= (t2tb2151 (tb2t2151 j)) j)) :pattern ((t2tb2151 (tb2t2151 j))) )))

(declare-fun t2tb2152 ((tuple21 a (set (tuple21 c b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 a (set (tuple21 c b))))) (sort
  (tuple2 a1 (set1 (tuple2 c1 b1))) (t2tb2152 x))))

(declare-fun tb2t2152 (uni) (tuple21 a (set (tuple21 c b))))

;; BridgeL
  (assert
  (forall ((i (tuple21 a (set (tuple21 c b)))))
  (! (= (tb2t2152 (t2tb2152 i)) i) :pattern ((t2tb2152 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 a1 (set1 (tuple2 c1 b1))) j)
     (= (t2tb2152 (tb2t2152 j)) j)) :pattern ((t2tb2152 (tb2t2152 j))) )))

;; mem_times
  (assert
  (forall ((s (set a)) (t (set (set (tuple21 c b)))) (x a) (y (set (tuple21 c
  b))))
  (= (mem (tuple2 a1 (set1 (tuple2 c1 b1)))
  (Tuple2 a1 (set1 (tuple2 c1 b1)) (t2tb2 x) (t2tb222 y))
  (times (set1 (tuple2 c1 b1)) a1 (t2tb1 s) (t2tb308 t)))
  (and (mem1 x s) (mem31 y t)))))
...
(declare-fun t2tb2153 ((set (set (set (tuple21 c b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (set (tuple21 c b)))))) (sort
  (set1 (set1 (set1 (tuple2 c1 b1)))) (t2tb2153 x))))

(declare-fun tb2t2153 (uni) (set (set (set (tuple21 c b)))))

;; BridgeL
  (assert
  (forall ((i (set (set (set (tuple21 c b))))))
  (! (= (tb2t2153 (t2tb2153 i)) i) :pattern ((t2tb2153 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (set1 (tuple2 c1 b1)))) j)
     (= (t2tb2153 (tb2t2153 j)) j)) :pattern ((t2tb2153 (tb2t2153 j))) )))

;; mem_power
  (assert
  (forall ((s (set (set (tuple21 c b)))) (t (set (set (tuple21 c b)))))
  (= (mem (set1 (set1 (tuple2 c1 b1))) (t2tb308 s)
  (power (set1 (tuple2 c1 b1)) (t2tb308 t)))
  (forall ((x (set (tuple21 c b)))) (=> (mem31 x s) (mem31 x t))))))

;; mem_power
  (assert
  (forall ((s (set (tuple21 c b))) (t (set (tuple21 c b))))
  (= (mem31 s (tb2t308 (power (tuple2 c1 b1) (t2tb222 t))))
  (forall ((x (tuple21 c b))) (=> (mem28 x s) (mem28 x t))))))
...
;; mem_non_empty_power
  ...
  (forall ((s (set (set (tuple21 c b)))) (t (set (set (tuple21 c b)))))
  (= (mem (set1 (set1 (tuple2 c1 b1))) (t2tb308 s)
  (non_empty_power (set1 (tuple2 c1 b1)) (t2tb308 t)))
  (and (forall ((x (set (tuple21 c b)))) (=> (mem31 x s) (mem31 x t)))
  (not (infix_eqeq23 s (tb2t308 (empty (set1 (tuple2 c1 b1))))))))))

;; mem_non_empty_power
  (assert
  (forall ((s (set (tuple21 c b))) (t (set (tuple21 c b))))
  (= (mem31 s (tb2t308 (non_empty_power (tuple2 c1 b1) (t2tb222 t))))
...
(declare-fun relation8 ((set c) (set b)) (set (set (tuple21 c b))))

;; mem_relation
  (assert
  (forall ((a2 ty))
  (forall ((u uni) (v (set (set (tuple21 c b)))) (r uni))
  (and
  (=> (mem (set1 (tuple2 a2 (set1 (tuple2 c1 b1)))) r
  (relation (set1 (tuple2 c1 b1)) a2 u (t2tb308 v)))
  (forall ((x uni) (y (set (tuple21 c b))))
  (=> (mem (tuple2 a2 (set1 (tuple2 c1 b1)))
  (Tuple2 a2 (set1 (tuple2 c1 b1)) x (t2tb222 y)) r)
  (and (mem a2 x u) (mem31 y v)))))
  (=>
  (forall ((x uni) (y (set (tuple21 c b))))
  (=> (sort a2 x)
  (=> (mem (tuple2 a2 (set1 (tuple2 c1 b1)))
  (Tuple2 a2 (set1 (tuple2 c1 b1)) x (t2tb222 y)) r)
  (and (mem a2 x u) (mem31 y v))))) (mem
  (set1 (tuple2 a2 (set1 (tuple2 c1 b1)))) r
  (relation (set1 (tuple2 c1 b1)) a2 u (t2tb308 v))))))))
...
(declare-fun t2tb2154 ((set (set (tuple21 (set (tuple21 c b)) (set (tuple21 c
  b)))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (set (tuple21 c b)) (set (tuple21 c b)))))))
  (sort (set1 (set1 (tuple2 (set1 (tuple2 c1 b1)) (set1 (tuple2 c1 b1)))))
  (t2tb2154 x))))

(declare-fun tb2t2154 (uni) (set (set (tuple21 (set (tuple21 c b))
  (set (tuple21 c b))))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (set (tuple21 c b)) (set (tuple21 c b)))))))
  (! (= (tb2t2154 (t2tb2154 i)) i) :pattern ((t2tb2154 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort
     (set1 (set1 (tuple2 (set1 (tuple2 c1 b1)) (set1 (tuple2 c1 b1))))) j)
     (= (t2tb2154 (tb2t2154 j)) j)) :pattern ((t2tb2154 (tb2t2154 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (set (tuple21 c b)))) (v (set (set (tuple21 c b))))
  (r (set (tuple21 (set (tuple21 c b)) (set (tuple21 c b))))))
  (= (mem (set1 (tuple2 (set1 (tuple2 c1 b1)) (set1 (tuple2 c1 b1))))
  (t2tb2091 r)
  (relation (set1 (tuple2 c1 b1)) (set1 (tuple2 c1 b1)) (t2tb308 u)
  (t2tb308 v)))
  (forall ((x (set (tuple21 c b))) (y (set (tuple21 c b))))
  (=> (mem (tuple2 (set1 (tuple2 c1 b1)) (set1 (tuple2 c1 b1)))
  (Tuple2 (set1 (tuple2 c1 b1)) (set1 (tuple2 c1 b1)) (t2tb222 x)
  (t2tb222 y)) (t2tb2091 r)) (and (mem31 x u) (mem31 y v)))))))

(declare-fun t2tb2155 ((set (set (tuple21 (set (tuple21 c b)) (tuple21 c
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (set (tuple21 c b)) (tuple21 c b)))))) (sort
  (set1 (set1 (tuple2 (set1 (tuple2 c1 b1)) (tuple2 c1 b1)))) (t2tb2155 x))))

(declare-fun tb2t2155 (uni) (set (set (tuple21 (set (tuple21 c b)) (tuple21 c
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (set (tuple21 c b)) (tuple21 c b))))))
  (! (= (tb2t2155 (t2tb2155 i)) i) :pattern ((t2tb2155 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (set1 (tuple2 c1 b1)) (tuple2 c1 b1)))) j)
     (= (t2tb2155 (tb2t2155 j)) j)) :pattern ((t2tb2155 (tb2t2155 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (set (tuple21 c b)))) (v (set (tuple21 c b)))
  (r (set (tuple21 (set (tuple21 c b)) (tuple21 c b)))))
  (= (mem (set1 (tuple2 (set1 (tuple2 c1 b1)) (tuple2 c1 b1))) (t2tb2093 r)
  (relation (tuple2 c1 b1) (set1 (tuple2 c1 b1)) (t2tb308 u) (t2tb222 v)))
  (forall ((x (set (tuple21 c b))) (y (tuple21 c b)))
  (=> (mem (tuple2 (set1 (tuple2 c1 b1)) (tuple2 c1 b1))
  (Tuple2 (set1 (tuple2 c1 b1)) (tuple2 c1 b1) (t2tb222 x) (t2tb223 y))
  (t2tb2093 r)) (and (mem31 x u) (mem28 y v)))))))

(declare-fun t2tb2156 ((set (set (tuple21 (set (tuple21 c b)) (tuple21 a
  c))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (set (tuple21 c b)) (tuple21 a c)))))) (sort
  (set1 (set1 (tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 c1)))) (t2tb2156 x))))

(declare-fun tb2t2156 (uni) (set (set (tuple21 (set (tuple21 c b)) (tuple21 a
  c)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (set (tuple21 c b)) (tuple21 a c))))))
  (! (= (tb2t2156 (t2tb2156 i)) i) :pattern ((t2tb2156 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 c1)))) j)
     (= (t2tb2156 (tb2t2156 j)) j)) :pattern ((t2tb2156 (tb2t2156 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (set (tuple21 c b)))) (v (set (tuple21 a c)))
  (r (set (tuple21 (set (tuple21 c b)) (tuple21 a c)))))
  (= (mem (set1 (tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 c1))) (t2tb2095 r)
  (relation (tuple2 a1 c1) (set1 (tuple2 c1 b1)) (t2tb308 u) (t2tb129 v)))
  (forall ((x (set (tuple21 c b))) (y (tuple21 a c)))
  (=> (mem (tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 c1))
  (Tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 c1) (t2tb222 x) (t2tb133 y))
  (t2tb2095 r)) (and (mem31 x u) (mem10 y v)))))))

(declare-fun t2tb2157 ((set (set (tuple21 (set (tuple21 c b)) (tuple21 b
  c))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (set (tuple21 c b)) (tuple21 b c)))))) (sort
  (set1 (set1 (tuple2 (set1 (tuple2 c1 b1)) (tuple2 b1 c1)))) (t2tb2157 x))))

(declare-fun tb2t2157 (uni) (set (set (tuple21 (set (tuple21 c b)) (tuple21 b
  c)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (set (tuple21 c b)) (tuple21 b c))))))
  (! (= (tb2t2157 (t2tb2157 i)) i) :pattern ((t2tb2157 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (set1 (tuple2 c1 b1)) (tuple2 b1 c1)))) j)
     (= (t2tb2157 (tb2t2157 j)) j)) :pattern ((t2tb2157 (tb2t2157 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (set (tuple21 c b)))) (v (set (tuple21 b c)))
  (r (set (tuple21 (set (tuple21 c b)) (tuple21 b c)))))
  (= (mem (set1 (tuple2 (set1 (tuple2 c1 b1)) (tuple2 b1 c1))) (t2tb2097 r)
  (relation (tuple2 b1 c1) (set1 (tuple2 c1 b1)) (t2tb308 u) (t2tb131 v)))
  (forall ((x (set (tuple21 c b))) (y (tuple21 b c)))
  (=> (mem (tuple2 (set1 (tuple2 c1 b1)) (tuple2 b1 c1))
  (Tuple2 (set1 (tuple2 c1 b1)) (tuple2 b1 c1) (t2tb222 x) (t2tb134 y))
  (t2tb2097 r)) (and (mem31 x u) (mem8 y v)))))))

(declare-fun t2tb2158 ((set (set (tuple21 (set (tuple21 c b)) c)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (set (tuple21 c b)) c))))) (sort
  (set1 (set1 (tuple2 (set1 (tuple2 c1 b1)) c1))) (t2tb2158 x))))

(declare-fun tb2t2158 (uni) (set (set (tuple21 (set (tuple21 c b)) c))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (set (tuple21 c b)) c)))))
  (! (= (tb2t2158 (t2tb2158 i)) i) :pattern ((t2tb2158 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (set1 (tuple2 c1 b1)) c1))) j)
     (= (t2tb2158 (tb2t2158 j)) j)) :pattern ((t2tb2158 (tb2t2158 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (set (tuple21 c b)))) (v (set c))
  (r (set (tuple21 (set (tuple21 c b)) c))))
  (= (mem (set1 (tuple2 (set1 (tuple2 c1 b1)) c1)) (t2tb2099 r)
  (relation c1 (set1 (tuple2 c1 b1)) (t2tb308 u) (t2tb132 v)))
  (forall ((x (set (tuple21 c b))) (y c))
  (=> (mem (tuple2 (set1 (tuple2 c1 b1)) c1)
  (Tuple2 (set1 (tuple2 c1 b1)) c1 (t2tb222 x) (t2tb135 y)) (t2tb2099 r))
  (and (mem31 x u) (mem7 y v)))))))

(declare-fun t2tb2159 ((set (set (tuple21 (set (tuple21 c b)) (set (tuple21 a
  b)))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (set (tuple21 c b)) (set (tuple21 a b)))))))
  (sort (set1 (set1 (tuple2 (set1 (tuple2 c1 b1)) (set1 (tuple2 a1 b1)))))
  (t2tb2159 x))))

(declare-fun tb2t2159 (uni) (set (set (tuple21 (set (tuple21 c b))
  (set (tuple21 a b))))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (set (tuple21 c b)) (set (tuple21 a b)))))))
  (! (= (tb2t2159 (t2tb2159 i)) i) :pattern ((t2tb2159 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort
     (set1 (set1 (tuple2 (set1 (tuple2 c1 b1)) (set1 (tuple2 a1 b1))))) j)
     (= (t2tb2159 (tb2t2159 j)) j)) :pattern ((t2tb2159 (tb2t2159 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (set (tuple21 c b)))) (v (set (set (tuple21 a b))))
  (r (set (tuple21 (set (tuple21 c b)) (set (tuple21 a b))))))
  (= (mem (set1 (tuple2 (set1 (tuple2 c1 b1)) (set1 (tuple2 a1 b1))))
  (t2tb2101 r)
  (relation (set1 (tuple2 a1 b1)) (set1 (tuple2 c1 b1)) (t2tb308 u)
  (t2tb10 v)))
  (forall ((x (set (tuple21 c b))) (y (set (tuple21 a b))))
  (=> (mem (tuple2 (set1 (tuple2 c1 b1)) (set1 (tuple2 a1 b1)))
  (Tuple2 (set1 (tuple2 c1 b1)) (set1 (tuple2 a1 b1)) (t2tb222 x) (t2tb11 y))
  (t2tb2101 r)) (and (mem31 x u) (mem4 y v)))))))

(declare-fun t2tb2160 ((set (set (tuple21 (set (tuple21 c b)) (tuple21 a
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (set (tuple21 c b)) (tuple21 a b)))))) (sort
  (set1 (set1 (tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 b1)))) (t2tb2160 x))))

(declare-fun tb2t2160 (uni) (set (set (tuple21 (set (tuple21 c b)) (tuple21 a
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (set (tuple21 c b)) (tuple21 a b))))))
  (! (= (tb2t2160 (t2tb2160 i)) i) :pattern ((t2tb2160 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 b1)))) j)
     (= (t2tb2160 (tb2t2160 j)) j)) :pattern ((t2tb2160 (tb2t2160 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (set (tuple21 c b)))) (v (set (tuple21 a b)))
  (r (set (tuple21 (set (tuple21 c b)) (tuple21 a b)))))
  (= (mem (set1 (tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 b1))) (t2tb2103 r)
  (relation (tuple2 a1 b1) (set1 (tuple2 c1 b1)) (t2tb308 u) (t2tb11 v)))
  (forall ((x (set (tuple21 c b))) (y (tuple21 a b)))
  (=> (mem (tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 b1))
  (Tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 b1) (t2tb222 x) (t2tb13 y))
  (t2tb2103 r)) (and (mem31 x u) (mem3 y v)))))))

(declare-fun t2tb2161 ((set (set (tuple21 (set (tuple21 c b)) b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (set (tuple21 c b)) b))))) (sort
  (set1 (set1 (tuple2 (set1 (tuple2 c1 b1)) b1))) (t2tb2161 x))))

(declare-fun tb2t2161 (uni) (set (set (tuple21 (set (tuple21 c b)) b))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (set (tuple21 c b)) b)))))
  (! (= (tb2t2161 (t2tb2161 i)) i) :pattern ((t2tb2161 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (set1 (tuple2 c1 b1)) b1))) j)
     (= (t2tb2161 (tb2t2161 j)) j)) :pattern ((t2tb2161 (tb2t2161 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (set (tuple21 c b)))) (v (set b))
  (r (set (tuple21 (set (tuple21 c b)) b))))
  (= (mem (set1 (tuple2 (set1 (tuple2 c1 b1)) b1)) (t2tb2105 r)
  (relation b1 (set1 (tuple2 c1 b1)) (t2tb308 u) (t2tb12 v)))
  (forall ((x (set (tuple21 c b))) (y b))
  (=> (mem (tuple2 (set1 (tuple2 c1 b1)) b1)
  (Tuple2 (set1 (tuple2 c1 b1)) b1 (t2tb222 x) (t2tb14 y)) (t2tb2105 r))
  (and (mem31 x u) (mem2 y v)))))))

(declare-fun t2tb2162 ((set (set (tuple21 (set (tuple21 c b)) a)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (set (tuple21 c b)) a))))) (sort
  (set1 (set1 (tuple2 (set1 (tuple2 c1 b1)) a1))) (t2tb2162 x))))

(declare-fun tb2t2162 (uni) (set (set (tuple21 (set (tuple21 c b)) a))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (set (tuple21 c b)) a)))))
  (! (= (tb2t2162 (t2tb2162 i)) i) :pattern ((t2tb2162 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (set1 (tuple2 c1 b1)) a1))) j)
     (= (t2tb2162 (tb2t2162 j)) j)) :pattern ((t2tb2162 (tb2t2162 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (set (tuple21 c b)))) (v (set a))
  (r (set (tuple21 (set (tuple21 c b)) a))))
  (= (mem (set1 (tuple2 (set1 (tuple2 c1 b1)) a1)) (t2tb2107 r)
  (relation a1 (set1 (tuple2 c1 b1)) (t2tb308 u) (t2tb1 v)))
  (forall ((x (set (tuple21 c b))) (y a))
  (=> (mem (tuple2 (set1 (tuple2 c1 b1)) a1)
  (Tuple2 (set1 (tuple2 c1 b1)) a1 (t2tb222 x) (t2tb2 y)) (t2tb2107 r))
  (and (mem31 x u) (mem1 y v)))))))

;; mem_relation
  (assert
  (forall ((b2 ty))
  (forall ((u (set (set (tuple21 c b)))) (v uni) (r uni))
  (and
  (=> (mem (set1 (tuple2 (set1 (tuple2 c1 b1)) b2)) r
  (relation b2 (set1 (tuple2 c1 b1)) (t2tb308 u) v))
  (forall ((x (set (tuple21 c b))) (y uni))
  (=> (mem (tuple2 (set1 (tuple2 c1 b1)) b2)
  (Tuple2 (set1 (tuple2 c1 b1)) b2 (t2tb222 x) y) r)
  (and (mem31 x u) (mem b2 y v)))))
  (=>
  (forall ((x (set (tuple21 c b))) (y uni))
  (=> (sort b2 y)
  (=> (mem (tuple2 (set1 (tuple2 c1 b1)) b2)
  (Tuple2 (set1 (tuple2 c1 b1)) b2 (t2tb222 x) y) r)
  (and (mem31 x u) (mem b2 y v))))) (mem
  (set1 (tuple2 (set1 (tuple2 c1 b1)) b2)) r
  (relation b2 (set1 (tuple2 c1 b1)) (t2tb308 u) v)))))))

(declare-fun t2tb2163 ((set (set (tuple21 (tuple21 c b) (set (tuple21 c
  b)))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 c b) (set (tuple21 c b))))))) (sort
  (set1 (set1 (tuple2 (tuple2 c1 b1) (set1 (tuple2 c1 b1))))) (t2tb2163 x))))

(declare-fun tb2t2163 (uni) (set (set (tuple21 (tuple21 c b) (set (tuple21 c
  b))))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 c b) (set (tuple21 c b)))))))
  (! (= (tb2t2163 (t2tb2163 i)) i) :pattern ((t2tb2163 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 c1 b1) (set1 (tuple2 c1 b1))))) j)
     (= (t2tb2163 (tb2t2163 j)) j)) :pattern ((t2tb2163 (tb2t2163 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 c b))) (v (set (set (tuple21 c b))))
  (r (set (tuple21 (tuple21 c b) (set (tuple21 c b))))))
  (= (mem (set1 (tuple2 (tuple2 c1 b1) (set1 (tuple2 c1 b1)))) (t2tb2109 r)
  (relation (set1 (tuple2 c1 b1)) (tuple2 c1 b1) (t2tb222 u) (t2tb308 v)))
  (forall ((x (tuple21 c b)) (y (set (tuple21 c b))))
  (=> (mem (tuple2 (tuple2 c1 b1) (set1 (tuple2 c1 b1)))
  (Tuple2 (tuple2 c1 b1) (set1 (tuple2 c1 b1)) (t2tb223 x) (t2tb222 y))
  (t2tb2109 r)) (and (mem28 x u) (mem31 y v)))))))

(declare-fun t2tb2164 ((set (set (tuple21 (tuple21 c b) (tuple21 c
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 c b) (tuple21 c b)))))) (sort
  (set1 (set1 (tuple2 (tuple2 c1 b1) (tuple2 c1 b1)))) (t2tb2164 x))))

(declare-fun tb2t2164 (uni) (set (set (tuple21 (tuple21 c b) (tuple21 c
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 c b) (tuple21 c b))))))
  (! (= (tb2t2164 (t2tb2164 i)) i) :pattern ((t2tb2164 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 c1 b1) (tuple2 c1 b1)))) j)
     (= (t2tb2164 (tb2t2164 j)) j)) :pattern ((t2tb2164 (tb2t2164 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 c b))) (v (set (tuple21 c b)))
  (r (set (tuple21 (tuple21 c b) (tuple21 c b)))))
  (= (mem (set1 (tuple2 (tuple2 c1 b1) (tuple2 c1 b1))) (t2tb2111 r)
  (relation (tuple2 c1 b1) (tuple2 c1 b1) (t2tb222 u) (t2tb222 v)))
  (forall ((x (tuple21 c b)) (y (tuple21 c b)))
  (=> (mem (tuple2 (tuple2 c1 b1) (tuple2 c1 b1))
  (Tuple2 (tuple2 c1 b1) (tuple2 c1 b1) (t2tb223 x) (t2tb223 y))
  (t2tb2111 r)) (and (mem28 x u) (mem28 y v)))))))

(declare-fun t2tb2165 ((set (set (tuple21 (tuple21 c b) (tuple21 a
  c))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 c b) (tuple21 a c)))))) (sort
  (set1 (set1 (tuple2 (tuple2 c1 b1) (tuple2 a1 c1)))) (t2tb2165 x))))

(declare-fun tb2t2165 (uni) (set (set (tuple21 (tuple21 c b) (tuple21 a
  c)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 c b) (tuple21 a c))))))
  (! (= (tb2t2165 (t2tb2165 i)) i) :pattern ((t2tb2165 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 c1 b1) (tuple2 a1 c1)))) j)
     (= (t2tb2165 (tb2t2165 j)) j)) :pattern ((t2tb2165 (tb2t2165 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 c b))) (v (set (tuple21 a c)))
  (r (set (tuple21 (tuple21 c b) (tuple21 a c)))))
  (= (mem (set1 (tuple2 (tuple2 c1 b1) (tuple2 a1 c1))) (t2tb2113 r)
  (relation (tuple2 a1 c1) (tuple2 c1 b1) (t2tb222 u) (t2tb129 v)))
  (forall ((x (tuple21 c b)) (y (tuple21 a c)))
  (=> (mem (tuple2 (tuple2 c1 b1) (tuple2 a1 c1))
  (Tuple2 (tuple2 c1 b1) (tuple2 a1 c1) (t2tb223 x) (t2tb133 y))
  (t2tb2113 r)) (and (mem28 x u) (mem10 y v)))))))

(declare-fun t2tb2166 ((set (set (tuple21 (tuple21 c b) (tuple21 b
  c))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 c b) (tuple21 b c)))))) (sort
  (set1 (set1 (tuple2 (tuple2 c1 b1) (tuple2 b1 c1)))) (t2tb2166 x))))

(declare-fun tb2t2166 (uni) (set (set (tuple21 (tuple21 c b) (tuple21 b
  c)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 c b) (tuple21 b c))))))
  (! (= (tb2t2166 (t2tb2166 i)) i) :pattern ((t2tb2166 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 c1 b1) (tuple2 b1 c1)))) j)
     (= (t2tb2166 (tb2t2166 j)) j)) :pattern ((t2tb2166 (tb2t2166 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 c b))) (v (set (tuple21 b c)))
  (r (set (tuple21 (tuple21 c b) (tuple21 b c)))))
  (= (mem (set1 (tuple2 (tuple2 c1 b1) (tuple2 b1 c1))) (t2tb2115 r)
  (relation (tuple2 b1 c1) (tuple2 c1 b1) (t2tb222 u) (t2tb131 v)))
  (forall ((x (tuple21 c b)) (y (tuple21 b c)))
  (=> (mem (tuple2 (tuple2 c1 b1) (tuple2 b1 c1))
  (Tuple2 (tuple2 c1 b1) (tuple2 b1 c1) (t2tb223 x) (t2tb134 y))
  (t2tb2115 r)) (and (mem28 x u) (mem8 y v)))))))

(declare-fun t2tb2167 ((set (set (tuple21 (tuple21 c b) c)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 c b) c))))) (sort
  (set1 (set1 (tuple2 (tuple2 c1 b1) c1))) (t2tb2167 x))))

(declare-fun tb2t2167 (uni) (set (set (tuple21 (tuple21 c b) c))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 c b) c)))))
  (! (= (tb2t2167 (t2tb2167 i)) i) :pattern ((t2tb2167 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 c1 b1) c1))) j)
     (= (t2tb2167 (tb2t2167 j)) j)) :pattern ((t2tb2167 (tb2t2167 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 c b))) (v (set c)) (r (set (tuple21 (tuple21 c b)
  c))))
  (= (mem (set1 (tuple2 (tuple2 c1 b1) c1)) (t2tb2117 r)
  (relation c1 (tuple2 c1 b1) (t2tb222 u) (t2tb132 v)))
  (forall ((x (tuple21 c b)) (y c))
  (=> (mem (tuple2 (tuple2 c1 b1) c1)
  (Tuple2 (tuple2 c1 b1) c1 (t2tb223 x) (t2tb135 y)) (t2tb2117 r))
  (and (mem28 x u) (mem7 y v)))))))

(declare-fun t2tb2168 ((set (set (tuple21 (tuple21 c b) (set (tuple21 a
  b)))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 c b) (set (tuple21 a b))))))) (sort
  (set1 (set1 (tuple2 (tuple2 c1 b1) (set1 (tuple2 a1 b1))))) (t2tb2168 x))))

(declare-fun tb2t2168 (uni) (set (set (tuple21 (tuple21 c b) (set (tuple21 a
  b))))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 c b) (set (tuple21 a b)))))))
  (! (= (tb2t2168 (t2tb2168 i)) i) :pattern ((t2tb2168 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 c1 b1) (set1 (tuple2 a1 b1))))) j)
     (= (t2tb2168 (tb2t2168 j)) j)) :pattern ((t2tb2168 (tb2t2168 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 c b))) (v (set (set (tuple21 a b))))
  (r (set (tuple21 (tuple21 c b) (set (tuple21 a b))))))
  (= (mem (set1 (tuple2 (tuple2 c1 b1) (set1 (tuple2 a1 b1)))) (t2tb2119 r)
  (relation (set1 (tuple2 a1 b1)) (tuple2 c1 b1) (t2tb222 u) (t2tb10 v)))
  (forall ((x (tuple21 c b)) (y (set (tuple21 a b))))
  (=> (mem (tuple2 (tuple2 c1 b1) (set1 (tuple2 a1 b1)))
  (Tuple2 (tuple2 c1 b1) (set1 (tuple2 a1 b1)) (t2tb223 x) (t2tb11 y))
  (t2tb2119 r)) (and (mem28 x u) (mem4 y v)))))))

(declare-fun t2tb2169 ((set (set (tuple21 (tuple21 c b) (tuple21 a
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 c b) (tuple21 a b)))))) (sort
  (set1 (set1 (tuple2 (tuple2 c1 b1) (tuple2 a1 b1)))) (t2tb2169 x))))

(declare-fun tb2t2169 (uni) (set (set (tuple21 (tuple21 c b) (tuple21 a
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 c b) (tuple21 a b))))))
  (! (= (tb2t2169 (t2tb2169 i)) i) :pattern ((t2tb2169 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 c1 b1) (tuple2 a1 b1)))) j)
     (= (t2tb2169 (tb2t2169 j)) j)) :pattern ((t2tb2169 (tb2t2169 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 c b))) (v (set (tuple21 a b)))
  (r (set (tuple21 (tuple21 c b) (tuple21 a b)))))
  (= (mem (set1 (tuple2 (tuple2 c1 b1) (tuple2 a1 b1))) (t2tb2121 r)
  (relation (tuple2 a1 b1) (tuple2 c1 b1) (t2tb222 u) (t2tb11 v)))
  (forall ((x (tuple21 c b)) (y (tuple21 a b)))
  (=> (mem (tuple2 (tuple2 c1 b1) (tuple2 a1 b1))
  (Tuple2 (tuple2 c1 b1) (tuple2 a1 b1) (t2tb223 x) (t2tb13 y)) (t2tb2121 r))
  (and (mem28 x u) (mem3 y v)))))))

(declare-fun t2tb2170 ((set (set (tuple21 (tuple21 c b) b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 c b) b))))) (sort
  (set1 (set1 (tuple2 (tuple2 c1 b1) b1))) (t2tb2170 x))))

(declare-fun tb2t2170 (uni) (set (set (tuple21 (tuple21 c b) b))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 c b) b)))))
  (! (= (tb2t2170 (t2tb2170 i)) i) :pattern ((t2tb2170 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 c1 b1) b1))) j)
     (= (t2tb2170 (tb2t2170 j)) j)) :pattern ((t2tb2170 (tb2t2170 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 c b))) (v (set b)) (r (set (tuple21 (tuple21 c b)
  b))))
  (= (mem (set1 (tuple2 (tuple2 c1 b1) b1)) (t2tb2123 r)
  (relation b1 (tuple2 c1 b1) (t2tb222 u) (t2tb12 v)))
  (forall ((x (tuple21 c b)) (y b))
  (=> (mem (tuple2 (tuple2 c1 b1) b1)
  (Tuple2 (tuple2 c1 b1) b1 (t2tb223 x) (t2tb14 y)) (t2tb2123 r))
  (and (mem28 x u) (mem2 y v)))))))

(declare-fun t2tb2171 ((set (set (tuple21 (tuple21 c b) a)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 c b) a))))) (sort
  (set1 (set1 (tuple2 (tuple2 c1 b1) a1))) (t2tb2171 x))))

(declare-fun tb2t2171 (uni) (set (set (tuple21 (tuple21 c b) a))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 c b) a)))))
  (! (= (tb2t2171 (t2tb2171 i)) i) :pattern ((t2tb2171 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 c1 b1) a1))) j)
     (= (t2tb2171 (tb2t2171 j)) j)) :pattern ((t2tb2171 (tb2t2171 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 c b))) (v (set a)) (r (set (tuple21 (tuple21 c b)
  a))))
  (= (mem (set1 (tuple2 (tuple2 c1 b1) a1)) (t2tb2125 r)
  (relation a1 (tuple2 c1 b1) (t2tb222 u) (t2tb1 v)))
  (forall ((x (tuple21 c b)) (y a))
  (=> (mem (tuple2 (tuple2 c1 b1) a1)
  (Tuple2 (tuple2 c1 b1) a1 (t2tb223 x) (t2tb2 y)) (t2tb2125 r))
...
(declare-fun t2tb2172 ((set (set (tuple21 (tuple21 a c) (set (tuple21 c
  b)))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 a c) (set (tuple21 c b))))))) (sort
  (set1 (set1 (tuple2 (tuple2 a1 c1) (set1 (tuple2 c1 b1))))) (t2tb2172 x))))

(declare-fun tb2t2172 (uni) (set (set (tuple21 (tuple21 a c) (set (tuple21 c
  b))))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 a c) (set (tuple21 c b)))))))
  (! (= (tb2t2172 (t2tb2172 i)) i) :pattern ((t2tb2172 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 a1 c1) (set1 (tuple2 c1 b1))))) j)
     (= (t2tb2172 (tb2t2172 j)) j)) :pattern ((t2tb2172 (tb2t2172 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 a c))) (v (set (set (tuple21 c b))))
  (r (set (tuple21 (tuple21 a c) (set (tuple21 c b))))))
  (= (mem (set1 (tuple2 (tuple2 a1 c1) (set1 (tuple2 c1 b1)))) (t2tb2127 r)
  (relation (set1 (tuple2 c1 b1)) (tuple2 a1 c1) (t2tb129 u) (t2tb308 v)))
  (forall ((x (tuple21 a c)) (y (set (tuple21 c b))))
  (=> (mem (tuple2 (tuple2 a1 c1) (set1 (tuple2 c1 b1)))
  (Tuple2 (tuple2 a1 c1) (set1 (tuple2 c1 b1)) (t2tb133 x) (t2tb222 y))
  (t2tb2127 r)) (and (mem10 x u) (mem31 y v)))))))

(declare-fun t2tb2173 ((set (set (tuple21 (tuple21 a c) (tuple21 c
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 a c) (tuple21 c b)))))) (sort
  (set1 (set1 (tuple2 (tuple2 a1 c1) (tuple2 c1 b1)))) (t2tb2173 x))))

(declare-fun tb2t2173 (uni) (set (set (tuple21 (tuple21 a c) (tuple21 c
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 a c) (tuple21 c b))))))
  (! (= (tb2t2173 (t2tb2173 i)) i) :pattern ((t2tb2173 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 a1 c1) (tuple2 c1 b1)))) j)
     (= (t2tb2173 (tb2t2173 j)) j)) :pattern ((t2tb2173 (tb2t2173 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 a c))) (v (set (tuple21 c b)))
  (r (set (tuple21 (tuple21 a c) (tuple21 c b)))))
  (= (mem (set1 (tuple2 (tuple2 a1 c1) (tuple2 c1 b1))) (t2tb2129 r)
  (relation (tuple2 c1 b1) (tuple2 a1 c1) (t2tb129 u) (t2tb222 v)))
  (forall ((x (tuple21 a c)) (y (tuple21 c b)))
  (=> (mem (tuple2 (tuple2 a1 c1) (tuple2 c1 b1))
  (Tuple2 (tuple2 a1 c1) (tuple2 c1 b1) (t2tb133 x) (t2tb223 y))
  (t2tb2129 r)) (and (mem10 x u) (mem28 y v)))))))
...
(declare-fun t2tb2174 ((set (set (tuple21 (tuple21 b c) (set (tuple21 c
  b)))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 b c) (set (tuple21 c b))))))) (sort
  (set1 (set1 (tuple2 (tuple2 b1 c1) (set1 (tuple2 c1 b1))))) (t2tb2174 x))))

(declare-fun tb2t2174 (uni) (set (set (tuple21 (tuple21 b c) (set (tuple21 c
  b))))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 b c) (set (tuple21 c b)))))))
  (! (= (tb2t2174 (t2tb2174 i)) i) :pattern ((t2tb2174 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 b1 c1) (set1 (tuple2 c1 b1))))) j)
     (= (t2tb2174 (tb2t2174 j)) j)) :pattern ((t2tb2174 (tb2t2174 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 b c))) (v (set (set (tuple21 c b))))
  (r (set (tuple21 (tuple21 b c) (set (tuple21 c b))))))
  (= (mem (set1 (tuple2 (tuple2 b1 c1) (set1 (tuple2 c1 b1)))) (t2tb2131 r)
  (relation (set1 (tuple2 c1 b1)) (tuple2 b1 c1) (t2tb131 u) (t2tb308 v)))
  (forall ((x (tuple21 b c)) (y (set (tuple21 c b))))
  (=> (mem (tuple2 (tuple2 b1 c1) (set1 (tuple2 c1 b1)))
  (Tuple2 (tuple2 b1 c1) (set1 (tuple2 c1 b1)) (t2tb134 x) (t2tb222 y))
  (t2tb2131 r)) (and (mem8 x u) (mem31 y v)))))))

(declare-fun t2tb2175 ((set (set (tuple21 (tuple21 b c) (tuple21 c
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 b c) (tuple21 c b)))))) (sort
  (set1 (set1 (tuple2 (tuple2 b1 c1) (tuple2 c1 b1)))) (t2tb2175 x))))

(declare-fun tb2t2175 (uni) (set (set (tuple21 (tuple21 b c) (tuple21 c
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 b c) (tuple21 c b))))))
  (! (= (tb2t2175 (t2tb2175 i)) i) :pattern ((t2tb2175 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 b1 c1) (tuple2 c1 b1)))) j)
     (= (t2tb2175 (tb2t2175 j)) j)) :pattern ((t2tb2175 (tb2t2175 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 b c))) (v (set (tuple21 c b)))
  (r (set (tuple21 (tuple21 b c) (tuple21 c b)))))
  (= (mem (set1 (tuple2 (tuple2 b1 c1) (tuple2 c1 b1))) (t2tb2133 r)
  (relation (tuple2 c1 b1) (tuple2 b1 c1) (t2tb131 u) (t2tb222 v)))
  (forall ((x (tuple21 b c)) (y (tuple21 c b)))
  (=> (mem (tuple2 (tuple2 b1 c1) (tuple2 c1 b1))
  (Tuple2 (tuple2 b1 c1) (tuple2 c1 b1) (t2tb134 x) (t2tb223 y))
  (t2tb2133 r)) (and (mem8 x u) (mem28 y v)))))))
...
(declare-fun t2tb2176 ((set (set (tuple21 c (set (tuple21 c b)))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 c (set (tuple21 c b))))))) (sort
  (set1 (set1 (tuple2 c1 (set1 (tuple2 c1 b1))))) (t2tb2176 x))))

(declare-fun tb2t2176 (uni) (set (set (tuple21 c (set (tuple21 c b))))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 c (set (tuple21 c b)))))))
  (! (= (tb2t2176 (t2tb2176 i)) i) :pattern ((t2tb2176 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 c1 (set1 (tuple2 c1 b1))))) j)
     (= (t2tb2176 (tb2t2176 j)) j)) :pattern ((t2tb2176 (tb2t2176 j))) )))

;; mem_relation
  (assert
  (forall ((u (set c)) (v (set (set (tuple21 c b)))) (r (set (tuple21 c
  (set (tuple21 c b))))))
  (= (mem (set1 (tuple2 c1 (set1 (tuple2 c1 b1)))) (t2tb2135 r)
  (relation (set1 (tuple2 c1 b1)) c1 (t2tb132 u) (t2tb308 v)))
  (forall ((x c) (y (set (tuple21 c b))))
  (=> (mem (tuple2 c1 (set1 (tuple2 c1 b1)))
  (Tuple2 c1 (set1 (tuple2 c1 b1)) (t2tb135 x) (t2tb222 y)) (t2tb2135 r))
  (and (mem7 x u) (mem31 y v)))))))

(declare-fun t2tb2177 ((set (set (tuple21 c (tuple21 c b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 c (tuple21 c b)))))) (sort
  (set1 (set1 (tuple2 c1 (tuple2 c1 b1)))) (t2tb2177 x))))

(declare-fun tb2t2177 (uni) (set (set (tuple21 c (tuple21 c b)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 c (tuple21 c b))))))
  (! (= (tb2t2177 (t2tb2177 i)) i) :pattern ((t2tb2177 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 c1 (tuple2 c1 b1)))) j)
     (= (t2tb2177 (tb2t2177 j)) j)) :pattern ((t2tb2177 (tb2t2177 j))) )))

;; mem_relation
  (assert
  (forall ((u (set c)) (v (set (tuple21 c b))) (r (set (tuple21 c (tuple21 c
  b)))))
  (= (mem (set1 (tuple2 c1 (tuple2 c1 b1))) (t2tb2137 r)
  (relation (tuple2 c1 b1) c1 (t2tb132 u) (t2tb222 v)))
  (forall ((x c) (y (tuple21 c b)))
  (=> (mem (tuple2 c1 (tuple2 c1 b1))
  (Tuple2 c1 (tuple2 c1 b1) (t2tb135 x) (t2tb223 y)) (t2tb2137 r))
...
(declare-fun t2tb2178 ((set (set (tuple21 (set (tuple21 a b)) (set (tuple21 c
  b)))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (set (tuple21 a b)) (set (tuple21 c b)))))))
  (sort (set1 (set1 (tuple2 (set1 (tuple2 a1 b1)) (set1 (tuple2 c1 b1)))))
  (t2tb2178 x))))

(declare-fun tb2t2178 (uni) (set (set (tuple21 (set (tuple21 a b))
  (set (tuple21 c b))))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (set (tuple21 a b)) (set (tuple21 c b)))))))
  (! (= (tb2t2178 (t2tb2178 i)) i) :pattern ((t2tb2178 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort
     (set1 (set1 (tuple2 (set1 (tuple2 a1 b1)) (set1 (tuple2 c1 b1))))) j)
     (= (t2tb2178 (tb2t2178 j)) j)) :pattern ((t2tb2178 (tb2t2178 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (set (tuple21 a b)))) (v (set (set (tuple21 c b))))
  (r (set (tuple21 (set (tuple21 a b)) (set (tuple21 c b))))))
  (= (mem (set1 (tuple2 (set1 (tuple2 a1 b1)) (set1 (tuple2 c1 b1))))
  (t2tb2139 r)
  (relation (set1 (tuple2 c1 b1)) (set1 (tuple2 a1 b1)) (t2tb10 u)
  (t2tb308 v)))
  (forall ((x (set (tuple21 a b))) (y (set (tuple21 c b))))
  (=> (mem (tuple2 (set1 (tuple2 a1 b1)) (set1 (tuple2 c1 b1)))
  (Tuple2 (set1 (tuple2 a1 b1)) (set1 (tuple2 c1 b1)) (t2tb11 x) (t2tb222 y))
  (t2tb2139 r)) (and (mem4 x u) (mem31 y v)))))))

(declare-fun t2tb2179 ((set (set (tuple21 (set (tuple21 a b)) (tuple21 c
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (set (tuple21 a b)) (tuple21 c b)))))) (sort
  (set1 (set1 (tuple2 (set1 (tuple2 a1 b1)) (tuple2 c1 b1)))) (t2tb2179 x))))

(declare-fun tb2t2179 (uni) (set (set (tuple21 (set (tuple21 a b)) (tuple21 c
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (set (tuple21 a b)) (tuple21 c b))))))
  (! (= (tb2t2179 (t2tb2179 i)) i) :pattern ((t2tb2179 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (set1 (tuple2 a1 b1)) (tuple2 c1 b1)))) j)
     (= (t2tb2179 (tb2t2179 j)) j)) :pattern ((t2tb2179 (tb2t2179 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (set (tuple21 a b)))) (v (set (tuple21 c b)))
  (r (set (tuple21 (set (tuple21 a b)) (tuple21 c b)))))
  (= (mem (set1 (tuple2 (set1 (tuple2 a1 b1)) (tuple2 c1 b1))) (t2tb2141 r)
  (relation (tuple2 c1 b1) (set1 (tuple2 a1 b1)) (t2tb10 u) (t2tb222 v)))
  (forall ((x (set (tuple21 a b))) (y (tuple21 c b)))
  (=> (mem (tuple2 (set1 (tuple2 a1 b1)) (tuple2 c1 b1))
  (Tuple2 (set1 (tuple2 a1 b1)) (tuple2 c1 b1) (t2tb11 x) (t2tb223 y))
  (t2tb2141 r)) (and (mem4 x u) (mem28 y v)))))))
...
(declare-fun t2tb2180 ((set (set (tuple21 (tuple21 a b) (set (tuple21 c
  b)))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 a b) (set (tuple21 c b))))))) (sort
  (set1 (set1 (tuple2 (tuple2 a1 b1) (set1 (tuple2 c1 b1))))) (t2tb2180 x))))

(declare-fun tb2t2180 (uni) (set (set (tuple21 (tuple21 a b) (set (tuple21 c
  b))))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 a b) (set (tuple21 c b)))))))
  (! (= (tb2t2180 (t2tb2180 i)) i) :pattern ((t2tb2180 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 a1 b1) (set1 (tuple2 c1 b1))))) j)
     (= (t2tb2180 (tb2t2180 j)) j)) :pattern ((t2tb2180 (tb2t2180 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 a b))) (v (set (set (tuple21 c b))))
  (r (set (tuple21 (tuple21 a b) (set (tuple21 c b))))))
  (= (mem (set1 (tuple2 (tuple2 a1 b1) (set1 (tuple2 c1 b1)))) (t2tb2143 r)
  (relation (set1 (tuple2 c1 b1)) (tuple2 a1 b1) (t2tb11 u) (t2tb308 v)))
  (forall ((x (tuple21 a b)) (y (set (tuple21 c b))))
  (=> (mem (tuple2 (tuple2 a1 b1) (set1 (tuple2 c1 b1)))
  (Tuple2 (tuple2 a1 b1) (set1 (tuple2 c1 b1)) (t2tb13 x) (t2tb222 y))
  (t2tb2143 r)) (and (mem3 x u) (mem31 y v)))))))

(declare-fun t2tb2181 ((set (set (tuple21 (tuple21 a b) (tuple21 c
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 a b) (tuple21 c b)))))) (sort
  (set1 (set1 (tuple2 (tuple2 a1 b1) (tuple2 c1 b1)))) (t2tb2181 x))))

(declare-fun tb2t2181 (uni) (set (set (tuple21 (tuple21 a b) (tuple21 c
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 a b) (tuple21 c b))))))
  (! (= (tb2t2181 (t2tb2181 i)) i) :pattern ((t2tb2181 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 a1 b1) (tuple2 c1 b1)))) j)
     (= (t2tb2181 (tb2t2181 j)) j)) :pattern ((t2tb2181 (tb2t2181 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 a b))) (v (set (tuple21 c b)))
  (r (set (tuple21 (tuple21 a b) (tuple21 c b)))))
  (= (mem (set1 (tuple2 (tuple2 a1 b1) (tuple2 c1 b1))) (t2tb2145 r)
  (relation (tuple2 c1 b1) (tuple2 a1 b1) (t2tb11 u) (t2tb222 v)))
  (forall ((x (tuple21 a b)) (y (tuple21 c b)))
  (=> (mem (tuple2 (tuple2 a1 b1) (tuple2 c1 b1))
  (Tuple2 (tuple2 a1 b1) (tuple2 c1 b1) (t2tb13 x) (t2tb223 y)) (t2tb2145 r))
...
(declare-fun t2tb2182 ((set (set (tuple21 b (set (tuple21 c b)))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 b (set (tuple21 c b))))))) (sort
  (set1 (set1 (tuple2 b1 (set1 (tuple2 c1 b1))))) (t2tb2182 x))))

(declare-fun tb2t2182 (uni) (set (set (tuple21 b (set (tuple21 c b))))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 b (set (tuple21 c b)))))))
  (! (= (tb2t2182 (t2tb2182 i)) i) :pattern ((t2tb2182 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 b1 (set1 (tuple2 c1 b1))))) j)
     (= (t2tb2182 (tb2t2182 j)) j)) :pattern ((t2tb2182 (tb2t2182 j))) )))

;; mem_relation
  (assert
  (forall ((u (set b)) (v (set (set (tuple21 c b)))) (r (set (tuple21 b
  (set (tuple21 c b))))))
  (= (mem (set1 (tuple2 b1 (set1 (tuple2 c1 b1)))) (t2tb2147 r)
  (relation (set1 (tuple2 c1 b1)) b1 (t2tb12 u) (t2tb308 v)))
  (forall ((x b) (y (set (tuple21 c b))))
  (=> (mem (tuple2 b1 (set1 (tuple2 c1 b1)))
  (Tuple2 b1 (set1 (tuple2 c1 b1)) (t2tb14 x) (t2tb222 y)) (t2tb2147 r))
  (and (mem2 x u) (mem31 y v)))))))

(declare-fun t2tb2183 ((set (set (tuple21 b (tuple21 c b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 b (tuple21 c b)))))) (sort
  (set1 (set1 (tuple2 b1 (tuple2 c1 b1)))) (t2tb2183 x))))

(declare-fun tb2t2183 (uni) (set (set (tuple21 b (tuple21 c b)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 b (tuple21 c b))))))
  (! (= (tb2t2183 (t2tb2183 i)) i) :pattern ((t2tb2183 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 b1 (tuple2 c1 b1)))) j)
     (= (t2tb2183 (tb2t2183 j)) j)) :pattern ((t2tb2183 (tb2t2183 j))) )))

;; mem_relation
  (assert
  (forall ((u (set b)) (v (set (tuple21 c b))) (r (set (tuple21 b (tuple21 c
  b)))))
  (= (mem (set1 (tuple2 b1 (tuple2 c1 b1))) (t2tb2149 r)
  (relation (tuple2 c1 b1) b1 (t2tb12 u) (t2tb222 v)))
  (forall ((x b) (y (tuple21 c b)))
  (=> (mem (tuple2 b1 (tuple2 c1 b1))
  (Tuple2 b1 (tuple2 c1 b1) (t2tb14 x) (t2tb223 y)) (t2tb2149 r))
...
(declare-fun t2tb2184 ((set (set (tuple21 a (set (tuple21 c b)))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 a (set (tuple21 c b))))))) (sort
  (set1 (set1 (tuple2 a1 (set1 (tuple2 c1 b1))))) (t2tb2184 x))))

(declare-fun tb2t2184 (uni) (set (set (tuple21 a (set (tuple21 c b))))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 a (set (tuple21 c b)))))))
  (! (= (tb2t2184 (t2tb2184 i)) i) :pattern ((t2tb2184 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 a1 (set1 (tuple2 c1 b1))))) j)
     (= (t2tb2184 (tb2t2184 j)) j)) :pattern ((t2tb2184 (tb2t2184 j))) )))

;; mem_relation
  (assert
  (forall ((u (set a)) (v (set (set (tuple21 c b)))) (r (set (tuple21 a
  (set (tuple21 c b))))))
  (= (mem (set1 (tuple2 a1 (set1 (tuple2 c1 b1)))) (t2tb2151 r)
  (relation (set1 (tuple2 c1 b1)) a1 (t2tb1 u) (t2tb308 v)))
  (forall ((x a) (y (set (tuple21 c b))))
  (=> (mem (tuple2 a1 (set1 (tuple2 c1 b1)))
  (Tuple2 a1 (set1 (tuple2 c1 b1)) (t2tb2 x) (t2tb222 y)) (t2tb2151 r))
  (and (mem1 x u) (mem31 y v)))))))

(declare-fun t2tb2185 ((set (set (tuple21 a (tuple21 c b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 a (tuple21 c b)))))) (sort
  (set1 (set1 (tuple2 a1 (tuple2 c1 b1)))) (t2tb2185 x))))

(declare-fun tb2t2185 (uni) (set (set (tuple21 a (tuple21 c b)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 a (tuple21 c b))))))
  (! (= (tb2t2185 (t2tb2185 i)) i) :pattern ((t2tb2185 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 a1 (tuple2 c1 b1)))) j)
     (= (t2tb2185 (tb2t2185 j)) j)) :pattern ((t2tb2185 (tb2t2185 j))) )))
...
;; mem_dom
  (assert
  (forall ((b2 ty))
  (forall ((p uni) (x (set (tuple21 c b))))
  (and
  (=> (mem31 x (tb2t308 (dom b2 (set1 (tuple2 c1 b1)) p)))
  (exists ((b3 uni))
  (and (sort b2 b3) (mem (tuple2 (set1 (tuple2 c1 b1)) b2)
  (Tuple2 (set1 (tuple2 c1 b1)) b2 (t2tb222 x) b3) p))))
  (=>
  (exists ((b3 uni)) (mem (tuple2 (set1 (tuple2 c1 b1)) b2)
  (Tuple2 (set1 (tuple2 c1 b1)) b2 (t2tb222 x) b3) p)) (mem31 x
  (tb2t308 (dom b2 (set1 (tuple2 c1 b1)) p))))))))
...
;; mem_ran
  ...
  (forall ((p uni) (x (set (tuple21 c b))))
  (and
  (=> (mem31 x (tb2t308 (ran (set1 (tuple2 c1 b1)) a2 p)))
  (exists ((a3 uni))
  (and (sort a2 a3) (mem (tuple2 a2 (set1 (tuple2 c1 b1)))
  (Tuple2 a2 (set1 (tuple2 c1 b1)) a3 (t2tb222 x)) p))))
  (=>
  (exists ((a3 uni)) (mem (tuple2 a2 (set1 (tuple2 c1 b1)))
  (Tuple2 a2 (set1 (tuple2 c1 b1)) a3 (t2tb222 x)) p)) (mem31 x
  (tb2t308 (ran (set1 (tuple2 c1 b1)) a2 p))))))))
...
;; mem_semicolon
  ...
  (= (mem28 (tb2t223 (Tuple2 c1 b1 (t2tb135 x) (t2tb14 y)))
  (tb2t222 (semicolon b1 a1 c1 (t2tb224 p) (t2tb11 q))))
  (exists ((b2 a))
...
;; mem_id
  (assert
  (forall ((u (set (set (tuple21 c b)))) (x (set (tuple21 c b)))
  (y (set (tuple21 c b))))
  (= (mem (tuple2 (set1 (tuple2 c1 b1)) (set1 (tuple2 c1 b1)))
  (Tuple2 (set1 (tuple2 c1 b1)) (set1 (tuple2 c1 b1)) (t2tb222 x)
  (t2tb222 y)) (id (set1 (tuple2 c1 b1)) (t2tb308 u)))
  (and (mem31 x u) (= x y)))))
...
;; mem_domain_restriction
  (assert
  (forall ((b2 ty))
  (forall ((p uni) (s (set (set (tuple21 c b)))) (x (set (tuple21 c b)))
  (y uni))
  (= (mem (tuple2 (set1 (tuple2 c1 b1)) b2)
  (Tuple2 (set1 (tuple2 c1 b1)) b2 (t2tb222 x) y)
  (domain_restriction b2 (set1 (tuple2 c1 b1)) (t2tb308 s) p))
  (and (mem (tuple2 (set1 (tuple2 c1 b1)) b2)
  (Tuple2 (set1 (tuple2 c1 b1)) b2 (t2tb222 x) y) p) (mem31 x s))))))
...
;; mem_range_restriction
  (assert
  (forall ((a2 ty))
  (forall ((p uni) (t (set (set (tuple21 c b)))) (x uni) (y (set (tuple21 c
  b))))
  (= (mem (tuple2 a2 (set1 (tuple2 c1 b1)))
  (Tuple2 a2 (set1 (tuple2 c1 b1)) x (t2tb222 y))
  (range_restriction (set1 (tuple2 c1 b1)) a2 p (t2tb308 t)))
  (and (mem (tuple2 a2 (set1 (tuple2 c1 b1)))
  (Tuple2 a2 (set1 (tuple2 c1 b1)) x (t2tb222 y)) p) (mem31 y t))))))
...
;; mem_domain_substraction
  ...
  (= (mem (tuple2 (set1 (tuple2 c1 b1)) b2)
  (Tuple2 (set1 (tuple2 c1 b1)) b2 (t2tb222 x) y)
  (domain_substraction b2 (set1 (tuple2 c1 b1)) (t2tb308 s) p))
  (and (mem (tuple2 (set1 (tuple2 c1 b1)) b2)
  (Tuple2 (set1 (tuple2 c1 b1)) b2 (t2tb222 x) y) p) (not (mem31 x s)))))))
...
;; mem_range_substraction
  ...
  (= (mem (tuple2 a2 (set1 (tuple2 c1 b1)))
  (Tuple2 a2 (set1 (tuple2 c1 b1)) x (t2tb222 y))
  (range_substraction (set1 (tuple2 c1 b1)) a2 p (t2tb308 t)))
  (and (mem (tuple2 a2 (set1 (tuple2 c1 b1)))
  (Tuple2 a2 (set1 (tuple2 c1 b1)) x (t2tb222 y)) p) (not (mem31 y t)))))))
...
;; mem_image
  (assert
  (forall ((a2 ty))
  (forall ((p uni) (w uni) (x (set (tuple21 c b))))
  (and
  (=> (mem31 x (tb2t308 (image (set1 (tuple2 c1 b1)) a2 p w)))
  (exists ((a3 uni))
  (and (sort a2 a3)
  (and (mem a2 a3 w) (mem (tuple2 a2 (set1 (tuple2 c1 b1)))
  (Tuple2 a2 (set1 (tuple2 c1 b1)) a3 (t2tb222 x)) p)))))
  (=>
  (exists ((a3 uni))
  (and (mem a2 a3 w) (mem (tuple2 a2 (set1 (tuple2 c1 b1)))
  (Tuple2 a2 (set1 (tuple2 c1 b1)) a3 (t2tb222 x)) p))) (mem31 x
  (tb2t308 (image (set1 (tuple2 c1 b1)) a2 p w))))))))
...
;; mem_image
  (assert
  (forall ((p (set (tuple21 (set (tuple21 c b)) (set (tuple21 c b)))))
  (w (set (set (tuple21 c b)))) (x (set (tuple21 c b))))
  (= (mem31 x
  (tb2t308
  (image (set1 (tuple2 c1 b1)) (set1 (tuple2 c1 b1)) (t2tb2091 p)
  (t2tb308 w))))
  (exists ((a2 (set (tuple21 c b))))
  (and (mem31 a2 w) (mem (tuple2 (set1 (tuple2 c1 b1)) (set1 (tuple2 c1 b1)))
  (Tuple2 (set1 (tuple2 c1 b1)) (set1 (tuple2 c1 b1)) (t2tb222 a2)
  (t2tb222 x)) (t2tb2091 p)))))))

;; mem_image
  (assert
  (forall ((p (set (tuple21 (set (tuple21 c b)) (tuple21 c b))))
  (w (set (set (tuple21 c b)))) (x (tuple21 c b)))
  (= (mem28 x
  (tb2t222
  (image (tuple2 c1 b1) (set1 (tuple2 c1 b1)) (t2tb2093 p) (t2tb308 w))))
  (exists ((a2 (set (tuple21 c b))))
  (and (mem31 a2 w) (mem (tuple2 (set1 (tuple2 c1 b1)) (tuple2 c1 b1))
  (Tuple2 (set1 (tuple2 c1 b1)) (tuple2 c1 b1) (t2tb222 a2) (t2tb223 x))
  (t2tb2093 p)))))))

;; mem_image
  (assert
  (forall ((p (set (tuple21 (set (tuple21 c b)) (tuple21 a c))))
  (w (set (set (tuple21 c b)))) (x (tuple21 a c)))
  (= (mem10 x
  (tb2t129
  (image (tuple2 a1 c1) (set1 (tuple2 c1 b1)) (t2tb2095 p) (t2tb308 w))))
  (exists ((a2 (set (tuple21 c b))))
  (and (mem31 a2 w) (mem (tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 c1))
  (Tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 c1) (t2tb222 a2) (t2tb133 x))
  (t2tb2095 p)))))))

;; mem_image
  (assert
  (forall ((p (set (tuple21 (set (tuple21 c b)) (tuple21 b c))))
  (w (set (set (tuple21 c b)))) (x (tuple21 b c)))
  (= (mem8 x
  (tb2t131
  (image (tuple2 b1 c1) (set1 (tuple2 c1 b1)) (t2tb2097 p) (t2tb308 w))))
  (exists ((a2 (set (tuple21 c b))))
  (and (mem31 a2 w) (mem (tuple2 (set1 (tuple2 c1 b1)) (tuple2 b1 c1))
  (Tuple2 (set1 (tuple2 c1 b1)) (tuple2 b1 c1) (t2tb222 a2) (t2tb134 x))
  (t2tb2097 p)))))))

;; mem_image
  (assert
  (forall ((p (set (tuple21 (set (tuple21 c b)) c))) (w (set (set (tuple21 c
  b)))) (x c))
  (= (mem7 x
  (tb2t132 (image c1 (set1 (tuple2 c1 b1)) (t2tb2099 p) (t2tb308 w))))
  (exists ((a2 (set (tuple21 c b))))
  (and (mem31 a2 w) (mem (tuple2 (set1 (tuple2 c1 b1)) c1)
  (Tuple2 (set1 (tuple2 c1 b1)) c1 (t2tb222 a2) (t2tb135 x)) (t2tb2099 p)))))))

;; mem_image
  (assert
  (forall ((p (set (tuple21 (set (tuple21 c b)) (set (tuple21 a b)))))
  (w (set (set (tuple21 c b)))) (x (set (tuple21 a b))))
  (= (mem4 x
  (tb2t10
  (image (set1 (tuple2 a1 b1)) (set1 (tuple2 c1 b1)) (t2tb2101 p)
  (t2tb308 w))))
  (exists ((a2 (set (tuple21 c b))))
  (and (mem31 a2 w) (mem (tuple2 (set1 (tuple2 c1 b1)) (set1 (tuple2 a1 b1)))
  (Tuple2 (set1 (tuple2 c1 b1)) (set1 (tuple2 a1 b1)) (t2tb222 a2)
  (t2tb11 x)) (t2tb2101 p)))))))

;; mem_image
  (assert
  (forall ((p (set (tuple21 (set (tuple21 c b)) (tuple21 a b))))
  (w (set (set (tuple21 c b)))) (x (tuple21 a b)))
  (= (mem3 x
  (tb2t11
  (image (tuple2 a1 b1) (set1 (tuple2 c1 b1)) (t2tb2103 p) (t2tb308 w))))
  (exists ((a2 (set (tuple21 c b))))
  (and (mem31 a2 w) (mem (tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 b1))
  (Tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 b1) (t2tb222 a2) (t2tb13 x))
  (t2tb2103 p)))))))

;; mem_image
  (assert
  (forall ((p (set (tuple21 (set (tuple21 c b)) b))) (w (set (set (tuple21 c
  b)))) (x b))
  (= (mem2 x
  (tb2t12 (image b1 (set1 (tuple2 c1 b1)) (t2tb2105 p) (t2tb308 w))))
  (exists ((a2 (set (tuple21 c b))))
  (and (mem31 a2 w) (mem (tuple2 (set1 (tuple2 c1 b1)) b1)
  (Tuple2 (set1 (tuple2 c1 b1)) b1 (t2tb222 a2) (t2tb14 x)) (t2tb2105 p)))))))

;; mem_image
  (assert
  (forall ((p (set (tuple21 (set (tuple21 c b)) a))) (w (set (set (tuple21 c
  b)))) (x a))
  (= (mem1 x
  (tb2t1 (image a1 (set1 (tuple2 c1 b1)) (t2tb2107 p) (t2tb308 w))))
  (exists ((a2 (set (tuple21 c b))))
  (and (mem31 a2 w) (mem (tuple2 (set1 (tuple2 c1 b1)) a1)
  (Tuple2 (set1 (tuple2 c1 b1)) a1 (t2tb222 a2) (t2tb2 x)) (t2tb2107 p)))))))

;; mem_image
  (assert
  (forall ((b2 ty))
  (forall ((p uni) (w (set (set (tuple21 c b)))) (x uni))
  (= (mem b2 x (image b2 (set1 (tuple2 c1 b1)) p (t2tb308 w)))
  (exists ((a2 (set (tuple21 c b))))
  (and (mem31 a2 w) (mem (tuple2 (set1 (tuple2 c1 b1)) b2)
  (Tuple2 (set1 (tuple2 c1 b1)) b2 (t2tb222 a2) x) p)))))))

;; mem_image
  (assert
  (forall ((p (set (tuple21 (tuple21 c b) (set (tuple21 c b)))))
  (w (set (tuple21 c b))) (x (set (tuple21 c b))))
  (= (mem31 x
  (tb2t308
  (image (set1 (tuple2 c1 b1)) (tuple2 c1 b1) (t2tb2109 p) (t2tb222 w))))
  (exists ((a2 (tuple21 c b)))
  (and (mem28 a2 w) (mem (tuple2 (tuple2 c1 b1) (set1 (tuple2 c1 b1)))
  (Tuple2 (tuple2 c1 b1) (set1 (tuple2 c1 b1)) (t2tb223 a2) (t2tb222 x))
  (t2tb2109 p)))))))
...
;; mem_image
  ...
  b))) (x (tuple21 c b)))
  (= (mem28 x
  (tb2t222 (image (tuple2 c1 b1) (tuple2 c1 b1) (t2tb2111 p) (t2tb222 w))))
  (exists ((a2 (tuple21 c b)))
...
;; mem_image
  ...
  b))) (x (tuple21 a c)))
  (= (mem10 x
  (tb2t129 (image (tuple2 a1 c1) (tuple2 c1 b1) (t2tb2113 p) (t2tb222 w))))
  (exists ((a2 (tuple21 c b)))
...
;; mem_image
  ...
  b))) (x (tuple21 b c)))
  (= (mem8 x
  (tb2t131 (image (tuple2 b1 c1) (tuple2 c1 b1) (t2tb2115 p) (t2tb222 w))))
  (exists ((a2 (tuple21 c b)))
...
;; mem_image
  ...
  (= (mem7 x (tb2t132 (image c1 (tuple2 c1 b1) (t2tb2117 p) (t2tb222 w))))
  (exists ((a2 (tuple21 c b)))
  (and (mem28 a2 w) (mem (tuple2 (tuple2 c1 b1) c1)
  (Tuple2 (tuple2 c1 b1) c1 (t2tb223 a2) (t2tb135 x)) (t2tb2117 p)))))))
...
;; mem_image
  ...
  (= (mem4 x
  (tb2t10
  (image (set1 (tuple2 a1 b1)) (tuple2 c1 b1) (t2tb2119 p) (t2tb222 w))))
  (exists ((a2 (tuple21 c b)))
...
;; mem_image
  ...
  b))) (x (tuple21 a b)))
  (= (mem3 x
  (tb2t11 (image (tuple2 a1 b1) (tuple2 c1 b1) (t2tb2121 p) (t2tb222 w))))
  (exists ((a2 (tuple21 c b)))
...
;; mem_image
  ...
  (= (mem2 x (tb2t12 (image b1 (tuple2 c1 b1) (t2tb2123 p) (t2tb222 w))))
  (exists ((a2 (tuple21 c b)))
  (and (mem28 a2 w) (mem (tuple2 (tuple2 c1 b1) b1)
  (Tuple2 (tuple2 c1 b1) b1 (t2tb223 a2) (t2tb14 x)) (t2tb2123 p)))))))

;; mem_image
  (assert
  (forall ((p (set (tuple21 (tuple21 c b) a))) (w (set (tuple21 c b))) (x a))
  (= (mem1 x (tb2t1 (image a1 (tuple2 c1 b1) (t2tb2125 p) (t2tb222 w))))
  (exists ((a2 (tuple21 c b)))
  (and (mem28 a2 w) (mem (tuple2 (tuple2 c1 b1) a1)
  (Tuple2 (tuple2 c1 b1) a1 (t2tb223 a2) (t2tb2 x)) (t2tb2125 p)))))))
...
;; mem_image
  (assert
  (forall ((p (set (tuple21 (tuple21 a c) (set (tuple21 c b)))))
  (w (set (tuple21 a c))) (x (set (tuple21 c b))))
  (= (mem31 x
  (tb2t308
  (image (set1 (tuple2 c1 b1)) (tuple2 a1 c1) (t2tb2127 p) (t2tb129 w))))
  (exists ((a2 (tuple21 a c)))
  (and (mem10 a2 w) (mem (tuple2 (tuple2 a1 c1) (set1 (tuple2 c1 b1)))
  (Tuple2 (tuple2 a1 c1) (set1 (tuple2 c1 b1)) (t2tb133 a2) (t2tb222 x))
  (t2tb2127 p)))))))
...
;; mem_image
  ...
  c))) (x (tuple21 c b)))
  (= (mem28 x
  (tb2t222 (image (tuple2 c1 b1) (tuple2 a1 c1) (t2tb2129 p) (t2tb129 w))))
  (exists ((a2 (tuple21 a c)))
...
;; mem_image
  (assert
  (forall ((p (set (tuple21 (tuple21 b c) (set (tuple21 c b)))))
  (w (set (tuple21 b c))) (x (set (tuple21 c b))))
  (= (mem31 x
  (tb2t308
  (image (set1 (tuple2 c1 b1)) (tuple2 b1 c1) (t2tb2131 p) (t2tb131 w))))
  (exists ((a2 (tuple21 b c)))
  (and (mem8 a2 w) (mem (tuple2 (tuple2 b1 c1) (set1 (tuple2 c1 b1)))
  (Tuple2 (tuple2 b1 c1) (set1 (tuple2 c1 b1)) (t2tb134 a2) (t2tb222 x))
  (t2tb2131 p)))))))
...
;; mem_image
  ...
  c))) (x (tuple21 c b)))
  (= (mem28 x
  (tb2t222 (image (tuple2 c1 b1) (tuple2 b1 c1) (t2tb2133 p) (t2tb131 w))))
  (exists ((a2 (tuple21 b c)))
...
;; mem_image
  (assert
  (forall ((p (set (tuple21 c (set (tuple21 c b))))) (w (set c))
  (x (set (tuple21 c b))))
  (= (mem31 x
  (tb2t308 (image (set1 (tuple2 c1 b1)) c1 (t2tb2135 p) (t2tb132 w))))
  (exists ((a2 c))
  (and (mem7 a2 w) (mem (tuple2 c1 (set1 (tuple2 c1 b1)))
  (Tuple2 c1 (set1 (tuple2 c1 b1)) (t2tb135 a2) (t2tb222 x)) (t2tb2135 p)))))))

;; mem_image
  (assert
  (forall ((p (set (tuple21 c (tuple21 c b)))) (w (set c)) (x (tuple21 c b)))
  (= (mem28 x (tb2t222 (image (tuple2 c1 b1) c1 (t2tb2137 p) (t2tb132 w))))
  (exists ((a2 c))
  (and (mem7 a2 w) (mem (tuple2 c1 (tuple2 c1 b1))
  (Tuple2 c1 (tuple2 c1 b1) (t2tb135 a2) (t2tb223 x)) (t2tb2137 p)))))))
...
;; mem_image
  (assert
  (forall ((p (set (tuple21 (set (tuple21 a b)) (set (tuple21 c b)))))
  (w (set (set (tuple21 a b)))) (x (set (tuple21 c b))))
  (= (mem31 x
  (tb2t308
  (image (set1 (tuple2 c1 b1)) (set1 (tuple2 a1 b1)) (t2tb2139 p) (t2tb10 w))))
  (exists ((a2 (set (tuple21 a b))))
  (and (mem4 a2 w) (mem (tuple2 (set1 (tuple2 a1 b1)) (set1 (tuple2 c1 b1)))
  (Tuple2 (set1 (tuple2 a1 b1)) (set1 (tuple2 c1 b1)) (t2tb11 a2)
  (t2tb222 x)) (t2tb2139 p)))))))
...
;; mem_image
  ...
  (= (mem28 x
  (tb2t222
  (image (tuple2 c1 b1) (set1 (tuple2 a1 b1)) (t2tb2141 p) (t2tb10 w))))
  (exists ((a2 (set (tuple21 a b))))
...
;; mem_image
  (assert
  (forall ((p (set (tuple21 (tuple21 a b) (set (tuple21 c b)))))
  (w (set (tuple21 a b))) (x (set (tuple21 c b))))
  (= (mem31 x
  (tb2t308
  (image (set1 (tuple2 c1 b1)) (tuple2 a1 b1) (t2tb2143 p) (t2tb11 w))))
  (exists ((a2 (tuple21 a b)))
  (and (mem3 a2 w) (mem (tuple2 (tuple2 a1 b1) (set1 (tuple2 c1 b1)))
  (Tuple2 (tuple2 a1 b1) (set1 (tuple2 c1 b1)) (t2tb13 a2) (t2tb222 x))
  (t2tb2143 p)))))))
...
;; mem_image
  ...
  b))) (x (tuple21 c b)))
  (= (mem28 x
  (tb2t222 (image (tuple2 c1 b1) (tuple2 a1 b1) (t2tb2145 p) (t2tb11 w))))
  (exists ((a2 (tuple21 a b)))
...
;; mem_image
  (assert
  (forall ((p (set (tuple21 b (set (tuple21 c b))))) (w (set b))
  (x (set (tuple21 c b))))
  (= (mem31 x
  (tb2t308 (image (set1 (tuple2 c1 b1)) b1 (t2tb2147 p) (t2tb12 w))))
  (exists ((a2 b))
  (and (mem2 a2 w) (mem (tuple2 b1 (set1 (tuple2 c1 b1)))
  (Tuple2 b1 (set1 (tuple2 c1 b1)) (t2tb14 a2) (t2tb222 x)) (t2tb2147 p)))))))

;; mem_image
  (assert
  (forall ((p (set (tuple21 b (tuple21 c b)))) (w (set b)) (x (tuple21 c b)))
  (= (mem28 x (tb2t222 (image (tuple2 c1 b1) b1 (t2tb2149 p) (t2tb12 w))))
  (exists ((a2 b))
  (and (mem2 a2 w) (mem (tuple2 b1 (tuple2 c1 b1))
  (Tuple2 b1 (tuple2 c1 b1) (t2tb14 a2) (t2tb223 x)) (t2tb2149 p)))))))
...
;; mem_image
  (assert
  (forall ((p (set (tuple21 a (set (tuple21 c b))))) (w (set a))
  (x (set (tuple21 c b))))
  (= (mem31 x
  (tb2t308 (image (set1 (tuple2 c1 b1)) a1 (t2tb2151 p) (t2tb1 w))))
  (exists ((a2 a))
  (and (mem1 a2 w) (mem (tuple2 a1 (set1 (tuple2 c1 b1)))
  (Tuple2 a1 (set1 (tuple2 c1 b1)) (t2tb2 a2) (t2tb222 x)) (t2tb2151 p)))))))
...
;; mem_overriding
  (assert
  (forall ((b2 ty))
  (forall ((q uni) (p uni) (x (set (tuple21 c b))) (y uni))
  (= (mem (tuple2 (set1 (tuple2 c1 b1)) b2)
  (Tuple2 (set1 (tuple2 c1 b1)) b2 (t2tb222 x) y)
  (infix_lspl b2 (set1 (tuple2 c1 b1)) q p))
  (or
  (and (mem (tuple2 (set1 (tuple2 c1 b1)) b2)
  (Tuple2 (set1 (tuple2 c1 b1)) b2 (t2tb222 x) y) q)
  (not (mem31 x (tb2t308 (dom b2 (set1 (tuple2 c1 b1)) p))))) (mem
  (tuple2 (set1 (tuple2 c1 b1)) b2)
  (Tuple2 (set1 (tuple2 c1 b1)) b2 (t2tb222 x) y) p))))))
...
(declare-fun t2tb2186 ((set (tuple21 c (tuple21 b b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 c (tuple21 b b))))) (sort
  (set1 (tuple2 c1 (tuple2 b1 b1))) (t2tb2186 x))))

(declare-fun tb2t2186 (uni) (set (tuple21 c (tuple21 b b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 c (tuple21 b b)))))
  (! (= (tb2t2186 (t2tb2186 i)) i) :pattern ((t2tb2186 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 c1 (tuple2 b1 b1))) j)
     (= (t2tb2186 (tb2t2186 j)) j)) :pattern ((t2tb2186 (tb2t2186 j))) )))

(declare-fun t2tb2187 ((tuple21 c (tuple21 b b))) uni)
...
(declare-fun tb2t2187 (uni) (tuple21 c (tuple21 b b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 c (tuple21 b b))))
  (! (= (tb2t2187 (t2tb2187 i)) i) :pattern ((t2tb2187 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 c1 (tuple2 b1 b1)) j) (= (t2tb2187 (tb2t2187 j)) j)) :pattern (
  (t2tb2187 (tb2t2187 j))) )))
...
(declare-fun t2tb2188 ((set (tuple21 (tuple21 c c) (tuple21 b b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 c c) (tuple21 b b))))) (sort
  (set1 (tuple2 (tuple2 c1 c1) (tuple2 b1 b1))) (t2tb2188 x))))

(declare-fun tb2t2188 (uni) (set (tuple21 (tuple21 c c) (tuple21 b b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 c c) (tuple21 b b)))))
  (! (= (tb2t2188 (t2tb2188 i)) i) :pattern ((t2tb2188 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 c1 c1) (tuple2 b1 b1))) j)
     (= (t2tb2188 (tb2t2188 j)) j)) :pattern ((t2tb2188 (tb2t2188 j))) )))

(declare-fun t2tb2189 ((tuple21 (tuple21 c c) (tuple21 b b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 c c) (tuple21 b b)))) (sort
  (tuple2 (tuple2 c1 c1) (tuple2 b1 b1)) (t2tb2189 x))))

(declare-fun tb2t2189 (uni) (tuple21 (tuple21 c c) (tuple21 b b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 c c) (tuple21 b b))))
  (! (= (tb2t2189 (t2tb2189 i)) i) :pattern ((t2tb2189 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 c1 c1) (tuple2 b1 b1)) j)
     (= (t2tb2189 (tb2t2189 j)) j)) :pattern ((t2tb2189 (tb2t2189 j))) )))
...
(declare-fun t2tb2190 ((set (tuple21 (tuple21 c a) (tuple21 b c)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 c a) (tuple21 b c))))) (sort
  (set1 (tuple2 (tuple2 c1 a1) (tuple2 b1 c1))) (t2tb2190 x))))

(declare-fun tb2t2190 (uni) (set (tuple21 (tuple21 c a) (tuple21 b c))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 c a) (tuple21 b c)))))
  (! (= (tb2t2190 (t2tb2190 i)) i) :pattern ((t2tb2190 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 c1 a1) (tuple2 b1 c1))) j)
     (= (t2tb2190 (tb2t2190 j)) j)) :pattern ((t2tb2190 (tb2t2190 j))) )))

(declare-fun t2tb2191 ((tuple21 (tuple21 c a) (tuple21 b c))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 c a) (tuple21 b c)))) (sort
  (tuple2 (tuple2 c1 a1) (tuple2 b1 c1)) (t2tb2191 x))))

(declare-fun tb2t2191 (uni) (tuple21 (tuple21 c a) (tuple21 b c)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 c a) (tuple21 b c))))
  (! (= (tb2t2191 (t2tb2191 i)) i) :pattern ((t2tb2191 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 c1 a1) (tuple2 b1 c1)) j)
     (= (t2tb2191 (tb2t2191 j)) j)) :pattern ((t2tb2191 (tb2t2191 j))) )))
...
(declare-fun t2tb2192 ((set (tuple21 (tuple21 c a) (tuple21 b b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 c a) (tuple21 b b))))) (sort
  (set1 (tuple2 (tuple2 c1 a1) (tuple2 b1 b1))) (t2tb2192 x))))

(declare-fun tb2t2192 (uni) (set (tuple21 (tuple21 c a) (tuple21 b b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 c a) (tuple21 b b)))))
  (! (= (tb2t2192 (t2tb2192 i)) i) :pattern ((t2tb2192 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 c1 a1) (tuple2 b1 b1))) j)
     (= (t2tb2192 (tb2t2192 j)) j)) :pattern ((t2tb2192 (tb2t2192 j))) )))

(declare-fun t2tb2193 ((tuple21 (tuple21 c a) (tuple21 b b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 c a) (tuple21 b b)))) (sort
  (tuple2 (tuple2 c1 a1) (tuple2 b1 b1)) (t2tb2193 x))))

(declare-fun tb2t2193 (uni) (tuple21 (tuple21 c a) (tuple21 b b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 c a) (tuple21 b b))))
  (! (= (tb2t2193 (t2tb2193 i)) i) :pattern ((t2tb2193 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 c1 a1) (tuple2 b1 b1)) j)
     (= (t2tb2193 (tb2t2193 j)) j)) :pattern ((t2tb2193 (tb2t2193 j))) )))
...
(declare-fun t2tb2194 ((set (tuple21 (tuple21 a c) (tuple21 b b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 a c) (tuple21 b b))))) (sort
  (set1 (tuple2 (tuple2 a1 c1) (tuple2 b1 b1))) (t2tb2194 x))))

(declare-fun tb2t2194 (uni) (set (tuple21 (tuple21 a c) (tuple21 b b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 a c) (tuple21 b b)))))
  (! (= (tb2t2194 (t2tb2194 i)) i) :pattern ((t2tb2194 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 a1 c1) (tuple2 b1 b1))) j)
     (= (t2tb2194 (tb2t2194 j)) j)) :pattern ((t2tb2194 (tb2t2194 j))) )))

(declare-fun t2tb2195 ((tuple21 (tuple21 a c) (tuple21 b b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 a c) (tuple21 b b)))) (sort
  (tuple2 (tuple2 a1 c1) (tuple2 b1 b1)) (t2tb2195 x))))

(declare-fun tb2t2195 (uni) (tuple21 (tuple21 a c) (tuple21 b b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 a c) (tuple21 b b))))
  (! (= (tb2t2195 (t2tb2195 i)) i) :pattern ((t2tb2195 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 a1 c1) (tuple2 b1 b1)) j)
     (= (t2tb2195 (tb2t2195 j)) j)) :pattern ((t2tb2195 (tb2t2195 j))) )))
...
;; mem_partial_function_set
  ...
  (= (mem31 f (tb2t308 (infix_plmngt b1 c1 (t2tb132 s) (t2tb12 t))))
  (and (mem31 f (relation8 s t))
...
;; mem_total_function_set
  (assert
  (forall ((b2 ty))
  (forall ((s (set (set (tuple21 c b)))) (t uni) (x uni))
  (= (mem (set1 (tuple2 (set1 (tuple2 c1 b1)) b2)) x
  (infix_mnmngt b2 (set1 (tuple2 c1 b1)) (t2tb308 s) t))
  (and (mem (set1 (tuple2 (set1 (tuple2 c1 b1)) b2)) x
  (infix_plmngt b2 (set1 (tuple2 c1 b1)) (t2tb308 s) t)) (infix_eqeq23
  (tb2t308 (dom b2 (set1 (tuple2 c1 b1)) x)) s))))))
...
;; mem_total_function_set
  ...
  (= (mem31 x (tb2t308 (infix_mnmngt b1 c1 (t2tb132 s) (t2tb12 t))))
  (and (mem31 x (tb2t308 (infix_plmngt b1 c1 (t2tb132 s) (t2tb12 t))))
  (infix_eqeq7 (tb2t132 (dom b1 c1 (t2tb222 x))) s)))))
...
;; mem_partial_injection_set
  (assert
  (forall ((s (set c)) (t (set b)) (x (set (tuple21 c b))))
  (= (mem31 x (tb2t308 (infix_gtplgt b1 c1 (t2tb132 s) (t2tb12 t))))
  (and (mem31 x (tb2t308 (infix_plmngt b1 c1 (t2tb132 s) (t2tb12 t)))) (mem
  (set1 (tuple2 b1 c1)) (t2tb131 (inverse5 x))
  (infix_plmngt c1 b1 (t2tb12 t) (t2tb132 s)))))))

;; mem_partial_injection_set
  (assert
  (forall ((s (set b)) (t (set c)) (x (set (tuple21 b c))))
  (= (mem (set1 (tuple2 b1 c1)) (t2tb131 x)
  (infix_gtplgt c1 b1 (t2tb12 s) (t2tb132 t)))
  (and (mem (set1 (tuple2 b1 c1)) (t2tb131 x)
  (infix_plmngt c1 b1 (t2tb12 s) (t2tb132 t))) (mem31 (inverse8 x)
  (tb2t308 (infix_plmngt b1 c1 (t2tb132 t) (t2tb12 s))))))))
...
;; mem_total_injection_set
  (assert
  (forall ((s (set c)) (t (set b)) (x (set (tuple21 c b))))
  (= (mem31 x (tb2t308 (infix_gtmngt b1 c1 (t2tb132 s) (t2tb12 t))))
  (and (mem31 x (tb2t308 (infix_gtplgt b1 c1 (t2tb132 s) (t2tb12 t)))) (mem31
  x (tb2t308 (infix_mnmngt b1 c1 (t2tb132 s) (t2tb12 t))))))))
...
(declare-fun infix_plmngtgt6 ((set c) (set b)) (set (set (tuple21 c b))))

;; mem_partial_surjection_set
  (assert
  (forall ((a2 ty))
  (forall ((s uni) (t (set (set (tuple21 c b)))) (x uni))
  (= (mem (set1 (tuple2 a2 (set1 (tuple2 c1 b1)))) x
  (infix_plmngtgt (set1 (tuple2 c1 b1)) a2 s (t2tb308 t)))
  (and (mem (set1 (tuple2 a2 (set1 (tuple2 c1 b1)))) x
  (infix_plmngt (set1 (tuple2 c1 b1)) a2 s (t2tb308 t))) (infix_eqeq23
  (tb2t308 (ran (set1 (tuple2 c1 b1)) a2 x)) t))))))
...
;; mem_partial_surjection_set
  (assert
  (forall ((s (set c)) (t (set b)) (x (set (tuple21 c b))))
  (= (mem31 x (infix_plmngtgt6 s t))
  (and (mem31 x (tb2t308 (infix_plmngt b1 c1 (t2tb132 s) (t2tb12 t))))
  (infix_eqeq3 (tb2t12 (ran b1 c1 (t2tb222 x))) t)))))
...
;; mem_total_surjection_set
  (assert
  (forall ((s (set c)) (t (set b)) (x (set (tuple21 c b))))
  (= (mem31 x (tb2t308 (infix_mnmngtgt b1 c1 (t2tb132 s) (t2tb12 t))))
  (and (mem31 x (infix_plmngtgt6 s t)) (mem31 x
  (tb2t308 (infix_mnmngt b1 c1 (t2tb132 s) (t2tb12 t))))))))
...
;; mem_partial_bijection_set
  (assert
  (forall ((s (set c)) (t (set b)) (x (set (tuple21 c b))))
  (= (mem31 x (tb2t308 (infix_gtplgtgt b1 c1 (t2tb132 s) (t2tb12 t))))
  (and (mem31 x (tb2t308 (infix_gtplgt b1 c1 (t2tb132 s) (t2tb12 t)))) (mem31
  x (infix_plmngtgt6 s t))))))
...
;; mem_total_bijection_set
  (assert
  (forall ((s (set c)) (t (set b)) (x (set (tuple21 c b))))
  (= (mem31 x (tb2t308 (infix_gtmngtgt b1 c1 (t2tb132 s) (t2tb12 t))))
  (and (mem31 x (tb2t308 (infix_gtmngt b1 c1 (t2tb132 s) (t2tb12 t)))) (mem31
  x (tb2t308 (infix_mnmngtgt b1 c1 (t2tb132 s) (t2tb12 t))))))))
...
;; apply_def0
  (assert
  (forall ((b2 ty))
  (forall ((f uni) (s (set (set (tuple21 c b)))) (t uni) (a2 (set (tuple21 c
  b))))
  (=>
  (and (mem (set1 (tuple2 (set1 (tuple2 c1 b1)) b2)) f
  (infix_plmngt b2 (set1 (tuple2 c1 b1)) (t2tb308 s) t)) (mem31 a2
  (tb2t308 (dom b2 (set1 (tuple2 c1 b1)) f)))) (mem
  (tuple2 (set1 (tuple2 c1 b1)) b2)
  (Tuple2 (set1 (tuple2 c1 b1)) b2 (t2tb222 a2)
  (apply b2 (set1 (tuple2 c1 b1)) f (t2tb222 a2))) f)))))
...
;; apply_def0
  ...
  (=>
  (and (mem31 f (tb2t308 (infix_plmngt b1 c1 (t2tb132 s) (t2tb12 t)))) (mem7
  a2 (tb2t132 (dom b1 c1 (t2tb222 f))))) (mem28
  (tb2t223
...
(assert
;; equal_semicolon_2
 ;; File "lemmes_bbook.why", line 1515, characters 7-24
  (not
  (forall ((s (set a)) (t (set b)) (u (set c)) (p (set (tuple21 a b)))
  (q (set (tuple21 a b))) (r (set (tuple21 b c))))
  (=>
  (and (mem4 p (relation1 s t))
  (and (mem4 q (relation1 s t))
  (and (mem31 (inverse8 r) (infix_plmngtgt6 u t)) (infix_eqeq9
  (semicolon1 p r) (semicolon1 q r))))) (infix_eqeq4 p q)))))
(check-sat)
