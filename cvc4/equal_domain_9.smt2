...
(declare-fun diff10 ((set (tuple21 b a)) (set (tuple21 b a))) (set (tuple21 b
  a)))

;; mem_diff
  (assert
  (forall ((s (set (tuple21 b a))) (t (set (tuple21 b a))) (x (tuple21 b a)))
  (= (mem5 x (diff10 s t)) (and (mem5 x s) (not (mem5 x t))))))
...
;; mem_total_function_set
  ...
  (and (mem4 x (infix_plmngt1 s t)) (infix_eqeq1 (dom1 x) s)))))
...
;; apply_def0
  ...
  (=> (and (mem4 f (infix_plmngt1 s t)) (mem1 a2 (dom1 f))) (mem3
...
(assert
;; equal_domain_9
 ;; File "lemmes_bbook.why", line 1275, characters 7-21
  (not
  (forall ((s (set a)) (t (set b)) (v (set b)) (f (set (tuple21 a b))))
  (=> (and (mem4 f (infix_plmngt1 s t)) (subset5 v t)) (infix_eqeq1
  (dom1 (range_substraction1 f v)) (diff1 (dom1 f) (image2 (inverse2 f) v)))))))
(check-sat)
