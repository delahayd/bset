...
(declare-fun empty6 () (set c))

(declare-fun empty7 () (set (tuple21 b c)))

(declare-fun empty8 () (set (tuple21 a c)))

(declare-fun empty9 () (set (set (tuple21 b c))))
...
;; empty_def1
  (assert (is_empty (tuple2 a1 c1) (t2tb129 empty8)))

;; empty_def1
  (assert (is_empty (set1 (tuple2 b1 c1)) (t2tb130 empty9)))

;; empty_def1
  (assert (is_empty (tuple2 b1 c1) (t2tb131 empty7)))

;; empty_def1
  (assert (is_empty c1 (t2tb132 empty6)))
...
;; empty
  (assert (forall ((x (tuple21 a c))) (not (mem10 x empty8))))

;; empty
  (assert (forall ((x (set (tuple21 b c)))) (not (mem9 x empty9))))

;; empty
  (assert (forall ((x (tuple21 b c))) (not (mem8 x empty7))))

;; empty
  (assert (forall ((x c)) (not (mem7 x empty6))))
...
(assert
;; equal_semicolon_15
 ;; File "lemmes_bbook.why", line 1632, characters 7-25
  (not
  (forall ((s (set a)) (t (set b)) (u (set c)) (r (set (tuple21 a b)))
  (p (set (tuple21 b c))))
  (=>
  (and (mem4 r (relation1 s t))
  (and (mem9 p (relation4 t u)) (infix_eqeq8 p empty7))) (infix_eqeq9
  (semicolon1 r p) empty8)))))
(check-sat)
