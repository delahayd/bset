...
(assert
;; equal_restriction_24
 ;; File "lemmes_bbook.why", line 2059, characters 7-27
  (not
  (forall ((s (set a)) (t (set b)) (x a) (r (set (tuple21 a b))))
  (=> (and (mem1 x s) (mem4 r (relation1 s t))) (infix_eqeq4
  (domain_restriction1 (singleton1 x) r)
  (times2 (singleton1 x) (image1 r (singleton1 x))))))))
(check-sat)
