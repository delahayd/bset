...
fof(mem_proj_1, conjecture, ![S, T]: ((sort(set(a), S) = S) => ((sort(set(b),
  T) = T) => mem(set(tuple2(tuple2(a, b), a)), prj1(b, a, tuple21(set(a),
  set(b), S, T)), infix_mnmngt(a, tuple2(a, b), times(b, a, S, T), S))))).
