...
(assert
;; monot_semicolon
 ;; File "lemmes_bbook.why", line 769, characters 7-22
  (not
  (forall ((s (set a)) (t (set b)) (u (set c)) (h (set (tuple21 a b)))
  (p (set (tuple21 a b))) (k (set (tuple21 b c))) (q (set (tuple21 b c))))
  (=> (and (mem4 h (relation1 s t)) (mem9 k (relation4 t u)))
  (=> (and (subset6 p h) (subset10 q k)) (subset11 (semicolon1 p q)
  (semicolon1 h k)))))))
(check-sat)
