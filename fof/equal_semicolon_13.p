...
fof(equal_semicolon_13, conjecture, ![S, T, U, F, P, Q]: ((sort(set(a),
  ...
  => infix_eqeq(tuple2(a, c), semicolon(c, b, a, F, diff(tuple2(b, c), P,
  Q)), diff(tuple2(a, c), semicolon(c, b, a, F, P), semicolon(c, b, a, F,
  Q))))))))))).
