...
(assert
;; equal_restriction_10
 ;; File "lemmes_bbook.why", line 1934, characters 7-27
  (not
  ...
  (domain_restriction6 u (direct_product1 p q))
  (direct_product1 (domain_restriction1 u p) (domain_restriction4 u q)))))))
(check-sat)
