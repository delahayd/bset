...
;; subsetnoteq_def
  ...
  (and (subset21 s t) (not (infix_eqeq25 s t))))))
...
(declare-fun t2tb2358 ((set (tuple21 (tuple21 b b) (tuple21 b b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b b) (tuple21 b b))))) (sort
  (set1 (tuple2 (tuple2 b1 b1) (tuple2 b1 b1))) (t2tb2358 x))))

(declare-fun tb2t2358 (uni) (set (tuple21 (tuple21 b b) (tuple21 b b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b b) (tuple21 b b)))))
  (! (= (tb2t2358 (t2tb2358 i)) i) :pattern ((t2tb2358 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 b1) (tuple2 b1 b1))) j)
     (= (t2tb2358 (tb2t2358 j)) j)) :pattern ((t2tb2358 (tb2t2358 j))) )))

(declare-fun t2tb2359 ((tuple21 (tuple21 b b) (tuple21 b b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 b b) (tuple21 b b)))) (sort
  (tuple2 (tuple2 b1 b1) (tuple2 b1 b1)) (t2tb2359 x))))

(declare-fun tb2t2359 (uni) (tuple21 (tuple21 b b) (tuple21 b b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b b) (tuple21 b b))))
  (! (= (tb2t2359 (t2tb2359 i)) i) :pattern ((t2tb2359 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 b1) (tuple2 b1 b1)) j)
     (= (t2tb2359 (tb2t2359 j)) j)) :pattern ((t2tb2359 (tb2t2359 j))) )))
...
(declare-fun t2tb2360 ((set (tuple21 (tuple21 b b) (set (tuple21 a
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b b) (set (tuple21 a b)))))) (sort
  (set1 (tuple2 (tuple2 b1 b1) (set1 (tuple2 a1 b1)))) (t2tb2360 x))))

(declare-fun tb2t2360 (uni) (set (tuple21 (tuple21 b b) (set (tuple21 a
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b b) (set (tuple21 a b))))))
  (! (= (tb2t2360 (t2tb2360 i)) i) :pattern ((t2tb2360 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 b1) (set1 (tuple2 a1 b1)))) j)
     (= (t2tb2360 (tb2t2360 j)) j)) :pattern ((t2tb2360 (tb2t2360 j))) )))

(declare-fun t2tb2361 ((tuple21 (tuple21 b b) (set (tuple21 a b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 b b) (set (tuple21 a b))))) (sort
  (tuple2 (tuple2 b1 b1) (set1 (tuple2 a1 b1))) (t2tb2361 x))))

(declare-fun tb2t2361 (uni) (tuple21 (tuple21 b b) (set (tuple21 a b))))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b b) (set (tuple21 a b)))))
  (! (= (tb2t2361 (t2tb2361 i)) i) :pattern ((t2tb2361 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 b1) (set1 (tuple2 a1 b1))) j)
     (= (t2tb2361 (tb2t2361 j)) j)) :pattern ((t2tb2361 (tb2t2361 j))) )))
...
(declare-fun t2tb2362 ((set (tuple21 (tuple21 b b) (tuple21 a b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b b) (tuple21 a b))))) (sort
  (set1 (tuple2 (tuple2 b1 b1) (tuple2 a1 b1))) (t2tb2362 x))))

(declare-fun tb2t2362 (uni) (set (tuple21 (tuple21 b b) (tuple21 a b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b b) (tuple21 a b)))))
  (! (= (tb2t2362 (t2tb2362 i)) i) :pattern ((t2tb2362 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 b1) (tuple2 a1 b1))) j)
     (= (t2tb2362 (tb2t2362 j)) j)) :pattern ((t2tb2362 (tb2t2362 j))) )))

(declare-fun t2tb2363 ((tuple21 (tuple21 b b) (tuple21 a b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 b b) (tuple21 a b)))) (sort
  (tuple2 (tuple2 b1 b1) (tuple2 a1 b1)) (t2tb2363 x))))

(declare-fun tb2t2363 (uni) (tuple21 (tuple21 b b) (tuple21 a b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b b) (tuple21 a b))))
  (! (= (tb2t2363 (t2tb2363 i)) i) :pattern ((t2tb2363 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 b1) (tuple2 a1 b1)) j)
     (= (t2tb2363 (tb2t2363 j)) j)) :pattern ((t2tb2363 (tb2t2363 j))) )))
...
(declare-fun t2tb2364 ((set (tuple21 (tuple21 b b) b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b b) b)))) (sort
  (set1 (tuple2 (tuple2 b1 b1) b1)) (t2tb2364 x))))

(declare-fun tb2t2364 (uni) (set (tuple21 (tuple21 b b) b)))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b b) b))))
  (! (= (tb2t2364 (t2tb2364 i)) i) :pattern ((t2tb2364 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 b1) b1)) j)
     (= (t2tb2364 (tb2t2364 j)) j)) :pattern ((t2tb2364 (tb2t2364 j))) )))

(declare-fun t2tb2365 ((tuple21 (tuple21 b b) b)) uni)
...
(declare-fun tb2t2365 (uni) (tuple21 (tuple21 b b) b))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b b) b)))
  (! (= (tb2t2365 (t2tb2365 i)) i) :pattern ((t2tb2365 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 b1) b1) j) (= (t2tb2365 (tb2t2365 j)) j)) :pattern (
  (t2tb2365 (tb2t2365 j))) )))
...
(declare-fun t2tb2366 ((set (tuple21 (tuple21 b b) a))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b b) a)))) (sort
  (set1 (tuple2 (tuple2 b1 b1) a1)) (t2tb2366 x))))

(declare-fun tb2t2366 (uni) (set (tuple21 (tuple21 b b) a)))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b b) a))))
  (! (= (tb2t2366 (t2tb2366 i)) i) :pattern ((t2tb2366 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 b1) a1)) j)
     (= (t2tb2366 (tb2t2366 j)) j)) :pattern ((t2tb2366 (tb2t2366 j))) )))

(declare-fun t2tb2367 ((tuple21 (tuple21 b b) a)) uni)
...
(declare-fun tb2t2367 (uni) (tuple21 (tuple21 b b) a))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b b) a)))
  (! (= (tb2t2367 (t2tb2367 i)) i) :pattern ((t2tb2367 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 b1) a1) j) (= (t2tb2367 (tb2t2367 j)) j)) :pattern (
  (t2tb2367 (tb2t2367 j))) )))
...
(declare-fun t2tb2368 ((set (tuple21 (set (tuple21 a b)) (tuple21 b
  b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (set (tuple21 a b)) (tuple21 b b))))) (sort
  (set1 (tuple2 (set1 (tuple2 a1 b1)) (tuple2 b1 b1))) (t2tb2368 x))))

(declare-fun tb2t2368 (uni) (set (tuple21 (set (tuple21 a b)) (tuple21 b
  b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (set (tuple21 a b)) (tuple21 b b)))))
  (! (= (tb2t2368 (t2tb2368 i)) i) :pattern ((t2tb2368 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (set1 (tuple2 a1 b1)) (tuple2 b1 b1))) j)
     (= (t2tb2368 (tb2t2368 j)) j)) :pattern ((t2tb2368 (tb2t2368 j))) )))

(declare-fun t2tb2369 ((tuple21 (set (tuple21 a b)) (tuple21 b b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (set (tuple21 a b)) (tuple21 b b)))) (sort
  (tuple2 (set1 (tuple2 a1 b1)) (tuple2 b1 b1)) (t2tb2369 x))))

(declare-fun tb2t2369 (uni) (tuple21 (set (tuple21 a b)) (tuple21 b b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (set (tuple21 a b)) (tuple21 b b))))
  (! (= (tb2t2369 (t2tb2369 i)) i) :pattern ((t2tb2369 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (set1 (tuple2 a1 b1)) (tuple2 b1 b1)) j)
     (= (t2tb2369 (tb2t2369 j)) j)) :pattern ((t2tb2369 (tb2t2369 j))) )))
...
(declare-fun t2tb2370 ((set (tuple21 (tuple21 a b) (tuple21 b b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 a b) (tuple21 b b))))) (sort
  (set1 (tuple2 (tuple2 a1 b1) (tuple2 b1 b1))) (t2tb2370 x))))

(declare-fun tb2t2370 (uni) (set (tuple21 (tuple21 a b) (tuple21 b b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 a b) (tuple21 b b)))))
  (! (= (tb2t2370 (t2tb2370 i)) i) :pattern ((t2tb2370 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 a1 b1) (tuple2 b1 b1))) j)
     (= (t2tb2370 (tb2t2370 j)) j)) :pattern ((t2tb2370 (tb2t2370 j))) )))

(declare-fun t2tb2371 ((tuple21 (tuple21 a b) (tuple21 b b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 a b) (tuple21 b b)))) (sort
  (tuple2 (tuple2 a1 b1) (tuple2 b1 b1)) (t2tb2371 x))))

(declare-fun tb2t2371 (uni) (tuple21 (tuple21 a b) (tuple21 b b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 a b) (tuple21 b b))))
  (! (= (tb2t2371 (t2tb2371 i)) i) :pattern ((t2tb2371 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 a1 b1) (tuple2 b1 b1)) j)
     (= (t2tb2371 (tb2t2371 j)) j)) :pattern ((t2tb2371 (tb2t2371 j))) )))
...
(declare-fun t2tb2372 ((set (tuple21 b (tuple21 b b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 b (tuple21 b b))))) (sort
  (set1 (tuple2 b1 (tuple2 b1 b1))) (t2tb2372 x))))

(declare-fun tb2t2372 (uni) (set (tuple21 b (tuple21 b b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 b (tuple21 b b)))))
  (! (= (tb2t2372 (t2tb2372 i)) i) :pattern ((t2tb2372 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 b1 (tuple2 b1 b1))) j)
     (= (t2tb2372 (tb2t2372 j)) j)) :pattern ((t2tb2372 (tb2t2372 j))) )))

(declare-fun t2tb2373 ((tuple21 b (tuple21 b b))) uni)
...
(declare-fun tb2t2373 (uni) (tuple21 b (tuple21 b b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 b (tuple21 b b))))
  (! (= (tb2t2373 (t2tb2373 i)) i) :pattern ((t2tb2373 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 b1 (tuple2 b1 b1)) j) (= (t2tb2373 (tb2t2373 j)) j)) :pattern (
  (t2tb2373 (tb2t2373 j))) )))
...
(declare-fun t2tb2374 ((set (set (tuple21 (tuple21 b b) (tuple21 b
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 b b) (tuple21 b b)))))) (sort
  (set1 (set1 (tuple2 (tuple2 b1 b1) (tuple2 b1 b1)))) (t2tb2374 x))))

(declare-fun tb2t2374 (uni) (set (set (tuple21 (tuple21 b b) (tuple21 b
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 b b) (tuple21 b b))))))
  (! (= (tb2t2374 (t2tb2374 i)) i) :pattern ((t2tb2374 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 b1 b1) (tuple2 b1 b1)))) j)
     (= (t2tb2374 (tb2t2374 j)) j)) :pattern ((t2tb2374 (tb2t2374 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 b b))) (v (set (tuple21 b b)))
  (r (set (tuple21 (tuple21 b b) (tuple21 b b)))))
  (= (mem (set1 (tuple2 (tuple2 b1 b1) (tuple2 b1 b1))) (t2tb2358 r)
  (relation (tuple2 b1 b1) (tuple2 b1 b1) (t2tb35 u) (t2tb35 v)))
  (forall ((x (tuple21 b b)) (y (tuple21 b b)))
  (=> (mem (tuple2 (tuple2 b1 b1) (tuple2 b1 b1))
  (Tuple2 (tuple2 b1 b1) (tuple2 b1 b1) (t2tb36 x) (t2tb36 y)) (t2tb2358 r))
  (and (mem26 x u) (mem26 y v)))))))

(declare-fun t2tb2375 ((set (set (tuple21 (tuple21 b b) (set (tuple21 a
  b)))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 b b) (set (tuple21 a b))))))) (sort
  (set1 (set1 (tuple2 (tuple2 b1 b1) (set1 (tuple2 a1 b1))))) (t2tb2375 x))))

(declare-fun tb2t2375 (uni) (set (set (tuple21 (tuple21 b b) (set (tuple21 a
  b))))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 b b) (set (tuple21 a b)))))))
  (! (= (tb2t2375 (t2tb2375 i)) i) :pattern ((t2tb2375 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 b1 b1) (set1 (tuple2 a1 b1))))) j)
     (= (t2tb2375 (tb2t2375 j)) j)) :pattern ((t2tb2375 (tb2t2375 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 b b))) (v (set (set (tuple21 a b))))
  (r (set (tuple21 (tuple21 b b) (set (tuple21 a b))))))
  (= (mem (set1 (tuple2 (tuple2 b1 b1) (set1 (tuple2 a1 b1)))) (t2tb2360 r)
  (relation (set1 (tuple2 a1 b1)) (tuple2 b1 b1) (t2tb35 u) (t2tb10 v)))
  (forall ((x (tuple21 b b)) (y (set (tuple21 a b))))
  (=> (mem (tuple2 (tuple2 b1 b1) (set1 (tuple2 a1 b1)))
  (Tuple2 (tuple2 b1 b1) (set1 (tuple2 a1 b1)) (t2tb36 x) (t2tb11 y))
  (t2tb2360 r)) (and (mem26 x u) (mem4 y v)))))))

(declare-fun t2tb2376 ((set (set (tuple21 (tuple21 b b) (tuple21 a
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 b b) (tuple21 a b)))))) (sort
  (set1 (set1 (tuple2 (tuple2 b1 b1) (tuple2 a1 b1)))) (t2tb2376 x))))

(declare-fun tb2t2376 (uni) (set (set (tuple21 (tuple21 b b) (tuple21 a
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 b b) (tuple21 a b))))))
  (! (= (tb2t2376 (t2tb2376 i)) i) :pattern ((t2tb2376 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 b1 b1) (tuple2 a1 b1)))) j)
     (= (t2tb2376 (tb2t2376 j)) j)) :pattern ((t2tb2376 (tb2t2376 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 b b))) (v (set (tuple21 a b)))
  (r (set (tuple21 (tuple21 b b) (tuple21 a b)))))
  (= (mem (set1 (tuple2 (tuple2 b1 b1) (tuple2 a1 b1))) (t2tb2362 r)
  (relation (tuple2 a1 b1) (tuple2 b1 b1) (t2tb35 u) (t2tb11 v)))
  (forall ((x (tuple21 b b)) (y (tuple21 a b)))
  (=> (mem (tuple2 (tuple2 b1 b1) (tuple2 a1 b1))
  (Tuple2 (tuple2 b1 b1) (tuple2 a1 b1) (t2tb36 x) (t2tb13 y)) (t2tb2362 r))
  (and (mem26 x u) (mem3 y v)))))))

(declare-fun t2tb2377 ((set (set (tuple21 (tuple21 b b) b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 b b) b))))) (sort
  (set1 (set1 (tuple2 (tuple2 b1 b1) b1))) (t2tb2377 x))))

(declare-fun tb2t2377 (uni) (set (set (tuple21 (tuple21 b b) b))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 b b) b)))))
  (! (= (tb2t2377 (t2tb2377 i)) i) :pattern ((t2tb2377 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 b1 b1) b1))) j)
     (= (t2tb2377 (tb2t2377 j)) j)) :pattern ((t2tb2377 (tb2t2377 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 b b))) (v (set b)) (r (set (tuple21 (tuple21 b b)
  b))))
  (= (mem (set1 (tuple2 (tuple2 b1 b1) b1)) (t2tb2364 r)
  (relation b1 (tuple2 b1 b1) (t2tb35 u) (t2tb12 v)))
  (forall ((x (tuple21 b b)) (y b))
  (=> (mem (tuple2 (tuple2 b1 b1) b1)
  (Tuple2 (tuple2 b1 b1) b1 (t2tb36 x) (t2tb14 y)) (t2tb2364 r))
  (and (mem26 x u) (mem2 y v)))))))

(declare-fun t2tb2378 ((set (set (tuple21 (tuple21 b b) a)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 b b) a))))) (sort
  (set1 (set1 (tuple2 (tuple2 b1 b1) a1))) (t2tb2378 x))))

(declare-fun tb2t2378 (uni) (set (set (tuple21 (tuple21 b b) a))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 b b) a)))))
  (! (= (tb2t2378 (t2tb2378 i)) i) :pattern ((t2tb2378 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 b1 b1) a1))) j)
     (= (t2tb2378 (tb2t2378 j)) j)) :pattern ((t2tb2378 (tb2t2378 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 b b))) (v (set a)) (r (set (tuple21 (tuple21 b b)
  a))))
  (= (mem (set1 (tuple2 (tuple2 b1 b1) a1)) (t2tb2366 r)
  (relation a1 (tuple2 b1 b1) (t2tb35 u) (t2tb1 v)))
  (forall ((x (tuple21 b b)) (y a))
  (=> (mem (tuple2 (tuple2 b1 b1) a1)
  (Tuple2 (tuple2 b1 b1) a1 (t2tb36 x) (t2tb2 y)) (t2tb2366 r))
...
(declare-fun t2tb2379 ((set (set (tuple21 (set (tuple21 a b)) (tuple21 b
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (set (tuple21 a b)) (tuple21 b b)))))) (sort
  (set1 (set1 (tuple2 (set1 (tuple2 a1 b1)) (tuple2 b1 b1)))) (t2tb2379 x))))

(declare-fun tb2t2379 (uni) (set (set (tuple21 (set (tuple21 a b)) (tuple21 b
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (set (tuple21 a b)) (tuple21 b b))))))
  (! (= (tb2t2379 (t2tb2379 i)) i) :pattern ((t2tb2379 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (set1 (tuple2 a1 b1)) (tuple2 b1 b1)))) j)
     (= (t2tb2379 (tb2t2379 j)) j)) :pattern ((t2tb2379 (tb2t2379 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (set (tuple21 a b)))) (v (set (tuple21 b b)))
  (r (set (tuple21 (set (tuple21 a b)) (tuple21 b b)))))
  (= (mem (set1 (tuple2 (set1 (tuple2 a1 b1)) (tuple2 b1 b1))) (t2tb2368 r)
  (relation (tuple2 b1 b1) (set1 (tuple2 a1 b1)) (t2tb10 u) (t2tb35 v)))
  (forall ((x (set (tuple21 a b))) (y (tuple21 b b)))
  (=> (mem (tuple2 (set1 (tuple2 a1 b1)) (tuple2 b1 b1))
  (Tuple2 (set1 (tuple2 a1 b1)) (tuple2 b1 b1) (t2tb11 x) (t2tb36 y))
  (t2tb2368 r)) (and (mem4 x u) (mem26 y v)))))))
...
(declare-fun t2tb2380 ((set (set (tuple21 (tuple21 a b) (tuple21 b
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 a b) (tuple21 b b)))))) (sort
  (set1 (set1 (tuple2 (tuple2 a1 b1) (tuple2 b1 b1)))) (t2tb2380 x))))

(declare-fun tb2t2380 (uni) (set (set (tuple21 (tuple21 a b) (tuple21 b
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 a b) (tuple21 b b))))))
  (! (= (tb2t2380 (t2tb2380 i)) i) :pattern ((t2tb2380 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 a1 b1) (tuple2 b1 b1)))) j)
     (= (t2tb2380 (tb2t2380 j)) j)) :pattern ((t2tb2380 (tb2t2380 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 a b))) (v (set (tuple21 b b)))
  (r (set (tuple21 (tuple21 a b) (tuple21 b b)))))
  (= (mem (set1 (tuple2 (tuple2 a1 b1) (tuple2 b1 b1))) (t2tb2370 r)
  (relation (tuple2 b1 b1) (tuple2 a1 b1) (t2tb11 u) (t2tb35 v)))
  (forall ((x (tuple21 a b)) (y (tuple21 b b)))
  (=> (mem (tuple2 (tuple2 a1 b1) (tuple2 b1 b1))
  (Tuple2 (tuple2 a1 b1) (tuple2 b1 b1) (t2tb13 x) (t2tb36 y)) (t2tb2370 r))
...
(declare-fun t2tb2381 ((set (set (tuple21 b (tuple21 b b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 b (tuple21 b b)))))) (sort
  (set1 (set1 (tuple2 b1 (tuple2 b1 b1)))) (t2tb2381 x))))

(declare-fun tb2t2381 (uni) (set (set (tuple21 b (tuple21 b b)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 b (tuple21 b b))))))
  (! (= (tb2t2381 (t2tb2381 i)) i) :pattern ((t2tb2381 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 b1 (tuple2 b1 b1)))) j)
     (= (t2tb2381 (tb2t2381 j)) j)) :pattern ((t2tb2381 (tb2t2381 j))) )))

;; mem_relation
  (assert
  (forall ((u (set b)) (v (set (tuple21 b b))) (r (set (tuple21 b (tuple21 b
  b)))))
  (= (mem (set1 (tuple2 b1 (tuple2 b1 b1))) (t2tb2372 r)
  (relation (tuple2 b1 b1) b1 (t2tb12 u) (t2tb35 v)))
  (forall ((x b) (y (tuple21 b b)))
  (=> (mem (tuple2 b1 (tuple2 b1 b1))
  (Tuple2 b1 (tuple2 b1 b1) (t2tb14 x) (t2tb36 y)) (t2tb2372 r))
...
(declare-fun t2tb2382 ((set (set (tuple21 a (tuple21 b b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 a (tuple21 b b)))))) (sort
  (set1 (set1 (tuple2 a1 (tuple2 b1 b1)))) (t2tb2382 x))))

(declare-fun tb2t2382 (uni) (set (set (tuple21 a (tuple21 b b)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 a (tuple21 b b))))))
  (! (= (tb2t2382 (t2tb2382 i)) i) :pattern ((t2tb2382 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 a1 (tuple2 b1 b1)))) j)
     (= (t2tb2382 (tb2t2382 j)) j)) :pattern ((t2tb2382 (tb2t2382 j))) )))
...
;; mem_inverse
  ...
  (= (mem26 (tb2t36 (Tuple2 b1 b1 (t2tb14 x) (t2tb14 y)))
  (tb2t35 (inverse b1 b1 (t2tb35 p)))) (mem26
  (tb2t36 (Tuple2 b1 b1 (t2tb14 y) (t2tb14 x))) p))))
...
;; mem_ran
  (assert
  (forall ((p (set (tuple21 b b))) (x b))
  (= (mem2 x (tb2t12 (ran b1 b1 (t2tb35 p))))
...
;; mem_semicolon
  ...
  (= (mem26 (tb2t36 (Tuple2 b1 b1 (t2tb14 x) (t2tb14 y)))
  (tb2t35 (semicolon b1 a1 b1 (t2tb37 p) (t2tb11 q))))
  (exists ((b2 a))
...
(declare-fun range_restriction1 ((set (tuple21 a b)) (set b)) (set (tuple21 a
  b)))

(declare-fun range_restriction3 ((set (tuple21 b b)) (set b)) (set (tuple21 b
  b)))
...
;; mem_image
  ...
  b))) (x (tuple21 b b)))
  (= (mem26 x
  (tb2t35 (image (tuple2 b1 b1) (tuple2 b1 b1) (t2tb2358 p) (t2tb35 w))))
...
;; mem_image
  ...
  (= (mem4 x
  (tb2t10
  (image (set1 (tuple2 a1 b1)) (tuple2 b1 b1) (t2tb2360 p) (t2tb35 w))))
  (exists ((a2 (tuple21 b b)))
...
;; mem_image
  ...
  b))) (x (tuple21 a b)))
  (= (mem3 x
  (tb2t11 (image (tuple2 a1 b1) (tuple2 b1 b1) (t2tb2362 p) (t2tb35 w))))
  (exists ((a2 (tuple21 b b)))
...
;; mem_image
  ...
  (= (mem2 x (tb2t12 (image b1 (tuple2 b1 b1) (t2tb2364 p) (t2tb35 w))))
  (exists ((a2 (tuple21 b b)))
  (and (mem26 a2 w) (mem (tuple2 (tuple2 b1 b1) b1)
  (Tuple2 (tuple2 b1 b1) b1 (t2tb36 a2) (t2tb14 x)) (t2tb2364 p)))))))

;; mem_image
  (assert
  (forall ((p (set (tuple21 (tuple21 b b) a))) (w (set (tuple21 b b))) (x a))
  (= (mem1 x (tb2t1 (image a1 (tuple2 b1 b1) (t2tb2366 p) (t2tb35 w))))
  (exists ((a2 (tuple21 b b)))
  (and (mem26 a2 w) (mem (tuple2 (tuple2 b1 b1) a1)
  (Tuple2 (tuple2 b1 b1) a1 (t2tb36 a2) (t2tb2 x)) (t2tb2366 p)))))))
...
;; mem_image
  ...
  (= (mem26 x
  (tb2t35
  (image (tuple2 b1 b1) (set1 (tuple2 a1 b1)) (t2tb2368 p) (t2tb10 w))))
...
;; mem_image
  ...
  b))) (x (tuple21 b b)))
  (= (mem26 x
  (tb2t35 (image (tuple2 b1 b1) (tuple2 a1 b1) (t2tb2370 p) (t2tb11 w))))
...
;; mem_image
  ...
  (= (mem26 x (tb2t35 (image (tuple2 b1 b1) b1 (t2tb2372 p) (t2tb12 w))))
  (exists ((a2 b))
  (and (mem2 a2 w) (mem (tuple2 b1 (tuple2 b1 b1))
  (Tuple2 b1 (tuple2 b1 b1) (t2tb14 a2) (t2tb36 x)) (t2tb2372 p)))))))
...
(declare-fun t2tb2383 ((set (tuple21 (tuple21 b a) (tuple21 b b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b a) (tuple21 b b))))) (sort
  (set1 (tuple2 (tuple2 b1 a1) (tuple2 b1 b1))) (t2tb2383 x))))

(declare-fun tb2t2383 (uni) (set (tuple21 (tuple21 b a) (tuple21 b b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b a) (tuple21 b b)))))
  (! (= (tb2t2383 (t2tb2383 i)) i) :pattern ((t2tb2383 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 a1) (tuple2 b1 b1))) j)
     (= (t2tb2383 (tb2t2383 j)) j)) :pattern ((t2tb2383 (tb2t2383 j))) )))

(declare-fun t2tb2384 ((tuple21 (tuple21 b a) (tuple21 b b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 b a) (tuple21 b b)))) (sort
  (tuple2 (tuple2 b1 a1) (tuple2 b1 b1)) (t2tb2384 x))))

(declare-fun tb2t2384 (uni) (tuple21 (tuple21 b a) (tuple21 b b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b a) (tuple21 b b))))
  (! (= (tb2t2384 (t2tb2384 i)) i) :pattern ((t2tb2384 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 a1) (tuple2 b1 b1)) j)
     (= (t2tb2384 (tb2t2384 j)) j)) :pattern ((t2tb2384 (tb2t2384 j))) )))
...
(assert
;; equal_semicolon_4
 ;; File "lemmes_bbook.why", line 1534, characters 7-24
  (not
  (forall ((s (set a)) (t (set b)) (v (set b)) (r (set (tuple21 a b))))
  (=> (and (mem4 r (relation1 s t)) (subset5 v t)) (infix_eqeq4
  (semicolon6 r (id2 v)) (range_restriction1 r v))))))
(check-sat)
