...
(declare-fun relation6 ((set (tuple21 a c)) (set (tuple21 b
...
(assert
;; mem_parallel_product_1
 ;; File "lemmes_bbook.why", line 579, characters 7-29
  (not
  (forall ((s (set a)) (t (set b)) (u (set c)) (v (set d)) (p (set (tuple21 a
  b))) (q (set (tuple21 c d))))
  (=> (and (mem4 p (relation1 s t)) (mem22 q (relation7 u v))) (mem25
  (parallel_product1 p q) (relation6 (times4 s u) (times10 t v)))))))
(check-sat)
