...
(declare-fun infix_gtmngt4 ((set a) (set (tuple21 b c))) (set (set (tuple21 a
  (tuple21 b c)))))
...
;; mem_total_bijection_set
  ...
  (and (mem15 x (infix_gtmngt4 s t)) (mem15 x
  (tb2t327 (infix_mnmngtgt (tuple2 b1 c1) a1 (t2tb1 s) (t2tb131 t))))))))
...
(assert
;; mem_direct_product_5
 ;; File "lemmes_bbook.why", line 545, characters 7-27
  (not
  (forall ((s (set a)) (t (set b)) (u (set c)) (f (set (tuple21 a b)))
  (g (set (tuple21 a c))))
  (=> (and (mem4 f (infix_gtmngt1 s t)) (mem11 g (infix_gtmngt2 s u))) (mem15
  (direct_product1 f g) (infix_gtmngt4 s (times3 t u)))))))
(check-sat)
