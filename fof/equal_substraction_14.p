...
fof(equal_substraction_14, conjecture, ![S, U, T, P, Q]: ((sort(set(a),
  ...
  b), domain_substraction(b, a, U, inter(tuple2(a, b), P, Q)),
  inter(tuple2(a, b), domain_substraction(b, a, U, P), domain_substraction(b,
  a, U, Q)))))))))).
