...
(assert
;; equal_image_21
 ;; File "lemmes_bbook.why", line 2465, characters 7-21
  (not
  (forall ((s (set a)) (u (set a)) (v (set a)) (t (set b)) (r (set (tuple21 a
  b))))
  (=>
  (and (mem6 (inverse2 r) (infix_plmngt2 t s))
  (and (subset2 u s) (subset2 v s))) (infix_eqeq3 (image1 r (inter1 u v))
  (inter3 (image1 r u) (image1 r v)))))))
(check-sat)
