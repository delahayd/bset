...
;; apply_def0
  ...
  (=>
  (and (mem (set1 (tuple2 b1 a1)) (t2tb37 f2)
  (infix_plmngt a1 b1 (t2tb12 s) (t2tb1 t))) (mem2 a2 (dom3 f2))) (mem5
...
(assert
;; equal_image_26
 ;; File "lemmes_bbook.why", line 2497, characters 7-21
  (not
  (forall ((s (set a)) (t (set b)) (r (set (tuple21 a b))))
  (=> (mem4 r (relation1 s t)) (infix_eqeq1 (image2 (inverse2 r) (ran1 r))
  (dom1 r))))))
(check-sat)
