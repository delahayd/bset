...
(declare-fun singleton9 ((set (tuple21 b c))) (set (set (tuple21 b c))))
...
;; mem_direct_product
  ...
  (and (mem (tuple2 b1 a1) (Tuple2 b1 a1 (t2tb14 x) (t2tb2 y)) (t2tb37 f))
  (mem8 (Tuple26 x z) g)))))
...
;; mem_parallel_product
  ...
  (and (mem (tuple2 b1 a1) (Tuple2 b1 a1 (t2tb14 x) (t2tb2 z)) (t2tb37 h))
  (mem (tuple2 c1 c1) (Tuple2 c1 c1 (t2tb135 y) (t2tb135 w)) (t2tb216 k))))))
...
;; mem_parallel_product
  ...
  (and (mem (tuple2 b1 a1) (Tuple2 b1 a1 (t2tb14 x) (t2tb2 z)) (t2tb37 h))
  (mem (tuple2 c1 b1) (Tuple2 c1 b1 (t2tb135 y) (t2tb14 w)) (t2tb222 k))))))
...
(assert
;; equal_semicolon_28
 ;; File "lemmes_bbook.why", line 1748, characters 7-25
  (not
  (forall ((s (set a)) (t (set b)) (u (set c)) (x a) (y b) (r (set (tuple21 b
  c))))
  (=> (and (mem1 x s) (and (mem2 y t) (mem9 r (relation4 t u)))) (infix_eqeq9
  (semicolon1 (singleton3 (Tuple21 x y)) r)
  (times4 (singleton1 x) (image3 r (singleton2 y))))))))
(check-sat)
