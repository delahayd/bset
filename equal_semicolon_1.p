...
tff(equal_semicolon_1, conjecture, ![A : $tType, B : $tType, C : $tType]:
  ![S:set(A), T:set(B), U:set(C), P:set(tuple2(B, C)), Q:set(tuple2(B, C)),
  R:set(tuple2(A, B))]: ((mem(set(tuple2(B, C)), P, relation(B, C, T, U))
  & (mem(set(tuple2(B, C)), Q, relation(B, C, T, U))
  & (mem(set(tuple2(A, B)), R, infix_plmngtgt(A, B, S, T))
  & infix_eqeq(tuple2(A, C), semicolon(A, B, C, R, P), semicolon(A, B, C, R,
