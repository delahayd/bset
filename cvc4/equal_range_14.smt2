...
(declare-fun inter13 ((set (set (tuple21 b a))) (set (set (tuple21 b
  a)))) (set (set (tuple21 b a))))

;; mem_inter
  (assert
  (forall ((s (set (set (tuple21 b a)))) (t (set (set (tuple21 b a))))
  (x (set (tuple21 b a))))
  (= (mem6 x (inter13 s t)) (and (mem6 x s) (mem6 x t)))))
...
;; mem_partial_surjection_set
  ...
  (and (mem6 x (infix_plmngt2 s t)) (infix_eqeq1 (ran2 x) t)))))

;; mem_partial_surjection_set
  (assert
  (forall ((s (set a)) (t (set b)) (x (set (tuple21 a b))))
  (= (mem (set1 (tuple2 a1 b1)) (t2tb11 x)
  (infix_plmngtgt b1 a1 (t2tb1 s) (t2tb12 t)))
  (and (mem (set1 (tuple2 a1 b1)) (t2tb11 x)
  (infix_plmngt b1 a1 (t2tb1 s) (t2tb12 t))) (infix_eqeq3 (ran1 x) t)))))
...
;; apply_def0
  ...
  (=>
  (and (mem6 f (infix_plmngt2 s t)) (mem2 a2
...
(assert
;; equal_range_14
 ;; File "lemmes_bbook.why", line 1460, characters 7-21
  (not
  (forall ((s (set a)) (t (set b)) (p (set (tuple21 a b))) (q (set (tuple21 a
  b))))
  (=>
  (and (mem6 (inverse2 p) (infix_plmngt2 t s))
  (and (mem6 (inverse2 q) (infix_plmngt2 t s)) (infix_eqeq4
  (range_restriction1 q (ran1 p)) (range_restriction1 p (ran1 q)))))
  (infix_eqeq3 (ran1 (inter4 p q)) (inter3 (ran1 p) (ran1 q)))))))
(check-sat)
