...
fof(equal_image_12, conjecture, ![S, U, T, P, Q]: ((sort(set(a), S) = S)
  ...
  S, T)) & subset(a, U, S))) => infix_eqeq(b, image(b, a, union(tuple2(a, b),
  P, Q), U), union(b, image(b, a, P, U), image(b, a, Q, U)))))))))).
