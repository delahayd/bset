...
(assert
;; mem_overriding_3
 ;; File "lemmes_bbook.why", line 470, characters 7-23
  (not
  (forall ((s (set a)) (t (set b)) (f (set (tuple21 a b))) (g (set (tuple21 a
  b))))
  (=>
  (and (mem4 f (infix_gtplgt1 s t))
  (and (mem4 g (infix_gtplgt1 s t)) (infix_eqeq3
  (inter3 (ran1 g) (ran1 (domain_substraction1 (dom1 g) f))) empty2))) (mem4
  (infix_lspl1 f g) (infix_gtplgt1 s t))))))
(check-sat)
