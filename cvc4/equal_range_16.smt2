...
;; mem_ran
  ...
  (= (mem2 x (ran1 p)) (exists ((a2 a)) (mem3 (Tuple21 a2 x) p)))))
...
(assert
;; equal_range_16
 ;; File "lemmes_bbook.why", line 1480, characters 7-21
  (not
  (forall ((s (set a)) (t (set b)) (x a) (y b))
  (=> (and (mem1 x s) (mem2 y t)) (infix_eqeq3
  (ran1 (singleton3 (Tuple21 x y))) (singleton2 y))))))
(check-sat)
