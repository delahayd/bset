...
;; mem_inverse
  ...
  (t2tb4 (inverse3 p))) (mem (tuple2 a1 a1)
  (Tuple2 a1 a1 (t2tb2 y) (t2tb2 x)) (t2tb4 p)))))
...
(assert
;; equal_inverse_3
 ;; File "lemmes_bbook.why", line 1114, characters 7-22
  (not (forall ((s (set a))) (infix_eqeq2 (inverse3 (id1 s)) (id1 s)))))
(check-sat)
