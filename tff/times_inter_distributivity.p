...
tff(times_inter_distributivity, conjecture, ![A : $tType]: ![A1:set(A), B:
  set(A), T:set(A)]: infix_eqeq(tuple2(A, A), times(A, A, T, inter(A, A1,
  B)), inter(tuple2(A, A), times(A, A, T, A1), times(A, A, T, B)))).
