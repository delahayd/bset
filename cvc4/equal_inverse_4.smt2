...
(assert
;; equal_inverse_4
 ;; File "lemmes_bbook.why", line 1119, characters 7-22
  (not
  (forall ((s (set a)) (u (set a)) (t (set b)) (r (set (tuple21 a b))))
  (=> (and (subset2 u s) (mem4 r (relation1 s t))) (infix_eqeq6
  (inverse2 (domain_restriction1 u r)) (range_restriction2 (inverse2 r) u))))))
(check-sat)
