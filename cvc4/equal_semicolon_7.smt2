...
(assert
;; equal_semicolon_7
 ;; File "lemmes_bbook.why", line 1558, characters 7-24
  (not
  (forall ((s (set a)) (t (set b)) (u (set c)) (w (set c)) (r (set (tuple21 a
  b))) (p (set (tuple21 b c))))
  (=>
  (and (mem4 r (relation1 s t)) (and (mem9 p (relation4 t u)) (subset9 w u)))
  (infix_eqeq9 (semicolon1 r (range_restriction4 p w))
  (range_restriction5 (semicolon1 r p) w))))))
(check-sat)
