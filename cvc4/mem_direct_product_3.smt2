...
(declare-fun infix_gtplgt5 ((set a) (set (tuple21 b c))) (set (set (tuple21 a
  (tuple21 b c)))))
...
;; mem_total_injection_set
  ...
  (and (mem15 x (infix_gtplgt5 s t)) (mem15 x
  (tb2t327 (infix_mnmngt (tuple2 b1 c1) a1 (t2tb1 s) (t2tb131 t))))))))
...
(assert
;; mem_direct_product_3
 ;; File "lemmes_bbook.why", line 529, characters 7-27
  (not
  (forall ((s (set a)) (t (set b)) (u (set c)) (f (set (tuple21 a b)))
  (g (set (tuple21 a c))))
  (=> (and (mem4 f (infix_gtplgt1 s t)) (mem11 g (infix_gtplgt3 s u))) (mem15
  (direct_product1 f g) (infix_gtplgt5 s (times3 t u)))))))
(check-sat)
