...
fof(inclusion_image_3, conjecture, ![S, U, T, P, Q]: ((sort(set(a), S) = S)
  ...
  S, T)) & subset(a, U, S))) => subset(b, image(b, a, inter(tuple2(a, b), P,
  Q), U), inter(b, image(b, a, P, U), image(b, a, Q, U)))))))))).
