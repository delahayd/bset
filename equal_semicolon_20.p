...
tff(equal_semicolon_20, conjecture, ![A : $tType, B : $tType]: ![S:set(A), U:
  ...
  => infix_eqeq(tuple2(A, A), semicolon(A, B, A, domain_restriction(A, B, U,
  P), R), domain_restriction(A, A, U, semicolon(A, B, A, P, R))))).
