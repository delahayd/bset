...
;; mem_partial_injection_set
  (assert
  (forall ((s (set a)) (t (set b)) (x (set (tuple21 a b))))
  (= (mem (set1 (tuple2 a1 b1)) (t2tb11 x) (t2tb10 (infix_gtplgt1 s t)))
  (and (mem (set1 (tuple2 a1 b1)) (t2tb11 x) (t2tb10 (infix_plmngt1 s t)))
...
;; mem_total_injection_set
  ...
  (forall ((s (set a)) (t (set b)) (x (set (tuple21 a b))))
  (= (mem (set1 (tuple2 a1 b1)) (t2tb11 x)
  (infix_gtmngt b1 a1 (t2tb1 s) (t2tb12 t)))
  (and (mem (set1 (tuple2 a1 b1)) (t2tb11 x) (t2tb10 (infix_gtplgt1 s t)))
  (mem (set1 (tuple2 a1 b1)) (t2tb11 x)
  (infix_mnmngt b1 a1 (t2tb1 s) (t2tb12 t)))))))
...
(assert
;; inclusion_function_8
 ;; File "lemmes_bbook.why", line 922, characters 7-27
  (not
  (forall ((s (set a)) (t (set b))) (subset7 (infix_gtplgt1 s t)
  (infix_plmngt1 s t)))))
(check-sat)
