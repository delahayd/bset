...
tff(equal_restriction_12, conjecture, ![A : $tType, B : $tType]: ![S:
  ...
  => infix_eqeq(tuple2(A, B), domain_restriction(A, B, U,
  union(tuple2(A, B), P, Q)), union(tuple2(A, B), domain_restriction(A, B, U,
  P), domain_restriction(A, B, U, Q))))).
