...
(declare-fun inter7 ((set (tuple21 b c)) (set (tuple21 b c))) (set (tuple21 b
  c)))

(declare-fun inter8 ((set (tuple21 a c)) (set (tuple21 a c))) (set (tuple21 a
  c)))

(declare-fun inter14 ((set (tuple21 c b)) (set (tuple21 c
  b))) (set (tuple21 c b)))

(declare-fun inter15 ((set (set (tuple21 c b))) (set (set (tuple21 c
  b)))) (set (set (tuple21 c b))))

;; mem_inter
  (assert
  (forall ((s (set (set (tuple21 c b)))) (t (set (set (tuple21 c b))))
  (x (set (tuple21 c b))))
  (= (mem31 x (inter15 s t)) (and (mem31 x s) (mem31 x t)))))

;; mem_inter
  (assert
  (forall ((s (set (tuple21 c b))) (t (set (tuple21 c b))) (x (tuple21 c b)))
  (= (mem28 x (inter14 s t)) (and (mem28 x s) (mem28 x t)))))
...
;; mem_inter
  (assert
  (forall ((s (set (tuple21 b c))) (t (set (tuple21 b c))) (x (tuple21 b c)))
  (= (mem8 x (inter7 s t)) (and (mem8 x s) (mem8 x t)))))
...
(declare-fun t2tb2757 ((set (tuple21 (set (tuple21 c b)) (set (tuple21 c
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (set (tuple21 c b)) (set (tuple21 c b)))))) (sort
  (set1 (tuple2 (set1 (tuple2 c1 b1)) (set1 (tuple2 c1 b1)))) (t2tb2757 x))))

(declare-fun tb2t2757 (uni) (set (tuple21 (set (tuple21 c b)) (set (tuple21 c
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (set (tuple21 c b)) (set (tuple21 c b))))))
  (! (= (tb2t2757 (t2tb2757 i)) i) :pattern ((t2tb2757 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (set1 (tuple2 c1 b1)) (set1 (tuple2 c1 b1)))) j)
     (= (t2tb2757 (tb2t2757 j)) j)) :pattern ((t2tb2757 (tb2t2757 j))) )))

(declare-fun t2tb2758 ((tuple21 (set (tuple21 c b)) (set (tuple21 c
  b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (set (tuple21 c b)) (set (tuple21 c b))))) (sort
  (tuple2 (set1 (tuple2 c1 b1)) (set1 (tuple2 c1 b1))) (t2tb2758 x))))

(declare-fun tb2t2758 (uni) (tuple21 (set (tuple21 c b)) (set (tuple21 c
  b))))

;; BridgeL
  (assert
  (forall ((i (tuple21 (set (tuple21 c b)) (set (tuple21 c b)))))
  (! (= (tb2t2758 (t2tb2758 i)) i) :pattern ((t2tb2758 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (set1 (tuple2 c1 b1)) (set1 (tuple2 c1 b1))) j)
     (= (t2tb2758 (tb2t2758 j)) j)) :pattern ((t2tb2758 (tb2t2758 j))) )))
...
(declare-fun t2tb2759 ((set (tuple21 (set (tuple21 c b)) (tuple21 c
  b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (set (tuple21 c b)) (tuple21 c b))))) (sort
  (set1 (tuple2 (set1 (tuple2 c1 b1)) (tuple2 c1 b1))) (t2tb2759 x))))

(declare-fun tb2t2759 (uni) (set (tuple21 (set (tuple21 c b)) (tuple21 c
  b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (set (tuple21 c b)) (tuple21 c b)))))
  (! (= (tb2t2759 (t2tb2759 i)) i) :pattern ((t2tb2759 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (set1 (tuple2 c1 b1)) (tuple2 c1 b1))) j)
     (= (t2tb2759 (tb2t2759 j)) j)) :pattern ((t2tb2759 (tb2t2759 j))) )))

(declare-fun t2tb2760 ((tuple21 (set (tuple21 c b)) (tuple21 c b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (set (tuple21 c b)) (tuple21 c b)))) (sort
  (tuple2 (set1 (tuple2 c1 b1)) (tuple2 c1 b1)) (t2tb2760 x))))

(declare-fun tb2t2760 (uni) (tuple21 (set (tuple21 c b)) (tuple21 c b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (set (tuple21 c b)) (tuple21 c b))))
  (! (= (tb2t2760 (t2tb2760 i)) i) :pattern ((t2tb2760 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (set1 (tuple2 c1 b1)) (tuple2 c1 b1)) j)
     (= (t2tb2760 (tb2t2760 j)) j)) :pattern ((t2tb2760 (tb2t2760 j))) )))
...
(declare-fun t2tb2761 ((set (tuple21 (set (tuple21 c b)) (tuple21 a
  c)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (set (tuple21 c b)) (tuple21 a c))))) (sort
  (set1 (tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 c1))) (t2tb2761 x))))

(declare-fun tb2t2761 (uni) (set (tuple21 (set (tuple21 c b)) (tuple21 a
  c))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (set (tuple21 c b)) (tuple21 a c)))))
  (! (= (tb2t2761 (t2tb2761 i)) i) :pattern ((t2tb2761 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 c1))) j)
     (= (t2tb2761 (tb2t2761 j)) j)) :pattern ((t2tb2761 (tb2t2761 j))) )))

(declare-fun t2tb2762 ((tuple21 (set (tuple21 c b)) (tuple21 a c))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (set (tuple21 c b)) (tuple21 a c)))) (sort
  (tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 c1)) (t2tb2762 x))))

(declare-fun tb2t2762 (uni) (tuple21 (set (tuple21 c b)) (tuple21 a c)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (set (tuple21 c b)) (tuple21 a c))))
  (! (= (tb2t2762 (t2tb2762 i)) i) :pattern ((t2tb2762 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 c1)) j)
     (= (t2tb2762 (tb2t2762 j)) j)) :pattern ((t2tb2762 (tb2t2762 j))) )))
...
(declare-fun t2tb2763 ((set (tuple21 (set (tuple21 c b)) (tuple21 b
  c)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (set (tuple21 c b)) (tuple21 b c))))) (sort
  (set1 (tuple2 (set1 (tuple2 c1 b1)) (tuple2 b1 c1))) (t2tb2763 x))))

(declare-fun tb2t2763 (uni) (set (tuple21 (set (tuple21 c b)) (tuple21 b
  c))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (set (tuple21 c b)) (tuple21 b c)))))
  (! (= (tb2t2763 (t2tb2763 i)) i) :pattern ((t2tb2763 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (set1 (tuple2 c1 b1)) (tuple2 b1 c1))) j)
     (= (t2tb2763 (tb2t2763 j)) j)) :pattern ((t2tb2763 (tb2t2763 j))) )))

(declare-fun t2tb2764 ((tuple21 (set (tuple21 c b)) (tuple21 b c))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (set (tuple21 c b)) (tuple21 b c)))) (sort
  (tuple2 (set1 (tuple2 c1 b1)) (tuple2 b1 c1)) (t2tb2764 x))))

(declare-fun tb2t2764 (uni) (tuple21 (set (tuple21 c b)) (tuple21 b c)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (set (tuple21 c b)) (tuple21 b c))))
  (! (= (tb2t2764 (t2tb2764 i)) i) :pattern ((t2tb2764 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (set1 (tuple2 c1 b1)) (tuple2 b1 c1)) j)
     (= (t2tb2764 (tb2t2764 j)) j)) :pattern ((t2tb2764 (tb2t2764 j))) )))
...
(declare-fun t2tb2765 ((set (tuple21 (set (tuple21 c b)) c))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (set (tuple21 c b)) c)))) (sort
  (set1 (tuple2 (set1 (tuple2 c1 b1)) c1)) (t2tb2765 x))))

(declare-fun tb2t2765 (uni) (set (tuple21 (set (tuple21 c b)) c)))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (set (tuple21 c b)) c))))
  (! (= (tb2t2765 (t2tb2765 i)) i) :pattern ((t2tb2765 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (set1 (tuple2 c1 b1)) c1)) j)
     (= (t2tb2765 (tb2t2765 j)) j)) :pattern ((t2tb2765 (tb2t2765 j))) )))

(declare-fun t2tb2766 ((tuple21 (set (tuple21 c b)) c)) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (set (tuple21 c b)) c))) (sort
  (tuple2 (set1 (tuple2 c1 b1)) c1) (t2tb2766 x))))

(declare-fun tb2t2766 (uni) (tuple21 (set (tuple21 c b)) c))

;; BridgeL
  (assert
  (forall ((i (tuple21 (set (tuple21 c b)) c)))
  (! (= (tb2t2766 (t2tb2766 i)) i) :pattern ((t2tb2766 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (set1 (tuple2 c1 b1)) c1) j)
     (= (t2tb2766 (tb2t2766 j)) j)) :pattern ((t2tb2766 (tb2t2766 j))) )))
...
(declare-fun t2tb2767 ((set (tuple21 (set (tuple21 c b)) (set (tuple21 a
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (set (tuple21 c b)) (set (tuple21 a b)))))) (sort
  (set1 (tuple2 (set1 (tuple2 c1 b1)) (set1 (tuple2 a1 b1)))) (t2tb2767 x))))

(declare-fun tb2t2767 (uni) (set (tuple21 (set (tuple21 c b)) (set (tuple21 a
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (set (tuple21 c b)) (set (tuple21 a b))))))
  (! (= (tb2t2767 (t2tb2767 i)) i) :pattern ((t2tb2767 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (set1 (tuple2 c1 b1)) (set1 (tuple2 a1 b1)))) j)
     (= (t2tb2767 (tb2t2767 j)) j)) :pattern ((t2tb2767 (tb2t2767 j))) )))

(declare-fun t2tb2768 ((tuple21 (set (tuple21 c b)) (set (tuple21 a
  b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (set (tuple21 c b)) (set (tuple21 a b))))) (sort
  (tuple2 (set1 (tuple2 c1 b1)) (set1 (tuple2 a1 b1))) (t2tb2768 x))))

(declare-fun tb2t2768 (uni) (tuple21 (set (tuple21 c b)) (set (tuple21 a
  b))))

;; BridgeL
  (assert
  (forall ((i (tuple21 (set (tuple21 c b)) (set (tuple21 a b)))))
  (! (= (tb2t2768 (t2tb2768 i)) i) :pattern ((t2tb2768 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (set1 (tuple2 c1 b1)) (set1 (tuple2 a1 b1))) j)
     (= (t2tb2768 (tb2t2768 j)) j)) :pattern ((t2tb2768 (tb2t2768 j))) )))
...
(declare-fun t2tb2769 ((tuple21 (set (tuple21 c b)) (tuple21 a b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (set (tuple21 c b)) (tuple21 a b)))) (sort
  (tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 b1)) (t2tb2769 x))))

(declare-fun tb2t2769 (uni) (tuple21 (set (tuple21 c b)) (tuple21 a b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (set (tuple21 c b)) (tuple21 a b))))
  (! (= (tb2t2769 (t2tb2769 i)) i) :pattern ((t2tb2769 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 b1)) j)
     (= (t2tb2769 (tb2t2769 j)) j)) :pattern ((t2tb2769 (tb2t2769 j))) )))

(declare-fun t2tb2770 ((set (tuple21 (set (tuple21 c b)) (tuple21 a
  b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (set (tuple21 c b)) (tuple21 a b))))) (sort
  (set1 (tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 b1))) (t2tb2770 x))))

(declare-fun tb2t2770 (uni) (set (tuple21 (set (tuple21 c b)) (tuple21 a
  b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (set (tuple21 c b)) (tuple21 a b)))))
  (! (= (tb2t2770 (t2tb2770 i)) i) :pattern ((t2tb2770 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 b1))) j)
     (= (t2tb2770 (tb2t2770 j)) j)) :pattern ((t2tb2770 (tb2t2770 j))) )))
...
(declare-fun t2tb2771 ((set (tuple21 (set (tuple21 c b)) b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (set (tuple21 c b)) b)))) (sort
  (set1 (tuple2 (set1 (tuple2 c1 b1)) b1)) (t2tb2771 x))))

(declare-fun tb2t2771 (uni) (set (tuple21 (set (tuple21 c b)) b)))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (set (tuple21 c b)) b))))
  (! (= (tb2t2771 (t2tb2771 i)) i) :pattern ((t2tb2771 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (set1 (tuple2 c1 b1)) b1)) j)
     (= (t2tb2771 (tb2t2771 j)) j)) :pattern ((t2tb2771 (tb2t2771 j))) )))

(declare-fun t2tb2772 ((tuple21 (set (tuple21 c b)) b)) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (set (tuple21 c b)) b))) (sort
  (tuple2 (set1 (tuple2 c1 b1)) b1) (t2tb2772 x))))

(declare-fun tb2t2772 (uni) (tuple21 (set (tuple21 c b)) b))

;; BridgeL
  (assert
  (forall ((i (tuple21 (set (tuple21 c b)) b)))
  (! (= (tb2t2772 (t2tb2772 i)) i) :pattern ((t2tb2772 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (set1 (tuple2 c1 b1)) b1) j)
     (= (t2tb2772 (tb2t2772 j)) j)) :pattern ((t2tb2772 (tb2t2772 j))) )))
...
(declare-fun t2tb2773 ((set (tuple21 (set (tuple21 c b)) a))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (set (tuple21 c b)) a)))) (sort
  (set1 (tuple2 (set1 (tuple2 c1 b1)) a1)) (t2tb2773 x))))

(declare-fun tb2t2773 (uni) (set (tuple21 (set (tuple21 c b)) a)))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (set (tuple21 c b)) a))))
  (! (= (tb2t2773 (t2tb2773 i)) i) :pattern ((t2tb2773 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (set1 (tuple2 c1 b1)) a1)) j)
     (= (t2tb2773 (tb2t2773 j)) j)) :pattern ((t2tb2773 (tb2t2773 j))) )))

(declare-fun t2tb2774 ((tuple21 (set (tuple21 c b)) a)) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (set (tuple21 c b)) a))) (sort
  (tuple2 (set1 (tuple2 c1 b1)) a1) (t2tb2774 x))))

(declare-fun tb2t2774 (uni) (tuple21 (set (tuple21 c b)) a))

;; BridgeL
  (assert
  (forall ((i (tuple21 (set (tuple21 c b)) a)))
  (! (= (tb2t2774 (t2tb2774 i)) i) :pattern ((t2tb2774 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (set1 (tuple2 c1 b1)) a1) j)
     (= (t2tb2774 (tb2t2774 j)) j)) :pattern ((t2tb2774 (tb2t2774 j))) )))
...
(declare-fun t2tb2775 ((set (tuple21 (tuple21 c b) (set (tuple21 c
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 c b) (set (tuple21 c b)))))) (sort
  (set1 (tuple2 (tuple2 c1 b1) (set1 (tuple2 c1 b1)))) (t2tb2775 x))))

(declare-fun tb2t2775 (uni) (set (tuple21 (tuple21 c b) (set (tuple21 c
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 c b) (set (tuple21 c b))))))
  (! (= (tb2t2775 (t2tb2775 i)) i) :pattern ((t2tb2775 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 c1 b1) (set1 (tuple2 c1 b1)))) j)
     (= (t2tb2775 (tb2t2775 j)) j)) :pattern ((t2tb2775 (tb2t2775 j))) )))

(declare-fun t2tb2776 ((tuple21 (tuple21 c b) (set (tuple21 c b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 c b) (set (tuple21 c b))))) (sort
  (tuple2 (tuple2 c1 b1) (set1 (tuple2 c1 b1))) (t2tb2776 x))))

(declare-fun tb2t2776 (uni) (tuple21 (tuple21 c b) (set (tuple21 c b))))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 c b) (set (tuple21 c b)))))
  (! (= (tb2t2776 (t2tb2776 i)) i) :pattern ((t2tb2776 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 c1 b1) (set1 (tuple2 c1 b1))) j)
     (= (t2tb2776 (tb2t2776 j)) j)) :pattern ((t2tb2776 (tb2t2776 j))) )))
...
(declare-fun t2tb2779 ((set (tuple21 (tuple21 c b) (tuple21 a c)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 c b) (tuple21 a c))))) (sort
  (set1 (tuple2 (tuple2 c1 b1) (tuple2 a1 c1))) (t2tb2779 x))))

(declare-fun tb2t2779 (uni) (set (tuple21 (tuple21 c b) (tuple21 a c))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 c b) (tuple21 a c)))))
  (! (= (tb2t2779 (t2tb2779 i)) i) :pattern ((t2tb2779 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 c1 b1) (tuple2 a1 c1))) j)
     (= (t2tb2779 (tb2t2779 j)) j)) :pattern ((t2tb2779 (tb2t2779 j))) )))

(declare-fun t2tb2780 ((tuple21 (tuple21 c b) (tuple21 a c))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 c b) (tuple21 a c)))) (sort
  (tuple2 (tuple2 c1 b1) (tuple2 a1 c1)) (t2tb2780 x))))

(declare-fun tb2t2780 (uni) (tuple21 (tuple21 c b) (tuple21 a c)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 c b) (tuple21 a c))))
  (! (= (tb2t2780 (t2tb2780 i)) i) :pattern ((t2tb2780 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 c1 b1) (tuple2 a1 c1)) j)
     (= (t2tb2780 (tb2t2780 j)) j)) :pattern ((t2tb2780 (tb2t2780 j))) )))
...
(declare-fun t2tb2781 ((set (tuple21 (tuple21 c b) (tuple21 b c)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 c b) (tuple21 b c))))) (sort
  (set1 (tuple2 (tuple2 c1 b1) (tuple2 b1 c1))) (t2tb2781 x))))

(declare-fun tb2t2781 (uni) (set (tuple21 (tuple21 c b) (tuple21 b c))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 c b) (tuple21 b c)))))
  (! (= (tb2t2781 (t2tb2781 i)) i) :pattern ((t2tb2781 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 c1 b1) (tuple2 b1 c1))) j)
     (= (t2tb2781 (tb2t2781 j)) j)) :pattern ((t2tb2781 (tb2t2781 j))) )))

(declare-fun t2tb2782 ((tuple21 (tuple21 c b) (tuple21 b c))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 c b) (tuple21 b c)))) (sort
  (tuple2 (tuple2 c1 b1) (tuple2 b1 c1)) (t2tb2782 x))))

(declare-fun tb2t2782 (uni) (tuple21 (tuple21 c b) (tuple21 b c)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 c b) (tuple21 b c))))
  (! (= (tb2t2782 (t2tb2782 i)) i) :pattern ((t2tb2782 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 c1 b1) (tuple2 b1 c1)) j)
     (= (t2tb2782 (tb2t2782 j)) j)) :pattern ((t2tb2782 (tb2t2782 j))) )))
...
(declare-fun t2tb2793 ((set (tuple21 (tuple21 a c) (set (tuple21 c
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 a c) (set (tuple21 c b)))))) (sort
  (set1 (tuple2 (tuple2 a1 c1) (set1 (tuple2 c1 b1)))) (t2tb2793 x))))

(declare-fun tb2t2793 (uni) (set (tuple21 (tuple21 a c) (set (tuple21 c
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 a c) (set (tuple21 c b))))))
  (! (= (tb2t2793 (t2tb2793 i)) i) :pattern ((t2tb2793 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 a1 c1) (set1 (tuple2 c1 b1)))) j)
     (= (t2tb2793 (tb2t2793 j)) j)) :pattern ((t2tb2793 (tb2t2793 j))) )))

(declare-fun t2tb2794 ((tuple21 (tuple21 a c) (set (tuple21 c b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 a c) (set (tuple21 c b))))) (sort
  (tuple2 (tuple2 a1 c1) (set1 (tuple2 c1 b1))) (t2tb2794 x))))

(declare-fun tb2t2794 (uni) (tuple21 (tuple21 a c) (set (tuple21 c b))))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 a c) (set (tuple21 c b)))))
  (! (= (tb2t2794 (t2tb2794 i)) i) :pattern ((t2tb2794 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 a1 c1) (set1 (tuple2 c1 b1))) j)
     (= (t2tb2794 (tb2t2794 j)) j)) :pattern ((t2tb2794 (tb2t2794 j))) )))
...
(declare-fun t2tb2795 ((set (tuple21 (tuple21 a c) (tuple21 c b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 a c) (tuple21 c b))))) (sort
  (set1 (tuple2 (tuple2 a1 c1) (tuple2 c1 b1))) (t2tb2795 x))))

(declare-fun tb2t2795 (uni) (set (tuple21 (tuple21 a c) (tuple21 c b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 a c) (tuple21 c b)))))
  (! (= (tb2t2795 (t2tb2795 i)) i) :pattern ((t2tb2795 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 a1 c1) (tuple2 c1 b1))) j)
     (= (t2tb2795 (tb2t2795 j)) j)) :pattern ((t2tb2795 (tb2t2795 j))) )))

(declare-fun t2tb2796 ((tuple21 (tuple21 a c) (tuple21 c b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 a c) (tuple21 c b)))) (sort
  (tuple2 (tuple2 a1 c1) (tuple2 c1 b1)) (t2tb2796 x))))

(declare-fun tb2t2796 (uni) (tuple21 (tuple21 a c) (tuple21 c b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 a c) (tuple21 c b))))
  (! (= (tb2t2796 (t2tb2796 i)) i) :pattern ((t2tb2796 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 a1 c1) (tuple2 c1 b1)) j)
     (= (t2tb2796 (tb2t2796 j)) j)) :pattern ((t2tb2796 (tb2t2796 j))) )))
...
(declare-fun t2tb2797 ((tuple21 (tuple21 b c) (set (tuple21 c b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 b c) (set (tuple21 c b))))) (sort
  (tuple2 (tuple2 b1 c1) (set1 (tuple2 c1 b1))) (t2tb2797 x))))

(declare-fun tb2t2797 (uni) (tuple21 (tuple21 b c) (set (tuple21 c b))))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b c) (set (tuple21 c b)))))
  (! (= (tb2t2797 (t2tb2797 i)) i) :pattern ((t2tb2797 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 c1) (set1 (tuple2 c1 b1))) j)
     (= (t2tb2797 (tb2t2797 j)) j)) :pattern ((t2tb2797 (tb2t2797 j))) )))

(declare-fun t2tb2798 ((set (tuple21 (tuple21 b c) (set (tuple21 c
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b c) (set (tuple21 c b)))))) (sort
  (set1 (tuple2 (tuple2 b1 c1) (set1 (tuple2 c1 b1)))) (t2tb2798 x))))

(declare-fun tb2t2798 (uni) (set (tuple21 (tuple21 b c) (set (tuple21 c
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b c) (set (tuple21 c b))))))
  (! (= (tb2t2798 (t2tb2798 i)) i) :pattern ((t2tb2798 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 c1) (set1 (tuple2 c1 b1)))) j)
     (= (t2tb2798 (tb2t2798 j)) j)) :pattern ((t2tb2798 (tb2t2798 j))) )))
...
(declare-fun t2tb2799 ((set (tuple21 (tuple21 b c) (tuple21 c b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b c) (tuple21 c b))))) (sort
  (set1 (tuple2 (tuple2 b1 c1) (tuple2 c1 b1))) (t2tb2799 x))))

(declare-fun tb2t2799 (uni) (set (tuple21 (tuple21 b c) (tuple21 c b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b c) (tuple21 c b)))))
  (! (= (tb2t2799 (t2tb2799 i)) i) :pattern ((t2tb2799 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 c1) (tuple2 c1 b1))) j)
     (= (t2tb2799 (tb2t2799 j)) j)) :pattern ((t2tb2799 (tb2t2799 j))) )))

(declare-fun t2tb2800 ((tuple21 (tuple21 b c) (tuple21 c b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 b c) (tuple21 c b)))) (sort
  (tuple2 (tuple2 b1 c1) (tuple2 c1 b1)) (t2tb2800 x))))

(declare-fun tb2t2800 (uni) (tuple21 (tuple21 b c) (tuple21 c b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b c) (tuple21 c b))))
  (! (= (tb2t2800 (t2tb2800 i)) i) :pattern ((t2tb2800 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 c1) (tuple2 c1 b1)) j)
     (= (t2tb2800 (tb2t2800 j)) j)) :pattern ((t2tb2800 (tb2t2800 j))) )))
...
(declare-fun t2tb2801 ((set (tuple21 c (set (tuple21 c b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 c (set (tuple21 c b)))))) (sort
  (set1 (tuple2 c1 (set1 (tuple2 c1 b1)))) (t2tb2801 x))))

(declare-fun tb2t2801 (uni) (set (tuple21 c (set (tuple21 c b)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 c (set (tuple21 c b))))))
  (! (= (tb2t2801 (t2tb2801 i)) i) :pattern ((t2tb2801 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 c1 (set1 (tuple2 c1 b1)))) j)
     (= (t2tb2801 (tb2t2801 j)) j)) :pattern ((t2tb2801 (tb2t2801 j))) )))

(declare-fun t2tb2802 ((tuple21 c (set (tuple21 c b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 c (set (tuple21 c b))))) (sort
  (tuple2 c1 (set1 (tuple2 c1 b1))) (t2tb2802 x))))

(declare-fun tb2t2802 (uni) (tuple21 c (set (tuple21 c b))))

;; BridgeL
  (assert
  (forall ((i (tuple21 c (set (tuple21 c b)))))
  (! (= (tb2t2802 (t2tb2802 i)) i) :pattern ((t2tb2802 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 c1 (set1 (tuple2 c1 b1))) j)
     (= (t2tb2802 (tb2t2802 j)) j)) :pattern ((t2tb2802 (tb2t2802 j))) )))
...
(declare-fun t2tb2805 ((set (tuple21 (set (tuple21 a b)) (set (tuple21 c
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (set (tuple21 a b)) (set (tuple21 c b)))))) (sort
  (set1 (tuple2 (set1 (tuple2 a1 b1)) (set1 (tuple2 c1 b1)))) (t2tb2805 x))))

(declare-fun tb2t2805 (uni) (set (tuple21 (set (tuple21 a b)) (set (tuple21 c
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (set (tuple21 a b)) (set (tuple21 c b))))))
  (! (= (tb2t2805 (t2tb2805 i)) i) :pattern ((t2tb2805 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (set1 (tuple2 a1 b1)) (set1 (tuple2 c1 b1)))) j)
     (= (t2tb2805 (tb2t2805 j)) j)) :pattern ((t2tb2805 (tb2t2805 j))) )))

(declare-fun t2tb2806 ((tuple21 (set (tuple21 a b)) (set (tuple21 c
  b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (set (tuple21 a b)) (set (tuple21 c b))))) (sort
  (tuple2 (set1 (tuple2 a1 b1)) (set1 (tuple2 c1 b1))) (t2tb2806 x))))

(declare-fun tb2t2806 (uni) (tuple21 (set (tuple21 a b)) (set (tuple21 c
  b))))

;; BridgeL
  (assert
  (forall ((i (tuple21 (set (tuple21 a b)) (set (tuple21 c b)))))
  (! (= (tb2t2806 (t2tb2806 i)) i) :pattern ((t2tb2806 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (set1 (tuple2 a1 b1)) (set1 (tuple2 c1 b1))) j)
     (= (t2tb2806 (tb2t2806 j)) j)) :pattern ((t2tb2806 (tb2t2806 j))) )))
...
(declare-fun t2tb2809 ((set (tuple21 (tuple21 a b) (set (tuple21 c
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 a b) (set (tuple21 c b)))))) (sort
  (set1 (tuple2 (tuple2 a1 b1) (set1 (tuple2 c1 b1)))) (t2tb2809 x))))

(declare-fun tb2t2809 (uni) (set (tuple21 (tuple21 a b) (set (tuple21 c
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 a b) (set (tuple21 c b))))))
  (! (= (tb2t2809 (t2tb2809 i)) i) :pattern ((t2tb2809 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 a1 b1) (set1 (tuple2 c1 b1)))) j)
     (= (t2tb2809 (tb2t2809 j)) j)) :pattern ((t2tb2809 (tb2t2809 j))) )))

(declare-fun t2tb2810 ((tuple21 (tuple21 a b) (set (tuple21 c b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 a b) (set (tuple21 c b))))) (sort
  (tuple2 (tuple2 a1 b1) (set1 (tuple2 c1 b1))) (t2tb2810 x))))

(declare-fun tb2t2810 (uni) (tuple21 (tuple21 a b) (set (tuple21 c b))))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 a b) (set (tuple21 c b)))))
  (! (= (tb2t2810 (t2tb2810 i)) i) :pattern ((t2tb2810 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 a1 b1) (set1 (tuple2 c1 b1))) j)
     (= (t2tb2810 (tb2t2810 j)) j)) :pattern ((t2tb2810 (tb2t2810 j))) )))
...
(declare-fun t2tb2813 ((tuple21 b (set (tuple21 c b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 b (set (tuple21 c b))))) (sort
  (tuple2 b1 (set1 (tuple2 c1 b1))) (t2tb2813 x))))

(declare-fun tb2t2813 (uni) (tuple21 b (set (tuple21 c b))))

;; BridgeL
  (assert
  (forall ((i (tuple21 b (set (tuple21 c b)))))
  (! (= (tb2t2813 (t2tb2813 i)) i) :pattern ((t2tb2813 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 b1 (set1 (tuple2 c1 b1))) j)
     (= (t2tb2813 (tb2t2813 j)) j)) :pattern ((t2tb2813 (tb2t2813 j))) )))

(declare-fun t2tb2814 ((set (tuple21 b (set (tuple21 c b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 b (set (tuple21 c b)))))) (sort
  (set1 (tuple2 b1 (set1 (tuple2 c1 b1)))) (t2tb2814 x))))

(declare-fun tb2t2814 (uni) (set (tuple21 b (set (tuple21 c b)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 b (set (tuple21 c b))))))
  (! (= (tb2t2814 (t2tb2814 i)) i) :pattern ((t2tb2814 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 b1 (set1 (tuple2 c1 b1)))) j)
     (= (t2tb2814 (tb2t2814 j)) j)) :pattern ((t2tb2814 (tb2t2814 j))) )))
...
(declare-fun t2tb2817 ((set (tuple21 a (set (tuple21 c b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 a (set (tuple21 c b)))))) (sort
  (set1 (tuple2 a1 (set1 (tuple2 c1 b1)))) (t2tb2817 x))))

(declare-fun tb2t2817 (uni) (set (tuple21 a (set (tuple21 c b)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 a (set (tuple21 c b))))))
  (! (= (tb2t2817 (t2tb2817 i)) i) :pattern ((t2tb2817 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 a1 (set1 (tuple2 c1 b1)))) j)
     (= (t2tb2817 (tb2t2817 j)) j)) :pattern ((t2tb2817 (tb2t2817 j))) )))

(declare-fun t2tb2818 ((tuple21 a (set (tuple21 c b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 a (set (tuple21 c b))))) (sort
  (tuple2 a1 (set1 (tuple2 c1 b1))) (t2tb2818 x))))

(declare-fun tb2t2818 (uni) (tuple21 a (set (tuple21 c b))))

;; BridgeL
  (assert
  (forall ((i (tuple21 a (set (tuple21 c b)))))
  (! (= (tb2t2818 (t2tb2818 i)) i) :pattern ((t2tb2818 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 a1 (set1 (tuple2 c1 b1))) j)
     (= (t2tb2818 (tb2t2818 j)) j)) :pattern ((t2tb2818 (tb2t2818 j))) )))
...
(declare-fun t2tb2819 ((set (set (set (tuple21 c b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (set (tuple21 c b)))))) (sort
  (set1 (set1 (set1 (tuple2 c1 b1)))) (t2tb2819 x))))

(declare-fun tb2t2819 (uni) (set (set (set (tuple21 c b)))))

;; BridgeL
  (assert
  (forall ((i (set (set (set (tuple21 c b))))))
  (! (= (tb2t2819 (t2tb2819 i)) i) :pattern ((t2tb2819 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (set1 (tuple2 c1 b1)))) j)
     (= (t2tb2819 (tb2t2819 j)) j)) :pattern ((t2tb2819 (tb2t2819 j))) )))
...
(declare-fun t2tb2820 ((set (set (tuple21 (set (tuple21 c b)) (set (tuple21 c
  b)))))) uni)
...
(declare-fun tb2t2820 (uni) (set (set (tuple21 (set (tuple21 c b))
  (set (tuple21 c b))))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (set (tuple21 c b)) (set (tuple21 c b)))))))
  (! (= (tb2t2820 (t2tb2820 i)) i) :pattern ((t2tb2820 i)) )))
...
;; BridgeR
  ...
  (! (=> (sort
     ...
     (= (t2tb2820 (tb2t2820 j)) j)) :pattern ((t2tb2820 (tb2t2820 j))) )))
...
;; mem_relation
  ...
  (=> (mem (tuple2 (set1 (tuple2 c1 b1)) (set1 (tuple2 c1 b1)))
  (Tuple2 (set1 (tuple2 c1 b1)) (set1 (tuple2 c1 b1)) (t2tb222 x)
  (t2tb222 y)) (t2tb2757 r)) (and (mem31 x u) (mem31 y v)))))))

(declare-fun t2tb2821 ((set (set (tuple21 (set (tuple21 c b)) (tuple21 c
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (set (tuple21 c b)) (tuple21 c b)))))) (sort
  (set1 (set1 (tuple2 (set1 (tuple2 c1 b1)) (tuple2 c1 b1)))) (t2tb2821 x))))

(declare-fun tb2t2821 (uni) (set (set (tuple21 (set (tuple21 c b)) (tuple21 c
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (set (tuple21 c b)) (tuple21 c b))))))
  (! (= (tb2t2821 (t2tb2821 i)) i) :pattern ((t2tb2821 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (set1 (tuple2 c1 b1)) (tuple2 c1 b1)))) j)
     (= (t2tb2821 (tb2t2821 j)) j)) :pattern ((t2tb2821 (tb2t2821 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (set (tuple21 c b)))) (v (set (tuple21 c b)))
  (r (set (tuple21 (set (tuple21 c b)) (tuple21 c b)))))
  (= (mem (set1 (tuple2 (set1 (tuple2 c1 b1)) (tuple2 c1 b1))) (t2tb2759 r)
  (relation (tuple2 c1 b1) (set1 (tuple2 c1 b1)) (t2tb308 u) (t2tb222 v)))
  (forall ((x (set (tuple21 c b))) (y (tuple21 c b)))
  (=> (mem (tuple2 (set1 (tuple2 c1 b1)) (tuple2 c1 b1))
  (Tuple2 (set1 (tuple2 c1 b1)) (tuple2 c1 b1) (t2tb222 x) (t2tb223 y))
  (t2tb2759 r)) (and (mem31 x u) (mem28 y v)))))))

(declare-fun t2tb2822 ((set (set (tuple21 (set (tuple21 c b)) (tuple21 a
  c))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (set (tuple21 c b)) (tuple21 a c)))))) (sort
  (set1 (set1 (tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 c1)))) (t2tb2822 x))))

(declare-fun tb2t2822 (uni) (set (set (tuple21 (set (tuple21 c b)) (tuple21 a
  c)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (set (tuple21 c b)) (tuple21 a c))))))
  (! (= (tb2t2822 (t2tb2822 i)) i) :pattern ((t2tb2822 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 c1)))) j)
     (= (t2tb2822 (tb2t2822 j)) j)) :pattern ((t2tb2822 (tb2t2822 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (set (tuple21 c b)))) (v (set (tuple21 a c)))
  (r (set (tuple21 (set (tuple21 c b)) (tuple21 a c)))))
  (= (mem (set1 (tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 c1))) (t2tb2761 r)
  (relation (tuple2 a1 c1) (set1 (tuple2 c1 b1)) (t2tb308 u) (t2tb129 v)))
  (forall ((x (set (tuple21 c b))) (y (tuple21 a c)))
  (=> (mem (tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 c1))
  (Tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 c1) (t2tb222 x) (t2tb133 y))
  (t2tb2761 r)) (and (mem31 x u) (mem10 y v)))))))

(declare-fun t2tb2823 ((set (set (tuple21 (set (tuple21 c b)) (tuple21 b
  c))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (set (tuple21 c b)) (tuple21 b c)))))) (sort
  (set1 (set1 (tuple2 (set1 (tuple2 c1 b1)) (tuple2 b1 c1)))) (t2tb2823 x))))

(declare-fun tb2t2823 (uni) (set (set (tuple21 (set (tuple21 c b)) (tuple21 b
  c)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (set (tuple21 c b)) (tuple21 b c))))))
  (! (= (tb2t2823 (t2tb2823 i)) i) :pattern ((t2tb2823 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (set1 (tuple2 c1 b1)) (tuple2 b1 c1)))) j)
     (= (t2tb2823 (tb2t2823 j)) j)) :pattern ((t2tb2823 (tb2t2823 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (set (tuple21 c b)))) (v (set (tuple21 b c)))
  (r (set (tuple21 (set (tuple21 c b)) (tuple21 b c)))))
  (= (mem (set1 (tuple2 (set1 (tuple2 c1 b1)) (tuple2 b1 c1))) (t2tb2763 r)
  (relation (tuple2 b1 c1) (set1 (tuple2 c1 b1)) (t2tb308 u) (t2tb131 v)))
  (forall ((x (set (tuple21 c b))) (y (tuple21 b c)))
  (=> (mem (tuple2 (set1 (tuple2 c1 b1)) (tuple2 b1 c1))
  (Tuple2 (set1 (tuple2 c1 b1)) (tuple2 b1 c1) (t2tb222 x) (t2tb134 y))
  (t2tb2763 r)) (and (mem31 x u) (mem8 y v)))))))

(declare-fun t2tb2824 ((set (set (tuple21 (set (tuple21 c b)) c)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (set (tuple21 c b)) c))))) (sort
  (set1 (set1 (tuple2 (set1 (tuple2 c1 b1)) c1))) (t2tb2824 x))))

(declare-fun tb2t2824 (uni) (set (set (tuple21 (set (tuple21 c b)) c))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (set (tuple21 c b)) c)))))
  (! (= (tb2t2824 (t2tb2824 i)) i) :pattern ((t2tb2824 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (set1 (tuple2 c1 b1)) c1))) j)
     (= (t2tb2824 (tb2t2824 j)) j)) :pattern ((t2tb2824 (tb2t2824 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (set (tuple21 c b)))) (v (set c))
  (r (set (tuple21 (set (tuple21 c b)) c))))
  (= (mem (set1 (tuple2 (set1 (tuple2 c1 b1)) c1)) (t2tb2765 r)
  (relation c1 (set1 (tuple2 c1 b1)) (t2tb308 u) (t2tb132 v)))
  (forall ((x (set (tuple21 c b))) (y c))
  (=> (mem (tuple2 (set1 (tuple2 c1 b1)) c1)
  (Tuple2 (set1 (tuple2 c1 b1)) c1 (t2tb222 x) (t2tb135 y)) (t2tb2765 r))
  (and (mem31 x u) (mem7 y v)))))))

(declare-fun t2tb2825 ((set (set (tuple21 (set (tuple21 c b)) (set (tuple21 a
  b)))))) uni)
...
(declare-fun tb2t2825 (uni) (set (set (tuple21 (set (tuple21 c b))
  (set (tuple21 a b))))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (set (tuple21 c b)) (set (tuple21 a b)))))))
  (! (= (tb2t2825 (t2tb2825 i)) i) :pattern ((t2tb2825 i)) )))
...
;; BridgeR
  ...
  (! (=> (sort
     ...
     (= (t2tb2825 (tb2t2825 j)) j)) :pattern ((t2tb2825 (tb2t2825 j))) )))
...
;; mem_relation
  ...
  (=> (mem (tuple2 (set1 (tuple2 c1 b1)) (set1 (tuple2 a1 b1)))
  (Tuple2 (set1 (tuple2 c1 b1)) (set1 (tuple2 a1 b1)) (t2tb222 x) (t2tb11 y))
  (t2tb2767 r)) (and (mem31 x u) (mem4 y v)))))))

(declare-fun t2tb2826 ((set (set (tuple21 (set (tuple21 c b)) (tuple21 a
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (set (tuple21 c b)) (tuple21 a b)))))) (sort
  (set1 (set1 (tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 b1)))) (t2tb2826 x))))

(declare-fun tb2t2826 (uni) (set (set (tuple21 (set (tuple21 c b)) (tuple21 a
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (set (tuple21 c b)) (tuple21 a b))))))
  (! (= (tb2t2826 (t2tb2826 i)) i) :pattern ((t2tb2826 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 b1)))) j)
     (= (t2tb2826 (tb2t2826 j)) j)) :pattern ((t2tb2826 (tb2t2826 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (set (tuple21 c b)))) (v (set (tuple21 a b)))
  (r (set (tuple21 (set (tuple21 c b)) (tuple21 a b)))))
  (= (mem (set1 (tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 b1))) (t2tb2770 r)
  (relation (tuple2 a1 b1) (set1 (tuple2 c1 b1)) (t2tb308 u) (t2tb11 v)))
  (forall ((x (set (tuple21 c b))) (y (tuple21 a b)))
  (=> (mem (tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 b1))
  (Tuple2 (set1 (tuple2 c1 b1)) (tuple2 a1 b1) (t2tb222 x) (t2tb13 y))
  (t2tb2770 r)) (and (mem31 x u) (mem3 y v)))))))

(declare-fun t2tb2827 ((set (set (tuple21 (set (tuple21 c b)) b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (set (tuple21 c b)) b))))) (sort
  (set1 (set1 (tuple2 (set1 (tuple2 c1 b1)) b1))) (t2tb2827 x))))

(declare-fun tb2t2827 (uni) (set (set (tuple21 (set (tuple21 c b)) b))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (set (tuple21 c b)) b)))))
  (! (= (tb2t2827 (t2tb2827 i)) i) :pattern ((t2tb2827 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (set1 (tuple2 c1 b1)) b1))) j)
     (= (t2tb2827 (tb2t2827 j)) j)) :pattern ((t2tb2827 (tb2t2827 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (set (tuple21 c b)))) (v (set b))
  (r (set (tuple21 (set (tuple21 c b)) b))))
  (= (mem (set1 (tuple2 (set1 (tuple2 c1 b1)) b1)) (t2tb2771 r)
  (relation b1 (set1 (tuple2 c1 b1)) (t2tb308 u) (t2tb12 v)))
  (forall ((x (set (tuple21 c b))) (y b))
  (=> (mem (tuple2 (set1 (tuple2 c1 b1)) b1)
  (Tuple2 (set1 (tuple2 c1 b1)) b1 (t2tb222 x) (t2tb14 y)) (t2tb2771 r))
  (and (mem31 x u) (mem2 y v)))))))

(declare-fun t2tb2828 ((set (set (tuple21 (set (tuple21 c b)) a)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (set (tuple21 c b)) a))))) (sort
  (set1 (set1 (tuple2 (set1 (tuple2 c1 b1)) a1))) (t2tb2828 x))))

(declare-fun tb2t2828 (uni) (set (set (tuple21 (set (tuple21 c b)) a))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (set (tuple21 c b)) a)))))
  (! (= (tb2t2828 (t2tb2828 i)) i) :pattern ((t2tb2828 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (set1 (tuple2 c1 b1)) a1))) j)
     (= (t2tb2828 (tb2t2828 j)) j)) :pattern ((t2tb2828 (tb2t2828 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (set (tuple21 c b)))) (v (set a))
  (r (set (tuple21 (set (tuple21 c b)) a))))
  (= (mem (set1 (tuple2 (set1 (tuple2 c1 b1)) a1)) (t2tb2773 r)
  (relation a1 (set1 (tuple2 c1 b1)) (t2tb308 u) (t2tb1 v)))
  (forall ((x (set (tuple21 c b))) (y a))
  (=> (mem (tuple2 (set1 (tuple2 c1 b1)) a1)
  (Tuple2 (set1 (tuple2 c1 b1)) a1 (t2tb222 x) (t2tb2 y)) (t2tb2773 r))
...
(declare-fun t2tb2829 ((set (set (tuple21 (tuple21 c b) (set (tuple21 c
  b)))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 c b) (set (tuple21 c b))))))) (sort
  (set1 (set1 (tuple2 (tuple2 c1 b1) (set1 (tuple2 c1 b1))))) (t2tb2829 x))))

(declare-fun tb2t2829 (uni) (set (set (tuple21 (tuple21 c b) (set (tuple21 c
  b))))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 c b) (set (tuple21 c b)))))))
  (! (= (tb2t2829 (t2tb2829 i)) i) :pattern ((t2tb2829 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 c1 b1) (set1 (tuple2 c1 b1))))) j)
     (= (t2tb2829 (tb2t2829 j)) j)) :pattern ((t2tb2829 (tb2t2829 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 c b))) (v (set (set (tuple21 c b))))
  (r (set (tuple21 (tuple21 c b) (set (tuple21 c b))))))
  (= (mem (set1 (tuple2 (tuple2 c1 b1) (set1 (tuple2 c1 b1)))) (t2tb2775 r)
  (relation (set1 (tuple2 c1 b1)) (tuple2 c1 b1) (t2tb222 u) (t2tb308 v)))
  (forall ((x (tuple21 c b)) (y (set (tuple21 c b))))
  (=> (mem (tuple2 (tuple2 c1 b1) (set1 (tuple2 c1 b1)))
  (Tuple2 (tuple2 c1 b1) (set1 (tuple2 c1 b1)) (t2tb223 x) (t2tb222 y))
  (t2tb2775 r)) (and (mem28 x u) (mem31 y v)))))))
...
(declare-fun t2tb2831 ((set (set (tuple21 (tuple21 c b) (tuple21 a
  c))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 c b) (tuple21 a c)))))) (sort
  (set1 (set1 (tuple2 (tuple2 c1 b1) (tuple2 a1 c1)))) (t2tb2831 x))))

(declare-fun tb2t2831 (uni) (set (set (tuple21 (tuple21 c b) (tuple21 a
  c)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 c b) (tuple21 a c))))))
  (! (= (tb2t2831 (t2tb2831 i)) i) :pattern ((t2tb2831 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 c1 b1) (tuple2 a1 c1)))) j)
     (= (t2tb2831 (tb2t2831 j)) j)) :pattern ((t2tb2831 (tb2t2831 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 c b))) (v (set (tuple21 a c)))
  (r (set (tuple21 (tuple21 c b) (tuple21 a c)))))
  (= (mem (set1 (tuple2 (tuple2 c1 b1) (tuple2 a1 c1))) (t2tb2779 r)
  (relation (tuple2 a1 c1) (tuple2 c1 b1) (t2tb222 u) (t2tb129 v)))
  (forall ((x (tuple21 c b)) (y (tuple21 a c)))
  (=> (mem (tuple2 (tuple2 c1 b1) (tuple2 a1 c1))
  (Tuple2 (tuple2 c1 b1) (tuple2 a1 c1) (t2tb223 x) (t2tb133 y))
  (t2tb2779 r)) (and (mem28 x u) (mem10 y v)))))))

(declare-fun t2tb2832 ((set (set (tuple21 (tuple21 c b) (tuple21 b
  c))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 c b) (tuple21 b c)))))) (sort
  (set1 (set1 (tuple2 (tuple2 c1 b1) (tuple2 b1 c1)))) (t2tb2832 x))))

(declare-fun tb2t2832 (uni) (set (set (tuple21 (tuple21 c b) (tuple21 b
  c)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 c b) (tuple21 b c))))))
  (! (= (tb2t2832 (t2tb2832 i)) i) :pattern ((t2tb2832 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 c1 b1) (tuple2 b1 c1)))) j)
     (= (t2tb2832 (tb2t2832 j)) j)) :pattern ((t2tb2832 (tb2t2832 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 c b))) (v (set (tuple21 b c)))
  (r (set (tuple21 (tuple21 c b) (tuple21 b c)))))
  (= (mem (set1 (tuple2 (tuple2 c1 b1) (tuple2 b1 c1))) (t2tb2781 r)
  (relation (tuple2 b1 c1) (tuple2 c1 b1) (t2tb222 u) (t2tb131 v)))
  (forall ((x (tuple21 c b)) (y (tuple21 b c)))
  (=> (mem (tuple2 (tuple2 c1 b1) (tuple2 b1 c1))
  (Tuple2 (tuple2 c1 b1) (tuple2 b1 c1) (t2tb223 x) (t2tb134 y))
  (t2tb2781 r)) (and (mem28 x u) (mem8 y v)))))))
...
(declare-fun t2tb2838 ((set (set (tuple21 (tuple21 a c) (set (tuple21 c
  b)))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 a c) (set (tuple21 c b))))))) (sort
  (set1 (set1 (tuple2 (tuple2 a1 c1) (set1 (tuple2 c1 b1))))) (t2tb2838 x))))

(declare-fun tb2t2838 (uni) (set (set (tuple21 (tuple21 a c) (set (tuple21 c
  b))))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 a c) (set (tuple21 c b)))))))
  (! (= (tb2t2838 (t2tb2838 i)) i) :pattern ((t2tb2838 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 a1 c1) (set1 (tuple2 c1 b1))))) j)
     (= (t2tb2838 (tb2t2838 j)) j)) :pattern ((t2tb2838 (tb2t2838 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 a c))) (v (set (set (tuple21 c b))))
  (r (set (tuple21 (tuple21 a c) (set (tuple21 c b))))))
  (= (mem (set1 (tuple2 (tuple2 a1 c1) (set1 (tuple2 c1 b1)))) (t2tb2793 r)
  (relation (set1 (tuple2 c1 b1)) (tuple2 a1 c1) (t2tb129 u) (t2tb308 v)))
  (forall ((x (tuple21 a c)) (y (set (tuple21 c b))))
  (=> (mem (tuple2 (tuple2 a1 c1) (set1 (tuple2 c1 b1)))
  (Tuple2 (tuple2 a1 c1) (set1 (tuple2 c1 b1)) (t2tb133 x) (t2tb222 y))
  (t2tb2793 r)) (and (mem10 x u) (mem31 y v)))))))

(declare-fun t2tb2839 ((set (set (tuple21 (tuple21 a c) (tuple21 c
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 a c) (tuple21 c b)))))) (sort
  (set1 (set1 (tuple2 (tuple2 a1 c1) (tuple2 c1 b1)))) (t2tb2839 x))))

(declare-fun tb2t2839 (uni) (set (set (tuple21 (tuple21 a c) (tuple21 c
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 a c) (tuple21 c b))))))
  (! (= (tb2t2839 (t2tb2839 i)) i) :pattern ((t2tb2839 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 a1 c1) (tuple2 c1 b1)))) j)
     (= (t2tb2839 (tb2t2839 j)) j)) :pattern ((t2tb2839 (tb2t2839 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 a c))) (v (set (tuple21 c b)))
  (r (set (tuple21 (tuple21 a c) (tuple21 c b)))))
  (= (mem (set1 (tuple2 (tuple2 a1 c1) (tuple2 c1 b1))) (t2tb2795 r)
  (relation (tuple2 c1 b1) (tuple2 a1 c1) (t2tb129 u) (t2tb222 v)))
  (forall ((x (tuple21 a c)) (y (tuple21 c b)))
  (=> (mem (tuple2 (tuple2 a1 c1) (tuple2 c1 b1))
  (Tuple2 (tuple2 a1 c1) (tuple2 c1 b1) (t2tb133 x) (t2tb223 y))
  (t2tb2795 r)) (and (mem10 x u) (mem28 y v)))))))
...
(declare-fun t2tb2840 ((set (set (tuple21 (tuple21 b c) (set (tuple21 c
  b)))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 b c) (set (tuple21 c b))))))) (sort
  (set1 (set1 (tuple2 (tuple2 b1 c1) (set1 (tuple2 c1 b1))))) (t2tb2840 x))))

(declare-fun tb2t2840 (uni) (set (set (tuple21 (tuple21 b c) (set (tuple21 c
  b))))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 b c) (set (tuple21 c b)))))))
  (! (= (tb2t2840 (t2tb2840 i)) i) :pattern ((t2tb2840 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 b1 c1) (set1 (tuple2 c1 b1))))) j)
     (= (t2tb2840 (tb2t2840 j)) j)) :pattern ((t2tb2840 (tb2t2840 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 b c))) (v (set (set (tuple21 c b))))
  (r (set (tuple21 (tuple21 b c) (set (tuple21 c b))))))
  (= (mem (set1 (tuple2 (tuple2 b1 c1) (set1 (tuple2 c1 b1)))) (t2tb2798 r)
  (relation (set1 (tuple2 c1 b1)) (tuple2 b1 c1) (t2tb131 u) (t2tb308 v)))
  (forall ((x (tuple21 b c)) (y (set (tuple21 c b))))
  (=> (mem (tuple2 (tuple2 b1 c1) (set1 (tuple2 c1 b1)))
  (Tuple2 (tuple2 b1 c1) (set1 (tuple2 c1 b1)) (t2tb134 x) (t2tb222 y))
  (t2tb2798 r)) (and (mem8 x u) (mem31 y v)))))))

(declare-fun t2tb2841 ((set (set (tuple21 (tuple21 b c) (tuple21 c
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 b c) (tuple21 c b)))))) (sort
  (set1 (set1 (tuple2 (tuple2 b1 c1) (tuple2 c1 b1)))) (t2tb2841 x))))

(declare-fun tb2t2841 (uni) (set (set (tuple21 (tuple21 b c) (tuple21 c
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 b c) (tuple21 c b))))))
  (! (= (tb2t2841 (t2tb2841 i)) i) :pattern ((t2tb2841 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 b1 c1) (tuple2 c1 b1)))) j)
     (= (t2tb2841 (tb2t2841 j)) j)) :pattern ((t2tb2841 (tb2t2841 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 b c))) (v (set (tuple21 c b)))
  (r (set (tuple21 (tuple21 b c) (tuple21 c b)))))
  (= (mem (set1 (tuple2 (tuple2 b1 c1) (tuple2 c1 b1))) (t2tb2799 r)
  (relation (tuple2 c1 b1) (tuple2 b1 c1) (t2tb131 u) (t2tb222 v)))
  (forall ((x (tuple21 b c)) (y (tuple21 c b)))
  (=> (mem (tuple2 (tuple2 b1 c1) (tuple2 c1 b1))
  (Tuple2 (tuple2 b1 c1) (tuple2 c1 b1) (t2tb134 x) (t2tb223 y))
  (t2tb2799 r)) (and (mem8 x u) (mem28 y v)))))))
...
(declare-fun t2tb2842 ((set (set (tuple21 c (set (tuple21 c b)))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 c (set (tuple21 c b))))))) (sort
  (set1 (set1 (tuple2 c1 (set1 (tuple2 c1 b1))))) (t2tb2842 x))))

(declare-fun tb2t2842 (uni) (set (set (tuple21 c (set (tuple21 c b))))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 c (set (tuple21 c b)))))))
  (! (= (tb2t2842 (t2tb2842 i)) i) :pattern ((t2tb2842 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 c1 (set1 (tuple2 c1 b1))))) j)
     (= (t2tb2842 (tb2t2842 j)) j)) :pattern ((t2tb2842 (tb2t2842 j))) )))

;; mem_relation
  (assert
  (forall ((u (set c)) (v (set (set (tuple21 c b)))) (r (set (tuple21 c
  (set (tuple21 c b))))))
  (= (mem (set1 (tuple2 c1 (set1 (tuple2 c1 b1)))) (t2tb2801 r)
  (relation (set1 (tuple2 c1 b1)) c1 (t2tb132 u) (t2tb308 v)))
  (forall ((x c) (y (set (tuple21 c b))))
  (=> (mem (tuple2 c1 (set1 (tuple2 c1 b1)))
  (Tuple2 c1 (set1 (tuple2 c1 b1)) (t2tb135 x) (t2tb222 y)) (t2tb2801 r))
...
(declare-fun t2tb2844 ((set (set (tuple21 (set (tuple21 a b)) (set (tuple21 c
  b)))))) uni)
...
(declare-fun tb2t2844 (uni) (set (set (tuple21 (set (tuple21 a b))
  (set (tuple21 c b))))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (set (tuple21 a b)) (set (tuple21 c b)))))))
  (! (= (tb2t2844 (t2tb2844 i)) i) :pattern ((t2tb2844 i)) )))
...
;; BridgeR
  ...
  (! (=> (sort
     ...
     (= (t2tb2844 (tb2t2844 j)) j)) :pattern ((t2tb2844 (tb2t2844 j))) )))
...
;; mem_relation
  ...
  (=> (mem (tuple2 (set1 (tuple2 a1 b1)) (set1 (tuple2 c1 b1)))
  (Tuple2 (set1 (tuple2 a1 b1)) (set1 (tuple2 c1 b1)) (t2tb11 x) (t2tb222 y))
  (t2tb2805 r)) (and (mem4 x u) (mem31 y v)))))))
...
(declare-fun t2tb2846 ((set (set (tuple21 (tuple21 a b) (set (tuple21 c
  b)))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 a b) (set (tuple21 c b))))))) (sort
  (set1 (set1 (tuple2 (tuple2 a1 b1) (set1 (tuple2 c1 b1))))) (t2tb2846 x))))

(declare-fun tb2t2846 (uni) (set (set (tuple21 (tuple21 a b) (set (tuple21 c
  b))))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 a b) (set (tuple21 c b)))))))
  (! (= (tb2t2846 (t2tb2846 i)) i) :pattern ((t2tb2846 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 a1 b1) (set1 (tuple2 c1 b1))))) j)
     (= (t2tb2846 (tb2t2846 j)) j)) :pattern ((t2tb2846 (tb2t2846 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 a b))) (v (set (set (tuple21 c b))))
  (r (set (tuple21 (tuple21 a b) (set (tuple21 c b))))))
  (= (mem (set1 (tuple2 (tuple2 a1 b1) (set1 (tuple2 c1 b1)))) (t2tb2809 r)
  (relation (set1 (tuple2 c1 b1)) (tuple2 a1 b1) (t2tb11 u) (t2tb308 v)))
  (forall ((x (tuple21 a b)) (y (set (tuple21 c b))))
  (=> (mem (tuple2 (tuple2 a1 b1) (set1 (tuple2 c1 b1)))
  (Tuple2 (tuple2 a1 b1) (set1 (tuple2 c1 b1)) (t2tb13 x) (t2tb222 y))
  (t2tb2809 r)) (and (mem3 x u) (mem31 y v)))))))
...
(declare-fun t2tb2848 ((set (set (tuple21 b (set (tuple21 c b)))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 b (set (tuple21 c b))))))) (sort
  (set1 (set1 (tuple2 b1 (set1 (tuple2 c1 b1))))) (t2tb2848 x))))

(declare-fun tb2t2848 (uni) (set (set (tuple21 b (set (tuple21 c b))))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 b (set (tuple21 c b)))))))
  (! (= (tb2t2848 (t2tb2848 i)) i) :pattern ((t2tb2848 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 b1 (set1 (tuple2 c1 b1))))) j)
     (= (t2tb2848 (tb2t2848 j)) j)) :pattern ((t2tb2848 (tb2t2848 j))) )))

;; mem_relation
  (assert
  (forall ((u (set b)) (v (set (set (tuple21 c b)))) (r (set (tuple21 b
  (set (tuple21 c b))))))
  (= (mem (set1 (tuple2 b1 (set1 (tuple2 c1 b1)))) (t2tb2814 r)
  (relation (set1 (tuple2 c1 b1)) b1 (t2tb12 u) (t2tb308 v)))
  (forall ((x b) (y (set (tuple21 c b))))
  (=> (mem (tuple2 b1 (set1 (tuple2 c1 b1)))
  (Tuple2 b1 (set1 (tuple2 c1 b1)) (t2tb14 x) (t2tb222 y)) (t2tb2814 r))
...
(declare-fun t2tb2850 ((set (set (tuple21 a (set (tuple21 c b)))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 a (set (tuple21 c b))))))) (sort
  (set1 (set1 (tuple2 a1 (set1 (tuple2 c1 b1))))) (t2tb2850 x))))

(declare-fun tb2t2850 (uni) (set (set (tuple21 a (set (tuple21 c b))))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 a (set (tuple21 c b)))))))
  (! (= (tb2t2850 (t2tb2850 i)) i) :pattern ((t2tb2850 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 a1 (set1 (tuple2 c1 b1))))) j)
     (= (t2tb2850 (tb2t2850 j)) j)) :pattern ((t2tb2850 (tb2t2850 j))) )))

;; mem_relation
  (assert
  (forall ((u (set a)) (v (set (set (tuple21 c b)))) (r (set (tuple21 a
  (set (tuple21 c b))))))
  (= (mem (set1 (tuple2 a1 (set1 (tuple2 c1 b1)))) (t2tb2817 r)
  (relation (set1 (tuple2 c1 b1)) a1 (t2tb1 u) (t2tb308 v)))
  (forall ((x a) (y (set (tuple21 c b))))
  (=> (mem (tuple2 a1 (set1 (tuple2 c1 b1)))
  (Tuple2 a1 (set1 (tuple2 c1 b1)) (t2tb2 x) (t2tb222 y)) (t2tb2817 r))
...
;; mem_image
  ...
  (= (mem31 x
  (tb2t308
  (image (set1 (tuple2 c1 b1)) (set1 (tuple2 c1 b1)) (t2tb2757 p)
  (t2tb308 w))))
...
;; mem_image
  ...
  (= (mem28 x
  (tb2t222
  (image (tuple2 c1 b1) (set1 (tuple2 c1 b1)) (t2tb2759 p) (t2tb308 w))))
  (exists ((a2 (set (tuple21 c b))))
...
;; mem_image
  ...
  (= (mem10 x
  (tb2t129
  (image (tuple2 a1 c1) (set1 (tuple2 c1 b1)) (t2tb2761 p) (t2tb308 w))))
  (exists ((a2 (set (tuple21 c b))))
...
;; mem_image
  ...
  (= (mem8 x
  (tb2t131
  (image (tuple2 b1 c1) (set1 (tuple2 c1 b1)) (t2tb2763 p) (t2tb308 w))))
  (exists ((a2 (set (tuple21 c b))))
...
;; mem_image
  ...
  b)))) (x c))
  (= (mem7 x
  (tb2t132 (image c1 (set1 (tuple2 c1 b1)) (t2tb2765 p) (t2tb308 w))))
  (exists ((a2 (set (tuple21 c b))))
  (and (mem31 a2 w) (mem (tuple2 (set1 (tuple2 c1 b1)) c1)
  (Tuple2 (set1 (tuple2 c1 b1)) c1 (t2tb222 a2) (t2tb135 x)) (t2tb2765 p)))))))
...
;; mem_image
  ...
  (= (mem4 x
  (tb2t10
  (image (set1 (tuple2 a1 b1)) (set1 (tuple2 c1 b1)) (t2tb2767 p)
  (t2tb308 w))))
  (exists ((a2 (set (tuple21 c b))))
...
;; mem_image
  ...
  (= (mem3 x
  (tb2t11
  (image (tuple2 a1 b1) (set1 (tuple2 c1 b1)) (t2tb2770 p) (t2tb308 w))))
  (exists ((a2 (set (tuple21 c b))))
...
;; mem_image
  ...
  b)))) (x b))
  (= (mem2 x
  (tb2t12 (image b1 (set1 (tuple2 c1 b1)) (t2tb2771 p) (t2tb308 w))))
  (exists ((a2 (set (tuple21 c b))))
  (and (mem31 a2 w) (mem (tuple2 (set1 (tuple2 c1 b1)) b1)
  (Tuple2 (set1 (tuple2 c1 b1)) b1 (t2tb222 a2) (t2tb14 x)) (t2tb2771 p)))))))
...
;; mem_image
  ...
  b)))) (x a))
  (= (mem1 x
  (tb2t1 (image a1 (set1 (tuple2 c1 b1)) (t2tb2773 p) (t2tb308 w))))
  (exists ((a2 (set (tuple21 c b))))
  (and (mem31 a2 w) (mem (tuple2 (set1 (tuple2 c1 b1)) a1)
  (Tuple2 (set1 (tuple2 c1 b1)) a1 (t2tb222 a2) (t2tb2 x)) (t2tb2773 p)))))))
...
;; mem_image
  ...
  (= (mem31 x
  (tb2t308
  (image (set1 (tuple2 c1 b1)) (tuple2 c1 b1) (t2tb2775 p) (t2tb222 w))))
...
;; mem_image
  ...
  b))) (x (tuple21 a c)))
  (= (mem10 x
  (tb2t129 (image (tuple2 a1 c1) (tuple2 c1 b1) (t2tb2779 p) (t2tb222 w))))
  (exists ((a2 (tuple21 c b)))
...
;; mem_image
  ...
  b))) (x (tuple21 b c)))
  (= (mem8 x
  (tb2t131 (image (tuple2 b1 c1) (tuple2 c1 b1) (t2tb2781 p) (t2tb222 w))))
  (exists ((a2 (tuple21 c b)))
...
;; mem_image
  ...
  (= (mem31 x
  (tb2t308
  (image (set1 (tuple2 c1 b1)) (tuple2 a1 c1) (t2tb2793 p) (t2tb129 w))))
...
;; mem_image
  ...
  c))) (x (tuple21 c b)))
  (= (mem28 x
  (tb2t222 (image (tuple2 c1 b1) (tuple2 a1 c1) (t2tb2795 p) (t2tb129 w))))
  (exists ((a2 (tuple21 a c)))
...
;; mem_image
  ...
  (= (mem31 x
  (tb2t308
  (image (set1 (tuple2 c1 b1)) (tuple2 b1 c1) (t2tb2798 p) (t2tb131 w))))
...
;; mem_image
  ...
  c))) (x (tuple21 c b)))
  (= (mem28 x
  (tb2t222 (image (tuple2 c1 b1) (tuple2 b1 c1) (t2tb2799 p) (t2tb131 w))))
  (exists ((a2 (tuple21 b c)))
...
;; mem_image
  ...
  (x (set (tuple21 c b))))
  (= (mem31 x
  (tb2t308 (image (set1 (tuple2 c1 b1)) c1 (t2tb2801 p) (t2tb132 w))))
  (exists ((a2 c))
  (and (mem7 a2 w) (mem (tuple2 c1 (set1 (tuple2 c1 b1)))
  (Tuple2 c1 (set1 (tuple2 c1 b1)) (t2tb135 a2) (t2tb222 x)) (t2tb2801 p)))))))
...
;; mem_image
  ...
  (= (mem31 x
  (tb2t308
  (image (set1 (tuple2 c1 b1)) (set1 (tuple2 a1 b1)) (t2tb2805 p) (t2tb10 w))))
...
;; mem_image
  ...
  (= (mem31 x
  (tb2t308
  (image (set1 (tuple2 c1 b1)) (tuple2 a1 b1) (t2tb2809 p) (t2tb11 w))))
...
;; mem_image
  ...
  (x (set (tuple21 c b))))
  (= (mem31 x
  (tb2t308 (image (set1 (tuple2 c1 b1)) b1 (t2tb2814 p) (t2tb12 w))))
  (exists ((a2 b))
  (and (mem2 a2 w) (mem (tuple2 b1 (set1 (tuple2 c1 b1)))
  (Tuple2 b1 (set1 (tuple2 c1 b1)) (t2tb14 a2) (t2tb222 x)) (t2tb2814 p)))))))
...
;; mem_image
  ...
  (x (set (tuple21 c b))))
  (= (mem31 x
  (tb2t308 (image (set1 (tuple2 c1 b1)) a1 (t2tb2817 p) (t2tb1 w))))
  (exists ((a2 a))
  (and (mem1 a2 w) (mem (tuple2 a1 (set1 (tuple2 c1 b1)))
  (Tuple2 a1 (set1 (tuple2 c1 b1)) (t2tb2 a2) (t2tb222 x)) (t2tb2817 p)))))))
...
(declare-fun t2tb2856 ((set (tuple21 (tuple21 c a) (tuple21 b c)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 c a) (tuple21 b c))))) (sort
  (set1 (tuple2 (tuple2 c1 a1) (tuple2 b1 c1))) (t2tb2856 x))))

(declare-fun tb2t2856 (uni) (set (tuple21 (tuple21 c a) (tuple21 b c))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 c a) (tuple21 b c)))))
  (! (= (tb2t2856 (t2tb2856 i)) i) :pattern ((t2tb2856 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 c1 a1) (tuple2 b1 c1))) j)
     (= (t2tb2856 (tb2t2856 j)) j)) :pattern ((t2tb2856 (tb2t2856 j))) )))

(declare-fun t2tb2857 ((tuple21 (tuple21 c a) (tuple21 b c))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 c a) (tuple21 b c)))) (sort
  (tuple2 (tuple2 c1 a1) (tuple2 b1 c1)) (t2tb2857 x))))

(declare-fun tb2t2857 (uni) (tuple21 (tuple21 c a) (tuple21 b c)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 c a) (tuple21 b c))))
  (! (= (tb2t2857 (t2tb2857 i)) i) :pattern ((t2tb2857 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 c1 a1) (tuple2 b1 c1)) j)
     (= (t2tb2857 (tb2t2857 j)) j)) :pattern ((t2tb2857 (tb2t2857 j))) )))
...
(declare-fun infix_plmngt9 ((set c) (set b)) (set (set (tuple21 c b))))

;; mem_partial_function_set
  (assert
  (forall ((s (set c)) (t (set b)) (f (set (tuple21 c b))))
  (= (mem31 f (infix_plmngt9 s t))
...
;; mem_total_function_set
  ...
  (and (mem31 x (infix_plmngt9 s t)) (infix_eqeq7
  (tb2t132 (dom b1 c1 (t2tb222 x))) s)))))
...
;; mem_partial_injection_set
  ...
  (and (mem31 x (infix_plmngt9 s t)) (mem (set1 (tuple2 b1 c1))
  (t2tb131 (inverse5 x)) (infix_plmngt c1 b1 (t2tb12 t) (t2tb132 s)))))))
...
;; mem_partial_surjection_set
  (assert
  (forall ((s (set c)) (t (set b)) (x (set (tuple21 c b))))
  (= (mem31 x (tb2t308 (infix_plmngtgt b1 c1 (t2tb132 s) (t2tb12 t))))
  (and (mem31 x (infix_plmngt9 s t)) (infix_eqeq3
  (tb2t12 (ran b1 c1 (t2tb222 x))) t)))))
...
;; mem_total_surjection_set
  ...
  (and (mem31 x (tb2t308 (infix_plmngtgt b1 c1 (t2tb132 s) (t2tb12 t))))
  (mem31 x (tb2t308 (infix_mnmngt b1 c1 (t2tb132 s) (t2tb12 t))))))))
...
;; mem_partial_bijection_set
  ...
  (and (mem31 x (tb2t308 (infix_gtplgt b1 c1 (t2tb132 s) (t2tb12 t)))) (mem31
  x (tb2t308 (infix_plmngtgt b1 c1 (t2tb132 s) (t2tb12 t))))))))
...
;; apply_def0
  ...
  (=>
  (and (mem31 f (infix_plmngt9 s t)) (mem7 a2
...
(assert
;; equal_semicolon_26
 ;; File "lemmes_bbook.why", line 1730, characters 7-25
  (not
  (forall ((s (set a)) (t (set b)) (u (set c)) (p (set (tuple21 a b)))
  (q (set (tuple21 a b))) (r (set (tuple21 b c))))
  (=>
  (and (mem4 p (relation1 s t))
  (and (mem4 q (relation1 s t)) (mem31 (inverse8 r) (infix_plmngt9 u t))))
  (infix_eqeq9 (semicolon1 (inter4 p q) r)
  (inter8 (semicolon1 p r) (semicolon1 q r)))))))
(check-sat)
