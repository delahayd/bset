...
fof(inclusion_semicolon_3, conjecture, ![S, T, U, P, Q, R]: ((sort(set(a),
  ...
  & mem(set(tuple2(b, c)), R, relation(c, b, T, U)))) => subset(tuple2(a, c),
  semicolon(c, b, a, inter(tuple2(a, b), P, Q), R), inter(tuple2(a, c),
