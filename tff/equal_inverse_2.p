...
tff(equal_inverse_2, conjecture, ![A : $tType, B : $tType, C : $tType]: ![S:
  set(A), T:set(B), U:set(C), P:set(tuple2(A, B)), Q:set(tuple2(B, C))]:
  ((mem(set(tuple2(A, B)), P, relation(A, B, S, T))
  & mem(set(tuple2(B, C)), Q, relation(B, C, T, U)))
  => infix_eqeq(tuple2(C, A), inverse(A, C, semicolon(A, B, C, P, Q)),
  semicolon(C, B, A, inverse(B, C, Q), inverse(A, B, P))))).
