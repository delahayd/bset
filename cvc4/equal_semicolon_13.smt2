...
(declare-fun diff9 ((set (set (tuple21 b c))) (set (set (tuple21 b
...
;; mem_diff
  ...
  (forall ((s (set (set (tuple21 b c)))) (t (set (set (tuple21 b c))))
  (x (set (tuple21 b c))))
  (= (mem9 x (diff9 s t)) (and (mem9 x s) (not (mem9 x t))))))
...
(assert
;; equal_semicolon_13
 ;; File "lemmes_bbook.why", line 1612, characters 7-25
  (not
  ...
  (semicolon1 f (diff7 p q)) (diff8 (semicolon1 f p) (semicolon1 f q)))))))
(check-sat)
