...
fof(mem_direct_product_2, conjecture, ![S, T, U, F, G]: ((sort(set(a),
  ...
  & mem(set(tuple2(a, c)), G, infix_plmngt(c, a, S, U))) => mem(set(tuple2(a,
  tuple2(b, c))), direct_product(c, b, a, F, G), infix_plmngt(tuple2(b, c),
  a, S, times(c, b, T, U)))))))))).
