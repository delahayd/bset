...
tff(equal_semicolon_2, conjecture, ![A : $tType, B : $tType, C : $tType]:
  ...
  & (mem(set(tuple2(C, B)), inverse(B, C, R), infix_plmngtgt(C, B, U, T))
  & infix_eqeq(tuple2(A, C), semicolon(A, B, C, P, R), semicolon(A, B, C, Q,
