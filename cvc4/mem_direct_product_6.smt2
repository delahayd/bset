...
(declare-fun infix_mnmngtgt4 ((set a) (set (tuple21 b
  c))) (set (set (tuple21 a (tuple21 b c)))))

;; mem_total_surjection_set
  (assert
  (forall ((s (set a)) (t (set (tuple21 b c))) (x (set (tuple21 a (tuple21 b
  c)))))
  (= (mem15 x (infix_mnmngtgt4 s t))
  (and (mem15 x
...
(assert
;; mem_direct_product_6
 ;; File "lemmes_bbook.why", line 553, characters 7-27
  (not
  (forall ((s (set a)) (t (set b)) (u (set c)) (f (set (tuple21 a b)))
  (g (set (tuple21 a c))))
  (=> (and (mem4 f (infix_mnmngtgt1 s t)) (mem11 g (infix_mnmngtgt2 s u)))
  (mem15 (direct_product1 f g) (infix_mnmngtgt4 s (times3 t u)))))))
(check-sat)
