...
fof(equal_inverse_2, conjecture, ![S, T, U, P, Q]: ((sort(set(a), S) = S)
  ...
  U))) => infix_eqeq(tuple2(c, a), inverse(c, a, semicolon(c, b, a, P, Q)),
  semicolon(a, b, c, inverse(c, b, Q), inverse(b, a, P)))))))))).
