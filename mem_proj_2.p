...
tff(mem_proj_2, conjecture, ![A : $tType, B : $tType]: ![S:set(A), T:
  set(B)]: mem(set(tuple2(tuple2(A, B), B)), prj2(A, B, tuple21(set(B),
  set(A), S, T)), infix_mnmngt(tuple2(A, B), B, times(A, B, S, T), T))).
