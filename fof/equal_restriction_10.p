...
fof(equal_restriction_10, conjecture, ![S, U, T, V, P, Q]: ((sort(set(a),
  ...
  domain_restriction(tuple2(b, c), a, U, direct_product(c, b, a, P, Q)),
  direct_product(c, b, a, domain_restriction(b, a, U, P),
  domain_restriction(c, a, U, Q))))))))))).
