...
(assert
;; equal_overriding_2
 ;; File "lemmes_bbook.why", line 2516, characters 7-25
  (not
  (forall ((s (set a)) (t (set b)) (p (set (tuple21 a b))) (q (set (tuple21 a
  b))))
  (=>
  (and (mem4 p (relation1 s t))
  (and (mem4 q (relation1 s t)) (infix_eqeq4 (domain_restriction1 (dom1 q) p)
  (domain_restriction1 (dom1 p) q)))) (infix_eqeq4 (infix_lspl1 p q)
  (union5 p q))))))
(check-sat)
