...
(assert
;; equal_image_5
 ;; File "lemmes_bbook.why", line 2314, characters 7-20
  (not
  (forall ((s (set a)) (u (set a)) (t (set b)) (v (set b)) (r (set (tuple21 a
  b))))
  (=> (and (mem4 r (relation1 s t)) (and (subset5 v t) (subset2 u s)))
  (infix_eqeq3 (image1 (range_restriction1 r v) u) (inter3 (image1 r u) v))))))
(check-sat)
