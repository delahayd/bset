...
tff(times_diff_distributivity, conjecture, ![A : $tType]: ![A1:set(A), B:
  set(A), T:set(A)]: infix_eqeq(tuple2(A, A), times(A, A, T, diff(A, A1, B)),
  diff(tuple2(A, A), times(A, A, T, A1), times(A, A, T, B)))).
