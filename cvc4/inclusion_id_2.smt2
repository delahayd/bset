...
(declare-fun mem26 ((tuple21 b b) (set (tuple21 b b))) Bool)
...
;; infix ==_def
  (assert
  (forall ((s (set (tuple21 b b))) (t (set (tuple21 b b))))
  (= (infix_eqeq (tuple2 b1 b1) (t2tb35 s) (t2tb35 t))
  (forall ((x (tuple21 b b))) (= (mem26 x s) (mem26 x t))))))
...
(declare-fun subset21 ((set (tuple21 b b)) (set (tuple21 b b))) Bool)
...
;; subset_def
  (assert
  (forall ((s (set (tuple21 b b))) (t (set (tuple21 b b))))
  (= (subset21 s t) (mem (set1 (tuple2 b1 b1)) (t2tb35 s)
  (power (tuple2 b1 b1) (t2tb35 t))))))
...
;; subsetnoteq_def
  (assert
  (forall ((s (set (tuple21 b b))) (t (set (tuple21 b b))))
  (= (subsetnoteq (tuple2 b1 b1) (t2tb35 s) (t2tb35 t))
  (and (subset21 s t)
  (not (infix_eqeq (tuple2 b1 b1) (t2tb35 s) (t2tb35 t)))))))

;; subsetnoteq_def
  (assert
  (forall ((s (set (tuple21 b a))) (t (set (tuple21 b a))))
  (= (subsetnoteq (tuple2 b1 a1) (t2tb37 s) (t2tb37 t))
  (and (subset8 s t) (not (infix_eqeq (tuple2 b1 a1) (t2tb37 s) (t2tb37 t)))))))
...
;; is_empty_def
  (assert
  (forall ((s (set (tuple21 b b))))
  (= (is_empty (tuple2 b1 b1) (t2tb35 s))
  (forall ((x (tuple21 b b))) (not (mem26 x s))))))
...
;; empty
  (assert
  (forall ((x (tuple21 b b)))
  (not (mem26 x (tb2t35 (empty (tuple2 b1 b1)))))))
...
;; add_def1
  (assert
  (forall ((x (tuple21 b b)) (y (tuple21 b b)))
  (forall ((s (set (tuple21 b b))))
  (= (mem26 x (tb2t35 (add (tuple2 b1 b1) (t2tb36 y) (t2tb35 s))))
  (or (= x y) (mem26 x s))))))
...
;; mem_singleton
  (assert
  (forall ((x (tuple21 b b)) (y (tuple21 b b)))
  (= (mem26 x (tb2t35 (singleton (tuple2 b1 b1) (t2tb36 y)))) (= x y))))
...
;; remove_def1
  (assert
  (forall ((x (tuple21 b b)) (y (tuple21 b b)) (s (set (tuple21 b b))))
  (= (mem26 x (tb2t35 (remove (tuple2 b1 b1) (t2tb36 y) (t2tb35 s))))
  (and (not (= x y)) (mem26 x s)))))
...
;; all_def
  (assert
  (forall ((x (tuple21 b b))) (mem26 x (tb2t35 (all (tuple2 b1 b1))))))
...
;; mem_union
  (assert
  (forall ((s (set (tuple21 b b))) (t (set (tuple21 b b))) (x (tuple21 b b)))
  (= (mem26 x (tb2t35 (union1 (tuple2 b1 b1) (t2tb35 s) (t2tb35 t))))
  (or (mem26 x s) (mem26 x t)))))
...
;; mem_inter
  (assert
  (forall ((s (set (tuple21 b b))) (t (set (tuple21 b b))) (x (tuple21 b b)))
  (= (mem26 x (tb2t35 (inter (tuple2 b1 b1) (t2tb35 s) (t2tb35 t))))
  (and (mem26 x s) (mem26 x t)))))
...
;; mem_diff
  (assert
  (forall ((s (set (tuple21 b b))) (t (set (tuple21 b b))) (x (tuple21 b b)))
  (= (mem26 x (tb2t35 (diff (tuple2 b1 b1) (t2tb35 s) (t2tb35 t))))
  (and (mem26 x s) (not (mem26 x t))))))
...
;; mem_times
  (assert
  (forall ((a2 ty))
  (forall ((s uni) (t (set (tuple21 b b))) (x uni) (y (tuple21 b b)))
  (= (mem (tuple2 a2 (tuple2 b1 b1)) (Tuple2 a2 (tuple2 b1 b1) x (t2tb36 y))
  (times (tuple2 b1 b1) a2 s (t2tb35 t))) (and (mem a2 x s) (mem26 y t))))))
...
(declare-fun t2tb1409 ((set (tuple21 (tuple21 b b) (tuple21 b b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b b) (tuple21 b b))))) (sort
  (set1 (tuple2 (tuple2 b1 b1) (tuple2 b1 b1))) (t2tb1409 x))))

(declare-fun tb2t1409 (uni) (set (tuple21 (tuple21 b b) (tuple21 b b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b b) (tuple21 b b)))))
  (! (= (tb2t1409 (t2tb1409 i)) i) :pattern ((t2tb1409 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 b1) (tuple2 b1 b1))) j)
     (= (t2tb1409 (tb2t1409 j)) j)) :pattern ((t2tb1409 (tb2t1409 j))) )))

(declare-fun t2tb1410 ((tuple21 (tuple21 b b) (tuple21 b b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 b b) (tuple21 b b)))) (sort
  (tuple2 (tuple2 b1 b1) (tuple2 b1 b1)) (t2tb1410 x))))

(declare-fun tb2t1410 (uni) (tuple21 (tuple21 b b) (tuple21 b b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b b) (tuple21 b b))))
  (! (= (tb2t1410 (t2tb1410 i)) i) :pattern ((t2tb1410 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 b1) (tuple2 b1 b1)) j)
     (= (t2tb1410 (tb2t1410 j)) j)) :pattern ((t2tb1410 (tb2t1410 j))) )))

;; mem_times
  (assert
  (forall ((s (set (tuple21 b b))) (t (set (tuple21 b b))) (x (tuple21 b b))
  (y (tuple21 b b)))
  (= (mem (tuple2 (tuple2 b1 b1) (tuple2 b1 b1))
  (Tuple2 (tuple2 b1 b1) (tuple2 b1 b1) (t2tb36 x) (t2tb36 y))
  (times (tuple2 b1 b1) (tuple2 b1 b1) (t2tb35 s) (t2tb35 t)))
  (and (mem26 x s) (mem26 y t)))))

(declare-fun t2tb1411 ((set (tuple21 (tuple21 b b) (tuple21 b a)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b b) (tuple21 b a))))) (sort
  (set1 (tuple2 (tuple2 b1 b1) (tuple2 b1 a1))) (t2tb1411 x))))

(declare-fun tb2t1411 (uni) (set (tuple21 (tuple21 b b) (tuple21 b a))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b b) (tuple21 b a)))))
  (! (= (tb2t1411 (t2tb1411 i)) i) :pattern ((t2tb1411 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 b1) (tuple2 b1 a1))) j)
     (= (t2tb1411 (tb2t1411 j)) j)) :pattern ((t2tb1411 (tb2t1411 j))) )))

(declare-fun t2tb1412 ((tuple21 (tuple21 b b) (tuple21 b a))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 b b) (tuple21 b a)))) (sort
  (tuple2 (tuple2 b1 b1) (tuple2 b1 a1)) (t2tb1412 x))))

(declare-fun tb2t1412 (uni) (tuple21 (tuple21 b b) (tuple21 b a)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b b) (tuple21 b a))))
  (! (= (tb2t1412 (t2tb1412 i)) i) :pattern ((t2tb1412 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 b1) (tuple2 b1 a1)) j)
     (= (t2tb1412 (tb2t1412 j)) j)) :pattern ((t2tb1412 (tb2t1412 j))) )))

;; mem_times
  (assert
  (forall ((s (set (tuple21 b b))) (t (set (tuple21 b a))) (x (tuple21 b b))
  (y (tuple21 b a)))
  (= (mem (tuple2 (tuple2 b1 b1) (tuple2 b1 a1))
  (Tuple2 (tuple2 b1 b1) (tuple2 b1 a1) (t2tb36 x) (t2tb38 y))
  (times (tuple2 b1 a1) (tuple2 b1 b1) (t2tb35 s) (t2tb37 t)))
  (and (mem26 x s) (mem5 y t)))))

(declare-fun t2tb1413 ((set (tuple21 (tuple21 b b) (set (tuple21 a
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b b) (set (tuple21 a b)))))) (sort
  (set1 (tuple2 (tuple2 b1 b1) (set1 (tuple2 a1 b1)))) (t2tb1413 x))))

(declare-fun tb2t1413 (uni) (set (tuple21 (tuple21 b b) (set (tuple21 a
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b b) (set (tuple21 a b))))))
  (! (= (tb2t1413 (t2tb1413 i)) i) :pattern ((t2tb1413 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 b1) (set1 (tuple2 a1 b1)))) j)
     (= (t2tb1413 (tb2t1413 j)) j)) :pattern ((t2tb1413 (tb2t1413 j))) )))

(declare-fun t2tb1414 ((tuple21 (tuple21 b b) (set (tuple21 a b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 b b) (set (tuple21 a b))))) (sort
  (tuple2 (tuple2 b1 b1) (set1 (tuple2 a1 b1))) (t2tb1414 x))))

(declare-fun tb2t1414 (uni) (tuple21 (tuple21 b b) (set (tuple21 a b))))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b b) (set (tuple21 a b)))))
  (! (= (tb2t1414 (t2tb1414 i)) i) :pattern ((t2tb1414 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 b1) (set1 (tuple2 a1 b1))) j)
     (= (t2tb1414 (tb2t1414 j)) j)) :pattern ((t2tb1414 (tb2t1414 j))) )))

;; mem_times
  (assert
  (forall ((s (set (tuple21 b b))) (t (set (set (tuple21 a b))))
  (x (tuple21 b b)) (y (set (tuple21 a b))))
  (= (mem (tuple2 (tuple2 b1 b1) (set1 (tuple2 a1 b1)))
  (Tuple2 (tuple2 b1 b1) (set1 (tuple2 a1 b1)) (t2tb36 x) (t2tb11 y))
  (times (set1 (tuple2 a1 b1)) (tuple2 b1 b1) (t2tb35 s) (t2tb10 t)))
  (and (mem26 x s) (mem4 y t)))))

(declare-fun t2tb1415 ((set (tuple21 (tuple21 b b) (tuple21 a b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b b) (tuple21 a b))))) (sort
  (set1 (tuple2 (tuple2 b1 b1) (tuple2 a1 b1))) (t2tb1415 x))))

(declare-fun tb2t1415 (uni) (set (tuple21 (tuple21 b b) (tuple21 a b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b b) (tuple21 a b)))))
  (! (= (tb2t1415 (t2tb1415 i)) i) :pattern ((t2tb1415 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 b1) (tuple2 a1 b1))) j)
     (= (t2tb1415 (tb2t1415 j)) j)) :pattern ((t2tb1415 (tb2t1415 j))) )))

(declare-fun t2tb1416 ((tuple21 (tuple21 b b) (tuple21 a b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 b b) (tuple21 a b)))) (sort
  (tuple2 (tuple2 b1 b1) (tuple2 a1 b1)) (t2tb1416 x))))

(declare-fun tb2t1416 (uni) (tuple21 (tuple21 b b) (tuple21 a b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b b) (tuple21 a b))))
  (! (= (tb2t1416 (t2tb1416 i)) i) :pattern ((t2tb1416 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 b1) (tuple2 a1 b1)) j)
     (= (t2tb1416 (tb2t1416 j)) j)) :pattern ((t2tb1416 (tb2t1416 j))) )))

;; mem_times
  (assert
  (forall ((s (set (tuple21 b b))) (t (set (tuple21 a b))) (x (tuple21 b b))
  (y (tuple21 a b)))
  (= (mem (tuple2 (tuple2 b1 b1) (tuple2 a1 b1))
  (Tuple2 (tuple2 b1 b1) (tuple2 a1 b1) (t2tb36 x) (t2tb13 y))
  (times (tuple2 a1 b1) (tuple2 b1 b1) (t2tb35 s) (t2tb11 t)))
  (and (mem26 x s) (mem3 y t)))))

(declare-fun t2tb1417 ((set (tuple21 (tuple21 b b) b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b b) b)))) (sort
  (set1 (tuple2 (tuple2 b1 b1) b1)) (t2tb1417 x))))

(declare-fun tb2t1417 (uni) (set (tuple21 (tuple21 b b) b)))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b b) b))))
  (! (= (tb2t1417 (t2tb1417 i)) i) :pattern ((t2tb1417 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 b1) b1)) j)
     (= (t2tb1417 (tb2t1417 j)) j)) :pattern ((t2tb1417 (tb2t1417 j))) )))

(declare-fun t2tb1418 ((tuple21 (tuple21 b b) b)) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 b b) b))) (sort (tuple2 (tuple2 b1 b1) b1)
  (t2tb1418 x))))

(declare-fun tb2t1418 (uni) (tuple21 (tuple21 b b) b))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b b) b)))
  (! (= (tb2t1418 (t2tb1418 i)) i) :pattern ((t2tb1418 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 b1) b1) j) (= (t2tb1418 (tb2t1418 j)) j)) :pattern (
  (t2tb1418 (tb2t1418 j))) )))

;; mem_times
  (assert
  (forall ((s (set (tuple21 b b))) (t (set b)) (x (tuple21 b b)) (y b))
  (= (mem (tuple2 (tuple2 b1 b1) b1)
  (Tuple2 (tuple2 b1 b1) b1 (t2tb36 x) (t2tb14 y))
  (times b1 (tuple2 b1 b1) (t2tb35 s) (t2tb12 t)))
  (and (mem26 x s) (mem2 y t)))))

(declare-fun t2tb1419 ((set (tuple21 (tuple21 b b) a))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b b) a)))) (sort
  (set1 (tuple2 (tuple2 b1 b1) a1)) (t2tb1419 x))))

(declare-fun tb2t1419 (uni) (set (tuple21 (tuple21 b b) a)))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b b) a))))
  (! (= (tb2t1419 (t2tb1419 i)) i) :pattern ((t2tb1419 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 b1) a1)) j)
     (= (t2tb1419 (tb2t1419 j)) j)) :pattern ((t2tb1419 (tb2t1419 j))) )))

(declare-fun t2tb1420 ((tuple21 (tuple21 b b) a)) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 b b) a))) (sort (tuple2 (tuple2 b1 b1) a1)
  (t2tb1420 x))))

(declare-fun tb2t1420 (uni) (tuple21 (tuple21 b b) a))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b b) a)))
  (! (= (tb2t1420 (t2tb1420 i)) i) :pattern ((t2tb1420 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 b1) a1) j) (= (t2tb1420 (tb2t1420 j)) j)) :pattern (
  (t2tb1420 (tb2t1420 j))) )))

;; mem_times
  (assert
  (forall ((s (set (tuple21 b b))) (t (set a)) (x (tuple21 b b)) (y a))
  (= (mem (tuple2 (tuple2 b1 b1) a1)
  (Tuple2 (tuple2 b1 b1) a1 (t2tb36 x) (t2tb2 y))
  (times a1 (tuple2 b1 b1) (t2tb35 s) (t2tb1 t)))
  (and (mem26 x s) (mem1 y t)))))

;; mem_times
  (assert
  (forall ((b2 ty))
  (forall ((s (set (tuple21 b b))) (t uni) (x (tuple21 b b)) (y uni))
  (= (mem (tuple2 (tuple2 b1 b1) b2) (Tuple2 (tuple2 b1 b1) b2 (t2tb36 x) y)
  (times b2 (tuple2 b1 b1) (t2tb35 s) t)) (and (mem26 x s) (mem b2 y t))))))

(declare-fun t2tb1421 ((set (tuple21 (tuple21 b a) (tuple21 b b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b a) (tuple21 b b))))) (sort
  (set1 (tuple2 (tuple2 b1 a1) (tuple2 b1 b1))) (t2tb1421 x))))

(declare-fun tb2t1421 (uni) (set (tuple21 (tuple21 b a) (tuple21 b b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b a) (tuple21 b b)))))
  (! (= (tb2t1421 (t2tb1421 i)) i) :pattern ((t2tb1421 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 a1) (tuple2 b1 b1))) j)
     (= (t2tb1421 (tb2t1421 j)) j)) :pattern ((t2tb1421 (tb2t1421 j))) )))

(declare-fun t2tb1422 ((tuple21 (tuple21 b a) (tuple21 b b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 b a) (tuple21 b b)))) (sort
  (tuple2 (tuple2 b1 a1) (tuple2 b1 b1)) (t2tb1422 x))))

(declare-fun tb2t1422 (uni) (tuple21 (tuple21 b a) (tuple21 b b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b a) (tuple21 b b))))
  (! (= (tb2t1422 (t2tb1422 i)) i) :pattern ((t2tb1422 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 a1) (tuple2 b1 b1)) j)
     (= (t2tb1422 (tb2t1422 j)) j)) :pattern ((t2tb1422 (tb2t1422 j))) )))

;; mem_times
  (assert
  (forall ((s (set (tuple21 b a))) (t (set (tuple21 b b))) (x (tuple21 b a))
  (y (tuple21 b b)))
  (= (mem (tuple2 (tuple2 b1 a1) (tuple2 b1 b1))
  (Tuple2 (tuple2 b1 a1) (tuple2 b1 b1) (t2tb38 x) (t2tb36 y))
  (times (tuple2 b1 b1) (tuple2 b1 a1) (t2tb37 s) (t2tb35 t)))
  (and (mem5 x s) (mem26 y t)))))
...
(declare-fun t2tb1423 ((set (tuple21 (set (tuple21 a b)) (tuple21 b
  b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (set (tuple21 a b)) (tuple21 b b))))) (sort
  (set1 (tuple2 (set1 (tuple2 a1 b1)) (tuple2 b1 b1))) (t2tb1423 x))))

(declare-fun tb2t1423 (uni) (set (tuple21 (set (tuple21 a b)) (tuple21 b
  b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (set (tuple21 a b)) (tuple21 b b)))))
  (! (= (tb2t1423 (t2tb1423 i)) i) :pattern ((t2tb1423 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (set1 (tuple2 a1 b1)) (tuple2 b1 b1))) j)
     (= (t2tb1423 (tb2t1423 j)) j)) :pattern ((t2tb1423 (tb2t1423 j))) )))

(declare-fun t2tb1424 ((tuple21 (set (tuple21 a b)) (tuple21 b b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (set (tuple21 a b)) (tuple21 b b)))) (sort
  (tuple2 (set1 (tuple2 a1 b1)) (tuple2 b1 b1)) (t2tb1424 x))))

(declare-fun tb2t1424 (uni) (tuple21 (set (tuple21 a b)) (tuple21 b b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (set (tuple21 a b)) (tuple21 b b))))
  (! (= (tb2t1424 (t2tb1424 i)) i) :pattern ((t2tb1424 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (set1 (tuple2 a1 b1)) (tuple2 b1 b1)) j)
     (= (t2tb1424 (tb2t1424 j)) j)) :pattern ((t2tb1424 (tb2t1424 j))) )))

;; mem_times
  (assert
  (forall ((s (set (set (tuple21 a b)))) (t (set (tuple21 b b)))
  (x (set (tuple21 a b))) (y (tuple21 b b)))
  (= (mem (tuple2 (set1 (tuple2 a1 b1)) (tuple2 b1 b1))
  (Tuple2 (set1 (tuple2 a1 b1)) (tuple2 b1 b1) (t2tb11 x) (t2tb36 y))
  (times (tuple2 b1 b1) (set1 (tuple2 a1 b1)) (t2tb10 s) (t2tb35 t)))
  (and (mem4 x s) (mem26 y t)))))
...
(declare-fun t2tb1355 ((set (tuple21 (tuple21 a b) (tuple21 b b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 a b) (tuple21 b b))))) (sort
  (set1 (tuple2 (tuple2 a1 b1) (tuple2 b1 b1))) (t2tb1355 x))))

(declare-fun tb2t1355 (uni) (set (tuple21 (tuple21 a b) (tuple21 b b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 a b) (tuple21 b b)))))
  (! (= (tb2t1355 (t2tb1355 i)) i) :pattern ((t2tb1355 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 a1 b1) (tuple2 b1 b1))) j)
     (= (t2tb1355 (tb2t1355 j)) j)) :pattern ((t2tb1355 (tb2t1355 j))) )))

(declare-fun t2tb1356 ((tuple21 (tuple21 a b) (tuple21 b b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 a b) (tuple21 b b)))) (sort
  (tuple2 (tuple2 a1 b1) (tuple2 b1 b1)) (t2tb1356 x))))

(declare-fun tb2t1356 (uni) (tuple21 (tuple21 a b) (tuple21 b b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 a b) (tuple21 b b))))
  (! (= (tb2t1356 (t2tb1356 i)) i) :pattern ((t2tb1356 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 a1 b1) (tuple2 b1 b1)) j)
     (= (t2tb1356 (tb2t1356 j)) j)) :pattern ((t2tb1356 (tb2t1356 j))) )))

;; mem_times
  (assert
  (forall ((s (set (tuple21 a b))) (t (set (tuple21 b b))) (x (tuple21 a b))
  (y (tuple21 b b)))
  (= (mem (tuple2 (tuple2 a1 b1) (tuple2 b1 b1))
  (Tuple2 (tuple2 a1 b1) (tuple2 b1 b1) (t2tb13 x) (t2tb36 y))
  (times (tuple2 b1 b1) (tuple2 a1 b1) (t2tb11 s) (t2tb35 t)))
  (and (mem3 x s) (mem26 y t)))))
...
(declare-fun t2tb1425 ((set (tuple21 b (tuple21 b b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 b (tuple21 b b))))) (sort
  (set1 (tuple2 b1 (tuple2 b1 b1))) (t2tb1425 x))))

(declare-fun tb2t1425 (uni) (set (tuple21 b (tuple21 b b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 b (tuple21 b b)))))
  (! (= (tb2t1425 (t2tb1425 i)) i) :pattern ((t2tb1425 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 b1 (tuple2 b1 b1))) j)
     (= (t2tb1425 (tb2t1425 j)) j)) :pattern ((t2tb1425 (tb2t1425 j))) )))

(declare-fun t2tb1426 ((tuple21 b (tuple21 b b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 b (tuple21 b b)))) (sort (tuple2 b1 (tuple2 b1 b1))
  (t2tb1426 x))))

(declare-fun tb2t1426 (uni) (tuple21 b (tuple21 b b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 b (tuple21 b b))))
  (! (= (tb2t1426 (t2tb1426 i)) i) :pattern ((t2tb1426 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 b1 (tuple2 b1 b1)) j) (= (t2tb1426 (tb2t1426 j)) j)) :pattern (
  (t2tb1426 (tb2t1426 j))) )))

;; mem_times
  (assert
  (forall ((s (set b)) (t (set (tuple21 b b))) (x b) (y (tuple21 b b)))
  (= (mem (tuple2 b1 (tuple2 b1 b1))
  (Tuple2 b1 (tuple2 b1 b1) (t2tb14 x) (t2tb36 y))
  (times (tuple2 b1 b1) b1 (t2tb12 s) (t2tb35 t)))
  (and (mem2 x s) (mem26 y t)))))
...
;; mem_times
  ...
  (= (mem26 (tb2t36 (Tuple2 b1 b1 (t2tb14 x) (t2tb14 y)))
  (tb2t35 (times b1 b1 (t2tb12 s) (t2tb12 t)))) (and (mem2 x s) (mem2 y t)))))
...
;; mem_times
  (assert
  (forall ((s (set a)) (t (set (tuple21 b b))) (x a) (y (tuple21 b b)))
  (= (mem (tuple2 a1 (tuple2 b1 b1))
  (Tuple2 a1 (tuple2 b1 b1) (t2tb2 x) (t2tb36 y))
  (times (tuple2 b1 b1) a1 (t2tb1 s) (t2tb35 t)))
  (and (mem1 x s) (mem26 y t)))))
...
;; mem_power
  (assert
  (forall ((s (set (tuple21 b b))) (t (set (tuple21 b b))))
  (= (mem (set1 (tuple2 b1 b1)) (t2tb35 s) (power (tuple2 b1 b1) (t2tb35 t)))
  (forall ((x (tuple21 b b))) (=> (mem26 x s) (mem26 x t))))))
...
;; mem_non_empty_power
  (assert
  (forall ((s (set (tuple21 b b))) (t (set (tuple21 b b))))
  (= (mem (set1 (tuple2 b1 b1)) (t2tb35 s)
  (non_empty_power (tuple2 b1 b1) (t2tb35 t)))
  (and (forall ((x (tuple21 b b))) (=> (mem26 x s) (mem26 x t)))
  (not (infix_eqeq (tuple2 b1 b1) (t2tb35 s) (empty (tuple2 b1 b1))))))))
...
;; mem_relation
  (assert
  (forall ((a2 ty))
  (forall ((u uni) (v (set (tuple21 b b))) (r uni))
  (and
  (=> (mem (set1 (tuple2 a2 (tuple2 b1 b1))) r
  (relation (tuple2 b1 b1) a2 u (t2tb35 v)))
  (forall ((x uni) (y (tuple21 b b)))
  (=> (mem (tuple2 a2 (tuple2 b1 b1)) (Tuple2 a2 (tuple2 b1 b1) x (t2tb36 y))
  r) (and (mem a2 x u) (mem26 y v)))))
  (=>
  (forall ((x uni) (y (tuple21 b b)))
  (=> (sort a2 x)
  (=> (mem (tuple2 a2 (tuple2 b1 b1)) (Tuple2 a2 (tuple2 b1 b1) x (t2tb36 y))
  r) (and (mem a2 x u) (mem26 y v))))) (mem (set1 (tuple2 a2 (tuple2 b1 b1)))
  r (relation (tuple2 b1 b1) a2 u (t2tb35 v))))))))
...
(declare-fun t2tb1427 ((set (set (tuple21 (tuple21 b b) (tuple21 b
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 b b) (tuple21 b b)))))) (sort
  (set1 (set1 (tuple2 (tuple2 b1 b1) (tuple2 b1 b1)))) (t2tb1427 x))))

(declare-fun tb2t1427 (uni) (set (set (tuple21 (tuple21 b b) (tuple21 b
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 b b) (tuple21 b b))))))
  (! (= (tb2t1427 (t2tb1427 i)) i) :pattern ((t2tb1427 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 b1 b1) (tuple2 b1 b1)))) j)
     (= (t2tb1427 (tb2t1427 j)) j)) :pattern ((t2tb1427 (tb2t1427 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 b b))) (v (set (tuple21 b b)))
  (r (set (tuple21 (tuple21 b b) (tuple21 b b)))))
  (= (mem (set1 (tuple2 (tuple2 b1 b1) (tuple2 b1 b1))) (t2tb1409 r)
  (relation (tuple2 b1 b1) (tuple2 b1 b1) (t2tb35 u) (t2tb35 v)))
  (forall ((x (tuple21 b b)) (y (tuple21 b b)))
  (=> (mem (tuple2 (tuple2 b1 b1) (tuple2 b1 b1))
  (Tuple2 (tuple2 b1 b1) (tuple2 b1 b1) (t2tb36 x) (t2tb36 y)) (t2tb1409 r))
  (and (mem26 x u) (mem26 y v)))))))

(declare-fun t2tb1428 ((set (set (tuple21 (tuple21 b b) (tuple21 b
  a))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 b b) (tuple21 b a)))))) (sort
  (set1 (set1 (tuple2 (tuple2 b1 b1) (tuple2 b1 a1)))) (t2tb1428 x))))

(declare-fun tb2t1428 (uni) (set (set (tuple21 (tuple21 b b) (tuple21 b
  a)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 b b) (tuple21 b a))))))
  (! (= (tb2t1428 (t2tb1428 i)) i) :pattern ((t2tb1428 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 b1 b1) (tuple2 b1 a1)))) j)
     (= (t2tb1428 (tb2t1428 j)) j)) :pattern ((t2tb1428 (tb2t1428 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 b b))) (v (set (tuple21 b a)))
  (r (set (tuple21 (tuple21 b b) (tuple21 b a)))))
  (= (mem (set1 (tuple2 (tuple2 b1 b1) (tuple2 b1 a1))) (t2tb1411 r)
  (relation (tuple2 b1 a1) (tuple2 b1 b1) (t2tb35 u) (t2tb37 v)))
  (forall ((x (tuple21 b b)) (y (tuple21 b a)))
  (=> (mem (tuple2 (tuple2 b1 b1) (tuple2 b1 a1))
  (Tuple2 (tuple2 b1 b1) (tuple2 b1 a1) (t2tb36 x) (t2tb38 y)) (t2tb1411 r))
  (and (mem26 x u) (mem5 y v)))))))

(declare-fun t2tb1429 ((set (set (tuple21 (tuple21 b b) (set (tuple21 a
  b)))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 b b) (set (tuple21 a b))))))) (sort
  (set1 (set1 (tuple2 (tuple2 b1 b1) (set1 (tuple2 a1 b1))))) (t2tb1429 x))))

(declare-fun tb2t1429 (uni) (set (set (tuple21 (tuple21 b b) (set (tuple21 a
  b))))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 b b) (set (tuple21 a b)))))))
  (! (= (tb2t1429 (t2tb1429 i)) i) :pattern ((t2tb1429 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 b1 b1) (set1 (tuple2 a1 b1))))) j)
     (= (t2tb1429 (tb2t1429 j)) j)) :pattern ((t2tb1429 (tb2t1429 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 b b))) (v (set (set (tuple21 a b))))
  (r (set (tuple21 (tuple21 b b) (set (tuple21 a b))))))
  (= (mem (set1 (tuple2 (tuple2 b1 b1) (set1 (tuple2 a1 b1)))) (t2tb1413 r)
  (relation (set1 (tuple2 a1 b1)) (tuple2 b1 b1) (t2tb35 u) (t2tb10 v)))
  (forall ((x (tuple21 b b)) (y (set (tuple21 a b))))
  (=> (mem (tuple2 (tuple2 b1 b1) (set1 (tuple2 a1 b1)))
  (Tuple2 (tuple2 b1 b1) (set1 (tuple2 a1 b1)) (t2tb36 x) (t2tb11 y))
  (t2tb1413 r)) (and (mem26 x u) (mem4 y v)))))))

(declare-fun t2tb1430 ((set (set (tuple21 (tuple21 b b) (tuple21 a
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 b b) (tuple21 a b)))))) (sort
  (set1 (set1 (tuple2 (tuple2 b1 b1) (tuple2 a1 b1)))) (t2tb1430 x))))

(declare-fun tb2t1430 (uni) (set (set (tuple21 (tuple21 b b) (tuple21 a
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 b b) (tuple21 a b))))))
  (! (= (tb2t1430 (t2tb1430 i)) i) :pattern ((t2tb1430 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 b1 b1) (tuple2 a1 b1)))) j)
     (= (t2tb1430 (tb2t1430 j)) j)) :pattern ((t2tb1430 (tb2t1430 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 b b))) (v (set (tuple21 a b)))
  (r (set (tuple21 (tuple21 b b) (tuple21 a b)))))
  (= (mem (set1 (tuple2 (tuple2 b1 b1) (tuple2 a1 b1))) (t2tb1415 r)
  (relation (tuple2 a1 b1) (tuple2 b1 b1) (t2tb35 u) (t2tb11 v)))
  (forall ((x (tuple21 b b)) (y (tuple21 a b)))
  (=> (mem (tuple2 (tuple2 b1 b1) (tuple2 a1 b1))
  (Tuple2 (tuple2 b1 b1) (tuple2 a1 b1) (t2tb36 x) (t2tb13 y)) (t2tb1415 r))
  (and (mem26 x u) (mem3 y v)))))))

(declare-fun t2tb1431 ((set (set (tuple21 (tuple21 b b) b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 b b) b))))) (sort
  (set1 (set1 (tuple2 (tuple2 b1 b1) b1))) (t2tb1431 x))))

(declare-fun tb2t1431 (uni) (set (set (tuple21 (tuple21 b b) b))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 b b) b)))))
  (! (= (tb2t1431 (t2tb1431 i)) i) :pattern ((t2tb1431 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 b1 b1) b1))) j)
     (= (t2tb1431 (tb2t1431 j)) j)) :pattern ((t2tb1431 (tb2t1431 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 b b))) (v (set b)) (r (set (tuple21 (tuple21 b b)
  b))))
  (= (mem (set1 (tuple2 (tuple2 b1 b1) b1)) (t2tb1417 r)
  (relation b1 (tuple2 b1 b1) (t2tb35 u) (t2tb12 v)))
  (forall ((x (tuple21 b b)) (y b))
  (=> (mem (tuple2 (tuple2 b1 b1) b1)
  (Tuple2 (tuple2 b1 b1) b1 (t2tb36 x) (t2tb14 y)) (t2tb1417 r))
  (and (mem26 x u) (mem2 y v)))))))

(declare-fun t2tb1432 ((set (set (tuple21 (tuple21 b b) a)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 b b) a))))) (sort
  (set1 (set1 (tuple2 (tuple2 b1 b1) a1))) (t2tb1432 x))))

(declare-fun tb2t1432 (uni) (set (set (tuple21 (tuple21 b b) a))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 b b) a)))))
  (! (= (tb2t1432 (t2tb1432 i)) i) :pattern ((t2tb1432 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 b1 b1) a1))) j)
     (= (t2tb1432 (tb2t1432 j)) j)) :pattern ((t2tb1432 (tb2t1432 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 b b))) (v (set a)) (r (set (tuple21 (tuple21 b b)
  a))))
  (= (mem (set1 (tuple2 (tuple2 b1 b1) a1)) (t2tb1419 r)
  (relation a1 (tuple2 b1 b1) (t2tb35 u) (t2tb1 v)))
  (forall ((x (tuple21 b b)) (y a))
  (=> (mem (tuple2 (tuple2 b1 b1) a1)
  (Tuple2 (tuple2 b1 b1) a1 (t2tb36 x) (t2tb2 y)) (t2tb1419 r))
  (and (mem26 x u) (mem1 y v)))))))

;; mem_relation
  (assert
  (forall ((b2 ty))
  (forall ((u (set (tuple21 b b))) (v uni) (r uni))
  (and
  (=> (mem (set1 (tuple2 (tuple2 b1 b1) b2)) r
  (relation b2 (tuple2 b1 b1) (t2tb35 u) v))
  (forall ((x (tuple21 b b)) (y uni))
  (=> (mem (tuple2 (tuple2 b1 b1) b2) (Tuple2 (tuple2 b1 b1) b2 (t2tb36 x) y)
  r) (and (mem26 x u) (mem b2 y v)))))
  (=>
  (forall ((x (tuple21 b b)) (y uni))
  (=> (sort b2 y)
  (=> (mem (tuple2 (tuple2 b1 b1) b2) (Tuple2 (tuple2 b1 b1) b2 (t2tb36 x) y)
  r) (and (mem26 x u) (mem b2 y v))))) (mem (set1 (tuple2 (tuple2 b1 b1) b2))
  r (relation b2 (tuple2 b1 b1) (t2tb35 u) v)))))))

(declare-fun t2tb1433 ((set (set (tuple21 (tuple21 b a) (tuple21 b
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 b a) (tuple21 b b)))))) (sort
  (set1 (set1 (tuple2 (tuple2 b1 a1) (tuple2 b1 b1)))) (t2tb1433 x))))

(declare-fun tb2t1433 (uni) (set (set (tuple21 (tuple21 b a) (tuple21 b
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 b a) (tuple21 b b))))))
  (! (= (tb2t1433 (t2tb1433 i)) i) :pattern ((t2tb1433 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 b1 a1) (tuple2 b1 b1)))) j)
     (= (t2tb1433 (tb2t1433 j)) j)) :pattern ((t2tb1433 (tb2t1433 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 b a))) (v (set (tuple21 b b)))
  (r (set (tuple21 (tuple21 b a) (tuple21 b b)))))
  (= (mem (set1 (tuple2 (tuple2 b1 a1) (tuple2 b1 b1))) (t2tb1421 r)
  (relation (tuple2 b1 b1) (tuple2 b1 a1) (t2tb37 u) (t2tb35 v)))
  (forall ((x (tuple21 b a)) (y (tuple21 b b)))
  (=> (mem (tuple2 (tuple2 b1 a1) (tuple2 b1 b1))
  (Tuple2 (tuple2 b1 a1) (tuple2 b1 b1) (t2tb38 x) (t2tb36 y)) (t2tb1421 r))
  (and (mem5 x u) (mem26 y v)))))))
...
(declare-fun t2tb1434 ((set (set (tuple21 (set (tuple21 a b)) (tuple21 b
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (set (tuple21 a b)) (tuple21 b b)))))) (sort
  (set1 (set1 (tuple2 (set1 (tuple2 a1 b1)) (tuple2 b1 b1)))) (t2tb1434 x))))

(declare-fun tb2t1434 (uni) (set (set (tuple21 (set (tuple21 a b)) (tuple21 b
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (set (tuple21 a b)) (tuple21 b b))))))
  (! (= (tb2t1434 (t2tb1434 i)) i) :pattern ((t2tb1434 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (set1 (tuple2 a1 b1)) (tuple2 b1 b1)))) j)
     (= (t2tb1434 (tb2t1434 j)) j)) :pattern ((t2tb1434 (tb2t1434 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (set (tuple21 a b)))) (v (set (tuple21 b b)))
  (r (set (tuple21 (set (tuple21 a b)) (tuple21 b b)))))
  (= (mem (set1 (tuple2 (set1 (tuple2 a1 b1)) (tuple2 b1 b1))) (t2tb1423 r)
  (relation (tuple2 b1 b1) (set1 (tuple2 a1 b1)) (t2tb10 u) (t2tb35 v)))
  (forall ((x (set (tuple21 a b))) (y (tuple21 b b)))
  (=> (mem (tuple2 (set1 (tuple2 a1 b1)) (tuple2 b1 b1))
  (Tuple2 (set1 (tuple2 a1 b1)) (tuple2 b1 b1) (t2tb11 x) (t2tb36 y))
  (t2tb1423 r)) (and (mem4 x u) (mem26 y v)))))))
...
(declare-fun t2tb1435 ((set (set (tuple21 (tuple21 a b) (tuple21 b
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 a b) (tuple21 b b)))))) (sort
  (set1 (set1 (tuple2 (tuple2 a1 b1) (tuple2 b1 b1)))) (t2tb1435 x))))

(declare-fun tb2t1435 (uni) (set (set (tuple21 (tuple21 a b) (tuple21 b
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 a b) (tuple21 b b))))))
  (! (= (tb2t1435 (t2tb1435 i)) i) :pattern ((t2tb1435 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 a1 b1) (tuple2 b1 b1)))) j)
     (= (t2tb1435 (tb2t1435 j)) j)) :pattern ((t2tb1435 (tb2t1435 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 a b))) (v (set (tuple21 b b)))
  (r (set (tuple21 (tuple21 a b) (tuple21 b b)))))
  (= (mem (set1 (tuple2 (tuple2 a1 b1) (tuple2 b1 b1))) (t2tb1355 r)
  (relation (tuple2 b1 b1) (tuple2 a1 b1) (t2tb11 u) (t2tb35 v)))
  (forall ((x (tuple21 a b)) (y (tuple21 b b)))
  (=> (mem (tuple2 (tuple2 a1 b1) (tuple2 b1 b1))
  (Tuple2 (tuple2 a1 b1) (tuple2 b1 b1) (t2tb13 x) (t2tb36 y)) (t2tb1355 r))
  (and (mem3 x u) (mem26 y v)))))))
...
(declare-fun t2tb1436 ((set (set (tuple21 b (tuple21 b b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 b (tuple21 b b)))))) (sort
  (set1 (set1 (tuple2 b1 (tuple2 b1 b1)))) (t2tb1436 x))))

(declare-fun tb2t1436 (uni) (set (set (tuple21 b (tuple21 b b)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 b (tuple21 b b))))))
  (! (= (tb2t1436 (t2tb1436 i)) i) :pattern ((t2tb1436 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 b1 (tuple2 b1 b1)))) j)
     (= (t2tb1436 (tb2t1436 j)) j)) :pattern ((t2tb1436 (tb2t1436 j))) )))

;; mem_relation
  (assert
  (forall ((u (set b)) (v (set (tuple21 b b))) (r (set (tuple21 b (tuple21 b
  b)))))
  (= (mem (set1 (tuple2 b1 (tuple2 b1 b1))) (t2tb1425 r)
  (relation (tuple2 b1 b1) b1 (t2tb12 u) (t2tb35 v)))
  (forall ((x b) (y (tuple21 b b)))
  (=> (mem (tuple2 b1 (tuple2 b1 b1))
  (Tuple2 b1 (tuple2 b1 b1) (t2tb14 x) (t2tb36 y)) (t2tb1425 r))
  (and (mem2 x u) (mem26 y v)))))))
...
;; mem_relation
  ...
  (forall ((x b) (y b))
  (=> (mem26 (tb2t36 (Tuple2 b1 b1 (t2tb14 x) (t2tb14 y))) r)
...
(declare-fun t2tb1437 ((set (set (tuple21 a (tuple21 b b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 a (tuple21 b b)))))) (sort
  (set1 (set1 (tuple2 a1 (tuple2 b1 b1)))) (t2tb1437 x))))

(declare-fun tb2t1437 (uni) (set (set (tuple21 a (tuple21 b b)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 a (tuple21 b b))))))
  (! (= (tb2t1437 (t2tb1437 i)) i) :pattern ((t2tb1437 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 a1 (tuple2 b1 b1)))) j)
     (= (t2tb1437 (tb2t1437 j)) j)) :pattern ((t2tb1437 (tb2t1437 j))) )))

;; mem_relation
  (assert
  (forall ((u (set a)) (v (set (tuple21 b b))) (r (set (tuple21 a (tuple21 b
  b)))))
  (= (mem (set1 (tuple2 a1 (tuple2 b1 b1))) (t2tb59 r)
  (relation (tuple2 b1 b1) a1 (t2tb1 u) (t2tb35 v)))
  (forall ((x a) (y (tuple21 b b)))
  (=> (mem (tuple2 a1 (tuple2 b1 b1))
  (Tuple2 a1 (tuple2 b1 b1) (t2tb2 x) (t2tb36 y)) (t2tb59 r))
  (and (mem1 x u) (mem26 y v)))))))
...
(declare-fun inverse4 ((set (tuple21 b b))) (set (tuple21 b b)))

;; mem_inverse
  (assert
  (forall ((p (set (tuple21 b b))) (x b) (y b))
  (= (mem26 (tb2t36 (Tuple2 b1 b1 (t2tb14 x) (t2tb14 y))) (inverse4 p))
  (mem26 (tb2t36 (Tuple2 b1 b1 (t2tb14 y) (t2tb14 x))) p))))
...
;; mem_dom
  (assert
  (forall ((b2 ty))
  (forall ((p uni) (x (tuple21 b b)))
  (and
  (=> (mem26 x (tb2t35 (dom b2 (tuple2 b1 b1) p)))
  (exists ((b3 uni))
  (and (sort b2 b3) (mem (tuple2 (tuple2 b1 b1) b2)
  (Tuple2 (tuple2 b1 b1) b2 (t2tb36 x) b3) p))))
  (=>
  (exists ((b3 uni)) (mem (tuple2 (tuple2 b1 b1) b2)
  (Tuple2 (tuple2 b1 b1) b2 (t2tb36 x) b3) p)) (mem26 x
  (tb2t35 (dom b2 (tuple2 b1 b1) p))))))))
...
;; mem_dom
  (assert
  (forall ((p (set (tuple21 b b))) (x b))
  (= (mem2 x (tb2t12 (dom b1 b1 (t2tb35 p))))
  (exists ((b2 b)) (mem26 (tb2t36 (Tuple2 b1 b1 (t2tb14 x) (t2tb14 b2))) p)))))
...
(declare-fun ran3 ((set (tuple21 b b))) (set b))
...
;; mem_ran
  ...
  (forall ((p uni) (x (tuple21 b b)))
  (and
  (=> (mem26 x (tb2t35 (ran (tuple2 b1 b1) a2 p)))
  (exists ((a3 uni))
  (and (sort a2 a3) (mem (tuple2 a2 (tuple2 b1 b1))
  (Tuple2 a2 (tuple2 b1 b1) a3 (t2tb36 x)) p))))
  (=>
  (exists ((a3 uni)) (mem (tuple2 a2 (tuple2 b1 b1))
  (Tuple2 a2 (tuple2 b1 b1) a3 (t2tb36 x)) p)) (mem26 x
  (tb2t35 (ran (tuple2 b1 b1) a2 p))))))))
...
;; mem_ran
  ...
  (forall ((p (set (tuple21 b b))) (x b))
  (= (mem2 x (ran3 p))
  (exists ((a2 b)) (mem26 (tb2t36 (Tuple2 b1 b1 (t2tb14 a2) (t2tb14 x))) p)))))
...
(declare-fun semicolon6 ((set (tuple21 a b)) (set (tuple21 b
  b))) (set (tuple21 a b)))

(declare-fun semicolon7 ((set (tuple21 b b)) (set (tuple21 b
  a))) (set (tuple21 b a)))

(declare-fun semicolon8 ((set (tuple21 b a)) (set (tuple21 a
  b))) (set (tuple21 b b)))

(declare-fun semicolon9 ((set (tuple21 b b)) (set (tuple21 b
  b))) (set (tuple21 b b)))

;; mem_semicolon
  (assert
  (forall ((a2 ty))
  (forall ((p uni) (q (set (tuple21 b b))) (x uni) (y b))
  (= (mem (tuple2 a2 b1) (Tuple2 a2 b1 x (t2tb14 y))
  (semicolon b1 b1 a2 p (t2tb35 q)))
  (exists ((b2 b))
  (and (mem (tuple2 a2 b1) (Tuple2 a2 b1 x (t2tb14 b2)) p) (mem26
  (tb2t36 (Tuple2 b1 b1 (t2tb14 b2) (t2tb14 y))) q)))))))
...
;; mem_semicolon
  (assert
  (forall ((b2 ty))
  (forall ((p uni) (q uni) (x b) (y b))
  (and
  (=> (mem26 (tb2t36 (Tuple2 b1 b1 (t2tb14 x) (t2tb14 y)))
  (tb2t35 (semicolon b1 b2 b1 p q)))
  (exists ((b3 uni))
  (and (sort b2 b3)
  ...
  (exists ((b3 uni))
  (and (mem (tuple2 b1 b2) (Tuple2 b1 b2 (t2tb14 x) b3) p) (mem
  (tuple2 b2 b1) (Tuple2 b2 b1 b3 (t2tb14 y)) q))) (mem26
  (tb2t36 (Tuple2 b1 b1 (t2tb14 x) (t2tb14 y)))
  (tb2t35 (semicolon b1 b2 b1 p q))))))))
...
;; mem_semicolon
  (assert
  (forall ((p (set (tuple21 b b))) (q (set (tuple21 b b))) (x b) (y b))
  (= (mem26 (tb2t36 (Tuple2 b1 b1 (t2tb14 x) (t2tb14 y))) (semicolon9 p q))
  (exists ((b2 b))
  (and (mem26 (tb2t36 (Tuple2 b1 b1 (t2tb14 x) (t2tb14 b2))) p) (mem26
  (tb2t36 (Tuple2 b1 b1 (t2tb14 b2) (t2tb14 y))) q))))))

;; mem_semicolon
  (assert
  (forall ((p (set (tuple21 b b))) (q (set (tuple21 b a))) (x b) (y a))
  (= (mem5 (tb2t38 (Tuple2 b1 a1 (t2tb14 x) (t2tb2 y))) (semicolon7 p q))
  (exists ((b2 b))
  (and (mem26 (tb2t36 (Tuple2 b1 b1 (t2tb14 x) (t2tb14 b2))) p) (mem5
  (tb2t38 (Tuple2 b1 a1 (t2tb14 b2) (t2tb2 y))) q))))))

;; mem_semicolon
  (assert
  (forall ((c2 ty))
  (forall ((p (set (tuple21 b b))) (q uni) (x b) (y uni))
  (= (mem (tuple2 b1 c2) (Tuple2 b1 c2 (t2tb14 x) y)
  (semicolon c2 b1 b1 (t2tb35 p) q))
  (exists ((b2 b))
  (and (mem26 (tb2t36 (Tuple2 b1 b1 (t2tb14 x) (t2tb14 b2))) p) (mem
  (tuple2 b1 c2) (Tuple2 b1 c2 (t2tb14 b2) y) q)))))))

;; mem_semicolon
  (assert
  (forall ((p (set (tuple21 b a))) (q (set (tuple21 a b))) (x b) (y b))
  (= (mem26 (tb2t36 (Tuple2 b1 b1 (t2tb14 x) (t2tb14 y))) (semicolon8 p q))
  (exists ((b2 a))
...
;; mem_semicolon
  ...
  (= (mem3 (tb2t13 (Tuple2 a1 b1 (t2tb2 x) (t2tb14 y))) (semicolon6 p q))
  (exists ((b2 b))
  (and (mem3 (tb2t13 (Tuple2 a1 b1 (t2tb2 x) (t2tb14 b2))) p) (mem26
  (tb2t36 (Tuple2 b1 b1 (t2tb14 b2) (t2tb14 y))) q))))))
...
;; semicolon_back
  (assert
  (forall ((p (set (tuple21 b b))) (q (set (tuple21 b b))))
  (= (tb2t35 (semicolon_back b1 b1 b1 (t2tb35 q) (t2tb35 p))) (semicolon9 p
                                                              q))))

;; semicolon_back
  (assert
  (forall ((p (set (tuple21 b b))) (q (set (tuple21 b a))))
  (= (tb2t37 (semicolon_back a1 b1 b1 (t2tb37 q) (t2tb35 p))) (semicolon7 p
                                                              q))))

;; semicolon_back
  (assert
  (forall ((p (set (tuple21 b a))) (q (set (tuple21 a b))))
  (= (tb2t35 (semicolon_back b1 a1 b1 (t2tb11 q) (t2tb37 p))) (semicolon8 p
                                                              q))))

;; semicolon_back
  (assert
  (forall ((p (set (tuple21 a b))) (q (set (tuple21 b b))))
  (= (tb2t11 (semicolon_back b1 b1 a1 (t2tb35 q) (t2tb11 p))) (semicolon6 p
                                                              q))))
...
(declare-fun id2 ((set b)) (set (tuple21 b b)))

;; mem_id
  (assert
  (forall ((u (set (tuple21 b b))) (x (tuple21 b b)) (y (tuple21 b b)))
  (= (mem (tuple2 (tuple2 b1 b1) (tuple2 b1 b1))
  (Tuple2 (tuple2 b1 b1) (tuple2 b1 b1) (t2tb36 x) (t2tb36 y))
  (id (tuple2 b1 b1) (t2tb35 u))) (and (mem26 x u) (= x y)))))
...
;; mem_id
  ...
  (= (mem26 (tb2t36 (Tuple2 b1 b1 (t2tb14 x) (t2tb14 y))) (id2 u))
  (and (mem2 x u) (= x y)))))
...
;; mem_domain_restriction
  (assert
  (forall ((b2 ty))
  (forall ((p uni) (s (set (tuple21 b b))) (x (tuple21 b b)) (y uni))
  (= (mem (tuple2 (tuple2 b1 b1) b2) (Tuple2 (tuple2 b1 b1) b2 (t2tb36 x) y)
  (domain_restriction b2 (tuple2 b1 b1) (t2tb35 s) p))
  (and (mem (tuple2 (tuple2 b1 b1) b2)
  (Tuple2 (tuple2 b1 b1) b2 (t2tb36 x) y) p) (mem26 x s))))))
...
;; mem_domain_restriction
  (assert
  (forall ((p (set (tuple21 b b))) (s (set b)) (x b) (y b))
  (= (mem26 (tb2t36 (Tuple2 b1 b1 (t2tb14 x) (t2tb14 y)))
  (tb2t35 (domain_restriction b1 b1 (t2tb12 s) (t2tb35 p))))
  (and (mem26 (tb2t36 (Tuple2 b1 b1 (t2tb14 x) (t2tb14 y))) p) (mem2 x s)))))
...
;; mem_range_restriction
  (assert
  (forall ((a2 ty))
  (forall ((p uni) (t (set (tuple21 b b))) (x uni) (y (tuple21 b b)))
  (= (mem (tuple2 a2 (tuple2 b1 b1)) (Tuple2 a2 (tuple2 b1 b1) x (t2tb36 y))
  (range_restriction (tuple2 b1 b1) a2 p (t2tb35 t)))
  (and (mem (tuple2 a2 (tuple2 b1 b1))
  (Tuple2 a2 (tuple2 b1 b1) x (t2tb36 y)) p) (mem26 y t))))))
...
;; mem_range_restriction
  (assert
  (forall ((p (set (tuple21 b b))) (t (set b)) (x b) (y b))
  (= (mem26 (tb2t36 (Tuple2 b1 b1 (t2tb14 x) (t2tb14 y)))
  (tb2t35 (range_restriction b1 b1 (t2tb35 p) (t2tb12 t))))
  (and (mem26 (tb2t36 (Tuple2 b1 b1 (t2tb14 x) (t2tb14 y))) p) (mem2 y t)))))
...
;; mem_domain_substraction
  ...
  (forall ((p uni) (s (set (tuple21 b b))) (x (tuple21 b b)) (y uni))
  (= (mem (tuple2 (tuple2 b1 b1) b2) (Tuple2 (tuple2 b1 b1) b2 (t2tb36 x) y)
  (domain_substraction b2 (tuple2 b1 b1) (t2tb35 s) p))
  (and (mem (tuple2 (tuple2 b1 b1) b2)
  (Tuple2 (tuple2 b1 b1) b2 (t2tb36 x) y) p) (not (mem26 x s)))))))
...
;; mem_domain_substraction
  ...
  (forall ((p (set (tuple21 b b))) (s (set b)) (x b) (y b))
  (= (mem26 (tb2t36 (Tuple2 b1 b1 (t2tb14 x) (t2tb14 y)))
  (tb2t35 (domain_substraction b1 b1 (t2tb12 s) (t2tb35 p))))
  (and (mem26 (tb2t36 (Tuple2 b1 b1 (t2tb14 x) (t2tb14 y))) p)
  (not (mem2 x s))))))
...
;; mem_range_substraction
  ...
  (forall ((p uni) (t (set (tuple21 b b))) (x uni) (y (tuple21 b b)))
  (= (mem (tuple2 a2 (tuple2 b1 b1)) (Tuple2 a2 (tuple2 b1 b1) x (t2tb36 y))
  (range_substraction (tuple2 b1 b1) a2 p (t2tb35 t)))
  (and (mem (tuple2 a2 (tuple2 b1 b1))
  (Tuple2 a2 (tuple2 b1 b1) x (t2tb36 y)) p) (not (mem26 y t)))))))
...
;; mem_range_substraction
  ...
  (forall ((p (set (tuple21 b b))) (t (set b)) (x b) (y b))
  (= (mem26 (tb2t36 (Tuple2 b1 b1 (t2tb14 x) (t2tb14 y)))
  (tb2t35 (range_substraction b1 b1 (t2tb35 p) (t2tb12 t))))
  (and (mem26 (tb2t36 (Tuple2 b1 b1 (t2tb14 x) (t2tb14 y))) p)
  (not (mem2 y t))))))
...
;; mem_image
  (assert
  (forall ((a2 ty))
  (forall ((p uni) (w uni) (x (tuple21 b b)))
  (and
  (=> (mem26 x (tb2t35 (image (tuple2 b1 b1) a2 p w)))
  (exists ((a3 uni))
  (and (sort a2 a3)
  (and (mem a2 a3 w) (mem (tuple2 a2 (tuple2 b1 b1))
  (Tuple2 a2 (tuple2 b1 b1) a3 (t2tb36 x)) p)))))
  (=>
  (exists ((a3 uni))
  (and (mem a2 a3 w) (mem (tuple2 a2 (tuple2 b1 b1))
  (Tuple2 a2 (tuple2 b1 b1) a3 (t2tb36 x)) p))) (mem26 x
  (tb2t35 (image (tuple2 b1 b1) a2 p w))))))))
...
;; mem_image
  (assert
  (forall ((p (set (tuple21 (tuple21 b b) (tuple21 b b)))) (w (set (tuple21 b
  b))) (x (tuple21 b b)))
  (= (mem26 x
  (tb2t35 (image (tuple2 b1 b1) (tuple2 b1 b1) (t2tb1409 p) (t2tb35 w))))
  (exists ((a2 (tuple21 b b)))
  (and (mem26 a2 w) (mem (tuple2 (tuple2 b1 b1) (tuple2 b1 b1))
  (Tuple2 (tuple2 b1 b1) (tuple2 b1 b1) (t2tb36 a2) (t2tb36 x))
  (t2tb1409 p)))))))

;; mem_image
  (assert
  (forall ((p (set (tuple21 (tuple21 b b) (tuple21 b a)))) (w (set (tuple21 b
  b))) (x (tuple21 b a)))
  (= (mem5 x
  (tb2t37 (image (tuple2 b1 a1) (tuple2 b1 b1) (t2tb1411 p) (t2tb35 w))))
  (exists ((a2 (tuple21 b b)))
  (and (mem26 a2 w) (mem (tuple2 (tuple2 b1 b1) (tuple2 b1 a1))
  (Tuple2 (tuple2 b1 b1) (tuple2 b1 a1) (t2tb36 a2) (t2tb38 x))
  (t2tb1411 p)))))))

;; mem_image
  (assert
  (forall ((p (set (tuple21 (tuple21 b b) (set (tuple21 a b)))))
  (w (set (tuple21 b b))) (x (set (tuple21 a b))))
  (= (mem4 x
  (tb2t10
  (image (set1 (tuple2 a1 b1)) (tuple2 b1 b1) (t2tb1413 p) (t2tb35 w))))
  (exists ((a2 (tuple21 b b)))
  (and (mem26 a2 w) (mem (tuple2 (tuple2 b1 b1) (set1 (tuple2 a1 b1)))
  (Tuple2 (tuple2 b1 b1) (set1 (tuple2 a1 b1)) (t2tb36 a2) (t2tb11 x))
  (t2tb1413 p)))))))

;; mem_image
  (assert
  (forall ((p (set (tuple21 (tuple21 b b) (tuple21 a b)))) (w (set (tuple21 b
  b))) (x (tuple21 a b)))
  (= (mem3 x
  (tb2t11 (image (tuple2 a1 b1) (tuple2 b1 b1) (t2tb1415 p) (t2tb35 w))))
  (exists ((a2 (tuple21 b b)))
  (and (mem26 a2 w) (mem (tuple2 (tuple2 b1 b1) (tuple2 a1 b1))
  (Tuple2 (tuple2 b1 b1) (tuple2 a1 b1) (t2tb36 a2) (t2tb13 x))
  (t2tb1415 p)))))))

;; mem_image
  (assert
  (forall ((p (set (tuple21 (tuple21 b b) b))) (w (set (tuple21 b b))) (x b))
  (= (mem2 x (tb2t12 (image b1 (tuple2 b1 b1) (t2tb1417 p) (t2tb35 w))))
  (exists ((a2 (tuple21 b b)))
  (and (mem26 a2 w) (mem (tuple2 (tuple2 b1 b1) b1)
  (Tuple2 (tuple2 b1 b1) b1 (t2tb36 a2) (t2tb14 x)) (t2tb1417 p)))))))

;; mem_image
  (assert
  (forall ((p (set (tuple21 (tuple21 b b) a))) (w (set (tuple21 b b))) (x a))
  (= (mem1 x (tb2t1 (image a1 (tuple2 b1 b1) (t2tb1419 p) (t2tb35 w))))
  (exists ((a2 (tuple21 b b)))
  (and (mem26 a2 w) (mem (tuple2 (tuple2 b1 b1) a1)
  (Tuple2 (tuple2 b1 b1) a1 (t2tb36 a2) (t2tb2 x)) (t2tb1419 p)))))))

;; mem_image
  (assert
  (forall ((b2 ty))
  (forall ((p uni) (w (set (tuple21 b b))) (x uni))
  (= (mem b2 x (image b2 (tuple2 b1 b1) p (t2tb35 w)))
  (exists ((a2 (tuple21 b b)))
  (and (mem26 a2 w) (mem (tuple2 (tuple2 b1 b1) b2)
  (Tuple2 (tuple2 b1 b1) b2 (t2tb36 a2) x) p)))))))

;; mem_image
  (assert
  (forall ((p (set (tuple21 (tuple21 b a) (tuple21 b b)))) (w (set (tuple21 b
  a))) (x (tuple21 b b)))
  (= (mem26 x
  (tb2t35 (image (tuple2 b1 b1) (tuple2 b1 a1) (t2tb1421 p) (t2tb37 w))))
  (exists ((a2 (tuple21 b a)))
  (and (mem5 a2 w) (mem (tuple2 (tuple2 b1 a1) (tuple2 b1 b1))
  (Tuple2 (tuple2 b1 a1) (tuple2 b1 b1) (t2tb38 a2) (t2tb36 x))
  (t2tb1421 p)))))))
...
;; mem_image
  (assert
  (forall ((p (set (tuple21 (set (tuple21 a b)) (tuple21 b b))))
  (w (set (set (tuple21 a b)))) (x (tuple21 b b)))
  (= (mem26 x
  (tb2t35
  (image (tuple2 b1 b1) (set1 (tuple2 a1 b1)) (t2tb1423 p) (t2tb10 w))))
  (exists ((a2 (set (tuple21 a b))))
  (and (mem4 a2 w) (mem (tuple2 (set1 (tuple2 a1 b1)) (tuple2 b1 b1))
  (Tuple2 (set1 (tuple2 a1 b1)) (tuple2 b1 b1) (t2tb11 a2) (t2tb36 x))
  (t2tb1423 p)))))))
...
;; mem_image
  (assert
  (forall ((p (set (tuple21 (tuple21 a b) (tuple21 b b)))) (w (set (tuple21 a
  b))) (x (tuple21 b b)))
  (= (mem26 x
  (tb2t35 (image (tuple2 b1 b1) (tuple2 a1 b1) (t2tb1355 p) (t2tb11 w))))
  (exists ((a2 (tuple21 a b)))
  (and (mem3 a2 w) (mem (tuple2 (tuple2 a1 b1) (tuple2 b1 b1))
  (Tuple2 (tuple2 a1 b1) (tuple2 b1 b1) (t2tb13 a2) (t2tb36 x))
  (t2tb1355 p)))))))
...
;; mem_image
  (assert
  (forall ((p (set (tuple21 b (tuple21 b b)))) (w (set b)) (x (tuple21 b b)))
  (= (mem26 x (tb2t35 (image (tuple2 b1 b1) b1 (t2tb1425 p) (t2tb12 w))))
  (exists ((a2 b))
  (and (mem2 a2 w) (mem (tuple2 b1 (tuple2 b1 b1))
  (Tuple2 b1 (tuple2 b1 b1) (t2tb14 a2) (t2tb36 x)) (t2tb1425 p)))))))
...
;; mem_image
  ...
  (exists ((a2 b))
  (and (mem2 a2 w) (mem26 (tb2t36 (Tuple2 b1 b1 (t2tb14 a2) (t2tb14 x))) p))))))
...
;; mem_image
  (assert
  (forall ((p (set (tuple21 a (tuple21 b b)))) (w (set a)) (x (tuple21 b b)))
  (= (mem26 x (tb2t35 (image (tuple2 b1 b1) a1 (t2tb59 p) (t2tb1 w))))
  (exists ((a2 a))
  (and (mem1 a2 w) (mem (tuple2 a1 (tuple2 b1 b1))
  (Tuple2 a1 (tuple2 b1 b1) (t2tb2 a2) (t2tb36 x)) (t2tb59 p)))))))
...
;; mem_overriding
  (assert
  (forall ((b2 ty))
  (forall ((q uni) (p uni) (x (tuple21 b b)) (y uni))
  (= (mem (tuple2 (tuple2 b1 b1) b2) (Tuple2 (tuple2 b1 b1) b2 (t2tb36 x) y)
  (infix_lspl b2 (tuple2 b1 b1) q p))
  (or
  (and (mem (tuple2 (tuple2 b1 b1) b2)
  (Tuple2 (tuple2 b1 b1) b2 (t2tb36 x) y) q)
  (not (mem26 x (tb2t35 (dom b2 (tuple2 b1 b1) p))))) (mem
  (tuple2 (tuple2 b1 b1) b2) (Tuple2 (tuple2 b1 b1) b2 (t2tb36 x) y) p))))))
...
;; mem_overriding
  (assert
  (forall ((q (set (tuple21 b b))) (p (set (tuple21 b b))) (x b) (y b))
  (= (mem26 (tb2t36 (Tuple2 b1 b1 (t2tb14 x) (t2tb14 y)))
  (tb2t35 (infix_lspl b1 b1 (t2tb35 q) (t2tb35 p))))
  (or
  (and (mem26 (tb2t36 (Tuple2 b1 b1 (t2tb14 x) (t2tb14 y))) q)
  (not (mem2 x (tb2t12 (dom b1 b1 (t2tb35 p)))))) (mem26
  (tb2t36 (Tuple2 b1 b1 (t2tb14 x) (t2tb14 y))) p)))))
...
;; mem_direct_product
  (assert
  (forall ((b2 ty))
  (forall ((f uni) (g (set (tuple21 b b))) (x b) (y uni) (z b))
  (= (mem (tuple2 b1 (tuple2 b2 b1))
  (Tuple2 b1 (tuple2 b2 b1) (t2tb14 x) (Tuple2 b2 b1 y (t2tb14 z)))
  (direct_product b1 b2 b1 f (t2tb35 g)))
  (and (mem (tuple2 b1 b2) (Tuple2 b1 b2 (t2tb14 x) y) f) (mem26
  (tb2t36 (Tuple2 b1 b1 (t2tb14 x) (t2tb14 z))) g))))))
...
;; mem_direct_product
  (assert
  (forall ((f (set (tuple21 b b))) (g (set (tuple21 b b))) (x b) (y b) (z b))
  (= (mem (tuple2 b1 (tuple2 b1 b1))
  (Tuple2 b1 (tuple2 b1 b1) (t2tb14 x) (Tuple2 b1 b1 (t2tb14 y) (t2tb14 z)))
  (direct_product b1 b1 b1 (t2tb35 f) (t2tb35 g)))
  (and (mem26 (tb2t36 (Tuple2 b1 b1 (t2tb14 x) (t2tb14 y))) f) (mem26
  (tb2t36 (Tuple2 b1 b1 (t2tb14 x) (t2tb14 z))) g)))))

;; mem_direct_product
  (assert
  (forall ((f (set (tuple21 b b))) (g (set (tuple21 b a))) (x b) (y b) (z a))
  (= (mem (tuple2 b1 (tuple2 b1 a1))
  (Tuple2 b1 (tuple2 b1 a1) (t2tb14 x) (Tuple2 b1 a1 (t2tb14 y) (t2tb2 z)))
  (direct_product a1 b1 b1 (t2tb35 f) (t2tb37 g)))
  (and (mem26 (tb2t36 (Tuple2 b1 b1 (t2tb14 x) (t2tb14 y))) f) (mem5
  (tb2t38 (Tuple2 b1 a1 (t2tb14 x) (t2tb2 z))) g)))))

;; mem_direct_product
  (assert
  (forall ((c2 ty))
  (forall ((f (set (tuple21 b b))) (g uni) (x b) (y b) (z uni))
  (= (mem (tuple2 b1 (tuple2 b1 c2))
  (Tuple2 b1 (tuple2 b1 c2) (t2tb14 x) (Tuple2 b1 c2 (t2tb14 y) z))
  (direct_product c2 b1 b1 (t2tb35 f) g))
  (and (mem26 (tb2t36 (Tuple2 b1 b1 (t2tb14 x) (t2tb14 y))) f) (mem
  (tuple2 b1 c2) (Tuple2 b1 c2 (t2tb14 x) z) g))))))

;; mem_direct_product
  (assert
  (forall ((f (set (tuple21 b a))) (g (set (tuple21 b b))) (x b) (y a) (z b))
  (= (mem (tuple2 b1 (tuple2 a1 b1))
  (Tuple2 b1 (tuple2 a1 b1) (t2tb14 x) (Tuple2 a1 b1 (t2tb2 y) (t2tb14 z)))
  (direct_product b1 a1 b1 (t2tb37 f) (t2tb35 g)))
  (and (mem5 (tb2t38 (Tuple2 b1 a1 (t2tb14 x) (t2tb2 y))) f) (mem26
  (tb2t36 (Tuple2 b1 b1 (t2tb14 x) (t2tb14 z))) g)))))
...
;; mem_parallel_product
  (assert
  (forall ((a2 ty) (b2 ty))
  (forall ((h uni) (k (set (tuple21 b b))) (x uni) (y b) (z uni) (w b))
  (= (mem (tuple2 (tuple2 a2 b1) (tuple2 b2 b1))
  (Tuple2 (tuple2 a2 b1) (tuple2 b2 b1) (Tuple2 a2 b1 x (t2tb14 y))
  (Tuple2 b2 b1 z (t2tb14 w))) (parallel_product b1 b1 b2 a2 h (t2tb35 k)))
  (and (mem (tuple2 a2 b2) (Tuple2 a2 b2 x z) h) (mem26
  (tb2t36 (Tuple2 b1 b1 (t2tb14 y) (t2tb14 w))) k))))))
...
;; mem_parallel_product
  (assert
  (forall ((h (set (tuple21 b b))) (k (set (tuple21 b b))) (x b) (y b) (z b)
  (w b))
  (= (mem (tuple2 (tuple2 b1 b1) (tuple2 b1 b1))
  (Tuple2 (tuple2 b1 b1) (tuple2 b1 b1) (Tuple2 b1 b1 (t2tb14 x) (t2tb14 y))
  (Tuple2 b1 b1 (t2tb14 z) (t2tb14 w)))
  (parallel_product b1 b1 b1 b1 (t2tb35 h) (t2tb35 k)))
  (and (mem26 (tb2t36 (Tuple2 b1 b1 (t2tb14 x) (t2tb14 z))) h) (mem26
  (tb2t36 (Tuple2 b1 b1 (t2tb14 y) (t2tb14 w))) k)))))

;; mem_parallel_product
  (assert
  (forall ((h (set (tuple21 b b))) (k (set (tuple21 b a))) (x b) (y b) (z b)
  (w a))
  (= (mem (tuple2 (tuple2 b1 b1) (tuple2 b1 a1))
  (Tuple2 (tuple2 b1 b1) (tuple2 b1 a1) (Tuple2 b1 b1 (t2tb14 x) (t2tb14 y))
  (Tuple2 b1 a1 (t2tb14 z) (t2tb2 w)))
  (parallel_product a1 b1 b1 b1 (t2tb35 h) (t2tb37 k)))
  (and (mem26 (tb2t36 (Tuple2 b1 b1 (t2tb14 x) (t2tb14 z))) h) (mem5
  (tb2t38 (Tuple2 b1 a1 (t2tb14 y) (t2tb2 w))) k)))))

;; mem_parallel_product
  (assert
  (forall ((h (set (tuple21 b b))) (k (set (tuple21 a b))) (x b) (y a) (z b)
  (w b))
  (= (mem (tuple2 (tuple2 b1 a1) (tuple2 b1 b1))
  (Tuple2 (tuple2 b1 a1) (tuple2 b1 b1) (Tuple2 b1 a1 (t2tb14 x) (t2tb2 y))
  (Tuple2 b1 b1 (t2tb14 z) (t2tb14 w)))
  (parallel_product b1 a1 b1 b1 (t2tb35 h) (t2tb11 k)))
  (and (mem26 (tb2t36 (Tuple2 b1 b1 (t2tb14 x) (t2tb14 z))) h) (mem3
  (tb2t13 (Tuple2 a1 b1 (t2tb2 y) (t2tb14 w))) k)))))

;; mem_parallel_product
  (assert
  (forall ((c2 ty) (d2 ty))
  (forall ((h (set (tuple21 b b))) (k uni) (x b) (y uni) (z b) (w uni))
  (= (mem (tuple2 (tuple2 b1 c2) (tuple2 b1 d2))
  (Tuple2 (tuple2 b1 c2) (tuple2 b1 d2) (Tuple2 b1 c2 (t2tb14 x) y)
  (Tuple2 b1 d2 (t2tb14 z) w)) (parallel_product d2 c2 b1 b1 (t2tb35 h) k))
  (and (mem26 (tb2t36 (Tuple2 b1 b1 (t2tb14 x) (t2tb14 z))) h) (mem
  (tuple2 c2 d2) (Tuple2 c2 d2 y w) k))))))

;; mem_parallel_product
  (assert
  (forall ((h (set (tuple21 b a))) (k (set (tuple21 b b))) (x b) (y b) (z a)
  (w b))
  (= (mem (tuple2 (tuple2 b1 b1) (tuple2 a1 b1))
  (Tuple2 (tuple2 b1 b1) (tuple2 a1 b1) (Tuple2 b1 b1 (t2tb14 x) (t2tb14 y))
  (Tuple2 a1 b1 (t2tb2 z) (t2tb14 w)))
  (parallel_product b1 b1 a1 b1 (t2tb37 h) (t2tb35 k)))
  (and (mem5 (tb2t38 (Tuple2 b1 a1 (t2tb14 x) (t2tb2 z))) h) (mem26
  (tb2t36 (Tuple2 b1 b1 (t2tb14 y) (t2tb14 w))) k)))))
...
;; mem_parallel_product
  (assert
  (forall ((h (set (tuple21 a b))) (k (set (tuple21 b b))) (x a) (y b) (z b)
  (w b))
  (= (mem (tuple2 (tuple2 a1 b1) (tuple2 b1 b1))
  (Tuple2 (tuple2 a1 b1) (tuple2 b1 b1) (Tuple2 a1 b1 (t2tb2 x) (t2tb14 y))
  (Tuple2 b1 b1 (t2tb14 z) (t2tb14 w)))
  (parallel_product b1 b1 b1 a1 (t2tb11 h) (t2tb35 k)))
  (and (mem3 (tb2t13 (Tuple2 a1 b1 (t2tb2 x) (t2tb14 z))) h) (mem26
  (tb2t36 (Tuple2 b1 b1 (t2tb14 y) (t2tb14 w))) k)))))
...
;; mem_partial_function_set
  (assert
  (forall ((s (set b)) (t (set b)) (f (set (tuple21 b b))))
  (= (mem (set1 (tuple2 b1 b1)) (t2tb35 f)
  (infix_plmngt b1 b1 (t2tb12 s) (t2tb12 t)))
  (and (mem (set1 (tuple2 b1 b1)) (t2tb35 f)
  (relation b1 b1 (t2tb12 s) (t2tb12 t)))
  (forall ((x b) (y1 b) (y2 b))
  (=>
  (and (mem26 (tb2t36 (Tuple2 b1 b1 (t2tb14 x) (t2tb14 y1))) f) (mem26
  (tb2t36 (Tuple2 b1 b1 (t2tb14 x) (t2tb14 y2))) f)) (= y1 y2)))))))
...
;; mem_partial_injection_set
  (assert
  (forall ((s (set b)) (t (set b)) (x (set (tuple21 b b))))
  (= (mem (set1 (tuple2 b1 b1)) (t2tb35 x)
  (infix_gtplgt b1 b1 (t2tb12 s) (t2tb12 t)))
  (and (mem (set1 (tuple2 b1 b1)) (t2tb35 x)
  (infix_plmngt b1 b1 (t2tb12 s) (t2tb12 t))) (mem (set1 (tuple2 b1 b1))
  (t2tb35 (inverse4 x)) (infix_plmngt b1 b1 (t2tb12 t) (t2tb12 s)))))))
...
;; mem_partial_surjection_set
  ...
  (forall ((s (set b)) (t (set b)) (x (set (tuple21 b b))))
  (= (mem (set1 (tuple2 b1 b1)) (t2tb35 x)
  (infix_plmngtgt b1 b1 (t2tb12 s) (t2tb12 t)))
  (and (mem (set1 (tuple2 b1 b1)) (t2tb35 x)
  (infix_plmngt b1 b1 (t2tb12 s) (t2tb12 t))) (infix_eqeq b1
  (t2tb12 (ran3 x)) (t2tb12 t))))))
...
;; mem_partial_surjection_set
  ...
  (and (mem (set1 (tuple2 b1 a1)) (t2tb37 x)
  (infix_plmngt a1 b1 (t2tb12 s) (t2tb1 t))) (infix_eqeq a1 (t2tb1 (ran2 x))
  (t2tb1 t))))))
...
;; mem_partial_surjection_set
  ...
  (and (mem4 x (tb2t10 (infix_plmngt b1 a1 (t2tb1 s) (t2tb12 t))))
  (infix_eqeq b1 (t2tb12 (ran1 x)) (t2tb12 t))))))
...
;; apply_def0
  (assert
  (forall ((b2 ty))
  (forall ((f uni) (s (set (tuple21 b b))) (t uni) (a2 (tuple21 b b)))
  (=>
  (and (mem (set1 (tuple2 (tuple2 b1 b1) b2)) f
  (infix_plmngt b2 (tuple2 b1 b1) (t2tb35 s) t)) (mem26 a2
  (tb2t35 (dom b2 (tuple2 b1 b1) f)))) (mem (tuple2 (tuple2 b1 b1) b2)
  (Tuple2 (tuple2 b1 b1) b2 (t2tb36 a2)
  (apply b2 (tuple2 b1 b1) f (t2tb36 a2))) f)))))
...
;; apply_def0
  (assert
  (forall ((f (set (tuple21 b b))) (s (set b)) (t (set b)) (a2 b))
  (=>
  (and (mem (set1 (tuple2 b1 b1)) (t2tb35 f)
  (infix_plmngt b1 b1 (t2tb12 s) (t2tb12 t))) (mem2 a2
  (tb2t12 (dom b1 b1 (t2tb35 f))))) (mem26
  (tb2t36 (Tuple2 b1 b1 (t2tb14 a2) (apply b1 b1 (t2tb35 f) (t2tb14 a2))))
  f))))
...
(assert
;; inclusion_id_2
 ;; File "lemmes_bbook.why", line 945, characters 7-21
  (not
  (forall ((s (set a)) (t (set b)) (r (set (tuple21 a b))))
  (=> (mem4 r (relation1 s t)) (subset21 (id2 (ran1 r))
  (semicolon8 (inverse2 r) r))))))
(check-sat)
