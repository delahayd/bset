...
tff(inter_times_distributivity, conjecture, ![A : $tType]: ![A1:set(A), B:
  set(A), T:set(A)]: infix_eqeq(tuple2(A, A), times(A, A, inter(A, A1, B),
  T), inter(tuple2(A, A), times(A, A, A1, T), times(A, A, B, T)))).
