...
(assert
;; equal_restriction_18
 ;; File "lemmes_bbook.why", line 2010, characters 7-27
  (not
  (forall ((s (set a)) (u (set a)) (v (set a)) (t (set b)))
  (=> (and (subset2 u s) (subset2 v s)) (infix_eqeq4
  (domain_restriction1 u (times2 v t)) (times2 (inter1 u v) t))))))
(check-sat)
