...
fof(inclusion_semicolon_2, conjecture, ![S, T, U, R, P, Q]: ((sort(set(a),
  ...
  diff(tuple2(a, c), semicolon(c, b, a, R, P), semicolon(c, b, a, R, Q)),
  semicolon(c, b, a, R, diff(tuple2(b, c), P, Q))))))))))).
