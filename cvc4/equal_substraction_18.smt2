...
(assert
;; equal_substraction_18
 ;; File "lemmes_bbook.why", line 2213, characters 7-28
  (not
  (forall ((s (set a)) (u (set a)) (t (set b)) (r (set (tuple21 a b))))
  (=> (and (subset2 u s) (and (mem4 r (relation1 s t)) (subset2 (dom1 r) u)))
  (infix_eqeq4 (domain_substraction1 u r) empty3)))))
(check-sat)
