...
;; mem_partial_surjection_set
  ...
  (infix_plmngt b1 a1 (t2tb1 s) (t2tb12 t))) (infix_eqeq b1
  (ran b1 a1 (t2tb11 x)) (t2tb12 t))))))
...
;; mem_total_surjection_set
  (assert
  (forall ((s (set a)) (t (set b)) (x (set (tuple21 a b))))
  (= (mem (set1 (tuple2 a1 b1)) (t2tb11 x) (t2tb10 (infix_mnmngtgt1 s t)))
...
;; mem_total_bijection_set
  ...
  (forall ((s (set a)) (t (set b)) (x (set (tuple21 a b))))
  (= (mem (set1 (tuple2 a1 b1)) (t2tb11 x)
  (infix_gtmngtgt b1 a1 (t2tb1 s) (t2tb12 t)))
  (and (mem (set1 (tuple2 a1 b1)) (t2tb11 x)
  (infix_gtmngt b1 a1 (t2tb1 s) (t2tb12 t))) (mem (set1 (tuple2 a1 b1))
  (t2tb11 x) (t2tb10 (infix_mnmngtgt1 s t)))))))
...
(assert
;; inclusion_function_3
 ;; File "lemmes_bbook.why", line 897, characters 7-27
  (not
  (forall ((s (set a)) (t (set b))) (subset7 (infix_mnmngtgt1 s t)
  (infix_plmngtgt1 s t)))))
(check-sat)
