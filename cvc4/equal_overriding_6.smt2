...
;; mem_overriding
  ...
  (= (mem3 (Tuple21 x y) (infix_lspl1 q p))
  (or
...
(assert
;; equal_overriding_6
 ;; File "lemmes_bbook.why", line 2549, characters 7-25
  (not
  (forall ((s (set a)) (u (set a)) (t (set b)) (x a) (y b))
  (=> (and (subset2 u s) (and (mem2 y t) (mem1 x s))) (infix_eqeq4
  (infix_lspl1 (times2 u (singleton2 y)) (singleton3 (Tuple21 x y)))
  (times2 (union2 u (singleton1 x)) (singleton2 y)))))))
(check-sat)
