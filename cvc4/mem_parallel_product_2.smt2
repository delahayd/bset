...
;; mem_total_function_set
  ...
  (and (mem25 x (infix_plmngt6 s t)) (infix_eqeq (tuple2 a1 c1)
  (dom (tuple2 b1 d1) (tuple2 a1 c1) (t2tb686 x)) (t2tb129 s))))))

;; mem_total_function_set
  (assert
  (forall ((s (set c)) (t (set d)) (x (set (tuple21 c d))))
  (= (mem22 x (tb2t688 (infix_mnmngt d1 c1 (t2tb132 s) (t2tb690 t))))
  (and (mem22 x (infix_plmngt7 s t)) (infix_eqeq c1 (dom d1 c1 (t2tb689 x))
  (t2tb132 s))))))
...
;; mem_total_function_set
  ...
  (and (mem4 x (infix_plmngt1 s t)) (infix_eqeq a1 (dom b1 a1 (t2tb11 x))
  (t2tb1 s))))))
...
;; mem_partial_injection_set
  ...
  (tb2t689 (inverse c1 d1 (t2tb829 x))) (infix_plmngt7 t s))))))
...
;; mem_partial_injection_set
  ...
  (and (mem25 x (infix_plmngt6 s t)) (mem
...
;; mem_partial_injection_set
  ...
  (and (mem22 x (infix_plmngt7 s t)) (mem (set1 (tuple2 d1 c1))
  (inverse d1 c1 (t2tb689 x)) (infix_plmngt c1 d1 (t2tb690 t) (t2tb132 s)))))))
...
;; mem_partial_surjection_set
  ...
  (and (mem25 x (infix_plmngt6 s t)) (infix_eqeq (tuple2 b1 d1)
  (ran (tuple2 b1 d1) (tuple2 a1 c1) (t2tb686 x)) (t2tb687 t))))))

;; mem_partial_surjection_set
  (assert
  (forall ((s (set c)) (t (set d)) (x (set (tuple21 c d))))
  (= (mem22 x (tb2t688 (infix_plmngtgt d1 c1 (t2tb132 s) (t2tb690 t))))
  (and (mem22 x (infix_plmngt7 s t)) (infix_eqeq d1 (ran d1 c1 (t2tb689 x))
  (t2tb690 t))))))
...
;; mem_partial_surjection_set
  ...
  (and (mem4 x (infix_plmngt1 s t)) (infix_eqeq b1 (ran b1 a1 (t2tb11 x))
  (t2tb12 t))))))
...
;; mem_total_surjection_set
  ...
  (= (mem25 x
  (tb2t685
  (infix_mnmngtgt (tuple2 b1 d1) (tuple2 a1 c1) (t2tb129 s) (t2tb687 t))))
  (and (mem25 x
  (tb2t685
  (infix_plmngtgt (tuple2 b1 d1) (tuple2 a1 c1) (t2tb129 s) (t2tb687 t))))
  (mem25 x
...
;; apply_def0
  ...
  (=>
  (and (mem25 f (infix_plmngt6 s t)) (mem10 a2
  (tb2t129 (dom (tuple2 b1 d1) (tuple2 a1 c1) (t2tb686 f))))) (mem24
  (tb2t691
...
;; apply_def0
  ...
  (=>
  (and (mem22 f (infix_plmngt7 s t)) (mem7 a2
  (tb2t132 (dom d1 c1 (t2tb689 f))))) (mem21
  (tb2t693
...
(assert
;; mem_parallel_product_2
 ;; File "lemmes_bbook.why", line 587, characters 7-29
  (not
  (forall ((s (set a)) (t (set b)) (u (set c)) (v (set d)) (f (set (tuple21 a
  b))) (g (set (tuple21 c d))))
  (=> (and (mem4 f (infix_plmngt1 s t)) (mem22 g (infix_plmngt7 u v))) (mem25
  (parallel_product1 f g) (infix_plmngt6 (times4 s u) (times10 t v)))))))
(check-sat)
