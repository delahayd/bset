...
;; mem_total_function_set
  ...
  (and (mem6 x (infix_plmngt2 s t)) (infix_eqeq b1 (dom a1 b1 (t2tb37 x))
  (t2tb12 s))))))
...
;; mem_partial_injection_set
  ...
  (and (mem6 x (infix_plmngt2 s t)) (mem4 (inverse1 x) (infix_plmngt1 t s))))))

;; mem_partial_injection_set
  (assert
  (forall ((s (set a)) (t (set b)) (x (set (tuple21 a b))))
  (= (mem4 x (infix_gtplgt1 s t))
  (and (mem4 x (infix_plmngt1 s t)) (mem6 (inverse2 x) (infix_plmngt2 t s))))))
...
;; mem_partial_surjection_set
  ...
  (and (mem6 x (infix_plmngt2 s t)) (infix_eqeq a1 (ran a1 b1 (t2tb37 x))
  (t2tb1 t))))))
...
(assert
;; mem_inverse_2
 ;; File "lemmes_bbook.why", line 318, characters 7-20
  (not
  (forall ((s (set a)) (t (set b)) (f (set (tuple21 a b))))
  (=> (mem4 f (infix_gtplgt1 s t)) (mem6 (inverse2 f) (infix_plmngt2 t s))))))
(check-sat)
