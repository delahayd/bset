...
(assert
;; equal_image_8
 ;; File "lemmes_bbook.why", line 2341, characters 7-20
  (not
  (forall ((s (set a)) (u (set a)) (t (set b)) (p (set (tuple21 a b)))
  (q (set (tuple21 a b))))
  (=>
  (and (mem4 p (relation1 s t)) (and (mem4 q (relation1 s t)) (subset2 u s)))
  (infix_eqeq3 (image1 (infix_lspl1 p q) u)
  (union4 (image1 (domain_substraction1 (dom1 q) p) u) (image1 q u)))))))
(check-sat)
