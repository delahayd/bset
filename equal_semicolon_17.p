...
tff(equal_semicolon_17, conjecture, ![A : $tType, B : $tType, C : $tType,
  D : $tType]: ![S:set(A), T:set(B), U:set(C), V:set(D), F:set(tuple2(A, B)),
  P:set(tuple2(B, C)), Q:set(tuple2(B, D))]: ((mem(set(tuple2(A, B)), F,
  infix_plmngt(A, B, S, T)) & (mem(set(tuple2(B, C)), P, relation(B, C, T,
  U)) & mem(set(tuple2(B, D)), Q, relation(B, D, T, V))))
  => infix_eqeq(tuple2(A, tuple2(C, D)), semicolon(A, B, tuple2(C, D), F,
  direct_product(B, C, D, P, Q)), direct_product(A, C, D, semicolon(A, B,
  C, F, P), semicolon(A, B, D, F, Q))))).
