...
;; mem_times
  ...
  (= (mem5 (Tuple25 x y) (tb2t37 (times a1 b1 (t2tb12 s) (t2tb1 t))))
...
;; mem_times
  ...
  (= (mem3 (Tuple21 x y) (tb2t11 (times b1 a1 (t2tb1 s) (t2tb12 t))))
...
;; mem_proj_op_1
  ...
  (Tuple2 (tuple2 b1 a1) b1 (t2tb38 (Tuple25 x y)) (t2tb14 z))
  (times b1 (tuple2 b1 a1) (times a1 b1 (t2tb12 s) (t2tb1 t)) (t2tb12 s)))
  (= z x)))))
...
;; mem_proj_op_2
  ...
  (Tuple2 (tuple2 b1 a1) a1 (t2tb38 (Tuple25 x y)) (t2tb2 z))
  (times a1 (tuple2 b1 a1) (times a1 b1 (t2tb12 s) (t2tb1 t)) (t2tb1 t)))
  (= z y)))))
...
(assert
;; equal_inverse_13
 ;; File "lemmes_bbook.why", line 1191, characters 7-23
  (not
  (forall ((s (set a)) (t (set b)) (x a) (y b))
  (=> (and (mem1 x s) (mem2 y t)) (infix_eqeq6
  (inverse2 (singleton3 (Tuple21 x y))) (singleton5 (Tuple25 y x)))))))
(check-sat)
