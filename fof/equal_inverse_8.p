...
fof(equal_inverse_8, conjecture, ![S, T, P, Q]: ((sort(set(a), S) = S)
  ...
  => infix_eqeq(tuple2(b, a), inverse(b, a, infix_lspl(b, a, P, Q)),
  union(tuple2(b, a), range_substraction(a, b, inverse(b, a, P), dom(b, a,
  Q)), inverse(b, a, Q))))))))).
