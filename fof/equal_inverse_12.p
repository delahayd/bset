...
fof(equal_inverse_12, conjecture, ![S, T, P, Q]: ((sort(set(a), S) = S)
  ...
  => infix_eqeq(tuple2(b, a), inverse(b, a, diff(tuple2(a, b), P, Q)),
  diff(tuple2(b, a), inverse(b, a, P), inverse(b, a, Q))))))))).
