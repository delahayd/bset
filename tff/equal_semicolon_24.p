...
tff(equal_semicolon_24, conjecture, ![A : $tType, B : $tType, C : $tType]:
  ...
  & (mem(set(tuple2(B, C)), R, relation(B, C, T, U)) & subset(B, ran(A,
  B, Q), dom(B, C, R))))) => infix_eqeq(tuple2(A, C), semicolon(A, B,
  C, infix_lspl(A, B, P, Q), R), infix_lspl(A, C, semicolon(A, B, C, P, R),
  semicolon(A, B, C, Q, R))))).
