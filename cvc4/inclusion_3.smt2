...
(assert
;; inclusion_3
 ;; File "lemmes_bbook.why", line 286, characters 7-18
  (not
  (forall ((s (set a)) (a2 (set a)) (b (set a)) (c (set a)))
  (=> (and (subset2 a2 s) (and (subset2 b s) (subset2 c s)))
  (= (subset2 (inter1 a2 b) c) (subset2 a2 (union2 (diff1 s b) c)))))))
(check-sat)
