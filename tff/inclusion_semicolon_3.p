...
tff(inclusion_semicolon_3, conjecture, ![A : $tType, B : $tType, C : $tType]:
  ...
  & mem(set(tuple2(B, C)), R, relation(B, C, T, U))))
  => subset(tuple2(A, C), semicolon(A, B, C, inter(tuple2(A, B), P, Q), R),
  inter(tuple2(A, C), semicolon(A, B, C, P, R), semicolon(A, B, C, Q, R))))).
