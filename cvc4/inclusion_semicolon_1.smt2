...
;; subsetnoteq_def
  ...
  (and (subset12 s t)
  (not (infix_eqeq (set1 (tuple2 b1 c1)) (t2tb130 s) (t2tb130 t)))))))
...
;; subsetnoteq_def
  ...
  (and (subset10 s t)
  (not (infix_eqeq (tuple2 b1 c1) (t2tb131 s) (t2tb131 t)))))))
...
(assert
;; inclusion_semicolon_1
 ;; File "lemmes_bbook.why", line 986, characters 7-28
  (not
  (forall ((s (set a)) (t (set b)) (u (set c)) (r (set (tuple21 a b)))
  (p (set (tuple21 b c))) (q (set (tuple21 b c))))
  (=>
  (and (mem4 r (relation1 s t))
  (and (mem9 p (relation4 t u)) (mem9 q (relation4 t u)))) (subset11
  (semicolon1 r (inter7 p q)) (inter8 (semicolon1 r p) (semicolon1 r q)))))))
(check-sat)
