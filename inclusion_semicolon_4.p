...
tff(inclusion_semicolon_4, conjecture, ![A : $tType, B : $tType, C : $tType]:
  ...
  => subset(tuple2(A, C), diff(tuple2(A, C), semicolon(A, B, C, P, R),
  semicolon(A, B, C, Q, R)), semicolon(A, B, C, diff(tuple2(A, B), P, Q),
  R)))).
