...
(assert
;; monot_substraction_2
 ;; File "lemmes_bbook.why", line 816, characters 7-27
  (not
  (forall ((s (set a)) (t (set b)) (u (set b)) (v (set b)) (p (set (tuple21 a
  b))) (r (set (tuple21 a b))))
  (=> (and (mem4 p (relation1 s t)) (subset5 u t))
  (=> (and (subset6 r p) (subset5 v u)) (subset6 (range_substraction1 r u)
  (range_substraction1 p v)))))))
(check-sat)
