...
(declare-fun infix_gtmngtgt6 ((set a) (set (tuple21 b
...
(assert
;; mem_direct_product_7
 ;; File "lemmes_bbook.why", line 561, characters 7-27
  (not
  (forall ((s (set a)) (t (set b)) (u (set c)) (f (set (tuple21 a b)))
  (g (set (tuple21 a c))))
  (=> (and (mem4 f (infix_gtmngtgt1 s t)) (mem11 g (infix_gtmngtgt3 s u)))
  (mem15 (direct_product1 f g) (infix_gtmngtgt6 s (times3 t u)))))))
(check-sat)
