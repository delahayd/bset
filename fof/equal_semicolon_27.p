...
fof(equal_semicolon_27, conjecture, ![S, T, U, P, Q, R]: ((sort(set(a),
  ...
  => infix_eqeq(tuple2(a, c), semicolon(c, b, a, diff(tuple2(a, b), P, Q),
  R), diff(tuple2(a, c), semicolon(c, b, a, P, R), semicolon(c, b, a, Q,
  R))))))))))).
