...
;; subsetnoteq_def
  ...
  (and (subset3 s t) (not (infix_eqeq (tuple2 a1 a1) (t2tb4 s) (t2tb4 t)))))))
...
(declare-fun t2tb1380 ((set (tuple21 (tuple21 b a) (tuple21 a a)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b a) (tuple21 a a))))) (sort
  (set1 (tuple2 (tuple2 b1 a1) (tuple2 a1 a1))) (t2tb1380 x))))

(declare-fun tb2t1380 (uni) (set (tuple21 (tuple21 b a) (tuple21 a a))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b a) (tuple21 a a)))))
  (! (= (tb2t1380 (t2tb1380 i)) i) :pattern ((t2tb1380 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 a1) (tuple2 a1 a1))) j)
     (= (t2tb1380 (tb2t1380 j)) j)) :pattern ((t2tb1380 (tb2t1380 j))) )))

(declare-fun t2tb1381 ((tuple21 (tuple21 b a) (tuple21 a a))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 b a) (tuple21 a a)))) (sort
  (tuple2 (tuple2 b1 a1) (tuple2 a1 a1)) (t2tb1381 x))))

(declare-fun tb2t1381 (uni) (tuple21 (tuple21 b a) (tuple21 a a)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b a) (tuple21 a a))))
  (! (= (tb2t1381 (t2tb1381 i)) i) :pattern ((t2tb1381 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 a1) (tuple2 a1 a1)) j)
     (= (t2tb1381 (tb2t1381 j)) j)) :pattern ((t2tb1381 (tb2t1381 j))) )))

;; mem_times
  (assert
  (forall ((s (set (tuple21 b a))) (t (set (tuple21 a a))) (x (tuple21 b a))
  (y (tuple21 a a)))
  (= (mem (tuple2 (tuple2 b1 a1) (tuple2 a1 a1))
  (Tuple2 (tuple2 b1 a1) (tuple2 a1 a1) (t2tb38 x) (t2tb5 y))
  (times (tuple2 a1 a1) (tuple2 b1 a1) (t2tb37 s) (t2tb4 t)))
  (and (mem5 x s) (mem12 y t)))))
...
(declare-fun t2tb1382 ((set (tuple21 (set (tuple21 a b)) (tuple21 a
  a)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (set (tuple21 a b)) (tuple21 a a))))) (sort
  (set1 (tuple2 (set1 (tuple2 a1 b1)) (tuple2 a1 a1))) (t2tb1382 x))))

(declare-fun tb2t1382 (uni) (set (tuple21 (set (tuple21 a b)) (tuple21 a
  a))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (set (tuple21 a b)) (tuple21 a a)))))
  (! (= (tb2t1382 (t2tb1382 i)) i) :pattern ((t2tb1382 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (set1 (tuple2 a1 b1)) (tuple2 a1 a1))) j)
     (= (t2tb1382 (tb2t1382 j)) j)) :pattern ((t2tb1382 (tb2t1382 j))) )))

(declare-fun t2tb1383 ((tuple21 (set (tuple21 a b)) (tuple21 a a))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (set (tuple21 a b)) (tuple21 a a)))) (sort
  (tuple2 (set1 (tuple2 a1 b1)) (tuple2 a1 a1)) (t2tb1383 x))))

(declare-fun tb2t1383 (uni) (tuple21 (set (tuple21 a b)) (tuple21 a a)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (set (tuple21 a b)) (tuple21 a a))))
  (! (= (tb2t1383 (t2tb1383 i)) i) :pattern ((t2tb1383 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (set1 (tuple2 a1 b1)) (tuple2 a1 a1)) j)
     (= (t2tb1383 (tb2t1383 j)) j)) :pattern ((t2tb1383 (tb2t1383 j))) )))
...
(declare-fun t2tb1384 ((set (tuple21 (tuple21 a a) (tuple21 b a)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 a a) (tuple21 b a))))) (sort
  (set1 (tuple2 (tuple2 a1 a1) (tuple2 b1 a1))) (t2tb1384 x))))

(declare-fun tb2t1384 (uni) (set (tuple21 (tuple21 a a) (tuple21 b a))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 a a) (tuple21 b a)))))
  (! (= (tb2t1384 (t2tb1384 i)) i) :pattern ((t2tb1384 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 a1 a1) (tuple2 b1 a1))) j)
     (= (t2tb1384 (tb2t1384 j)) j)) :pattern ((t2tb1384 (tb2t1384 j))) )))

(declare-fun t2tb1385 ((tuple21 (tuple21 a a) (tuple21 b a))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 a a) (tuple21 b a)))) (sort
  (tuple2 (tuple2 a1 a1) (tuple2 b1 a1)) (t2tb1385 x))))

(declare-fun tb2t1385 (uni) (tuple21 (tuple21 a a) (tuple21 b a)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 a a) (tuple21 b a))))
  (! (= (tb2t1385 (t2tb1385 i)) i) :pattern ((t2tb1385 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 a1 a1) (tuple2 b1 a1)) j)
     (= (t2tb1385 (tb2t1385 j)) j)) :pattern ((t2tb1385 (tb2t1385 j))) )))

;; mem_times
  (assert
  (forall ((s (set (tuple21 a a))) (t (set (tuple21 b a))) (x (tuple21 a a))
  (y (tuple21 b a)))
  (= (mem (tuple2 (tuple2 a1 a1) (tuple2 b1 a1))
  (Tuple2 (tuple2 a1 a1) (tuple2 b1 a1) (t2tb5 x) (t2tb38 y))
  (times (tuple2 b1 a1) (tuple2 a1 a1) (t2tb4 s) (t2tb37 t)))
  (and (mem12 x s) (mem5 y t)))))

(declare-fun t2tb1386 ((set (tuple21 (tuple21 a a) (set (tuple21 a
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 a a) (set (tuple21 a b)))))) (sort
  (set1 (tuple2 (tuple2 a1 a1) (set1 (tuple2 a1 b1)))) (t2tb1386 x))))

(declare-fun tb2t1386 (uni) (set (tuple21 (tuple21 a a) (set (tuple21 a
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 a a) (set (tuple21 a b))))))
  (! (= (tb2t1386 (t2tb1386 i)) i) :pattern ((t2tb1386 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 a1 a1) (set1 (tuple2 a1 b1)))) j)
     (= (t2tb1386 (tb2t1386 j)) j)) :pattern ((t2tb1386 (tb2t1386 j))) )))

(declare-fun t2tb1387 ((tuple21 (tuple21 a a) (set (tuple21 a b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 a a) (set (tuple21 a b))))) (sort
  (tuple2 (tuple2 a1 a1) (set1 (tuple2 a1 b1))) (t2tb1387 x))))

(declare-fun tb2t1387 (uni) (tuple21 (tuple21 a a) (set (tuple21 a b))))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 a a) (set (tuple21 a b)))))
  (! (= (tb2t1387 (t2tb1387 i)) i) :pattern ((t2tb1387 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 a1 a1) (set1 (tuple2 a1 b1))) j)
     (= (t2tb1387 (tb2t1387 j)) j)) :pattern ((t2tb1387 (tb2t1387 j))) )))
...
(declare-fun t2tb1388 ((tuple21 (tuple21 a a) (tuple21 a b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 a a) (tuple21 a b)))) (sort
  (tuple2 (tuple2 a1 a1) (tuple2 a1 b1)) (t2tb1388 x))))

(declare-fun tb2t1388 (uni) (tuple21 (tuple21 a a) (tuple21 a b)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 a a) (tuple21 a b))))
  (! (= (tb2t1388 (t2tb1388 i)) i) :pattern ((t2tb1388 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 a1 a1) (tuple2 a1 b1)) j)
     (= (t2tb1388 (tb2t1388 j)) j)) :pattern ((t2tb1388 (tb2t1388 j))) )))

(declare-fun t2tb1389 ((set (tuple21 (tuple21 a a) (tuple21 a b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 a a) (tuple21 a b))))) (sort
  (set1 (tuple2 (tuple2 a1 a1) (tuple2 a1 b1))) (t2tb1389 x))))

(declare-fun tb2t1389 (uni) (set (tuple21 (tuple21 a a) (tuple21 a b))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 a a) (tuple21 a b)))))
  (! (= (tb2t1389 (t2tb1389 i)) i) :pattern ((t2tb1389 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 a1 a1) (tuple2 a1 b1))) j)
     (= (t2tb1389 (tb2t1389 j)) j)) :pattern ((t2tb1389 (tb2t1389 j))) )))
...
(declare-fun t2tb1390 ((set (tuple21 (tuple21 a a) b))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 a a) b)))) (sort
  (set1 (tuple2 (tuple2 a1 a1) b1)) (t2tb1390 x))))

(declare-fun tb2t1390 (uni) (set (tuple21 (tuple21 a a) b)))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 a a) b))))
  (! (= (tb2t1390 (t2tb1390 i)) i) :pattern ((t2tb1390 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 a1 a1) b1)) j)
     (= (t2tb1390 (tb2t1390 j)) j)) :pattern ((t2tb1390 (tb2t1390 j))) )))

(declare-fun t2tb1391 ((tuple21 (tuple21 a a) b)) uni)
...
(declare-fun tb2t1391 (uni) (tuple21 (tuple21 a a) b))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 a a) b)))
  (! (= (tb2t1391 (t2tb1391 i)) i) :pattern ((t2tb1391 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 a1 a1) b1) j) (= (t2tb1391 (tb2t1391 j)) j)) :pattern (
  (t2tb1391 (tb2t1391 j))) )))
...
(declare-fun t2tb1392 ((set (tuple21 (tuple21 a a) (tuple21 a a)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 a a) (tuple21 a a))))) (sort
  (set1 (tuple2 (tuple2 a1 a1) (tuple2 a1 a1))) (t2tb1392 x))))

(declare-fun tb2t1392 (uni) (set (tuple21 (tuple21 a a) (tuple21 a a))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 a a) (tuple21 a a)))))
  (! (= (tb2t1392 (t2tb1392 i)) i) :pattern ((t2tb1392 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 a1 a1) (tuple2 a1 a1))) j)
     (= (t2tb1392 (tb2t1392 j)) j)) :pattern ((t2tb1392 (tb2t1392 j))) )))

(declare-fun t2tb1393 ((tuple21 (tuple21 a a) (tuple21 a a))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 a a) (tuple21 a a)))) (sort
  (tuple2 (tuple2 a1 a1) (tuple2 a1 a1)) (t2tb1393 x))))

(declare-fun tb2t1393 (uni) (tuple21 (tuple21 a a) (tuple21 a a)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 a a) (tuple21 a a))))
  (! (= (tb2t1393 (t2tb1393 i)) i) :pattern ((t2tb1393 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 a1 a1) (tuple2 a1 a1)) j)
     (= (t2tb1393 (tb2t1393 j)) j)) :pattern ((t2tb1393 (tb2t1393 j))) )))
...
(declare-fun t2tb1394 ((set (tuple21 (tuple21 a a) a))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 a a) a)))) (sort
  (set1 (tuple2 (tuple2 a1 a1) a1)) (t2tb1394 x))))

(declare-fun tb2t1394 (uni) (set (tuple21 (tuple21 a a) a)))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 a a) a))))
  (! (= (tb2t1394 (t2tb1394 i)) i) :pattern ((t2tb1394 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 a1 a1) a1)) j)
     (= (t2tb1394 (tb2t1394 j)) j)) :pattern ((t2tb1394 (tb2t1394 j))) )))

(declare-fun t2tb1395 ((tuple21 (tuple21 a a) a)) uni)
...
(declare-fun tb2t1395 (uni) (tuple21 (tuple21 a a) a))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 a a) a)))
  (! (= (tb2t1395 (t2tb1395 i)) i) :pattern ((t2tb1395 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 a1 a1) a1) j) (= (t2tb1395 (tb2t1395 j)) j)) :pattern (
  (t2tb1395 (tb2t1395 j))) )))
...
(declare-fun t2tb1396 ((set (tuple21 a (tuple21 a a)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 a (tuple21 a a))))) (sort
  (set1 (tuple2 a1 (tuple2 a1 a1))) (t2tb1396 x))))

(declare-fun tb2t1396 (uni) (set (tuple21 a (tuple21 a a))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 a (tuple21 a a)))))
  (! (= (tb2t1396 (t2tb1396 i)) i) :pattern ((t2tb1396 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 a1 (tuple2 a1 a1))) j)
     (= (t2tb1396 (tb2t1396 j)) j)) :pattern ((t2tb1396 (tb2t1396 j))) )))

(declare-fun t2tb1397 ((tuple21 a (tuple21 a a))) uni)
...
(declare-fun tb2t1397 (uni) (tuple21 a (tuple21 a a)))

;; BridgeL
  (assert
  (forall ((i (tuple21 a (tuple21 a a))))
  (! (= (tb2t1397 (t2tb1397 i)) i) :pattern ((t2tb1397 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 a1 (tuple2 a1 a1)) j) (= (t2tb1397 (tb2t1397 j)) j)) :pattern (
  (t2tb1397 (tb2t1397 j))) )))
...
(declare-fun t2tb1398 ((set (set (tuple21 (tuple21 b a) (tuple21 a
  a))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 b a) (tuple21 a a)))))) (sort
  (set1 (set1 (tuple2 (tuple2 b1 a1) (tuple2 a1 a1)))) (t2tb1398 x))))

(declare-fun tb2t1398 (uni) (set (set (tuple21 (tuple21 b a) (tuple21 a
  a)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 b a) (tuple21 a a))))))
  (! (= (tb2t1398 (t2tb1398 i)) i) :pattern ((t2tb1398 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 b1 a1) (tuple2 a1 a1)))) j)
     (= (t2tb1398 (tb2t1398 j)) j)) :pattern ((t2tb1398 (tb2t1398 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 b a))) (v (set (tuple21 a a)))
  (r (set (tuple21 (tuple21 b a) (tuple21 a a)))))
  (= (mem (set1 (tuple2 (tuple2 b1 a1) (tuple2 a1 a1))) (t2tb1380 r)
  (relation (tuple2 a1 a1) (tuple2 b1 a1) (t2tb37 u) (t2tb4 v)))
  (forall ((x (tuple21 b a)) (y (tuple21 a a)))
  (=> (mem (tuple2 (tuple2 b1 a1) (tuple2 a1 a1))
  (Tuple2 (tuple2 b1 a1) (tuple2 a1 a1) (t2tb38 x) (t2tb5 y)) (t2tb1380 r))
  (and (mem5 x u) (mem12 y v)))))))
...
(declare-fun t2tb1399 ((set (set (tuple21 (set (tuple21 a b)) (tuple21 a
  a))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (set (tuple21 a b)) (tuple21 a a)))))) (sort
  (set1 (set1 (tuple2 (set1 (tuple2 a1 b1)) (tuple2 a1 a1)))) (t2tb1399 x))))

(declare-fun tb2t1399 (uni) (set (set (tuple21 (set (tuple21 a b)) (tuple21 a
  a)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (set (tuple21 a b)) (tuple21 a a))))))
  (! (= (tb2t1399 (t2tb1399 i)) i) :pattern ((t2tb1399 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (set1 (tuple2 a1 b1)) (tuple2 a1 a1)))) j)
     (= (t2tb1399 (tb2t1399 j)) j)) :pattern ((t2tb1399 (tb2t1399 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (set (tuple21 a b)))) (v (set (tuple21 a a)))
  (r (set (tuple21 (set (tuple21 a b)) (tuple21 a a)))))
  (= (mem (set1 (tuple2 (set1 (tuple2 a1 b1)) (tuple2 a1 a1))) (t2tb1382 r)
  (relation (tuple2 a1 a1) (set1 (tuple2 a1 b1)) (t2tb10 u) (t2tb4 v)))
  (forall ((x (set (tuple21 a b))) (y (tuple21 a a)))
  (=> (mem (tuple2 (set1 (tuple2 a1 b1)) (tuple2 a1 a1))
  (Tuple2 (set1 (tuple2 a1 b1)) (tuple2 a1 a1) (t2tb11 x) (t2tb5 y))
  (t2tb1382 r)) (and (mem4 x u) (mem12 y v)))))))
...
(declare-fun t2tb1400 ((set (set (tuple21 (tuple21 a b) (tuple21 a
  a))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 a b) (tuple21 a a)))))) (sort
  (set1 (set1 (tuple2 (tuple2 a1 b1) (tuple2 a1 a1)))) (t2tb1400 x))))

(declare-fun tb2t1400 (uni) (set (set (tuple21 (tuple21 a b) (tuple21 a
  a)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 a b) (tuple21 a a))))))
  (! (= (tb2t1400 (t2tb1400 i)) i) :pattern ((t2tb1400 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 a1 b1) (tuple2 a1 a1)))) j)
     (= (t2tb1400 (tb2t1400 j)) j)) :pattern ((t2tb1400 (tb2t1400 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 a b))) (v (set (tuple21 a a)))
  (r (set (tuple21 (tuple21 a b) (tuple21 a a)))))
  (= (mem (set1 (tuple2 (tuple2 a1 b1) (tuple2 a1 a1))) (t2tb1295 r)
  (relation (tuple2 a1 a1) (tuple2 a1 b1) (t2tb11 u) (t2tb4 v)))
  (forall ((x (tuple21 a b)) (y (tuple21 a a)))
  (=> (mem (tuple2 (tuple2 a1 b1) (tuple2 a1 a1))
  (Tuple2 (tuple2 a1 b1) (tuple2 a1 a1) (t2tb13 x) (t2tb5 y)) (t2tb1295 r))
...
(declare-fun t2tb1401 ((set (set (tuple21 b (tuple21 a a))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 b (tuple21 a a)))))) (sort
  (set1 (set1 (tuple2 b1 (tuple2 a1 a1)))) (t2tb1401 x))))

(declare-fun tb2t1401 (uni) (set (set (tuple21 b (tuple21 a a)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 b (tuple21 a a))))))
  (! (= (tb2t1401 (t2tb1401 i)) i) :pattern ((t2tb1401 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 b1 (tuple2 a1 a1)))) j)
     (= (t2tb1401 (tb2t1401 j)) j)) :pattern ((t2tb1401 (tb2t1401 j))) )))
...
(declare-fun t2tb1402 ((set (set (tuple21 (tuple21 a a) (tuple21 b
  a))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 a a) (tuple21 b a)))))) (sort
  (set1 (set1 (tuple2 (tuple2 a1 a1) (tuple2 b1 a1)))) (t2tb1402 x))))

(declare-fun tb2t1402 (uni) (set (set (tuple21 (tuple21 a a) (tuple21 b
  a)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 a a) (tuple21 b a))))))
  (! (= (tb2t1402 (t2tb1402 i)) i) :pattern ((t2tb1402 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 a1 a1) (tuple2 b1 a1)))) j)
     (= (t2tb1402 (tb2t1402 j)) j)) :pattern ((t2tb1402 (tb2t1402 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 a a))) (v (set (tuple21 b a)))
  (r (set (tuple21 (tuple21 a a) (tuple21 b a)))))
  (= (mem (set1 (tuple2 (tuple2 a1 a1) (tuple2 b1 a1))) (t2tb1384 r)
  (relation (tuple2 b1 a1) (tuple2 a1 a1) (t2tb4 u) (t2tb37 v)))
  (forall ((x (tuple21 a a)) (y (tuple21 b a)))
  (=> (mem (tuple2 (tuple2 a1 a1) (tuple2 b1 a1))
  (Tuple2 (tuple2 a1 a1) (tuple2 b1 a1) (t2tb5 x) (t2tb38 y)) (t2tb1384 r))
  (and (mem12 x u) (mem5 y v)))))))

(declare-fun t2tb1403 ((set (set (tuple21 (tuple21 a a) (set (tuple21 a
  b)))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 a a) (set (tuple21 a b))))))) (sort
  (set1 (set1 (tuple2 (tuple2 a1 a1) (set1 (tuple2 a1 b1))))) (t2tb1403 x))))

(declare-fun tb2t1403 (uni) (set (set (tuple21 (tuple21 a a) (set (tuple21 a
  b))))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 a a) (set (tuple21 a b)))))))
  (! (= (tb2t1403 (t2tb1403 i)) i) :pattern ((t2tb1403 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 a1 a1) (set1 (tuple2 a1 b1))))) j)
     (= (t2tb1403 (tb2t1403 j)) j)) :pattern ((t2tb1403 (tb2t1403 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 a a))) (v (set (set (tuple21 a b))))
  (r (set (tuple21 (tuple21 a a) (set (tuple21 a b))))))
  (= (mem (set1 (tuple2 (tuple2 a1 a1) (set1 (tuple2 a1 b1)))) (t2tb1386 r)
  (relation (set1 (tuple2 a1 b1)) (tuple2 a1 a1) (t2tb4 u) (t2tb10 v)))
  (forall ((x (tuple21 a a)) (y (set (tuple21 a b))))
  (=> (mem (tuple2 (tuple2 a1 a1) (set1 (tuple2 a1 b1)))
  (Tuple2 (tuple2 a1 a1) (set1 (tuple2 a1 b1)) (t2tb5 x) (t2tb11 y))
  (t2tb1386 r)) (and (mem12 x u) (mem4 y v)))))))

(declare-fun t2tb1404 ((set (set (tuple21 (tuple21 a a) (tuple21 a
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 a a) (tuple21 a b)))))) (sort
  (set1 (set1 (tuple2 (tuple2 a1 a1) (tuple2 a1 b1)))) (t2tb1404 x))))

(declare-fun tb2t1404 (uni) (set (set (tuple21 (tuple21 a a) (tuple21 a
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 a a) (tuple21 a b))))))
  (! (= (tb2t1404 (t2tb1404 i)) i) :pattern ((t2tb1404 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 a1 a1) (tuple2 a1 b1)))) j)
     (= (t2tb1404 (tb2t1404 j)) j)) :pattern ((t2tb1404 (tb2t1404 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 a a))) (v (set (tuple21 a b)))
  (r (set (tuple21 (tuple21 a a) (tuple21 a b)))))
  (= (mem (set1 (tuple2 (tuple2 a1 a1) (tuple2 a1 b1))) (t2tb1389 r)
  (relation (tuple2 a1 b1) (tuple2 a1 a1) (t2tb4 u) (t2tb11 v)))
  (forall ((x (tuple21 a a)) (y (tuple21 a b)))
  (=> (mem (tuple2 (tuple2 a1 a1) (tuple2 a1 b1))
  (Tuple2 (tuple2 a1 a1) (tuple2 a1 b1) (t2tb5 x) (t2tb13 y)) (t2tb1389 r))
  (and (mem12 x u) (mem3 y v)))))))

(declare-fun t2tb1405 ((set (set (tuple21 (tuple21 a a) b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 a a) b))))) (sort
  (set1 (set1 (tuple2 (tuple2 a1 a1) b1))) (t2tb1405 x))))

(declare-fun tb2t1405 (uni) (set (set (tuple21 (tuple21 a a) b))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 a a) b)))))
  (! (= (tb2t1405 (t2tb1405 i)) i) :pattern ((t2tb1405 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 a1 a1) b1))) j)
     (= (t2tb1405 (tb2t1405 j)) j)) :pattern ((t2tb1405 (tb2t1405 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 a a))) (v (set b)) (r (set (tuple21 (tuple21 a a)
  b))))
  (= (mem (set1 (tuple2 (tuple2 a1 a1) b1)) (t2tb1390 r)
  (relation b1 (tuple2 a1 a1) (t2tb4 u) (t2tb12 v)))
  (forall ((x (tuple21 a a)) (y b))
  (=> (mem (tuple2 (tuple2 a1 a1) b1)
  (Tuple2 (tuple2 a1 a1) b1 (t2tb5 x) (t2tb14 y)) (t2tb1390 r))
  (and (mem12 x u) (mem2 y v)))))))

(declare-fun t2tb1406 ((set (set (tuple21 (tuple21 a a) (tuple21 a
  a))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 a a) (tuple21 a a)))))) (sort
  (set1 (set1 (tuple2 (tuple2 a1 a1) (tuple2 a1 a1)))) (t2tb1406 x))))

(declare-fun tb2t1406 (uni) (set (set (tuple21 (tuple21 a a) (tuple21 a
  a)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 a a) (tuple21 a a))))))
  (! (= (tb2t1406 (t2tb1406 i)) i) :pattern ((t2tb1406 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 a1 a1) (tuple2 a1 a1)))) j)
     (= (t2tb1406 (tb2t1406 j)) j)) :pattern ((t2tb1406 (tb2t1406 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 a a))) (v (set (tuple21 a a)))
  (r (set (tuple21 (tuple21 a a) (tuple21 a a)))))
  (= (mem (set1 (tuple2 (tuple2 a1 a1) (tuple2 a1 a1))) (t2tb1392 r)
  (relation (tuple2 a1 a1) (tuple2 a1 a1) (t2tb4 u) (t2tb4 v)))
  (forall ((x (tuple21 a a)) (y (tuple21 a a)))
  (=> (mem (tuple2 (tuple2 a1 a1) (tuple2 a1 a1))
  (Tuple2 (tuple2 a1 a1) (tuple2 a1 a1) (t2tb5 x) (t2tb5 y)) (t2tb1392 r))
  (and (mem12 x u) (mem12 y v)))))))

(declare-fun t2tb1407 ((set (set (tuple21 (tuple21 a a) a)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 a a) a))))) (sort
  (set1 (set1 (tuple2 (tuple2 a1 a1) a1))) (t2tb1407 x))))

(declare-fun tb2t1407 (uni) (set (set (tuple21 (tuple21 a a) a))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 a a) a)))))
  (! (= (tb2t1407 (t2tb1407 i)) i) :pattern ((t2tb1407 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 a1 a1) a1))) j)
     (= (t2tb1407 (tb2t1407 j)) j)) :pattern ((t2tb1407 (tb2t1407 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 a a))) (v (set a)) (r (set (tuple21 (tuple21 a a)
  a))))
  (= (mem (set1 (tuple2 (tuple2 a1 a1) a1)) (t2tb1394 r)
  (relation a1 (tuple2 a1 a1) (t2tb4 u) (t2tb1 v)))
  (forall ((x (tuple21 a a)) (y a))
  (=> (mem (tuple2 (tuple2 a1 a1) a1)
  (Tuple2 (tuple2 a1 a1) a1 (t2tb5 x) (t2tb2 y)) (t2tb1394 r))
...
(declare-fun t2tb1408 ((set (set (tuple21 a (tuple21 a a))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 a (tuple21 a a)))))) (sort
  (set1 (set1 (tuple2 a1 (tuple2 a1 a1)))) (t2tb1408 x))))

(declare-fun tb2t1408 (uni) (set (set (tuple21 a (tuple21 a a)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 a (tuple21 a a))))))
  (! (= (tb2t1408 (t2tb1408 i)) i) :pattern ((t2tb1408 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 a1 (tuple2 a1 a1)))) j)
     (= (t2tb1408 (tb2t1408 j)) j)) :pattern ((t2tb1408 (tb2t1408 j))) )))

;; mem_relation
  (assert
  (forall ((u (set a)) (v (set (tuple21 a a))) (r (set (tuple21 a (tuple21 a
  a)))))
  (= (mem (set1 (tuple2 a1 (tuple2 a1 a1))) (t2tb1396 r)
  (relation (tuple2 a1 a1) a1 (t2tb1 u) (t2tb4 v)))
  (forall ((x a) (y (tuple21 a a)))
  (=> (mem (tuple2 a1 (tuple2 a1 a1))
  (Tuple2 a1 (tuple2 a1 a1) (t2tb2 x) (t2tb5 y)) (t2tb1396 r))
...
(declare-fun inverse3 ((set (tuple21 a a))) (set (tuple21 a a)))
...
;; mem_inverse
  ...
  (= (mem12 (tb2t5 (Tuple2 a1 a1 (t2tb2 x) (t2tb2 y))) (inverse3 p)) (mem12
...
(declare-fun dom3 ((set (tuple21 b a))) (set b))
...
(declare-fun semicolon3 ((set (tuple21 a b)) (set (tuple21 b
  a))) (set (tuple21 a a)))

(declare-fun semicolon4 ((set (tuple21 a a)) (set (tuple21 a
  b))) (set (tuple21 a b)))

(declare-fun semicolon5 ((set (tuple21 b a)) (set (tuple21 a
  a))) (set (tuple21 b a)))
...
;; mem_semicolon
  ...
  (= (mem5 (tb2t38 (Tuple2 b1 a1 (t2tb14 x) (t2tb2 y))) (semicolon5 p q))
  (exists ((b2 a))
  (and (mem5 (tb2t38 (Tuple2 b1 a1 (t2tb14 x) (t2tb2 b2))) p) (mem12
  (tb2t5 (Tuple2 a1 a1 (t2tb2 b2) (t2tb2 y))) q))))))
...
;; mem_semicolon
  ...
  (= (mem12 (tb2t5 (Tuple2 a1 a1 (t2tb2 x) (t2tb2 y))) (semicolon3 p q))
  (exists ((b2 b))
...
;; semicolon_back
  (assert
  (forall ((p (set (tuple21 b a))) (q (set (tuple21 a a))))
  (= (tb2t37 (semicolon_back a1 a1 b1 (t2tb4 q) (t2tb37 p))) (semicolon5 p q))))

;; semicolon_back
  (assert
  (forall ((p (set (tuple21 a b))) (q (set (tuple21 b a))))
  (= (tb2t4 (semicolon_back a1 b1 a1 (t2tb37 q) (t2tb11 p))) (semicolon3 p q))))
...
;; mem_image
  (assert
  (forall ((p (set (tuple21 (tuple21 b a) (tuple21 a a)))) (w (set (tuple21 b
  a))) (x (tuple21 a a)))
  (= (mem12 x
  (tb2t4 (image (tuple2 a1 a1) (tuple2 b1 a1) (t2tb1380 p) (t2tb37 w))))
  (exists ((a2 (tuple21 b a)))
  (and (mem5 a2 w) (mem (tuple2 (tuple2 b1 a1) (tuple2 a1 a1))
  (Tuple2 (tuple2 b1 a1) (tuple2 a1 a1) (t2tb38 a2) (t2tb5 x)) (t2tb1380 p)))))))
...
;; mem_image
  ...
  (= (mem12 x
  (tb2t4
  (image (tuple2 a1 a1) (set1 (tuple2 a1 b1)) (t2tb1382 p) (t2tb10 w))))
  (exists ((a2 (set (tuple21 a b))))
...
;; mem_image
  ...
  b))) (x (tuple21 a a)))
  (= (mem12 x
  (tb2t4 (image (tuple2 a1 a1) (tuple2 a1 b1) (t2tb1295 p) (t2tb11 w))))
  (exists ((a2 (tuple21 a b)))
  (and (mem3 a2 w) (mem (tuple2 (tuple2 a1 b1) (tuple2 a1 a1))
  (Tuple2 (tuple2 a1 b1) (tuple2 a1 a1) (t2tb13 a2) (t2tb5 x)) (t2tb1295 p)))))))
...
;; mem_image
  (assert
  (forall ((p (set (tuple21 (tuple21 a a) (tuple21 b a)))) (w (set (tuple21 a
  a))) (x (tuple21 b a)))
  (= (mem5 x
  (tb2t37 (image (tuple2 b1 a1) (tuple2 a1 a1) (t2tb1384 p) (t2tb4 w))))
  (exists ((a2 (tuple21 a a)))
  (and (mem12 a2 w) (mem (tuple2 (tuple2 a1 a1) (tuple2 b1 a1))
  (Tuple2 (tuple2 a1 a1) (tuple2 b1 a1) (t2tb5 a2) (t2tb38 x)) (t2tb1384 p)))))))
...
;; mem_image
  ...
  (= (mem4 x
  (tb2t10
  (image (set1 (tuple2 a1 b1)) (tuple2 a1 a1) (t2tb1386 p) (t2tb4 w))))
  (exists ((a2 (tuple21 a a)))
...
;; mem_image
  ...
  a))) (x (tuple21 a b)))
  (= (mem3 x
  (tb2t11 (image (tuple2 a1 b1) (tuple2 a1 a1) (t2tb1389 p) (t2tb4 w))))
  (exists ((a2 (tuple21 a a)))
  (and (mem12 a2 w) (mem (tuple2 (tuple2 a1 a1) (tuple2 a1 b1))
  (Tuple2 (tuple2 a1 a1) (tuple2 a1 b1) (t2tb5 a2) (t2tb13 x)) (t2tb1389 p)))))))

;; mem_image
  (assert
  (forall ((p (set (tuple21 (tuple21 a a) b))) (w (set (tuple21 a a))) (x b))
  (= (mem2 x (tb2t12 (image b1 (tuple2 a1 a1) (t2tb1390 p) (t2tb4 w))))
  (exists ((a2 (tuple21 a a)))
  (and (mem12 a2 w) (mem (tuple2 (tuple2 a1 a1) b1)
  (Tuple2 (tuple2 a1 a1) b1 (t2tb5 a2) (t2tb14 x)) (t2tb1390 p)))))))
...
;; mem_image
  ...
  a))) (x (tuple21 a a)))
  (= (mem12 x
  (tb2t4 (image (tuple2 a1 a1) (tuple2 a1 a1) (t2tb1392 p) (t2tb4 w))))
  (exists ((a2 (tuple21 a a)))
  (and (mem12 a2 w) (mem (tuple2 (tuple2 a1 a1) (tuple2 a1 a1))
  (Tuple2 (tuple2 a1 a1) (tuple2 a1 a1) (t2tb5 a2) (t2tb5 x)) (t2tb1392 p)))))))

;; mem_image
  (assert
  (forall ((p (set (tuple21 (tuple21 a a) a))) (w (set (tuple21 a a))) (x a))
  (= (mem1 x (tb2t1 (image a1 (tuple2 a1 a1) (t2tb1394 p) (t2tb4 w))))
  (exists ((a2 (tuple21 a a)))
  (and (mem12 a2 w) (mem (tuple2 (tuple2 a1 a1) a1)
  (Tuple2 (tuple2 a1 a1) a1 (t2tb5 a2) (t2tb2 x)) (t2tb1394 p)))))))
...
;; mem_image
  ...
  (= (mem12 x (tb2t4 (image (tuple2 a1 a1) a1 (t2tb1396 p) (t2tb1 w))))
  (exists ((a2 a))
  (and (mem1 a2 w) (mem (tuple2 a1 (tuple2 a1 a1))
  (Tuple2 a1 (tuple2 a1 a1) (t2tb2 a2) (t2tb5 x)) (t2tb1396 p)))))))
...
;; mem_overriding
  ...
  (not (mem2 x (dom3 p)))) (mem5 (tb2t38 (Tuple2 b1 a1 (t2tb14 x) (t2tb2 y)))
  p)))))
...
;; mem_overriding
  ...
  (not (mem1 x (dom2 p)))) (mem12 (tb2t5 (Tuple2 a1 a1 (t2tb2 x) (t2tb2 y)))
  p)))))
...
;; mem_direct_product
  ...
  (and (mem3 (tb2t13 (Tuple2 a1 b1 (t2tb2 x) (t2tb14 y))) f) (mem12
  (tb2t5 (Tuple2 a1 a1 (t2tb2 x) (t2tb2 z))) g)))))
...
;; mem_direct_product
  ...
  (and (mem12 (tb2t5 (Tuple2 a1 a1 (t2tb2 x) (t2tb2 y))) f) (mem3
  (tb2t13 (Tuple2 a1 b1 (t2tb2 x) (t2tb14 z))) g)))))
...
;; mem_parallel_product
  (assert
  (forall ((h (set (tuple21 b a))) (k (set (tuple21 a a))) (x b) (y a) (z a)
  (w a))
  (= (mem (tuple2 (tuple2 b1 a1) (tuple2 a1 a1))
  (Tuple2 (tuple2 b1 a1) (tuple2 a1 a1) (Tuple2 b1 a1 (t2tb14 x) (t2tb2 y))
  (Tuple2 a1 a1 (t2tb2 z) (t2tb2 w)))
  (parallel_product a1 a1 a1 b1 (t2tb37 h) (t2tb4 k)))
  (and (mem5 (tb2t38 (Tuple2 b1 a1 (t2tb14 x) (t2tb2 z))) h) (mem12
  (tb2t5 (Tuple2 a1 a1 (t2tb2 y) (t2tb2 w))) k)))))
...
;; mem_parallel_product
  (assert
  (forall ((h (set (tuple21 a a))) (k (set (tuple21 b a))) (x a) (y b) (z a)
  (w a))
  (= (mem (tuple2 (tuple2 a1 b1) (tuple2 a1 a1))
  (Tuple2 (tuple2 a1 b1) (tuple2 a1 a1) (Tuple2 a1 b1 (t2tb2 x) (t2tb14 y))
  (Tuple2 a1 a1 (t2tb2 z) (t2tb2 w)))
  (parallel_product a1 b1 a1 a1 (t2tb4 h) (t2tb37 k)))
  (and (mem12 (tb2t5 (Tuple2 a1 a1 (t2tb2 x) (t2tb2 z))) h) (mem5
  (tb2t38 (Tuple2 b1 a1 (t2tb14 y) (t2tb2 w))) k)))))
...
;; mem_total_function_set
  ...
  (infix_mnmngt a1 b1 (t2tb12 s) (t2tb1 t)))
  (and (mem (set1 (tuple2 b1 a1)) (t2tb37 x)
  (infix_plmngt a1 b1 (t2tb12 s) (t2tb1 t))) (infix_eqeq b1 (t2tb12 (dom3 x))
  (t2tb12 s))))))
...
;; mem_total_function_set
  ...
  (infix_eqeq a1 (t2tb1 (dom1 x)) (t2tb1 s))))))
...
;; mem_total_function_set
  ...
  (infix_plmngt a1 a1 (t2tb1 s) (t2tb1 t))) (infix_eqeq a1 (t2tb1 (dom2 x))
  (t2tb1 s))))))
...
;; mem_partial_injection_set
  ...
  (forall ((s (set a)) (t (set a)) (x (set (tuple21 a a))))
  (= (mem (set1 (tuple2 a1 a1)) (t2tb4 x)
  (infix_gtplgt a1 a1 (t2tb1 s) (t2tb1 t)))
  (and (mem (set1 (tuple2 a1 a1)) (t2tb4 x)
  (infix_plmngt a1 a1 (t2tb1 s) (t2tb1 t))) (mem (set1 (tuple2 a1 a1))
  (t2tb4 (inverse3 x)) (infix_plmngt a1 a1 (t2tb1 t) (t2tb1 s)))))))
...
;; apply_def0
  ...
  (=>
  (and (mem (set1 (tuple2 b1 a1)) (t2tb37 f)
  (infix_plmngt a1 b1 (t2tb12 s) (t2tb1 t))) (mem2 a2 (dom3 f))) (mem5
...
;; apply_def0
  ...
  (=>
  (and (mem (set1 (tuple2 a1 a1)) (t2tb4 f)
  (infix_plmngt a1 a1 (t2tb1 s) (t2tb1 t))) (mem1 a2 (dom2 f))) (mem12
...
(assert
;; inclusion_id_1
 ;; File "lemmes_bbook.why", line 938, characters 7-21
  (not
  (forall ((s (set a)) (t (set b)) (r (set (tuple21 a b))))
  (=> (mem4 r (relation1 s t)) (subset3 (id1 (dom1 r))
  (semicolon3 r (inverse2 r)))))))
(check-sat)
