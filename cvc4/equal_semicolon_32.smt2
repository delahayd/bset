...
;; subsetnoteq_def
  ...
  (and (subset1 (set1 (tuple2 b1 a1)) (t2tb56 s) (t2tb56 t))
  (not (infix_eqeq21 s t))))))
...
;; mem_total_function_set
  ...
  (and (mem6 x (infix_plmngt2 s t)) (infix_eqeq3 (dom3 x) s)))))
...
;; mem_total_function_set
  ...
  (infix_mnmngt b1 a1 (t2tb1 s) (t2tb12 t)))
  (and (mem (set1 (tuple2 a1 b1)) (t2tb11 x)
  (infix_plmngt b1 a1 (t2tb1 s) (t2tb12 t))) (infix_eqeq1 (dom1 x) s)))))
...
;; apply_def0
  ...
  (=> (and (mem6 f (infix_plmngt2 s t)) (mem2 a2 (dom3 f))) (mem5
...
;; apply_def0
  ...
  (=>
  (and (mem (set1 (tuple2 a1 b1)) (t2tb11 f)
  (infix_plmngt b1 a1 (t2tb1 s) (t2tb12 t))) (mem1 a2 (dom1 f))) (mem3
...
(assert
;; equal_semicolon_32
 ;; File "lemmes_bbook.why", line 1782, characters 7-25
  (not
  (forall ((s (set a)) (t (set b)) (r (set (tuple21 a b))))
  (=> (mem6 (inverse2 r) (infix_plmngt2 t s)) (infix_eqeq2
  (semicolon3 r (inverse2 r)) (id1 (dom1 r)))))))
(check-sat)
