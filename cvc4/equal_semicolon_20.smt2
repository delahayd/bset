...
(assert
;; equal_semicolon_20
 ;; File "lemmes_bbook.why", line 1674, characters 7-25
  (not
  (forall ((s (set a)) (u (set a)) (t (set b)) (p (set (tuple21 a b)))
  (r (set (tuple21 b a))))
  (=>
  (and (subset2 u s) (and (mem4 p (relation1 s t)) (mem6 r (relation2 t u))))
  (infix_eqeq2 (semicolon3 (domain_restriction1 u p) r)
  (domain_restriction5 u (semicolon3 p r)))))))
(check-sat)
