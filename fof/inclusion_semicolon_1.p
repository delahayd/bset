...
fof(inclusion_semicolon_1, conjecture, ![S, T, U, R, P, Q]: ((sort(set(a),
  ...
  & mem(set(tuple2(b, c)), Q, relation(c, b, T, U)))) => subset(tuple2(a, c),
  semicolon(c, b, a, R, inter(tuple2(b, c), P, Q)), inter(tuple2(a, c),
