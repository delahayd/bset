...
fof(equal_restriction_13, conjecture, ![S, U, T, P, Q]: ((sort(set(a),
  ...
  b), domain_restriction(b, a, U, inter(tuple2(a, b), P, Q)), inter(tuple2(a,
  b), domain_restriction(b, a, U, P), domain_restriction(b, a, U,
  Q)))))))))).
