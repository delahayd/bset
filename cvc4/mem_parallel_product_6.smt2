...
(declare-fun infix_gtmngt5 ((set (tuple21 a c)) (set (tuple21 b
  d))) (set (set (tuple21 (tuple21 a c) (tuple21 b d)))))

(declare-fun infix_gtmngt6 ((set c) (set d)) (set (set (tuple21 c d))))

;; mem_total_injection_set
  (assert
  (forall ((s (set (tuple21 a c))) (t (set (tuple21 b d)))
  (x (set (tuple21 (tuple21 a c) (tuple21 b d)))))
  (= (mem25 x (infix_gtmngt5 s t))
  (and (mem25 x
  (tb2t685
  (infix_gtplgt (tuple2 b1 d1) (tuple2 a1 c1) (t2tb129 s) (t2tb687 t))))
  (mem25 x
...
;; mem_total_bijection_set
  ...
  (and (mem25 x (infix_gtmngt5 s t)) (mem25 x
  (tb2t685
  (infix_mnmngtgt (tuple2 b1 d1) (tuple2 a1 c1) (t2tb129 s) (t2tb687 t))))))))
...
;; mem_total_bijection_set
  ...
  (and (mem22 x (infix_gtmngt6 s t)) (mem22 x
  (tb2t688 (infix_mnmngtgt d1 c1 (t2tb132 s) (t2tb690 t))))))))
...
(assert
;; mem_parallel_product_6
 ;; File "lemmes_bbook.why", line 619, characters 7-29
  (not
  (forall ((s (set a)) (t (set b)) (u (set c)) (v (set d)) (f (set (tuple21 a
  b))) (g (set (tuple21 c d))))
  (=> (and (mem4 f (infix_gtmngt1 s t)) (mem22 g (infix_gtmngt6 u v))) (mem25
  (parallel_product1 f g) (infix_gtmngt5 (times4 s u) (times10 t v)))))))
(check-sat)
