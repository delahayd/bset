...
tff(equal_semicolon_22, conjecture, ![A : $tType, B : $tType]: ![S:set(A), U:
  set(A), T:set(B), P:set(tuple2(A, B)), R:set(tuple2(B, A))]: ((subset(A, U,
  S) & (mem(set(tuple2(A, B)), P, relation(A, B, S, T))
  & mem(set(tuple2(B, A)), R, relation(B, A, T, U))))
  => infix_eqeq(tuple2(A, A), semicolon(A, B, A, domain_substraction(A, B, U,
  P), R), domain_substraction(A, A, U, semicolon(A, B, A, P, R))))).
