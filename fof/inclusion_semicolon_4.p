...
fof(inclusion_semicolon_4, conjecture, ![S, T, U, P, Q, R]: ((sort(set(a),
  ...
  diff(tuple2(a, c), semicolon(c, b, a, P, R), semicolon(c, b, a, Q, R)),
  semicolon(c, b, a, diff(tuple2(a, b), P, Q), R)))))))))).
