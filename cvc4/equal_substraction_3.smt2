...
(declare-fun t2tb5058 ((set (tuple21 (set (tuple21 b a)) (set (tuple21 a
  b))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (set (tuple21 b a)) (set (tuple21 a b)))))) (sort
  (set1 (tuple2 (set1 (tuple2 b1 a1)) (set1 (tuple2 a1 b1)))) (t2tb5058 x))))

(declare-fun tb2t5058 (uni) (set (tuple21 (set (tuple21 b a)) (set (tuple21 a
  b)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (set (tuple21 b a)) (set (tuple21 a b))))))
  (! (= (tb2t5058 (t2tb5058 i)) i) :pattern ((t2tb5058 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (set1 (tuple2 b1 a1)) (set1 (tuple2 a1 b1)))) j)
     (= (t2tb5058 (tb2t5058 j)) j)) :pattern ((t2tb5058 (tb2t5058 j))) )))

(declare-fun t2tb5059 ((tuple21 (set (tuple21 b a)) (set (tuple21 a
  b)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (set (tuple21 b a)) (set (tuple21 a b))))) (sort
  (tuple2 (set1 (tuple2 b1 a1)) (set1 (tuple2 a1 b1))) (t2tb5059 x))))

(declare-fun tb2t5059 (uni) (tuple21 (set (tuple21 b a)) (set (tuple21 a
  b))))

;; BridgeL
  (assert
  (forall ((i (tuple21 (set (tuple21 b a)) (set (tuple21 a b)))))
  (! (= (tb2t5059 (t2tb5059 i)) i) :pattern ((t2tb5059 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (set1 (tuple2 b1 a1)) (set1 (tuple2 a1 b1))) j)
     (= (t2tb5059 (tb2t5059 j)) j)) :pattern ((t2tb5059 (tb2t5059 j))) )))
...
(declare-fun t2tb5060 ((set (tuple21 (set (tuple21 a b)) (set (tuple21 b
  a))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (set (tuple21 a b)) (set (tuple21 b a)))))) (sort
  (set1 (tuple2 (set1 (tuple2 a1 b1)) (set1 (tuple2 b1 a1)))) (t2tb5060 x))))

(declare-fun tb2t5060 (uni) (set (tuple21 (set (tuple21 a b)) (set (tuple21 b
  a)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (set (tuple21 a b)) (set (tuple21 b a))))))
  (! (= (tb2t5060 (t2tb5060 i)) i) :pattern ((t2tb5060 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (set1 (tuple2 a1 b1)) (set1 (tuple2 b1 a1)))) j)
     (= (t2tb5060 (tb2t5060 j)) j)) :pattern ((t2tb5060 (tb2t5060 j))) )))

(declare-fun t2tb5061 ((tuple21 (set (tuple21 a b)) (set (tuple21 b
  a)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (set (tuple21 a b)) (set (tuple21 b a))))) (sort
  (tuple2 (set1 (tuple2 a1 b1)) (set1 (tuple2 b1 a1))) (t2tb5061 x))))

(declare-fun tb2t5061 (uni) (tuple21 (set (tuple21 a b)) (set (tuple21 b
  a))))

;; BridgeL
  (assert
  (forall ((i (tuple21 (set (tuple21 a b)) (set (tuple21 b a)))))
  (! (= (tb2t5061 (t2tb5061 i)) i) :pattern ((t2tb5061 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (set1 (tuple2 a1 b1)) (set1 (tuple2 b1 a1))) j)
     (= (t2tb5061 (tb2t5061 j)) j)) :pattern ((t2tb5061 (tb2t5061 j))) )))
...
(declare-fun t2tb5066 ((set (set (tuple21 (set (tuple21 b a)) (set (tuple21 a
  b)))))) uni)
...
(declare-fun tb2t5066 (uni) (set (set (tuple21 (set (tuple21 b a))
  (set (tuple21 a b))))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (set (tuple21 b a)) (set (tuple21 a b)))))))
  (! (= (tb2t5066 (t2tb5066 i)) i) :pattern ((t2tb5066 i)) )))
...
;; BridgeR
  ...
  (! (=> (sort
     ...
     (= (t2tb5066 (tb2t5066 j)) j)) :pattern ((t2tb5066 (tb2t5066 j))) )))
...
;; mem_relation
  ...
  (=> (mem (tuple2 (set1 (tuple2 b1 a1)) (set1 (tuple2 a1 b1)))
  (Tuple2 (set1 (tuple2 b1 a1)) (set1 (tuple2 a1 b1)) (t2tb37 x) (t2tb11 y))
  (t2tb5058 r)) (and (mem6 x u) (mem4 y v)))))))
...
(declare-fun t2tb5067 ((set (set (tuple21 (set (tuple21 a b)) (set (tuple21 b
  a)))))) uni)
...
(declare-fun tb2t5067 (uni) (set (set (tuple21 (set (tuple21 a b))
  (set (tuple21 b a))))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (set (tuple21 a b)) (set (tuple21 b a)))))))
  (! (= (tb2t5067 (t2tb5067 i)) i) :pattern ((t2tb5067 i)) )))
...
;; BridgeR
  ...
  (! (=> (sort
     ...
     (= (t2tb5067 (tb2t5067 j)) j)) :pattern ((t2tb5067 (tb2t5067 j))) )))
...
;; mem_relation
  ...
  (=> (mem (tuple2 (set1 (tuple2 a1 b1)) (set1 (tuple2 b1 a1)))
  (Tuple2 (set1 (tuple2 a1 b1)) (set1 (tuple2 b1 a1)) (t2tb11 x) (t2tb37 y))
  (t2tb5060 r)) (and (mem4 x u) (mem6 y v)))))))
...
;; mem_image
  ...
  (= (mem4 x
  (tb2t10
  (image (set1 (tuple2 a1 b1)) (set1 (tuple2 b1 a1)) (t2tb5058 p) (t2tb56 w))))
  (exists ((a2 (set (tuple21 b a))))
...
;; mem_image
  ...
  (= (mem6 x
  (tb2t56
  (image (set1 (tuple2 b1 a1)) (set1 (tuple2 a1 b1)) (t2tb5060 p) (t2tb10 w))))
...
;; mem_partial_function_set
  ...
  (= (mem6 f2 (tb2t56 (infix_plmngt a1 b1 (t2tb12 s) (t2tb1 t))))
  (and (mem6 f2 (relation2 s t))
...
;; apply_def0
  ...
  (=>
  (and (mem6 f2 (tb2t56 (infix_plmngt a1 b1 (t2tb12 s) (t2tb1 t)))) (mem2 a2
...
(assert
;; equal_substraction_3
 ;; File "lemmes_bbook.why", line 2096, characters 7-27
  (not
  (forall ((s (set a)) (u (set a)) (t (set b)) (r (set (tuple21 a b)))
  (p (set (tuple21 b a))))
  (=>
  (and (subset2 u s) (and (mem4 r (relation1 s t)) (mem6 p (relation2 t u))))
  (infix_eqeq2 (domain_substraction5 u (semicolon3 r p))
  (semicolon3 (domain_substraction1 u r) p))))))
(check-sat)
