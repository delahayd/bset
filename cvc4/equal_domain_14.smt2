...
(assert
;; equal_domain_14
 ;; File "lemmes_bbook.why", line 1315, characters 7-22
  (not
  ...
  (domain_restriction1 (dom1 f) g) (domain_restriction1 (dom1 g) f))))
  (infix_eqeq1 (dom1 (inter4 f g)) (inter1 (dom1 f) (dom1 g)))))))
(check-sat)
