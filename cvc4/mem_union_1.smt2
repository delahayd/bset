...
(assert
;; mem_union_1
 ;; File "lemmes_bbook.why", line 644, characters 7-18
  (not
  (forall ((s (set a)) (t (set b)) (f (set (tuple21 a b))) (g (set (tuple21 a
  b))))
  (=>
  (and (mem4 f (infix_plmngt1 s t))
  (and (mem4 g (infix_plmngt1 s t)) (infix_eqeq4
  (domain_restriction1 (dom1 g) f) (domain_restriction1 (dom1 f) g)))) (mem4
  (union5 f g) (infix_plmngt1 s t))))))
(check-sat)
