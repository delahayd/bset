...
(assert
;; equal_overriding_1
 ;; File "lemmes_bbook.why", line 2507, characters 7-25
  (not
  (forall ((s (set a)) (t (set b)) (p (set (tuple21 a b))) (q (set (tuple21 a
  b))) (r (set (tuple21 a b))))
  (=>
  (and (mem4 p (relation1 s t))
  (and (mem4 q (relation1 s t)) (mem4 r (relation1 s t)))) (infix_eqeq4
  (infix_lspl1 p (infix_lspl1 q r)) (infix_lspl1 (infix_lspl1 p q) r))))))
(check-sat)
