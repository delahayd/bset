...
(assert
;; equal_image_4
 ;; File "lemmes_bbook.why", line 2305, characters 7-20
  (not
  (forall ((s (set a)) (u (set a)) (v (set a)) (t (set b)) (r (set (tuple21 a
  b))))
  (=> (and (subset2 u s) (and (mem4 r (relation1 s t)) (subset2 v s)))
  (infix_eqeq3 (image1 (domain_restriction1 u r) v) (image1 r (inter1 u v)))))))
(check-sat)
