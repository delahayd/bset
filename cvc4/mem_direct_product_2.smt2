...
(declare-fun infix_plmngt5 ((set a) (set (tuple21 b c))) (set (set (tuple21 a
  (tuple21 b c)))))
...
;; mem_total_function_set
  ...
  c)))))
  (= (mem15 x
  (tb2t327 (infix_mnmngt (tuple2 b1 c1) a1 (t2tb1 s) (t2tb131 t))))
  (and (mem15 x (infix_plmngt5 s t)) (infix_eqeq a1
  (dom (tuple2 b1 c1) a1 (t2tb261 x)) (t2tb1 s))))))
...
;; mem_partial_injection_set
  ...
  (tb2t261 (inverse a1 (tuple2 b1 c1) (t2tb206 x))) (infix_plmngt5 t s))))))
...
;; mem_partial_injection_set
  ...
  (and (mem15 x (infix_plmngt5 s t)) (mem (set1 (tuple2 (tuple2 b1 c1) a1))
  (inverse (tuple2 b1 c1) a1 (t2tb261 x))
...
;; mem_partial_surjection_set
  ...
  (and (mem15 x (infix_plmngt5 s t)) (infix_eqeq (tuple2 b1 c1)
  (ran (tuple2 b1 c1) a1 (t2tb261 x)) (t2tb131 t))))))
...
;; mem_total_surjection_set
  ...
  x (tb2t327 (infix_mnmngt (tuple2 b1 c1) a1 (t2tb1 s) (t2tb131 t))))))))
...
;; apply_def0
  ...
  c))) (a2 a))
  (=>
  (and (mem15 f (infix_plmngt5 s t)) (mem1 a2
...
(assert
;; mem_direct_product_2
 ;; File "lemmes_bbook.why", line 521, characters 7-27
  (not
  (forall ((s (set a)) (t (set b)) (u (set c)) (f (set (tuple21 a b)))
  (g (set (tuple21 a c))))
  (=> (and (mem4 f (infix_plmngt1 s t)) (mem11 g (infix_plmngt3 s u))) (mem15
  (direct_product1 f g) (infix_plmngt5 s (times3 t u)))))))
(check-sat)
