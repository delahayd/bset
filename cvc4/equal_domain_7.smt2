...
(declare-fun range_restriction2 ((set (tuple21 b a)) (set a)) (set (tuple21 b
  a)))
...
(assert
;; equal_domain_7
 ;; File "lemmes_bbook.why", line 1259, characters 7-21
  (not
  (forall ((s (set a)) (t (set b)) (v (set b)) (r (set (tuple21 a b))))
  (=> (and (mem4 r (relation1 s t)) (subset5 v t)) (infix_eqeq1
  (dom1 (range_restriction1 r v)) (image2 (inverse2 r) v))))))
(check-sat)
