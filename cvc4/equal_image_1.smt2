...
(assert
;; equal_image_1
 ;; File "lemmes_bbook.why", line 2281, characters 7-20
  (not
  (forall ((s (set a)) (u (set a)) (t (set b)) (v (set c)) (p (set (tuple21 a
  b))) (q (set (tuple21 b c))))
  (=>
  (and (mem4 p (relation1 s t)) (and (mem9 q (relation4 t v)) (subset2 u s)))
  (infix_eqeq7 (image4 (semicolon1 p q) u) (image3 q (image1 p u)))))))
(check-sat)
