...
(declare-fun infix_plmngt3 ((set a) (set c)) (set (set (tuple21 a c))))
...
;; mem_total_function_set
  ...
  (and (mem9 x (infix_plmngt4 s t)) (infix_eqeq b1 (dom c1 b1 (t2tb131 x))
  (t2tb12 s))))))
...
;; mem_total_function_set
  ...
  (and (mem11 x (infix_plmngt3 s t)) (infix_eqeq a1 (dom c1 a1 (t2tb129 x))
  (t2tb1 s))))))
...
;; mem_partial_injection_set
  ...
  (tb2t129 (inverse a1 c1 (t2tb224 x))) (infix_plmngt3 t s))))))
...
;; mem_partial_injection_set
  ...
  (and (mem11 x (infix_plmngt3 s t)) (mem (set1 (tuple2 c1 a1))
  (inverse c1 a1 (t2tb129 x)) (infix_plmngt a1 c1 (t2tb132 t) (t2tb1 s)))))))
...
;; mem_partial_surjection_set
  ...
  (and (mem9 x (infix_plmngt4 s t)) (infix_eqeq c1 (ran c1 b1 (t2tb131 x))
  (t2tb132 t))))))
...
;; mem_partial_surjection_set
  ...
  (and (mem11 x (infix_plmngt3 s t)) (infix_eqeq c1 (ran c1 a1 (t2tb129 x))
  (t2tb132 t))))))
...
;; apply_def0
  ...
  (=>
  (and (mem11 f (infix_plmngt3 s t)) (mem1 a2
...
(assert
;; mem_semicolon_2
 ;; File "lemmes_bbook.why", line 353, characters 7-22
  (not
  (forall ((s (set a)) (t (set b)) (u (set c)) (f (set (tuple21 a b)))
  (g (set (tuple21 b c))))
  (=> (and (mem4 f (infix_plmngt1 s t)) (mem9 g (infix_plmngt4 t u))) (mem11
  (semicolon1 f g) (infix_plmngt3 s u))))))
(check-sat)
