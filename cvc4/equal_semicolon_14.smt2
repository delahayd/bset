...
(declare-fun singleton2 (b) (set b))

(declare-fun singleton3 ((tuple21 a b)) (set (tuple21 a b)))

(declare-fun singleton4 ((set (tuple21 a b))) (set (set (tuple21 a b))))

(declare-fun singleton5 ((tuple21 b a)) (set (tuple21 b a)))

(declare-fun singleton6 (c) (set c))

(declare-fun singleton7 ((tuple21 b c)) (set (tuple21 b c)))

(declare-fun singleton8 ((tuple21 a c)) (set (tuple21 a c)))

;; mem_singleton
  (assert
  (forall ((x (tuple21 a c)) (y (tuple21 a c)))
  (= (mem10 x (singleton8 y)) (= x y))))

;; mem_singleton
  (assert
  (forall ((x (tuple21 b c)) (y (tuple21 b c)))
  (= (mem8 x (singleton7 y)) (= x y))))

;; mem_singleton
  (assert (forall ((x c) (y c)) (= (mem7 x (singleton6 y)) (= x y))))

;; mem_singleton
  (assert
  (forall ((x (tuple21 b a)) (y (tuple21 b a)))
  (= (mem5 x (singleton5 y)) (= x y))))

;; mem_singleton
  (assert
  (forall ((x (set (tuple21 a b))) (y (set (tuple21 a b))))
  (= (mem4 x (singleton4 y)) (= x y))))

;; mem_singleton
  (assert
  (forall ((x (tuple21 a b)) (y (tuple21 a b)))
  (= (mem3 x (singleton3 y)) (= x y))))

;; mem_singleton
  (assert (forall ((x b) (y b)) (= (mem2 x (singleton2 y)) (= x y))))
...
(declare-fun Tuple25 (b a) (tuple21 b a))

(declare-fun Tuple26 (b c) (tuple21 b c))

(declare-fun Tuple27 (a c) (tuple21 a c))
...
;; Tuple2_proj_1_def
  (assert
  (forall ((u b) (u1 c))
  (= (tb2t14 (Tuple2_proj_1 b1 c1 (t2tb134 (Tuple26 u u1)))) u)))

;; Tuple2_proj_1_def
  (assert
  (forall ((u a) (u1 c))
  (= (tb2t2 (Tuple2_proj_1 a1 c1 (t2tb133 (Tuple27 u u1)))) u)))
...
;; Tuple2_proj_1_def
  (assert
  (forall ((u b) (u1 a))
  (= (tb2t14 (Tuple2_proj_1 b1 a1 (t2tb38 (Tuple25 u u1)))) u)))
...
;; Tuple2_proj_2_def
  (assert
  (forall ((u b) (u1 c))
  (= (tb2t135 (Tuple2_proj_2 b1 c1 (t2tb134 (Tuple26 u u1)))) u1)))

;; Tuple2_proj_2_def
  (assert
  (forall ((u a) (u1 c))
  (= (tb2t135 (Tuple2_proj_2 a1 c1 (t2tb133 (Tuple27 u u1)))) u1)))
...
;; Tuple2_proj_2_def
  (assert
  (forall ((u b) (u1 a))
  (= (tb2t2 (Tuple2_proj_2 b1 a1 (t2tb38 (Tuple25 u u1)))) u1)))
...
;; tuple2_inversion
  (assert
  (forall ((u (tuple21 b c)))
  (= u (Tuple26 (tb2t14 (Tuple2_proj_1 b1 c1 (t2tb134 u)))
       (tb2t135 (Tuple2_proj_2 b1 c1 (t2tb134 u)))))))

;; tuple2_inversion
  (assert
  (forall ((u (tuple21 a c)))
  (= u (Tuple27 (tb2t2 (Tuple2_proj_1 a1 c1 (t2tb133 u)))
       (tb2t135 (Tuple2_proj_2 a1 c1 (t2tb133 u)))))))
...
;; tuple2_inversion
  (assert
  (forall ((u (tuple21 b a)))
  (= u (Tuple25 (tb2t14 (Tuple2_proj_1 b1 a1 (t2tb38 u)))
       (tb2t2 (Tuple2_proj_2 b1 a1 (t2tb38 u)))))))
...
(declare-fun t2tb2387 ((set (tuple21 (tuple21 b c) (tuple21 b a)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b c) (tuple21 b a))))) (sort
  (set1 (tuple2 (tuple2 b1 c1) (tuple2 b1 a1))) (t2tb2387 x))))

(declare-fun tb2t2387 (uni) (set (tuple21 (tuple21 b c) (tuple21 b a))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b c) (tuple21 b a)))))
  (! (= (tb2t2387 (t2tb2387 i)) i) :pattern ((t2tb2387 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 c1) (tuple2 b1 a1))) j)
     (= (t2tb2387 (tb2t2387 j)) j)) :pattern ((t2tb2387 (tb2t2387 j))) )))

(declare-fun t2tb2388 ((tuple21 (tuple21 b c) (tuple21 b a))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 b c) (tuple21 b a)))) (sort
  (tuple2 (tuple2 b1 c1) (tuple2 b1 a1)) (t2tb2388 x))))

(declare-fun tb2t2388 (uni) (tuple21 (tuple21 b c) (tuple21 b a)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b c) (tuple21 b a))))
  (! (= (tb2t2388 (t2tb2388 i)) i) :pattern ((t2tb2388 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 c1) (tuple2 b1 a1)) j)
     (= (t2tb2388 (tb2t2388 j)) j)) :pattern ((t2tb2388 (tb2t2388 j))) )))
...
(declare-fun t2tb2391 ((set (tuple21 (tuple21 b a) (tuple21 a c)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b a) (tuple21 a c))))) (sort
  (set1 (tuple2 (tuple2 b1 a1) (tuple2 a1 c1))) (t2tb2391 x))))

(declare-fun tb2t2391 (uni) (set (tuple21 (tuple21 b a) (tuple21 a c))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b a) (tuple21 a c)))))
  (! (= (tb2t2391 (t2tb2391 i)) i) :pattern ((t2tb2391 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 a1) (tuple2 a1 c1))) j)
     (= (t2tb2391 (tb2t2391 j)) j)) :pattern ((t2tb2391 (tb2t2391 j))) )))

(declare-fun t2tb2392 ((tuple21 (tuple21 b a) (tuple21 a c))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 b a) (tuple21 a c)))) (sort
  (tuple2 (tuple2 b1 a1) (tuple2 a1 c1)) (t2tb2392 x))))

(declare-fun tb2t2392 (uni) (tuple21 (tuple21 b a) (tuple21 a c)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b a) (tuple21 a c))))
  (! (= (tb2t2392 (t2tb2392 i)) i) :pattern ((t2tb2392 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 a1) (tuple2 a1 c1)) j)
     (= (t2tb2392 (tb2t2392 j)) j)) :pattern ((t2tb2392 (tb2t2392 j))) )))
...
(declare-fun t2tb2393 ((set (tuple21 (tuple21 b a) (tuple21 b c)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b a) (tuple21 b c))))) (sort
  (set1 (tuple2 (tuple2 b1 a1) (tuple2 b1 c1))) (t2tb2393 x))))

(declare-fun tb2t2393 (uni) (set (tuple21 (tuple21 b a) (tuple21 b c))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b a) (tuple21 b c)))))
  (! (= (tb2t2393 (t2tb2393 i)) i) :pattern ((t2tb2393 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 a1) (tuple2 b1 c1))) j)
     (= (t2tb2393 (tb2t2393 j)) j)) :pattern ((t2tb2393 (tb2t2393 j))) )))

(declare-fun t2tb2394 ((tuple21 (tuple21 b a) (tuple21 b c))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 b a) (tuple21 b c)))) (sort
  (tuple2 (tuple2 b1 a1) (tuple2 b1 c1)) (t2tb2394 x))))

(declare-fun tb2t2394 (uni) (tuple21 (tuple21 b a) (tuple21 b c)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b a) (tuple21 b c))))
  (! (= (tb2t2394 (t2tb2394 i)) i) :pattern ((t2tb2394 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 a1) (tuple2 b1 c1)) j)
     (= (t2tb2394 (tb2t2394 j)) j)) :pattern ((t2tb2394 (tb2t2394 j))) )))
...
(declare-fun t2tb2395 ((set (tuple21 (tuple21 b a) c))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b a) c)))) (sort
  (set1 (tuple2 (tuple2 b1 a1) c1)) (t2tb2395 x))))

(declare-fun tb2t2395 (uni) (set (tuple21 (tuple21 b a) c)))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b a) c))))
  (! (= (tb2t2395 (t2tb2395 i)) i) :pattern ((t2tb2395 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 a1) c1)) j)
     (= (t2tb2395 (tb2t2395 j)) j)) :pattern ((t2tb2395 (tb2t2395 j))) )))

(declare-fun t2tb2396 ((tuple21 (tuple21 b a) c)) uni)
...
(declare-fun tb2t2396 (uni) (tuple21 (tuple21 b a) c))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b a) c)))
  (! (= (tb2t2396 (t2tb2396 i)) i) :pattern ((t2tb2396 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 a1) c1) j) (= (t2tb2396 (tb2t2396 j)) j)) :pattern (
  (t2tb2396 (tb2t2396 j))) )))
...
;; mem_times
  ...
  (= (mem8 (Tuple26 x y) (times3 s t)) (and (mem2 x s) (mem7 y t)))))
...
;; mem_times
  ...
  (= (mem5 (Tuple25 x y) (times11 s t)) (and (mem2 x s) (mem1 y t)))))
...
;; mem_times
  ...
  (= (mem10 (Tuple27 x y) (times4 s t)) (and (mem1 x s) (mem7 y t)))))
...
(declare-fun t2tb2401 ((set (set (tuple21 (tuple21 a c) (tuple21 b
  a))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 a c) (tuple21 b a)))))) (sort
  (set1 (set1 (tuple2 (tuple2 a1 c1) (tuple2 b1 a1)))) (t2tb2401 x))))

(declare-fun tb2t2401 (uni) (set (set (tuple21 (tuple21 a c) (tuple21 b
  a)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 a c) (tuple21 b a))))))
  (! (= (tb2t2401 (t2tb2401 i)) i) :pattern ((t2tb2401 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 a1 c1) (tuple2 b1 a1)))) j)
     (= (t2tb2401 (tb2t2401 j)) j)) :pattern ((t2tb2401 (tb2t2401 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 a c))) (v (set (tuple21 b a)))
  (r (set (tuple21 (tuple21 a c) (tuple21 b a)))))
  (= (mem (set1 (tuple2 (tuple2 a1 c1) (tuple2 b1 a1))) (t2tb2385 r)
  (relation (tuple2 b1 a1) (tuple2 a1 c1) (t2tb129 u) (t2tb37 v)))
  (forall ((x (tuple21 a c)) (y (tuple21 b a)))
  (=> (mem (tuple2 (tuple2 a1 c1) (tuple2 b1 a1))
  (Tuple2 (tuple2 a1 c1) (tuple2 b1 a1) (t2tb133 x) (t2tb38 y)) (t2tb2385 r))
...
(declare-fun t2tb2402 ((set (set (tuple21 (tuple21 b c) (tuple21 b
  a))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 b c) (tuple21 b a)))))) (sort
  (set1 (set1 (tuple2 (tuple2 b1 c1) (tuple2 b1 a1)))) (t2tb2402 x))))

(declare-fun tb2t2402 (uni) (set (set (tuple21 (tuple21 b c) (tuple21 b
  a)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 b c) (tuple21 b a))))))
  (! (= (tb2t2402 (t2tb2402 i)) i) :pattern ((t2tb2402 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 b1 c1) (tuple2 b1 a1)))) j)
     (= (t2tb2402 (tb2t2402 j)) j)) :pattern ((t2tb2402 (tb2t2402 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 b c))) (v (set (tuple21 b a)))
  (r (set (tuple21 (tuple21 b c) (tuple21 b a)))))
  (= (mem (set1 (tuple2 (tuple2 b1 c1) (tuple2 b1 a1))) (t2tb2387 r)
  (relation (tuple2 b1 a1) (tuple2 b1 c1) (t2tb131 u) (t2tb37 v)))
  (forall ((x (tuple21 b c)) (y (tuple21 b a)))
  (=> (mem (tuple2 (tuple2 b1 c1) (tuple2 b1 a1))
  (Tuple2 (tuple2 b1 c1) (tuple2 b1 a1) (t2tb134 x) (t2tb38 y)) (t2tb2387 r))
...
(declare-fun t2tb2403 ((set (set (tuple21 c (tuple21 b a))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 c (tuple21 b a)))))) (sort
  (set1 (set1 (tuple2 c1 (tuple2 b1 a1)))) (t2tb2403 x))))

(declare-fun tb2t2403 (uni) (set (set (tuple21 c (tuple21 b a)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 c (tuple21 b a))))))
  (! (= (tb2t2403 (t2tb2403 i)) i) :pattern ((t2tb2403 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 c1 (tuple2 b1 a1)))) j)
     (= (t2tb2403 (tb2t2403 j)) j)) :pattern ((t2tb2403 (tb2t2403 j))) )))

;; mem_relation
  (assert
  (forall ((u (set c)) (v (set (tuple21 b a))) (r (set (tuple21 c (tuple21 b
  a)))))
  (= (mem (set1 (tuple2 c1 (tuple2 b1 a1))) (t2tb2389 r)
  (relation (tuple2 b1 a1) c1 (t2tb132 u) (t2tb37 v)))
  (forall ((x c) (y (tuple21 b a)))
  (=> (mem (tuple2 c1 (tuple2 b1 a1))
  (Tuple2 c1 (tuple2 b1 a1) (t2tb135 x) (t2tb38 y)) (t2tb2389 r))
...
(declare-fun t2tb2404 ((set (set (tuple21 (tuple21 b a) (tuple21 a
  c))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 b a) (tuple21 a c)))))) (sort
  (set1 (set1 (tuple2 (tuple2 b1 a1) (tuple2 a1 c1)))) (t2tb2404 x))))

(declare-fun tb2t2404 (uni) (set (set (tuple21 (tuple21 b a) (tuple21 a
  c)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 b a) (tuple21 a c))))))
  (! (= (tb2t2404 (t2tb2404 i)) i) :pattern ((t2tb2404 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 b1 a1) (tuple2 a1 c1)))) j)
     (= (t2tb2404 (tb2t2404 j)) j)) :pattern ((t2tb2404 (tb2t2404 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 b a))) (v (set (tuple21 a c)))
  (r (set (tuple21 (tuple21 b a) (tuple21 a c)))))
  (= (mem (set1 (tuple2 (tuple2 b1 a1) (tuple2 a1 c1))) (t2tb2391 r)
  (relation (tuple2 a1 c1) (tuple2 b1 a1) (t2tb37 u) (t2tb129 v)))
  (forall ((x (tuple21 b a)) (y (tuple21 a c)))
  (=> (mem (tuple2 (tuple2 b1 a1) (tuple2 a1 c1))
  (Tuple2 (tuple2 b1 a1) (tuple2 a1 c1) (t2tb38 x) (t2tb133 y)) (t2tb2391 r))
  (and (mem5 x u) (mem10 y v)))))))

(declare-fun t2tb2405 ((set (set (tuple21 (tuple21 b a) (tuple21 b
  c))))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 b a) (tuple21 b c)))))) (sort
  (set1 (set1 (tuple2 (tuple2 b1 a1) (tuple2 b1 c1)))) (t2tb2405 x))))

(declare-fun tb2t2405 (uni) (set (set (tuple21 (tuple21 b a) (tuple21 b
  c)))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 b a) (tuple21 b c))))))
  (! (= (tb2t2405 (t2tb2405 i)) i) :pattern ((t2tb2405 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 b1 a1) (tuple2 b1 c1)))) j)
     (= (t2tb2405 (tb2t2405 j)) j)) :pattern ((t2tb2405 (tb2t2405 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 b a))) (v (set (tuple21 b c)))
  (r (set (tuple21 (tuple21 b a) (tuple21 b c)))))
  (= (mem (set1 (tuple2 (tuple2 b1 a1) (tuple2 b1 c1))) (t2tb2393 r)
  (relation (tuple2 b1 c1) (tuple2 b1 a1) (t2tb37 u) (t2tb131 v)))
  (forall ((x (tuple21 b a)) (y (tuple21 b c)))
  (=> (mem (tuple2 (tuple2 b1 a1) (tuple2 b1 c1))
  (Tuple2 (tuple2 b1 a1) (tuple2 b1 c1) (t2tb38 x) (t2tb134 y)) (t2tb2393 r))
  (and (mem5 x u) (mem8 y v)))))))

(declare-fun t2tb2406 ((set (set (tuple21 (tuple21 b a) c)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (set (tuple21 (tuple21 b a) c))))) (sort
  (set1 (set1 (tuple2 (tuple2 b1 a1) c1))) (t2tb2406 x))))

(declare-fun tb2t2406 (uni) (set (set (tuple21 (tuple21 b a) c))))

;; BridgeL
  (assert
  (forall ((i (set (set (tuple21 (tuple21 b a) c)))))
  (! (= (tb2t2406 (t2tb2406 i)) i) :pattern ((t2tb2406 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (set1 (tuple2 (tuple2 b1 a1) c1))) j)
     (= (t2tb2406 (tb2t2406 j)) j)) :pattern ((t2tb2406 (tb2t2406 j))) )))

;; mem_relation
  (assert
  (forall ((u (set (tuple21 b a))) (v (set c)) (r (set (tuple21 (tuple21 b a)
  c))))
  (= (mem (set1 (tuple2 (tuple2 b1 a1) c1)) (t2tb2395 r)
  (relation c1 (tuple2 b1 a1) (t2tb37 u) (t2tb132 v)))
  (forall ((x (tuple21 b a)) (y c))
  (=> (mem (tuple2 (tuple2 b1 a1) c1)
  (Tuple2 (tuple2 b1 a1) c1 (t2tb38 x) (t2tb135 y)) (t2tb2395 r))
...
;; mem_relation
  ...
  (forall ((x b) (y c))
  (=> (mem8 (Tuple26 x y) r) (and (mem2 x u) (mem7 y v)))))))
...
;; mem_relation
  ...
  (forall ((x b) (y a))
  (=> (mem5 (Tuple25 x y) r) (and (mem2 x u) (mem1 y v)))))))
...
;; mem_relation
  ...
  (forall ((x a) (y c))
  (=> (mem10 (Tuple27 x y) r) (and (mem1 x u) (mem7 y v)))))))
...
;; mem_inverse
  ...
  (= (mem8 (Tuple26 x y) (tb2t131 (inverse b1 c1 (t2tb222 p)))) (mem
  (tuple2 c1 b1) (Tuple2 c1 b1 (t2tb135 y) (t2tb14 x)) (t2tb222 p)))))

;; mem_inverse
  (assert
  (forall ((p (set (tuple21 c a))) (x a) (y c))
  (= (mem10 (Tuple27 x y) (tb2t129 (inverse a1 c1 (t2tb224 p)))) (mem
  (tuple2 c1 a1) (Tuple2 c1 a1 (t2tb135 y) (t2tb2 x)) (t2tb224 p)))))

;; mem_inverse
  (assert
  (forall ((p (set (tuple21 b c))) (x c) (y b))
  (= (mem (tuple2 c1 b1) (Tuple2 c1 b1 (t2tb135 x) (t2tb14 y))
  (inverse c1 b1 (t2tb131 p))) (mem8 (Tuple26 y x) p))))

;; mem_inverse
  (assert
  (forall ((p (set (tuple21 b a))) (x a) (y b))
  (= (mem3 (Tuple21 x y) (inverse1 p)) (mem5 (Tuple25 y x) p))))

;; mem_inverse
  (assert
  (forall ((p (set (tuple21 a c))) (x c) (y a))
  (= (mem (tuple2 c1 a1) (Tuple2 c1 a1 (t2tb135 x) (t2tb2 y))
  (inverse c1 a1 (t2tb129 p))) (mem10 (Tuple27 y x) p))))

;; mem_inverse
  (assert
  (forall ((p (set (tuple21 a b))) (x b) (y a))
  (= (mem5 (Tuple25 x y) (inverse2 p)) (mem3 (Tuple21 y x) p))))
...
;; mem_dom
  ...
  (exists ((b2 c)) (mem8 (Tuple26 x b2) p)))))

;; mem_dom
  (assert
  (forall ((p (set (tuple21 b a))) (x b))
  (= (mem2 x (tb2t12 (dom a1 b1 (t2tb37 p))))
  (exists ((b2 a)) (mem5 (Tuple25 x b2) p)))))
...
;; mem_dom
  ...
  (exists ((b2 c)) (mem10 (Tuple27 x b2) p)))))
...
;; mem_semicolon
  ...
  (and
  (=> (mem8 (Tuple26 x y) (tb2t131 (semicolon c1 b2 b1 p q)))
  (exists ((b3 uni))
  (and (sort b2 b3)
  ...
  (exists ((b3 uni))
  (and (mem (tuple2 b1 b2) (Tuple2 b1 b2 (t2tb14 x) b3) p) (mem
  (tuple2 b2 c1) (Tuple2 b2 c1 b3 (t2tb135 y)) q))) (mem8 (Tuple26 x y)
...
;; mem_semicolon
  ...
  (and
  (=> (mem5 (Tuple25 x y) (tb2t37 (semicolon a1 b2 b1 p q)))
  (exists ((b3 uni))
  (and (sort b2 b3)
  (and (mem (tuple2 b1 b2) (Tuple2 b1 b2 (t2tb14 x) b3) p) (mem
  ...
  (exists ((b3 uni))
  (and (mem (tuple2 b1 b2) (Tuple2 b1 b2 (t2tb14 x) b3) p) (mem
  (tuple2 b2 a1) (Tuple2 b2 a1 b3 (t2tb2 y)) q))) (mem5 (Tuple25 x y)
...
;; mem_semicolon
  ...
  (exists ((b2 c))
  (and (mem8 (Tuple26 x b2) p) (mem (tuple2 c1 c1)
  (Tuple2 c1 c1 (t2tb135 b2) (t2tb135 y)) (t2tb216 q)))))))
...
;; mem_semicolon
  ...
  (exists ((b2 c))
  (and (mem8 (Tuple26 x b2) p) (mem (tuple2 c1 a1)
  (Tuple2 c1 a1 (t2tb135 b2) (t2tb2 y)) (t2tb224 q)))))))
...
;; mem_semicolon
  ...
  (exists ((b2 c))
  (and (mem8 (Tuple26 x b2) p) (mem (tuple2 c1 c2)
  (Tuple2 c1 c2 (t2tb135 b2) y) q)))))))
...
;; mem_semicolon
  ...
  (= (mem5 (Tuple25 x y) (tb2t37 (semicolon a1 b1 b1 (t2tb35 p) (t2tb37 q))))
  (exists ((b2 b))
  (and (mem (tuple2 b1 b1) (Tuple2 b1 b1 (t2tb14 x) (t2tb14 b2)) (t2tb35 p))
  (mem5 (Tuple25 b2 y) q))))))
...
;; mem_semicolon
  ...
  (= (mem8 (Tuple26 x y) (semicolon12 p q))
  (exists ((b2 a)) (and (mem5 (Tuple25 x b2) p) (mem10 (Tuple27 b2 y) q))))))
...
;; mem_semicolon
  ...
  (exists ((b2 a)) (and (mem5 (Tuple25 x b2) p) (mem3 (Tuple21 b2 y) q))))))

;; mem_semicolon
  (assert
  (forall ((p (set (tuple21 b a))) (q (set (tuple21 a a))) (x b) (y a))
  (= (mem5 (Tuple25 x y) (tb2t37 (semicolon a1 a1 b1 (t2tb37 p) (t2tb4 q))))
  (exists ((b2 a))
  (and (mem5 (Tuple25 x b2) p) (mem (tuple2 a1 a1)
...
;; mem_semicolon
  ...
  (exists ((b2 a))
  (and (mem5 (Tuple25 x b2) p) (mem (tuple2 a1 c2)
...
;; mem_semicolon
  ...
  (and
  (=> (mem10 (Tuple27 x y) (tb2t129 (semicolon c1 b2 a1 p q)))
  (exists ((b3 uni))
  (and (sort b2 b3)
  ...
  (exists ((b3 uni))
  (and (mem (tuple2 a1 b2) (Tuple2 a1 b2 (t2tb2 x) b3) p) (mem (tuple2 b2 c1)
  (Tuple2 b2 c1 b3 (t2tb135 y)) q))) (mem10 (Tuple27 x y)
...
;; mem_semicolon
  ...
  (exists ((b2 c))
  (and (mem10 (Tuple27 x b2) p) (mem (tuple2 c1 c1)
  (Tuple2 c1 c1 (t2tb135 b2) (t2tb135 y)) (t2tb216 q)))))))
...
;; mem_semicolon
  ...
  (exists ((b2 c))
  (and (mem10 (Tuple27 x b2) p) (mem (tuple2 c1 b1)
  (Tuple2 c1 b1 (t2tb135 b2) (t2tb14 y)) (t2tb222 q)))))))
...
;; mem_semicolon
  ...
  (exists ((b2 c))
  (and (mem10 (Tuple27 x b2) p) (mem (tuple2 c1 c2)
  (Tuple2 c1 c2 (t2tb135 b2) y) q)))))))

;; mem_semicolon
  (assert
  (forall ((p (set (tuple21 a b))) (q (set (tuple21 b c))) (x a) (y c))
  (= (mem10 (Tuple27 x y) (semicolon1 p q))
  (exists ((b2 b)) (and (mem3 (Tuple21 x b2) p) (mem8 (Tuple26 b2 y) q))))))
...
;; mem_semicolon
  ...
  (exists ((b2 b)) (and (mem3 (Tuple21 x b2) p) (mem5 (Tuple25 b2 y) q))))))
...
;; mem_domain_restriction
  ...
  (and (mem8 (Tuple26 x y) p) (mem2 x s)))))
...
;; mem_domain_restriction
  ...
  (and (mem5 (Tuple25 x y) p) (mem2 x s)))))
...
;; mem_domain_restriction
  ...
  (and (mem10 (Tuple27 x y) p) (mem1 x s)))))
...
;; mem_range_restriction
  ...
  (and (mem8 (Tuple26 x y) p) (mem7 y t)))))
...
;; mem_range_restriction
  ...
  (and (mem5 (Tuple25 x y) p) (mem1 y t)))))
...
;; mem_range_restriction
  ...
  (and (mem10 (Tuple27 x y) p) (mem7 y t)))))
...
;; mem_domain_substraction
  ...
  (and (mem8 (Tuple26 x y) p) (not (mem2 x s))))))
...
;; mem_domain_substraction
  ...
  (and (mem5 (Tuple25 x y) p) (not (mem2 x s))))))
...
;; mem_domain_substraction
  ...
  (and (mem10 (Tuple27 x y) p) (not (mem1 x s))))))
...
;; mem_range_substraction
  ...
  (and (mem8 (Tuple26 x y) p) (not (mem7 y t))))))
...
;; mem_range_substraction
  ...
  (and (mem5 (Tuple25 x y) p) (not (mem1 y t))))))
...
;; mem_range_substraction
  ...
  (and (mem10 (Tuple27 x y) p) (not (mem7 y t))))))
...
;; mem_image
  ...
  c))) (x (tuple21 b a)))
  (= (mem5 x
  (tb2t37 (image (tuple2 b1 a1) (tuple2 a1 c1) (t2tb2385 p) (t2tb129 w))))
  (exists ((a2 (tuple21 a c)))
...
;; mem_image
  ...
  c))) (x (tuple21 b a)))
  (= (mem5 x
  (tb2t37 (image (tuple2 b1 a1) (tuple2 b1 c1) (t2tb2387 p) (t2tb131 w))))
  (exists ((a2 (tuple21 b c)))
...
;; mem_image
  ...
  (= (mem5 x (tb2t37 (image (tuple2 b1 a1) c1 (t2tb2389 p) (t2tb132 w))))
  (exists ((a2 c))
  (and (mem7 a2 w) (mem (tuple2 c1 (tuple2 b1 a1))
  (Tuple2 c1 (tuple2 b1 a1) (t2tb135 a2) (t2tb38 x)) (t2tb2389 p)))))))
...
;; mem_image
  ...
  a))) (x (tuple21 a c)))
  (= (mem10 x
  (tb2t129 (image (tuple2 a1 c1) (tuple2 b1 a1) (t2tb2391 p) (t2tb37 w))))
...
;; mem_image
  ...
  a))) (x (tuple21 b c)))
  (= (mem8 x
  (tb2t131 (image (tuple2 b1 c1) (tuple2 b1 a1) (t2tb2393 p) (t2tb37 w))))
  (exists ((a2 (tuple21 b a)))
...
;; mem_image
  ...
  (= (mem7 x (tb2t132 (image c1 (tuple2 b1 a1) (t2tb2395 p) (t2tb37 w))))
  (exists ((a2 (tuple21 b a)))
  (and (mem5 a2 w) (mem (tuple2 (tuple2 b1 a1) c1)
  (Tuple2 (tuple2 b1 a1) c1 (t2tb38 a2) (t2tb135 x)) (t2tb2395 p)))))))
...
;; mem_image
  ...
  (= (mem7 x (image3 p w))
  (exists ((a2 b)) (and (mem2 a2 w) (mem8 (Tuple26 a2 x) p))))))
...
;; mem_image
  ...
  (= (mem1 x (image2 p w))
  (exists ((a2 b)) (and (mem2 a2 w) (mem5 (Tuple25 a2 x) p))))))
...
;; mem_image
  ...
  (= (mem7 x (image4 p w))
  (exists ((a2 a)) (and (mem1 a2 w) (mem10 (Tuple27 a2 x) p))))))
...
;; mem_overriding
  ...
  (or
  (and (mem8 (Tuple26 x y) q)
  (not (mem2 x (tb2t12 (dom c1 b1 (t2tb131 p)))))) (mem8 (Tuple26 x y) p)))))

;; mem_overriding
  (assert
  (forall ((q (set (tuple21 b a))) (p (set (tuple21 b a))) (x b) (y a))
  (= (mem5 (Tuple25 x y) (tb2t37 (infix_lspl a1 b1 (t2tb37 q) (t2tb37 p))))
  (or
  (and (mem5 (Tuple25 x y) q) (not (mem2 x (tb2t12 (dom a1 b1 (t2tb37 p))))))
  (mem5 (Tuple25 x y) p)))))
...
;; mem_overriding
  ...
  (or
  (and (mem10 (Tuple27 x y) q)
  (not (mem1 x (tb2t1 (dom c1 a1 (t2tb129 p)))))) (mem10 (Tuple27 x y) p)))))
...
;; mem_direct_product
  (assert
  (forall ((a2 ty))
  (forall ((f uni) (g uni) (x uni) (y b) (z c))
  (= (mem (tuple2 a2 (tuple2 b1 c1))
  (Tuple2 a2 (tuple2 b1 c1) x (t2tb134 (Tuple26 y z)))
  (direct_product c1 b1 a2 f g))
  (and (mem (tuple2 a2 b1) (Tuple2 a2 b1 x (t2tb14 y)) f) (mem (tuple2 a2 c1)
  (Tuple2 a2 c1 x (t2tb135 z)) g))))))

;; mem_direct_product
  (assert
  (forall ((a2 ty))
  (forall ((f uni) (g uni) (x uni) (y b) (z a))
  (= (mem (tuple2 a2 (tuple2 b1 a1))
  (Tuple2 a2 (tuple2 b1 a1) x (t2tb38 (Tuple25 y z)))
  (direct_product a1 b1 a2 f g))
  (and (mem (tuple2 a2 b1) (Tuple2 a2 b1 x (t2tb14 y)) f) (mem (tuple2 a2 a1)
  (Tuple2 a2 a1 x (t2tb2 z)) g))))))

;; mem_direct_product
  (assert
  (forall ((a2 ty))
  (forall ((f uni) (g uni) (x uni) (y a) (z c))
  (= (mem (tuple2 a2 (tuple2 a1 c1))
  (Tuple2 a2 (tuple2 a1 c1) x (t2tb133 (Tuple27 y z)))
  (direct_product c1 a1 a2 f g))
  (and (mem (tuple2 a2 a1) (Tuple2 a2 a1 x (t2tb2 y)) f) (mem (tuple2 a2 c1)
  (Tuple2 a2 c1 x (t2tb135 z)) g))))))
...
;; mem_direct_product
  ...
  (and (mem (tuple2 b1 b2) (Tuple2 b1 b2 (t2tb14 x) y) f) (mem8 (Tuple26 x z)
  g))))))
...
;; mem_direct_product
  ...
  (and (mem (tuple2 b1 b2) (Tuple2 b1 b2 (t2tb14 x) y) f) (mem5 (Tuple25 x z)
  g))))))
...
;; mem_direct_product
  ...
  (and (mem8 (Tuple26 x y) f) (mem8 (Tuple26 x z) g)))))
...
;; mem_direct_product
  ...
  (and (mem8 (Tuple26 x y) f) (mem5 (Tuple25 x z) g)))))
...
;; mem_direct_product
  ...
  (and (mem8 (Tuple26 x y) f) (mem (tuple2 b1 c2) (Tuple2 b1 c2 (t2tb14 x) z)
  g))))))

;; mem_direct_product
  (assert
  (forall ((f (set (tuple21 b b))) (g (set (tuple21 b c))) (x b) (y b) (z c))
  (= (mem (tuple2 b1 (tuple2 b1 c1))
  (Tuple2 b1 (tuple2 b1 c1) (t2tb14 x) (t2tb134 (Tuple26 y z)))
  (direct_product c1 b1 b1 (t2tb35 f) (t2tb131 g)))
  (and (mem (tuple2 b1 b1) (Tuple2 b1 b1 (t2tb14 x) (t2tb14 y)) (t2tb35 f))
  (mem8 (Tuple26 x z) g)))))
...
;; mem_direct_product
  ...
  (= (mem (tuple2 b1 (tuple2 b1 a1))
  (Tuple2 b1 (tuple2 b1 a1) (t2tb14 x) (t2tb38 (Tuple25 y z)))
...
;; mem_direct_product
  ...
  (= (mem (tuple2 b1 (tuple2 a1 c1))
  (Tuple2 b1 (tuple2 a1 c1) (t2tb14 x) (t2tb133 (Tuple27 y z)))
  (direct_product c1 a1 b1 (t2tb37 f) (t2tb131 g)))
  (and (mem5 (Tuple25 x y) f) (mem8 (Tuple26 x z) g)))))

;; mem_direct_product
  (assert
  (forall ((f (set (tuple21 b a))) (g (set (tuple21 b b))) (x b) (y a) (z b))
  (= (mem (tuple2 b1 (tuple2 a1 b1))
  (Tuple2 b1 (tuple2 a1 b1) (t2tb14 x) (t2tb13 (Tuple21 y z)))
  (direct_product b1 a1 b1 (t2tb37 f) (t2tb35 g)))
  (and (mem5 (Tuple25 x y) f) (mem (tuple2 b1 b1)
  (Tuple2 b1 b1 (t2tb14 x) (t2tb14 z)) (t2tb35 g))))))
...
;; mem_direct_product
  ...
  (and (mem5 (Tuple25 x y) f) (mem5 (Tuple25 x z) g)))))
...
;; mem_direct_product
  ...
  (and (mem5 (Tuple25 x y) f) (mem (tuple2 b1 c2) (Tuple2 b1 c2 (t2tb14 x) z)
  g))))))
...
;; mem_direct_product
  ...
  (and (mem (tuple2 a1 b2) (Tuple2 a1 b2 (t2tb2 x) y) f) (mem10 (Tuple27 x z)
  g))))))
...
;; mem_direct_product
  ...
  (and (mem10 (Tuple27 x y) f) (mem10 (Tuple27 x z) g)))))
...
;; mem_direct_product
  ...
  (and (mem10 (Tuple27 x y) f) (mem3 (Tuple21 x z) g)))))
...
;; mem_direct_product
  ...
  (and (mem10 (Tuple27 x y) f) (mem (tuple2 a1 c2) (Tuple2 a1 c2 (t2tb2 x) z)
  g))))))
...
;; mem_direct_product
  ...
  (= (mem (tuple2 a1 (tuple2 b1 c1))
  (Tuple2 a1 (tuple2 b1 c1) (t2tb2 x) (t2tb134 (Tuple26 y z)))
  (direct_product c1 b1 a1 (t2tb11 f) (t2tb129 g)))
  (and (mem3 (Tuple21 x y) f) (mem10 (Tuple27 x z) g)))))
...
;; mem_direct_product
  (assert
  (forall ((f (set (tuple21 a b))) (g (set (tuple21 a a))) (x a) (y b) (z a))
  (= (mem (tuple2 a1 (tuple2 b1 a1))
  (Tuple2 a1 (tuple2 b1 a1) (t2tb2 x) (t2tb38 (Tuple25 y z)))
  (direct_product a1 b1 a1 (t2tb11 f) (t2tb4 g)))
  (and (mem3 (Tuple21 x y) f) (mem (tuple2 a1 a1)
  (Tuple2 a1 a1 (t2tb2 x) (t2tb2 z)) (t2tb4 g))))))
...
;; mem_direct_product
  (assert
  (forall ((f (set (tuple21 a a))) (g (set (tuple21 a c))) (x a) (y a) (z c))
  (= (mem (tuple2 a1 (tuple2 a1 c1))
  (Tuple2 a1 (tuple2 a1 c1) (t2tb2 x) (t2tb133 (Tuple27 y z)))
  (direct_product c1 a1 a1 (t2tb4 f) (t2tb129 g)))
...
(declare-fun t2tb2411 ((tuple21 (set b) (set c))) uni)
...
(declare-fun tb2t2411 (uni) (tuple21 (set b) (set c)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (set b) (set c))))
  (! (= (tb2t2411 (t2tb2411 i)) i) :pattern ((t2tb2411 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (set1 b1) (set1 c1)) j) (= (t2tb2411 (tb2t2411 j)) j)) :pattern (
  (t2tb2411 (tb2t2411 j))) )))
...
;; mem_proj_op_1
  ...
  (= (mem (tuple2 (tuple2 b1 c1) b1)
  (Tuple2 (tuple2 b1 c1) b1 (t2tb134 (Tuple26 x y)) (t2tb14 z))
...
(declare-fun t2tb2412 ((tuple21 (set b) (set a))) uni)
...
(declare-fun tb2t2412 (uni) (tuple21 (set b) (set a)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (set b) (set a))))
  (! (= (tb2t2412 (t2tb2412 i)) i) :pattern ((t2tb2412 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (set1 b1) (set1 a1)) j) (= (t2tb2412 (tb2t2412 j)) j)) :pattern (
  (t2tb2412 (tb2t2412 j))) )))
...
;; mem_proj_op_1
  ...
  (= (mem (tuple2 (tuple2 b1 a1) b1)
  (Tuple2 (tuple2 b1 a1) b1 (t2tb38 (Tuple25 x y)) (t2tb14 z))
...
(declare-fun t2tb2413 ((tuple21 (set a) (set c))) uni)
...
(declare-fun tb2t2413 (uni) (tuple21 (set a) (set c)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (set a) (set c))))
  (! (= (tb2t2413 (t2tb2413 i)) i) :pattern ((t2tb2413 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (set1 a1) (set1 c1)) j) (= (t2tb2413 (tb2t2413 j)) j)) :pattern (
  (t2tb2413 (tb2t2413 j))) )))
...
;; mem_proj_op_1
  ...
  (= (mem (tuple2 (tuple2 a1 c1) a1)
  (Tuple2 (tuple2 a1 c1) a1 (t2tb133 (Tuple27 x y)) (t2tb2 z))
...
;; mem_proj_op_2
  ...
  (= (mem (tuple2 (tuple2 b1 c1) c1)
  (Tuple2 (tuple2 b1 c1) c1 (t2tb134 (Tuple26 x y)) (t2tb135 z))
  (prj2 c1 b1 (Tuple2 (set1 b1) (set1 c1) (t2tb12 s) (t2tb132 t))))
  (and (mem (tuple2 (tuple2 b1 c1) c1)
  (Tuple2 (tuple2 b1 c1) c1 (t2tb134 (Tuple26 x y)) (t2tb135 z))
  (times c1 (tuple2 b1 c1) (t2tb131 (times3 s t)) (t2tb132 t))) (= z y)))))

;; mem_proj_op_2
  (assert
  (forall ((s (set b)) (t (set a)) (x b) (y a) (z a))
  (= (mem (tuple2 (tuple2 b1 a1) a1)
  (Tuple2 (tuple2 b1 a1) a1 (t2tb38 (Tuple25 x y)) (t2tb2 z))
...
;; mem_proj_op_2
  ...
  (= (mem (tuple2 (tuple2 a1 c1) c1)
  (Tuple2 (tuple2 a1 c1) c1 (t2tb133 (Tuple27 x y)) (t2tb135 z))
...
;; mem_parallel_product
  ...
  (and (mem (tuple2 a2 b2) (Tuple2 a2 b2 x z) h) (mem8 (Tuple26 y w) k))))))
...
;; mem_parallel_product
  ...
  (and (mem (tuple2 a2 b2) (Tuple2 a2 b2 x z) h) (mem5 (Tuple25 y w) k))))))
...
;; mem_parallel_product
  ...
  (and (mem (tuple2 a2 b2) (Tuple2 a2 b2 x z) h) (mem10 (Tuple27 y w) k))))))
...
;; mem_parallel_product
  (assert
  (forall ((a2 ty) (c2 ty))
  (forall ((h uni) (k uni) (x uni) (y uni) (z b) (w c))
  (= (mem (tuple2 (tuple2 a2 c2) (tuple2 b1 c1))
  (Tuple2 (tuple2 a2 c2) (tuple2 b1 c1) (Tuple2 a2 c2 x y)
  (t2tb134 (Tuple26 z w))) (parallel_product c1 c2 b1 a2 h k))
  (and (mem (tuple2 a2 b1) (Tuple2 a2 b1 x (t2tb14 z)) h) (mem (tuple2 c2 c1)
  (Tuple2 c2 c1 y (t2tb135 w)) k))))))

;; mem_parallel_product
  (assert
  (forall ((a2 ty) (c2 ty))
  (forall ((h uni) (k uni) (x uni) (y uni) (z b) (w a))
  (= (mem (tuple2 (tuple2 a2 c2) (tuple2 b1 a1))
  (Tuple2 (tuple2 a2 c2) (tuple2 b1 a1) (Tuple2 a2 c2 x y)
  (t2tb38 (Tuple25 z w))) (parallel_product a1 c2 b1 a2 h k))
  (and (mem (tuple2 a2 b1) (Tuple2 a2 b1 x (t2tb14 z)) h) (mem (tuple2 c2 a1)
  (Tuple2 c2 a1 y (t2tb2 w)) k))))))

;; mem_parallel_product
  (assert
  (forall ((a2 ty))
  (forall ((h uni) (k (set (tuple21 b c))) (x uni) (y b) (z b) (w c))
  (= (mem (tuple2 (tuple2 a2 b1) (tuple2 b1 c1))
  (Tuple2 (tuple2 a2 b1) (tuple2 b1 c1) (Tuple2 a2 b1 x (t2tb14 y))
  (t2tb134 (Tuple26 z w))) (parallel_product c1 b1 b1 a2 h (t2tb131 k)))
  (and (mem (tuple2 a2 b1) (Tuple2 a2 b1 x (t2tb14 z)) h) (mem8 (Tuple26 y w)
  k))))))

;; mem_parallel_product
  (assert
  (forall ((a2 ty))
  (forall ((h uni) (k (set (tuple21 b a))) (x uni) (y b) (z b) (w a))
  (= (mem (tuple2 (tuple2 a2 b1) (tuple2 b1 a1))
  (Tuple2 (tuple2 a2 b1) (tuple2 b1 a1) (Tuple2 a2 b1 x (t2tb14 y))
  (t2tb38 (Tuple25 z w))) (parallel_product a1 b1 b1 a2 h (t2tb37 k)))
  (and (mem (tuple2 a2 b1) (Tuple2 a2 b1 x (t2tb14 z)) h) (mem5 (Tuple25 y w)
  k))))))

;; mem_parallel_product
  (assert
  (forall ((a2 ty))
  (forall ((h uni) (k (set (tuple21 a c))) (x uni) (y a) (z b) (w c))
  (= (mem (tuple2 (tuple2 a2 a1) (tuple2 b1 c1))
  (Tuple2 (tuple2 a2 a1) (tuple2 b1 c1) (Tuple2 a2 a1 x (t2tb2 y))
  (t2tb134 (Tuple26 z w))) (parallel_product c1 a1 b1 a2 h (t2tb129 k)))
  (and (mem (tuple2 a2 b1) (Tuple2 a2 b1 x (t2tb14 z)) h) (mem10
  (Tuple27 y w) k))))))

;; mem_parallel_product
  (assert
  (forall ((a2 ty) (c2 ty))
  (forall ((h uni) (k uni) (x uni) (y uni) (z a) (w c))
  (= (mem (tuple2 (tuple2 a2 c2) (tuple2 a1 c1))
  (Tuple2 (tuple2 a2 c2) (tuple2 a1 c1) (Tuple2 a2 c2 x y)
  (t2tb133 (Tuple27 z w))) (parallel_product c1 c2 a1 a2 h k))
  (and (mem (tuple2 a2 a1) (Tuple2 a2 a1 x (t2tb2 z)) h) (mem (tuple2 c2 c1)
  (Tuple2 c2 c1 y (t2tb135 w)) k))))))
...
;; mem_parallel_product
  (assert
  (forall ((a2 ty))
  (forall ((h uni) (k (set (tuple21 b c))) (x uni) (y b) (z a) (w c))
  (= (mem (tuple2 (tuple2 a2 b1) (tuple2 a1 c1))
  (Tuple2 (tuple2 a2 b1) (tuple2 a1 c1) (Tuple2 a2 b1 x (t2tb14 y))
  (t2tb133 (Tuple27 z w))) (parallel_product c1 b1 a1 a2 h (t2tb131 k)))
  (and (mem (tuple2 a2 a1) (Tuple2 a2 a1 x (t2tb2 z)) h) (mem8 (Tuple26 y w)
  k))))))

;; mem_parallel_product
  (assert
  (forall ((a2 ty))
  (forall ((h uni) (k (set (tuple21 a c))) (x uni) (y a) (z a) (w c))
  (= (mem (tuple2 (tuple2 a2 a1) (tuple2 a1 c1))
  (Tuple2 (tuple2 a2 a1) (tuple2 a1 c1) (Tuple2 a2 a1 x (t2tb2 y))
  (t2tb133 (Tuple27 z w))) (parallel_product c1 a1 a1 a2 h (t2tb129 k)))
  (and (mem (tuple2 a2 a1) (Tuple2 a2 a1 x (t2tb2 z)) h) (mem10 (Tuple27 y w)
  k))))))
...
;; mem_parallel_product
  (assert
  (forall ((b2 ty) (d2 ty))
  (forall ((h uni) (k uni) (x b) (y c) (z uni) (w uni))
  (= (mem (tuple2 (tuple2 b1 c1) (tuple2 b2 d2))
  (Tuple2 (tuple2 b1 c1) (tuple2 b2 d2) (t2tb134 (Tuple26 x y))
  (Tuple2 b2 d2 z w)) (parallel_product d2 c1 b2 b1 h k))
  (and (mem (tuple2 b1 b2) (Tuple2 b1 b2 (t2tb14 x) z) h) (mem (tuple2 c1 d2)
  (Tuple2 c1 d2 (t2tb135 y) w) k))))))

;; mem_parallel_product
  (assert
  (forall ((b2 ty))
  (forall ((h uni) (k (set (tuple21 a c))) (x b) (y a) (z uni) (w c))
  (= (mem (tuple2 (tuple2 b1 a1) (tuple2 b2 c1))
  (Tuple2 (tuple2 b1 a1) (tuple2 b2 c1) (t2tb38 (Tuple25 x y))
  (Tuple2 b2 c1 z (t2tb135 w))) (parallel_product c1 a1 b2 b1 h (t2tb129 k)))
  (and (mem (tuple2 b1 b2) (Tuple2 b1 b2 (t2tb14 x) z) h) (mem10
  (Tuple27 y w) k))))))

;; mem_parallel_product
  (assert
  (forall ((b2 ty))
  (forall ((h uni) (k (set (tuple21 a b))) (x b) (y a) (z uni) (w b))
  (= (mem (tuple2 (tuple2 b1 a1) (tuple2 b2 b1))
  (Tuple2 (tuple2 b1 a1) (tuple2 b2 b1) (t2tb38 (Tuple25 x y))
  (Tuple2 b2 b1 z (t2tb14 w))) (parallel_product b1 a1 b2 b1 h (t2tb11 k)))
  (and (mem (tuple2 b1 b2) (Tuple2 b1 b2 (t2tb14 x) z) h) (mem3 (Tuple21 y w)
  k))))))

;; mem_parallel_product
  (assert
  (forall ((b2 ty) (d2 ty))
  (forall ((h uni) (k uni) (x b) (y a) (z uni) (w uni))
  (= (mem (tuple2 (tuple2 b1 a1) (tuple2 b2 d2))
  (Tuple2 (tuple2 b1 a1) (tuple2 b2 d2) (t2tb38 (Tuple25 x y))
  (Tuple2 b2 d2 z w)) (parallel_product d2 a1 b2 b1 h k))
  (and (mem (tuple2 b1 b2) (Tuple2 b1 b2 (t2tb14 x) z) h) (mem (tuple2 a1 d2)
  (Tuple2 a1 d2 (t2tb2 y) w) k))))))

;; mem_parallel_product
  (assert
  (forall ((d2 ty))
  (forall ((h (set (tuple21 b c))) (k uni) (x b) (y c) (z c) (w uni))
  (= (mem (tuple2 (tuple2 b1 c1) (tuple2 c1 d2))
  (Tuple2 (tuple2 b1 c1) (tuple2 c1 d2) (t2tb134 (Tuple26 x y))
  (Tuple2 c1 d2 (t2tb135 z) w)) (parallel_product d2 c1 c1 b1 (t2tb131 h) k))
  (and (mem8 (Tuple26 x z) h) (mem (tuple2 c1 d2)
  (Tuple2 c1 d2 (t2tb135 y) w) k))))))
...
;; mem_parallel_product
  ...
  (and (mem8 (Tuple26 x z) h) (mem8 (Tuple26 y w) k)))))

(declare-fun t2tb2414 ((set (tuple21 (tuple21 b b) (tuple21 c a)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b b) (tuple21 c a))))) (sort
  (set1 (tuple2 (tuple2 b1 b1) (tuple2 c1 a1))) (t2tb2414 x))))

(declare-fun tb2t2414 (uni) (set (tuple21 (tuple21 b b) (tuple21 c a))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b b) (tuple21 c a)))))
  (! (= (tb2t2414 (t2tb2414 i)) i) :pattern ((t2tb2414 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 b1) (tuple2 c1 a1))) j)
     (= (t2tb2414 (tb2t2414 j)) j)) :pattern ((t2tb2414 (tb2t2414 j))) )))

(declare-fun t2tb2415 ((tuple21 (tuple21 b b) (tuple21 c a))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 b b) (tuple21 c a)))) (sort
  (tuple2 (tuple2 b1 b1) (tuple2 c1 a1)) (t2tb2415 x))))

(declare-fun tb2t2415 (uni) (tuple21 (tuple21 b b) (tuple21 c a)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b b) (tuple21 c a))))
  (! (= (tb2t2415 (t2tb2415 i)) i) :pattern ((t2tb2415 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 b1) (tuple2 c1 a1)) j)
     (= (t2tb2415 (tb2t2415 j)) j)) :pattern ((t2tb2415 (tb2t2415 j))) )))
...
;; mem_parallel_product
  ...
  (and (mem8 (Tuple26 x z) h) (mem5 (Tuple25 y w) k)))))
...
;; mem_parallel_product
  ...
  (Tuple2 (tuple2 b1 a1) (tuple2 c1 c1) (t2tb38 (Tuple25 x y))
  (Tuple2 c1 c1 (t2tb135 z) (t2tb135 w)))
  (parallel_product c1 a1 c1 b1 (t2tb131 h) (t2tb129 k)))
  (and (mem8 (Tuple26 x z) h) (mem10 (Tuple27 y w) k)))))
...
;; mem_parallel_product
  ...
  (Tuple2 (tuple2 b1 a1) (tuple2 c1 b1) (t2tb38 (Tuple25 x y))
  (Tuple2 c1 b1 (t2tb135 z) (t2tb14 w)))
  (parallel_product b1 a1 c1 b1 (t2tb131 h) (t2tb11 k)))
  (and (mem8 (Tuple26 x z) h) (mem3 (Tuple21 y w) k)))))

;; mem_parallel_product
  (assert
  (forall ((d2 ty))
  (forall ((h (set (tuple21 b c))) (k uni) (x b) (y a) (z c) (w uni))
  (= (mem (tuple2 (tuple2 b1 a1) (tuple2 c1 d2))
  (Tuple2 (tuple2 b1 a1) (tuple2 c1 d2) (t2tb38 (Tuple25 x y))
  (Tuple2 c1 d2 (t2tb135 z) w)) (parallel_product d2 a1 c1 b1 (t2tb131 h) k))
  (and (mem8 (Tuple26 x z) h) (mem (tuple2 a1 d2) (Tuple2 a1 d2 (t2tb2 y) w)
  k))))))
...
;; mem_parallel_product
  ...
  (and (mem8 (Tuple26 x z) h) (mem (tuple2 c2 d2) (Tuple2 c2 d2 y w) k))))))

;; mem_parallel_product
  (assert
  (forall ((h (set (tuple21 b b))) (k (set (tuple21 c c))) (x b) (y c) (z b)
  (w c))
  (= (mem (tuple2 (tuple2 b1 c1) (tuple2 b1 c1))
  (Tuple2 (tuple2 b1 c1) (tuple2 b1 c1) (t2tb134 (Tuple26 x y))
  (t2tb134 (Tuple26 z w)))
  (parallel_product c1 c1 b1 b1 (t2tb35 h) (t2tb216 k)))
  (and (mem (tuple2 b1 b1) (Tuple2 b1 b1 (t2tb14 x) (t2tb14 z)) (t2tb35 h))
  (mem (tuple2 c1 c1) (Tuple2 c1 c1 (t2tb135 y) (t2tb135 w)) (t2tb216 k))))))

;; mem_parallel_product
  (assert
  (forall ((h (set (tuple21 b b))) (k (set (tuple21 c a))) (x b) (y c) (z b)
  (w a))
  (= (mem (tuple2 (tuple2 b1 c1) (tuple2 b1 a1))
  (Tuple2 (tuple2 b1 c1) (tuple2 b1 a1) (t2tb134 (Tuple26 x y))
  (t2tb38 (Tuple25 z w)))
  (parallel_product a1 c1 b1 b1 (t2tb35 h) (t2tb224 k)))
  (and (mem (tuple2 b1 b1) (Tuple2 b1 b1 (t2tb14 x) (t2tb14 z)) (t2tb35 h))
  (mem (tuple2 c1 a1) (Tuple2 c1 a1 (t2tb135 y) (t2tb2 w)) (t2tb224 k))))))

;; mem_parallel_product
  (assert
  (forall ((h (set (tuple21 b b))) (k (set (tuple21 a c))) (x b) (y a) (z b)
  (w c))
  (= (mem (tuple2 (tuple2 b1 a1) (tuple2 b1 c1))
  (Tuple2 (tuple2 b1 a1) (tuple2 b1 c1) (t2tb38 (Tuple25 x y))
  (t2tb134 (Tuple26 z w)))
  (parallel_product c1 a1 b1 b1 (t2tb35 h) (t2tb129 k)))
  (and (mem (tuple2 b1 b1) (Tuple2 b1 b1 (t2tb14 x) (t2tb14 z)) (t2tb35 h))
  (mem10 (Tuple27 y w) k)))))

;; mem_parallel_product
  (assert
  (forall ((h (set (tuple21 b b))) (k (set (tuple21 a a))) (x b) (y a) (z b)
  (w a))
  (= (mem (tuple2 (tuple2 b1 a1) (tuple2 b1 a1))
  (Tuple2 (tuple2 b1 a1) (tuple2 b1 a1) (t2tb38 (Tuple25 x y))
  (t2tb38 (Tuple25 z w)))
  (parallel_product a1 a1 b1 b1 (t2tb35 h) (t2tb4 k)))
  (and (mem (tuple2 b1 b1) (Tuple2 b1 b1 (t2tb14 x) (t2tb14 z)) (t2tb35 h))
...
;; mem_parallel_product
  (assert
  (forall ((c2 ty))
  (forall ((h (set (tuple21 b a))) (k uni) (x b) (y uni) (z a) (w c))
  (= (mem (tuple2 (tuple2 b1 c2) (tuple2 a1 c1))
  (Tuple2 (tuple2 b1 c2) (tuple2 a1 c1) (Tuple2 b1 c2 (t2tb14 x) y)
  (t2tb133 (Tuple27 z w))) (parallel_product c1 c2 a1 b1 (t2tb37 h) k))
  (and (mem5 (Tuple25 x z) h) (mem (tuple2 c2 c1)
  (Tuple2 c2 c1 y (t2tb135 w)) k))))))

;; mem_parallel_product
  (assert
  (forall ((c2 ty))
  (forall ((h (set (tuple21 b a))) (k uni) (x b) (y uni) (z a) (w b))
  (= (mem (tuple2 (tuple2 b1 c2) (tuple2 a1 b1))
  (Tuple2 (tuple2 b1 c2) (tuple2 a1 b1) (Tuple2 b1 c2 (t2tb14 x) y)
  (t2tb13 (Tuple21 z w))) (parallel_product b1 c2 a1 b1 (t2tb37 h) k))
  (and (mem5 (Tuple25 x z) h) (mem (tuple2 c2 b1) (Tuple2 c2 b1 y (t2tb14 w))
  k))))))

;; mem_parallel_product
  (assert
  (forall ((h (set (tuple21 b a))) (k (set (tuple21 c c))) (x b) (y c) (z a)
  (w c))
  (= (mem (tuple2 (tuple2 b1 c1) (tuple2 a1 c1))
  (Tuple2 (tuple2 b1 c1) (tuple2 a1 c1) (t2tb134 (Tuple26 x y))
  (t2tb133 (Tuple27 z w)))
  (parallel_product c1 c1 a1 b1 (t2tb37 h) (t2tb216 k)))
  (and (mem5 (Tuple25 x z) h) (mem (tuple2 c1 c1)
  (Tuple2 c1 c1 (t2tb135 y) (t2tb135 w)) (t2tb216 k))))))
...
;; mem_parallel_product
  ...
  (w b))
  (= (mem (tuple2 (tuple2 b1 c1) (tuple2 a1 b1))
  (Tuple2 (tuple2 b1 c1) (tuple2 a1 b1) (t2tb134 (Tuple26 x y))
  (t2tb13 (Tuple21 z w)))
  (parallel_product b1 c1 a1 b1 (t2tb37 h) (t2tb222 k)))
  (and (mem5 (Tuple25 x z) h) (mem (tuple2 c1 b1)
  (Tuple2 c1 b1 (t2tb135 y) (t2tb14 w)) (t2tb222 k))))))

;; mem_parallel_product
  (assert
  (forall ((d2 ty))
  (forall ((h (set (tuple21 b a))) (k uni) (x b) (y c) (z a) (w uni))
  (= (mem (tuple2 (tuple2 b1 c1) (tuple2 a1 d2))
  (Tuple2 (tuple2 b1 c1) (tuple2 a1 d2) (t2tb134 (Tuple26 x y))
  (Tuple2 a1 d2 (t2tb2 z) w)) (parallel_product d2 c1 a1 b1 (t2tb37 h) k))
  (and (mem5 (Tuple25 x z) h) (mem (tuple2 c1 d2)
  (Tuple2 c1 d2 (t2tb135 y) w) k))))))

(declare-fun t2tb2416 ((set (tuple21 (tuple21 b b) (tuple21 a c)))) uni)

;; t2tb_sort
  (assert
  (forall ((x (set (tuple21 (tuple21 b b) (tuple21 a c))))) (sort
  (set1 (tuple2 (tuple2 b1 b1) (tuple2 a1 c1))) (t2tb2416 x))))

(declare-fun tb2t2416 (uni) (set (tuple21 (tuple21 b b) (tuple21 a c))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 b b) (tuple21 a c)))))
  (! (= (tb2t2416 (t2tb2416 i)) i) :pattern ((t2tb2416 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (set1 (tuple2 (tuple2 b1 b1) (tuple2 a1 c1))) j)
     (= (t2tb2416 (tb2t2416 j)) j)) :pattern ((t2tb2416 (tb2t2416 j))) )))

(declare-fun t2tb2417 ((tuple21 (tuple21 b b) (tuple21 a c))) uni)

;; t2tb_sort
  (assert
  (forall ((x (tuple21 (tuple21 b b) (tuple21 a c)))) (sort
  (tuple2 (tuple2 b1 b1) (tuple2 a1 c1)) (t2tb2417 x))))

(declare-fun tb2t2417 (uni) (tuple21 (tuple21 b b) (tuple21 a c)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 b b) (tuple21 a c))))
  (! (= (tb2t2417 (t2tb2417 i)) i) :pattern ((t2tb2417 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 b1 b1) (tuple2 a1 c1)) j)
     (= (t2tb2417 (tb2t2417 j)) j)) :pattern ((t2tb2417 (tb2t2417 j))) )))
...
;; mem_parallel_product
  ...
  (and (mem5 (Tuple25 x z) h) (mem8 (Tuple26 y w) k)))))
...
;; mem_parallel_product
  ...
  (and (mem5 (Tuple25 x z) h) (mem5 (Tuple25 y w) k)))))
...
;; mem_parallel_product
  ...
  (w c))
  (= (mem (tuple2 (tuple2 b1 a1) (tuple2 a1 c1))
  (Tuple2 (tuple2 b1 a1) (tuple2 a1 c1) (t2tb38 (Tuple25 x y))
  (t2tb133 (Tuple27 z w)))
  (parallel_product c1 a1 a1 b1 (t2tb37 h) (t2tb129 k)))
  (and (mem5 (Tuple25 x z) h) (mem10 (Tuple27 y w) k)))))
...
;; mem_parallel_product
  ...
  (w b))
  (= (mem (tuple2 (tuple2 b1 a1) (tuple2 a1 b1))
  (Tuple2 (tuple2 b1 a1) (tuple2 a1 b1) (t2tb38 (Tuple25 x y))
  (t2tb13 (Tuple21 z w)))
  (parallel_product b1 a1 a1 b1 (t2tb37 h) (t2tb11 k)))
  (and (mem5 (Tuple25 x z) h) (mem3 (Tuple21 y w) k)))))

;; mem_parallel_product
  (assert
  (forall ((d2 ty))
  (forall ((h (set (tuple21 b a))) (k uni) (x b) (y a) (z a) (w uni))
  (= (mem (tuple2 (tuple2 b1 a1) (tuple2 a1 d2))
  (Tuple2 (tuple2 b1 a1) (tuple2 a1 d2) (t2tb38 (Tuple25 x y))
  (Tuple2 a1 d2 (t2tb2 z) w)) (parallel_product d2 a1 a1 b1 (t2tb37 h) k))
  (and (mem5 (Tuple25 x z) h) (mem (tuple2 a1 d2) (Tuple2 a1 d2 (t2tb2 y) w)
  k))))))
...
;; mem_parallel_product
  ...
  (and (mem5 (Tuple25 x z) h) (mem (tuple2 c2 d2) (Tuple2 c2 d2 y w) k))))))

;; mem_parallel_product
  (assert
  (forall ((b2 ty) (d2 ty))
  (forall ((h uni) (k uni) (x a) (y c) (z uni) (w uni))
  (= (mem (tuple2 (tuple2 a1 c1) (tuple2 b2 d2))
  (Tuple2 (tuple2 a1 c1) (tuple2 b2 d2) (t2tb133 (Tuple27 x y))
  (Tuple2 b2 d2 z w)) (parallel_product d2 c1 b2 a1 h k))
  (and (mem (tuple2 a1 b2) (Tuple2 a1 b2 (t2tb2 x) z) h) (mem (tuple2 c1 d2)
  (Tuple2 c1 d2 (t2tb135 y) w) k))))))

;; mem_parallel_product
  (assert
  (forall ((b2 ty))
  (forall ((h uni) (k (set (tuple21 b c))) (x a) (y b) (z uni) (w c))
  (= (mem (tuple2 (tuple2 a1 b1) (tuple2 b2 c1))
  (Tuple2 (tuple2 a1 b1) (tuple2 b2 c1) (t2tb13 (Tuple21 x y))
  (Tuple2 b2 c1 z (t2tb135 w))) (parallel_product c1 b1 b2 a1 h (t2tb131 k)))
  (and (mem (tuple2 a1 b2) (Tuple2 a1 b2 (t2tb2 x) z) h) (mem8 (Tuple26 y w)
  k))))))

;; mem_parallel_product
  (assert
  (forall ((b2 ty))
  (forall ((h uni) (k (set (tuple21 b a))) (x a) (y b) (z uni) (w a))
  (= (mem (tuple2 (tuple2 a1 b1) (tuple2 b2 a1))
  (Tuple2 (tuple2 a1 b1) (tuple2 b2 a1) (t2tb13 (Tuple21 x y))
  (Tuple2 b2 a1 z (t2tb2 w))) (parallel_product a1 b1 b2 a1 h (t2tb37 k)))
  (and (mem (tuple2 a1 b2) (Tuple2 a1 b2 (t2tb2 x) z) h) (mem5 (Tuple25 y w)
  k))))))
...
;; mem_parallel_product
  (assert
  (forall ((d2 ty))
  (forall ((h (set (tuple21 a c))) (k uni) (x a) (y c) (z c) (w uni))
  (= (mem (tuple2 (tuple2 a1 c1) (tuple2 c1 d2))
  (Tuple2 (tuple2 a1 c1) (tuple2 c1 d2) (t2tb133 (Tuple27 x y))
  (Tuple2 c1 d2 (t2tb135 z) w)) (parallel_product d2 c1 c1 a1 (t2tb129 h) k))
  (and (mem10 (Tuple27 x z) h) (mem (tuple2 c1 d2)
  (Tuple2 c1 d2 (t2tb135 y) w) k))))))
...
;; mem_parallel_product
  ...
  (Tuple2 (tuple2 a1 b1) (tuple2 c1 c1) (t2tb13 (Tuple21 x y))
  (Tuple2 c1 c1 (t2tb135 z) (t2tb135 w)))
  (parallel_product c1 b1 c1 a1 (t2tb129 h) (t2tb131 k)))
  (and (mem10 (Tuple27 x z) h) (mem8 (Tuple26 y w) k)))))
...
;; mem_parallel_product
  ...
  (Tuple2 (tuple2 a1 b1) (tuple2 c1 a1) (t2tb13 (Tuple21 x y))
  (Tuple2 c1 a1 (t2tb135 z) (t2tb2 w)))
  (parallel_product a1 b1 c1 a1 (t2tb129 h) (t2tb37 k)))
  (and (mem10 (Tuple27 x z) h) (mem5 (Tuple25 y w) k)))))

;; mem_parallel_product
  (assert
  (forall ((d2 ty))
  (forall ((h (set (tuple21 a c))) (k uni) (x a) (y b) (z c) (w uni))
  (= (mem (tuple2 (tuple2 a1 b1) (tuple2 c1 d2))
  (Tuple2 (tuple2 a1 b1) (tuple2 c1 d2) (t2tb13 (Tuple21 x y))
  (Tuple2 c1 d2 (t2tb135 z) w)) (parallel_product d2 b1 c1 a1 (t2tb129 h) k))
  (and (mem10 (Tuple27 x z) h) (mem (tuple2 b1 d2)
  (Tuple2 b1 d2 (t2tb14 y) w) k))))))
...
;; mem_parallel_product
  ...
  (and (mem10 (Tuple27 x z) h) (mem10 (Tuple27 y w) k)))))
...
;; mem_parallel_product
  ...
  (and (mem10 (Tuple27 x z) h) (mem3 (Tuple21 y w) k)))))
...
;; mem_parallel_product
  ...
  (and (mem10 (Tuple27 x z) h) (mem (tuple2 c2 d2) (Tuple2 c2 d2 y w) k))))))

;; mem_parallel_product
  (assert
  (forall ((c2 ty))
  (forall ((h (set (tuple21 a b))) (k uni) (x a) (y uni) (z b) (w c))
  (= (mem (tuple2 (tuple2 a1 c2) (tuple2 b1 c1))
  (Tuple2 (tuple2 a1 c2) (tuple2 b1 c1) (Tuple2 a1 c2 (t2tb2 x) y)
  (t2tb134 (Tuple26 z w))) (parallel_product c1 c2 b1 a1 (t2tb11 h) k))
  (and (mem3 (Tuple21 x z) h) (mem (tuple2 c2 c1)
  (Tuple2 c2 c1 y (t2tb135 w)) k))))))

;; mem_parallel_product
  (assert
  (forall ((c2 ty))
  (forall ((h (set (tuple21 a b))) (k uni) (x a) (y uni) (z b) (w a))
  (= (mem (tuple2 (tuple2 a1 c2) (tuple2 b1 a1))
  (Tuple2 (tuple2 a1 c2) (tuple2 b1 a1) (Tuple2 a1 c2 (t2tb2 x) y)
  (t2tb38 (Tuple25 z w))) (parallel_product a1 c2 b1 a1 (t2tb11 h) k))
  (and (mem3 (Tuple21 x z) h) (mem (tuple2 c2 a1) (Tuple2 c2 a1 y (t2tb2 w))
  k))))))

;; mem_parallel_product
  (assert
  (forall ((h (set (tuple21 a b))) (k (set (tuple21 c c))) (x a) (y c) (z b)
  (w c))
  (= (mem (tuple2 (tuple2 a1 c1) (tuple2 b1 c1))
  (Tuple2 (tuple2 a1 c1) (tuple2 b1 c1) (t2tb133 (Tuple27 x y))
  (t2tb134 (Tuple26 z w)))
  (parallel_product c1 c1 b1 a1 (t2tb11 h) (t2tb216 k)))
  (and (mem3 (Tuple21 x z) h) (mem (tuple2 c1 c1)
  (Tuple2 c1 c1 (t2tb135 y) (t2tb135 w)) (t2tb216 k))))))
...
;; mem_parallel_product
  ...
  (w a))
  (= (mem (tuple2 (tuple2 a1 c1) (tuple2 b1 a1))
  (Tuple2 (tuple2 a1 c1) (tuple2 b1 a1) (t2tb133 (Tuple27 x y))
  (t2tb38 (Tuple25 z w)))
  (parallel_product a1 c1 b1 a1 (t2tb11 h) (t2tb224 k)))
  (and (mem3 (Tuple21 x z) h) (mem (tuple2 c1 a1)
  (Tuple2 c1 a1 (t2tb135 y) (t2tb2 w)) (t2tb224 k))))))

;; mem_parallel_product
  (assert
  (forall ((d2 ty))
  (forall ((h (set (tuple21 a b))) (k uni) (x a) (y c) (z b) (w uni))
  (= (mem (tuple2 (tuple2 a1 c1) (tuple2 b1 d2))
  (Tuple2 (tuple2 a1 c1) (tuple2 b1 d2) (t2tb133 (Tuple27 x y))
  (Tuple2 b1 d2 (t2tb14 z) w)) (parallel_product d2 c1 b1 a1 (t2tb11 h) k))
  (and (mem3 (Tuple21 x z) h) (mem (tuple2 c1 d2)
  (Tuple2 c1 d2 (t2tb135 y) w) k))))))
...
;; mem_parallel_product
  ...
  (w c))
  (= (mem (tuple2 (tuple2 a1 b1) (tuple2 b1 c1))
  (Tuple2 (tuple2 a1 b1) (tuple2 b1 c1) (t2tb13 (Tuple21 x y))
  (t2tb134 (Tuple26 z w)))
  (parallel_product c1 b1 b1 a1 (t2tb11 h) (t2tb131 k)))
  (and (mem3 (Tuple21 x z) h) (mem8 (Tuple26 y w) k)))))
...
;; mem_parallel_product
  ...
  (w a))
  (= (mem (tuple2 (tuple2 a1 b1) (tuple2 b1 a1))
  (Tuple2 (tuple2 a1 b1) (tuple2 b1 a1) (t2tb13 (Tuple21 x y))
  (t2tb38 (Tuple25 z w)))
  (parallel_product a1 b1 b1 a1 (t2tb11 h) (t2tb37 k)))
  (and (mem3 (Tuple21 x z) h) (mem5 (Tuple25 y w) k)))))
...
;; mem_parallel_product
  ...
  (and (mem3 (Tuple21 x z) h) (mem (tuple2 b1 d2) (Tuple2 b1 d2 (t2tb14 y) w)
  k))))))
...
;; mem_parallel_product
  ...
  (and (mem3 (Tuple21 x z) h) (mem10 (Tuple27 y w) k)))))
...
;; mem_parallel_product
  ...
  (and (mem3 (Tuple21 x z) h) (mem (tuple2 c2 d2) (Tuple2 c2 d2 y w) k))))))

;; mem_parallel_product
  (assert
  (forall ((h (set (tuple21 a a))) (k (set (tuple21 c c))) (x a) (y c) (z a)
  (w c))
  (= (mem (tuple2 (tuple2 a1 c1) (tuple2 a1 c1))
  (Tuple2 (tuple2 a1 c1) (tuple2 a1 c1) (t2tb133 (Tuple27 x y))
  (t2tb133 (Tuple27 z w)))
  (parallel_product c1 c1 a1 a1 (t2tb4 h) (t2tb216 k)))
  (and (mem (tuple2 a1 a1) (Tuple2 a1 a1 (t2tb2 x) (t2tb2 z)) (t2tb4 h)) (mem
  (tuple2 c1 c1) (Tuple2 c1 c1 (t2tb135 y) (t2tb135 w)) (t2tb216 k))))))

;; mem_parallel_product
  (assert
  (forall ((h (set (tuple21 a a))) (k (set (tuple21 c b))) (x a) (y c) (z a)
  (w b))
  (= (mem (tuple2 (tuple2 a1 c1) (tuple2 a1 b1))
  (Tuple2 (tuple2 a1 c1) (tuple2 a1 b1) (t2tb133 (Tuple27 x y))
  (t2tb13 (Tuple21 z w)))
  (parallel_product b1 c1 a1 a1 (t2tb4 h) (t2tb222 k)))
  (and (mem (tuple2 a1 a1) (Tuple2 a1 a1 (t2tb2 x) (t2tb2 z)) (t2tb4 h)) (mem
  (tuple2 c1 b1) (Tuple2 c1 b1 (t2tb135 y) (t2tb14 w)) (t2tb222 k))))))
...
;; mem_parallel_product
  ...
  (w c))
  (= (mem (tuple2 (tuple2 a1 b1) (tuple2 a1 c1))
  (Tuple2 (tuple2 a1 b1) (tuple2 a1 c1) (t2tb13 (Tuple21 x y))
  (t2tb133 (Tuple27 z w)))
  (parallel_product c1 b1 a1 a1 (t2tb4 h) (t2tb131 k)))
  (and (mem (tuple2 a1 a1) (Tuple2 a1 a1 (t2tb2 x) (t2tb2 z)) (t2tb4 h))
  (mem8 (Tuple26 y w) k)))))
...
;; mem_partial_function_set
  ...
  (=> (and (mem8 (Tuple26 x y1) f) (mem8 (Tuple26 x y2) f)) (= y1 y2)))))))
...
;; mem_partial_function_set
  ...
  (=> (and (mem5 (Tuple25 x y1) f) (mem5 (Tuple25 x y2) f)) (= y1 y2)))))))
...
;; mem_partial_function_set
  ...
  (=> (and (mem10 (Tuple27 x y1) f) (mem10 (Tuple27 x y2) f)) (= y1 y2)))))))
...
;; apply_def0
  ...
  (Tuple26 a2 (tb2t135 (apply c1 b1 (t2tb131 f) (t2tb14 a2)))) f))))
...
;; apply_def0
  ...
  (Tuple25 a2 (tb2t2 (apply a1 b1 (t2tb37 f) (t2tb14 a2)))) f))))
...
;; apply_def0
  ...
  (Tuple27 a2 (tb2t135 (apply c1 a1 (t2tb129 f) (t2tb2 a2)))) f))))
...
(assert
;; equal_semicolon_14
 ;; File "lemmes_bbook.why", line 1622, characters 7-25
  (not
  (forall ((s (set a)) (t (set b)) (u (set c)) (r (set (tuple21 a b))) (x b)
  (y c))
  (=> (and (mem4 r (relation1 s t)) (and (mem2 x t) (mem7 y u))) (infix_eqeq9
  (semicolon1 r (singleton7 (Tuple26 x y)))
  (times4 (image2 (inverse2 r) (singleton2 x)) (singleton6 y)))))))
(check-sat)
