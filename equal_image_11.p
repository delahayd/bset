...
tff(equal_image_11, conjecture, ![A : $tType, B : $tType, C : $tType]: ![S:
  ...
  => infix_eqeq(tuple2(A, C), image(tuple2(A, B),
  tuple2(A, C), parallel_product(A, A, B, C, id(A, S), Q), P), semicolon(A,
  B, C, P, Q)))).
