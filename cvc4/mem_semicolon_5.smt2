...
(declare-fun infix_mnmngt3 ((set b) (set c)) (set (set (tuple21 b c))))

;; mem_total_function_set
  (assert
  (forall ((s (set b)) (t (set c)) (x (set (tuple21 b c))))
  (= (mem9 x (infix_mnmngt3 s t))
...
(declare-fun infix_mnmngtgt2 ((set a) (set c)) (set (set (tuple21 a c))))

(declare-fun infix_mnmngtgt3 ((set b) (set c)) (set (set (tuple21 b c))))

;; mem_total_surjection_set
  (assert
  (forall ((s (set b)) (t (set c)) (x (set (tuple21 b c))))
  (= (mem9 x (infix_mnmngtgt3 s t))
...
(assert
;; mem_semicolon_5
 ;; File "lemmes_bbook.why", line 377, characters 7-22
  (not
  (forall ((s (set a)) (t (set b)) (u (set c)) (f (set (tuple21 a b)))
  (g (set (tuple21 b c))))
  (=> (and (mem4 f (infix_mnmngtgt1 s t)) (mem9 g (infix_mnmngt3 t u)))
  (mem11 (semicolon1 f g) (infix_mnmngt2 s u))))))
(check-sat)
