...
fof(mem_overriding_3, conjecture, ![S, T, F, G]: ((sort(set(a), S) = S)
  ...
  S, T)) & infix_eqeq(b, inter(b, ran(b, a, G), ran(b, a,
  domain_substraction(b, a, dom(b, a, G), F))), empty(b))))
  => mem(set(tuple2(a, b)), infix_lspl(b, a, F, G), infix_gtplgt(b, a, S,
  T)))))))).
