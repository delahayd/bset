...
tff(mem_inverse_4, conjecture, ![A : $tType, B : $tType]: ![S:set(A), T:
  set(B), F:set(tuple2(A, B))]: (mem(set(tuple2(A, B)), F, infix_gtmngtgt(A,
  B, S, T)) => mem(set(tuple2(B, A)), inverse(A, B, F), infix_gtmngtgt(B,
  A, T, S)))).
