...
(assert
;; equal_semicolon_23
 ;; File "lemmes_bbook.why", line 1702, characters 7-25
  (not
  (forall ((s (set a)) (t (set b)) (v (set b)) (u (set c)) (p (set (tuple21 a
  b))) (r (set (tuple21 b c))))
  (=>
  (and (mem4 p (relation1 s t)) (and (subset5 v t) (mem9 r (relation4 t u))))
  (infix_eqeq9 (semicolon1 (range_substraction1 p v) r)
  (semicolon1 p (domain_substraction3 v r)))))))
(check-sat)
