...
(assert
;; mem_substraction_1
 ;; File "lemmes_bbook.why", line 431, characters 7-25
  (not
  (forall ((s (set a)) (t (set b)) (u (set a)) (r (set (tuple21 a b))))
  (=> (and (subset2 u s) (mem4 r (relation1 s t))) (mem4
  (domain_substraction1 u r) (relation1 (diff1 s u) t))))))
(check-sat)
