...
(assert
;; monot_restriction_2
 ;; File "lemmes_bbook.why", line 796, characters 7-26
  (not
  (forall ((s (set a)) (t (set b)) (u (set b)) (v (set b)) (p (set (tuple21 a
  b))) (r (set (tuple21 a b))))
  (=> (and (mem4 p (relation1 s t)) (subset5 v t))
  (=> (and (subset6 r p) (subset5 u v)) (subset6 (range_restriction1 r u)
  (range_restriction1 p v)))))))
(check-sat)
