...
fof(equal_inverse_11, conjecture, ![S, T, P, Q]: ((sort(set(a), S) = S)
  ...
  => infix_eqeq(tuple2(b, a), inverse(b, a, inter(tuple2(a, b), P, Q)),
  inter(tuple2(b, a), inverse(b, a, P), inverse(b, a, Q))))))))).
