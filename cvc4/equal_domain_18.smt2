...
;; mem_dom
  ...
  (= (mem a1 (t2tb2 x) (t2tb1 (dom1 p)))
  (exists ((b2 b)) (mem (tuple2 a1 b1) (Tuple2 a1 b1 (t2tb2 x) (t2tb14 b2))
  (t2tb11 p))))))
...
;; mem_overriding
  ...
  (or
  (and (mem (tuple2 a1 b1) (Tuple2 a1 b1 (t2tb2 x) (t2tb14 y)) (t2tb11 q))
  (not (mem a1 (t2tb2 x) (t2tb1 (dom1 p))))) (mem (tuple2 a1 b1)
  (Tuple2 a1 b1 (t2tb2 x) (t2tb14 y)) (t2tb11 p))))))
...
;; apply_def0
  ...
  (t2tb1 (dom1 f)))) (mem (tuple2 a1 b1)
  (Tuple2 a1 b1 (t2tb2 a2) (apply b1 a1 (t2tb11 f) (t2tb2 a2))) (t2tb11 f)))))
...
(assert
;; equal_domain_18
 ;; File "lemmes_bbook.why", line 1351, characters 7-22
  (not
  (forall ((s (set a)) (t (set b)))
  (=> (not (infix_eqeq3 t empty2)) (infix_eqeq1 (dom1 (times2 s t)) s)))))
(check-sat)
