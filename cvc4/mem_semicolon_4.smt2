...
(declare-fun infix_plmngtgt2 ((set a) (set c)) (set (set (tuple21 a c))))
...
;; mem_total_surjection_set
  ...
  (and (mem11 x (infix_plmngtgt2 s t)) (mem11 x
  (tb2t128 (infix_mnmngt c1 a1 (t2tb1 s) (t2tb132 t))))))))
...
(assert
;; mem_semicolon_4
 ;; File "lemmes_bbook.why", line 369, characters 7-22
  (not
  (forall ((s (set a)) (t (set b)) (u (set c)) (f (set (tuple21 a b)))
  (g (set (tuple21 b c))))
  (=> (and (mem4 f (infix_plmngtgt1 s t)) (mem9 g (infix_plmngtgt3 t u)))
  (mem11 (semicolon1 f g) (infix_plmngtgt2 s u))))))
(check-sat)
