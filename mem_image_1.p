...
tff(mem_image_1, conjecture, ![A : $tType, B : $tType]: ![S:set(A), T:
  set(B), U:set(A), R:set(tuple2(A, B))]: ((mem(set(tuple2(A, B)), R,
  relation(A, B, S, T)) & subset(A, U, S)) => subset(B, image(A, B, R, U),
  T))).
