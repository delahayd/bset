...
(declare-fun t2tb1914 ((set (tuple21 (tuple21 (tuple21 a c) (tuple21 b d))
  (tuple21 a c)))) uni)
...
(declare-fun tb2t1914 (uni) (set (tuple21 (tuple21 (tuple21 a c) (tuple21 b
  d)) (tuple21 a c))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 (tuple21 a c) (tuple21 b d)) (tuple21 a
  c))))) (! (= (tb2t1914 (t2tb1914 i)) i) :pattern ((t2tb1914 i)) )))
...
;; BridgeR
  ...
  (! (=> (sort
     ...
     (= (t2tb1914 (tb2t1914 j)) j)) :pattern ((t2tb1914 (tb2t1914 j))) )))

(declare-fun t2tb1915 ((tuple21 (tuple21 (tuple21 a c) (tuple21 b d))
  (tuple21 a c))) uni)
...
(declare-fun tb2t1915 (uni) (tuple21 (tuple21 (tuple21 a c) (tuple21 b d))
  (tuple21 a c)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 (tuple21 a c) (tuple21 b d)) (tuple21 a c))))
  (! (= (tb2t1915 (t2tb1915 i)) i) :pattern ((t2tb1915 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 (tuple2 a1 c1) (tuple2 b1 d1)) (tuple2 a1 c1))
     j) (= (t2tb1915 (tb2t1915 j)) j)) :pattern ((t2tb1915 (tb2t1915 j))) )))
...
(declare-fun t2tb1921 ((set (tuple21 (tuple21 a c) (tuple21 (tuple21 a c)
  (tuple21 b d))))) uni)
...
(declare-fun tb2t1921 (uni) (set (tuple21 (tuple21 a c) (tuple21 (tuple21 a
  c) (tuple21 b d)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 a c) (tuple21 (tuple21 a c) (tuple21 b
  d)))))) (! (= (tb2t1921 (t2tb1921 i)) i) :pattern ((t2tb1921 i)) )))
...
;; BridgeR
  ...
  (! (=> (sort
     ...
     (= (t2tb1921 (tb2t1921 j)) j)) :pattern ((t2tb1921 (tb2t1921 j))) )))

(declare-fun t2tb1922 ((tuple21 (tuple21 a c) (tuple21 (tuple21 a c)
  (tuple21 b d)))) uni)
...
(declare-fun tb2t1922 (uni) (tuple21 (tuple21 a c) (tuple21 (tuple21 a c)
  (tuple21 b d))))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 a c) (tuple21 (tuple21 a c) (tuple21 b d)))))
  (! (= (tb2t1922 (t2tb1922 i)) i) :pattern ((t2tb1922 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 a1 c1) (tuple2 (tuple2 a1 c1) (tuple2 b1 d1)))
     j) (= (t2tb1922 (tb2t1922 j)) j)) :pattern ((t2tb1922 (tb2t1922 j))) )))
...
;; mem_times
  ...
  (and (mem10 x s) (mem (tuple2 b1 d1) (t2tb692 y) (t2tb687 t))))))
...
(declare-fun t2tb1927 ((set (set (tuple21 (tuple21 (tuple21 a c) (tuple21 b
  d)) (tuple21 a c))))) uni)
...
(declare-fun tb2t1927 (uni) (set (set (tuple21 (tuple21 (tuple21 a c)
...
;; BridgeL
  ...
  (forall ((i (set (set (tuple21 (tuple21 (tuple21 a c) (tuple21 b d))
  (tuple21 a c))))))
  (! (= (tb2t1927 (t2tb1927 i)) i) :pattern ((t2tb1927 i)) )))
...
;; BridgeR
  ...
  (! (=> (sort
     (set1
     (set1 (tuple2 (tuple2 (tuple2 a1 c1) (tuple2 b1 d1)) (tuple2 a1 c1))))
     j) (= (t2tb1927 (tb2t1927 j)) j)) :pattern ((t2tb1927 (tb2t1927 j))) )))
...
;; mem_relation
  ...
  (=> (mem (tuple2 (tuple2 (tuple2 a1 c1) (tuple2 b1 d1)) (tuple2 a1 c1))
  (Tuple2 (tuple2 (tuple2 a1 c1) (tuple2 b1 d1)) (tuple2 a1 c1) (t2tb691 x)
  (t2tb133 y)) (t2tb1914 r)) (and (mem24 x u) (mem10 y v)))))))
...
(declare-fun t2tb1931 ((set (set (tuple21 (tuple21 a c) (tuple21 (tuple21 a
  c) (tuple21 b d)))))) uni)
...
(declare-fun tb2t1931 (uni) (set (set (tuple21 (tuple21 a c)
  (tuple21 (tuple21 a c) (tuple21 b d))))))
...
;; BridgeL
  ...
  (tuple21 b d)))))))
  (! (= (tb2t1931 (t2tb1931 i)) i) :pattern ((t2tb1931 i)) )))
...
;; BridgeR
  ...
  (! (=> (sort
     (set1
     (set1 (tuple2 (tuple2 a1 c1) (tuple2 (tuple2 a1 c1) (tuple2 b1 d1)))))
     j) (= (t2tb1931 (tb2t1931 j)) j)) :pattern ((t2tb1931 (tb2t1931 j))) )))
...
;; mem_relation
  ...
  (=> (mem (tuple2 (tuple2 a1 c1) (tuple2 (tuple2 a1 c1) (tuple2 b1 d1)))
  (Tuple2 (tuple2 a1 c1) (tuple2 (tuple2 a1 c1) (tuple2 b1 d1)) (t2tb133 x)
  (t2tb691 y)) (t2tb1921 r)) (and (mem10 x u) (mem24 y v)))))))
...
;; mem_relation
  ...
  (and (mem10 x u) (mem (tuple2 b1 d1) (t2tb692 y) (t2tb687 v))))))))
...
(declare-fun dom7 ((set (tuple21 c d))) (set c))

(declare-fun dom8 ((set (tuple21 (tuple21 a c) (tuple21 b
  d)))) (set (tuple21 a c)))
...
;; mem_image
  ...
  (= (mem24 x
  (tb2t686
  (image (tuple2 (tuple2 a1 c1) (tuple2 b1 d1)) (tuple2 a1 c1) (t2tb1921 p)
  (t2tb129 w))))
...
(declare-fun t2tb1935 ((tuple21 (set c) (set d))) uni)
...
(declare-fun tb2t1935 (uni) (tuple21 (set c) (set d)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (set c) (set d))))
  (! (= (tb2t1935 (t2tb1935 i)) i) :pattern ((t2tb1935 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (set1 c1) (set1 d1)) j) (= (t2tb1935 (tb2t1935 j)) j)) :pattern (
  (t2tb1935 (tb2t1935 j))) )))
...
(declare-fun t2tb1936 ((tuple21 (set a) (set c))) uni)
...
(declare-fun tb2t1936 (uni) (tuple21 (set a) (set c)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (set a) (set c))))
  (! (= (tb2t1936 (t2tb1936 i)) i) :pattern ((t2tb1936 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (set1 a1) (set1 c1)) j) (= (t2tb1936 (tb2t1936 j)) j)) :pattern (
  (t2tb1936 (tb2t1936 j))) )))
...
(declare-fun t2tb1937 ((set (tuple21 (tuple21 (tuple21 a c) a)
...
(declare-fun tb2t1937 (uni) (set (tuple21 (tuple21 (tuple21 a c) a)
  (tuple21 (tuple21 b d) c))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 (tuple21 a c) a) (tuple21 (tuple21 b d)
  c))))) (! (= (tb2t1937 (t2tb1937 i)) i) :pattern ((t2tb1937 i)) )))
...
;; BridgeR
  ...
  (! (=> (sort
     ...
     (= (t2tb1937 (tb2t1937 j)) j)) :pattern ((t2tb1937 (tb2t1937 j))) )))

(declare-fun t2tb1938 ((tuple21 (tuple21 (tuple21 a c) a) (tuple21 (tuple21 b
  d) c))) uni)
...
(declare-fun tb2t1938 (uni) (tuple21 (tuple21 (tuple21 a c) a)
  (tuple21 (tuple21 b d) c)))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 (tuple21 a c) a) (tuple21 (tuple21 b d) c))))
  (! (= (tb2t1938 (t2tb1938 i)) i) :pattern ((t2tb1938 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 (tuple2 a1 c1) a1) (tuple2 (tuple2 b1 d1) c1))
     j) (= (t2tb1938 (tb2t1938 j)) j)) :pattern ((t2tb1938 (tb2t1938 j))) )))
...
(declare-fun t2tb1941 ((set (tuple21 (tuple21 a (tuple21 a c)) (tuple21 c
  (tuple21 b d))))) uni)
...
(declare-fun tb2t1941 (uni) (set (tuple21 (tuple21 a (tuple21 a c))
  (tuple21 c (tuple21 b d)))))

;; BridgeL
  (assert
  (forall ((i (set (tuple21 (tuple21 a (tuple21 a c)) (tuple21 c (tuple21 b
  d)))))) (! (= (tb2t1941 (t2tb1941 i)) i) :pattern ((t2tb1941 i)) )))
...
;; BridgeR
  ...
  (! (=> (sort
     ...
     (= (t2tb1941 (tb2t1941 j)) j)) :pattern ((t2tb1941 (tb2t1941 j))) )))

(declare-fun t2tb1942 ((tuple21 (tuple21 a (tuple21 a c)) (tuple21 c
  (tuple21 b d)))) uni)
...
(declare-fun tb2t1942 (uni) (tuple21 (tuple21 a (tuple21 a c)) (tuple21 c
  (tuple21 b d))))

;; BridgeL
  (assert
  (forall ((i (tuple21 (tuple21 a (tuple21 a c)) (tuple21 c (tuple21 b d)))))
  (! (= (tb2t1942 (t2tb1942 i)) i) :pattern ((t2tb1942 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (tuple2 (tuple2 a1 (tuple2 a1 c1)) (tuple2 c1 (tuple2 b1 d1)))
     j) (= (t2tb1942 (tb2t1942 j)) j)) :pattern ((t2tb1942 (tb2t1942 j))) )))
...
(assert
;; equal_domain_12
 ;; File "lemmes_bbook.why", line 1299, characters 7-22
  (not
  (forall ((s (set a)) (t (set b)) (u (set c)) (v (set d)) (p (set (tuple21 a
  b))) (q (set (tuple21 c d))))
  (=> (and (mem4 p (relation1 s t)) (mem22 q (relation7 u v))) (infix_eqeq9
  (dom8 (parallel_product1 p q)) (times4 (dom1 p) (dom7 q)))))))
(check-sat)
