...
;; apply_def0
  ...
  (=> (and (mem6 f2 (infix_plmngt2 s t)) (mem2 a2 (dom3 f2))) (mem5
...
;; apply_def0
  ...
  (=>
  (and (mem (set1 (tuple2 a1 b1)) (t2tb11 f2)
  (infix_plmngt b1 a1 (t2tb1 s) (t2tb12 t))) (mem1 a2 (dom1 f2))) (mem3
...
;; apply_def0
  ...
  (=>
  (and (mem (set1 (tuple2 a1 a1)) (t2tb4 f2)
  (infix_plmngt a1 a1 (t2tb1 s) (t2tb1 t))) (mem1 a2 (dom2 f2))) (mem12
...
(assert
;; equal_image_2
 ;; File "lemmes_bbook.why", line 2290, characters 7-20
  (not
  (forall ((s (set a)) (u (set a)) (t (set b)) (r (set (tuple21 a b))))
  (=> (and (mem6 (inverse2 r) (infix_plmngt2 t s)) (subset2 u (dom1 r)))
  (infix_eqeq1 (image7 (semicolon3 r (inverse2 r)) u) u)))))
(check-sat)
